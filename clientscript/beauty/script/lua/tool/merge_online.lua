...
local lua_dir = '/data/autodeploy/gt_client/online_cfg'
local target_json_dir = '/data/autodeploy/gt_client/online_cfg/json/'
...
local mergePath = {
    ...
    ['idn'] = {lua_dir, target_json_dir.."gameconfig_idn.json", target_json_dir.."gameconfig_idn_new.json", target_json_dir.."preloadconfig_idn.json"},
