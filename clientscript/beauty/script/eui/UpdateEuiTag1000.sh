...
if [[ ! -d /Users/publish/h5/gt_h5/client/tags/PalaceWarEuiTag ]]; then
    svn checkout http://svn.rjoy.com:9080/repos/jt/client/tags/PalaceWarEuiTag /Users/publish/h5/gt_h5/client/tags/PalaceWarEuiTag || exit 1
fi
...
if [[ ! -d /Users/publish/h5/gt_h5/clientscript ]]; then
    svn checkout http://svn.rjoy.com:9080/repos/jt/clientscript /Users/publish/h5/gt_h5/clientscript || exit 1
fi
cd /Users/publish/h5/gt_h5/clientscript || exit 1
svn revert -R . || exit 1
svn update || exit 1
