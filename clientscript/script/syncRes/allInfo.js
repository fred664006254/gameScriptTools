...
module.exports={
	getInfo:function (trunkPath) {
        ...
        // 多语言标识
        // var multiArr = ["en"];
        var multiArr = ["en", "iosshenhe", "iosshenhe_tw", "kr", "th", "tw", "twcn", "hexie", "wanba","iosshenhe_3k",
            "iosshenhe_en", "iosshenhe_th", "iosshenhe_xy","iosshenhe4","ru","iosshenhe_ru",
        ];
        needDelete["cn"] = {};
        dirR.dirR(trunkPath + "/PalaceWar/resource/assets", (type, path)=>{
            if (type === "file") {
    ...
    getPathMd5:function(trunkPath, language, path, needDelete) {
        ...
        if (md5merge) {
            ...
            ft1 = trunkPath + ((language === "cn")?"/PalaceWar/resource/assets":("/resoucres_multi/assets_"+language)) + ft1;
            ft2 = trunkPath + ((language === "cn")?"/PalaceWar/resource/assets":("/resoucres_multi/assets_"+language)) + ft2;
            ...
            var ft1 = trunkPath + ((language === "cn")?"/PalaceWar/resource/assets":("/resoucres_multi/assets_"+language)) + path;
