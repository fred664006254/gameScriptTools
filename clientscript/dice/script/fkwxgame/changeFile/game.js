...
var _scaleMode = "fixedWidth"
var _scw = _sysInfo.screenWidth;
var _sch = _sysInfo.screenHeight;
if ((_sch / _scw) < (1136 / 640)) {
  _scaleMode = "fixedHeight"
}
    ...
    let task = wx.loadSubpackage({
      ...
      success: function () {
        ...
        task.onProgressUpdate(res => {
          EgretSubPackageLoading.instance.setProgress(res, 2);
        })
      }
    });
  
    task.onProgressUpdate(res => {
      EgretSubPackageLoading.instance.setProgress(res, 1);
    })
  }
  else {
    //
