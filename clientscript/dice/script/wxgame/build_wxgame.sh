...
echo "复制sdk js"
cp $DIR/../../../client/tags/Librarys/wxgameRSDK/bin/wxgameRSDK.js $DIR/../../../client/tags/${tagname}_wxgame/js/wxgameRSDK.js  || exit 1
cp $DIR/../../../client/tags/Librarys/crypto/bin/crypto.js $DIR/../../../client/tags/${tagname}_wxgame/js/crypto.js || exit 1 
echo '; window.RSDK = RSDK; window.productInfo = productInfo;'>>$DIR/../../../client/tags/${tagname}_wxgame/js/wxgameRSDK.js || exit 1 
echo ''>>$DIR/../../../client/tags/${tagname}_wxgame/manifest.js || exit 1
echo 'require("js/crypto.js")'>>$DIR/../../../client/tags/${tagname}_wxgame/manifest.js || exit 1
echo 'require("js/wxgameRSDK.js")'>>$DIR/../../../client/tags/${tagname}_wxgame/manifest.js || exit 1
