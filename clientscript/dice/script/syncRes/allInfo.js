...
module.exports={
	getInfo:function (trunkPath) {
        ...
        var multiArr = [];
        needDelete["cn"] = {};
        dirR.dirR(trunkPath + "/Dice/resource/assets", (type, path)=>{
            if (type === "file") {
    ...
    getPathMd5:function(trunkPath, language, path, needDelete) {
        ...
        if (md5merge) {
            ...
            ft1 = trunkPath + ((language === "cn")?"/Dice/resource/assets":("/resoucres_multi/assets_"+language)) + ft1;
            ft2 = trunkPath + ((language === "cn")?"/Dice/resource/assets":("/resoucres_multi/assets_"+language)) + ft2;
            ...
            var ft1 = trunkPath + ((language === "cn")?"/Dice/resource/assets":("/resoucres_multi/assets_"+language)) + path;
