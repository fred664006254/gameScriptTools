...
gameFile=$1
plat=$2
# gameFile='/Users/develop/h5/dice/publishclient/localtest/local/gt_local'
defaultPath=''
...
echo "所有平台 用crc32文件名"
/usr/local/bin/node $scriptpath/buildResourcesVersionRenameCrc32.js $defaultPath || exit 1