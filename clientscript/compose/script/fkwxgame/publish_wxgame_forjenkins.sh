...
echo "同步publish"
$DIR/../syncSvn/updatePublish.sh wxmg || exit 1
...
echo "复制sdk js"
cp $DIR/../../../client/tags/Librarys/wxgameRSDK/rsdk-fkvip.js $DIR/../../../client/tags/${tag}_wxgame/js/rsdk-fkvip.js  || exit 1
...
echo 'window["WXMG_ISWXMG"] = true'>>$DIR/../../../client/tags/${tag}_wxgame/manifest.js || exit 1
...
echo "放到publish并上传"
rsync -avz $DIR/../../../client/tags/${tag}_wxgame/resourceallin/ $DIR/../../../publishclient/wxmg/gt_wxmg/resourceallin/ || exit 1
$DIR/../syncSvn/commitPublishNotOnlyTest.sh wxmg || exit 1
echo "删除资源"
rm -rf $DIR/../../../client/tags/${tag}_wxgame/resourceallin
...
ssh -tt opsteam@"gdhc-wxmg-web001.leishenhuyu.com"  -p 10220 'sudo bash /data/autodeploy/publish_client_wx.sh'
