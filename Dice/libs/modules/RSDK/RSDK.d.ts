declare namespace RSDK
{
    ...
    function checkHasAd(opt:{type:string,onCheckEnd:(data:any)=>void}):void;
    function showAd(opt:{roleId:string,type:string,onSuccess:Function,onFail:Function,onError:Function}):void;
    function copyToClipboard(code : string):void;
    /**退出应用，支持微信小游戏，微端，原生 */
    function forceAppExit():void;
