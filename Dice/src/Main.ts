class Main extends egret.DisplayObjectContainer 
{
    ...
    private onAddToStage(event: egret.Event) 
    {
        ...
        if(window["rgame_rotation"]==1)
        {
            ...
            let refreshTxt:BaseTextField=ComponentMgr.getTextField("",TextFieldConst.SIZE_CONTENT_COMMON);
            refreshTxt.stroke=1;
    ...
    {
        let logStr="default.res.json load error";
