...
class BaseLoadBitmap extends BaseBitmap
{
	...
	protected initLoadRes(res:string,rect?:egret.Rectangle,loadCompleteCallback?:{callback:(...args)=>void,callbackThisObj:any,callbackParams?:any[]}):void
	{
		if(!res)
		{
			return;
