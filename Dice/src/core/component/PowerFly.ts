...
class PowerFly extends BaseDisplayObjectContainer
{
	...
	{	
		...
		let message = LangMger.getlocal("powerAdd") + power;

		let msgTF:BaseBitmapText|BaseTextField = ComponentMgr.getBitmapText(message,"crit_fnt",NaN,TextFieldConst.SIZE_TITLE_COMMON);
		if(PlatMgr.checkIsThSp()||PlatMgr.checkIsRuSp() )
		{
