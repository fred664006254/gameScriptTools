 ...
 */
class CustomMovieClip extends BaseLoadBitmap
{
    protected _frameImages:string[] = [];
    private _frameRate:number = 60;
    private _timeRate:number = 0.001;//按时间播放
    private _playingIndex:number = 0;
    protected _playCount:number = 0;
    ...
    public set frameImages(textureNames:string[]){
        ...
        else
        {
            ...
            this.__groupName = ResMgr.loadResources(textureNames,[],()=>{},null,this);
        }
    }
    ...
    protected exceEndCallback():void
    {
