...
class GodLogin extends BaseDisplayObjectContainer
{
	...
	public show(godName:string):void
	{
		...
		ResMgr.loadResources(["godlogin_tips_bg","godlogin_tips_effect","godlogin_tips_world"],[],this.init,null,this);
	}
	/**
	 * 入口函数
	 */
	...
	private showName():void
	{
		...
		let nameTF:BaseTextField = ComponentMgr.getTextField(LangMger.getlocal("godloginTips",[this._godName]),TextFieldConst.SIZE_CONTENT_COMMON);
	...
	private remove():void
	{
		LayerMgr.msgLayer.removeChild(this);
	}
