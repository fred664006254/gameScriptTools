 ...
 * author qianjun
 */
var MyCardTeamTypeTab1 = (function (_super) {
    __extends(MyCardTeamTypeTab1, _super);
    function MyCardTeamTypeTab1() {
    ...
    MyCardTeamTypeTab1.prototype.refreshWhenSwitchBack = function () {
        var view = this;
    ...
    MyCardTeamTypeTab1.prototype.initView = function () {
        var view = this;
        view.name = "MyCardTeamTypeTab1";
    ...
    MyCardTeamTypeTab1.prototype.openChangeTeam = function (dice, width, height) {
        var view = this;
        view._curdice = dice;
        //打开编辑模式
        var line = Api.LineVoApi.getLineInfoById(view._teamid);
    ...
    MyCardTeamTypeTab1.prototype.useBack = function (evt) {
        var view = this;
        if (evt.data.ret) {
            var line = Api.LineVoApi.getLineInfoById(view._teamid);
            for (var i = 0; i < line.length; ++i) {
            ...
            view.setUseInfoShow(false);
            if (Api.GameinfoVoApi.checlIsInGuideId(21)) {
                App.CommonUtil.sendNewGuideId(21);
                //新手训练场 未开放
                //对战界面
                Api.GameinfoVoApi.setCurGudingId(24);
                App.MsgHelper.dispEvt(MsgConst.SHOW_GUIDE);
            }
        }
        view._curdice = "";
    };
    MyCardTeamTypeTab1.prototype.setUseInfoShow = function (flag) {
        var view = this;
    ...
    MyCardTeamTypeTab1.prototype.createChangeTeamGroup = function (dice) {
        var view = this;
    ...
    MyCardTeamTypeTab1.prototype.touchHandler = function (e) {
        var view = this;
    ...
    MyCardTeamTypeTab1.prototype.checkCanUse = function () {
        var view = this;
        var line = Api.LineVoApi.getLineInfoById(view._teamid);
        for (var i = 0; i < line.length; ++i) {
            var item = view._scrollList.getItemByIndex(i);
    ...
    MyCardTeamTypeTab1.prototype.getDistance = function (point1, point2) {
        return Math.sqrt(Math.pow(point1.x - point2.x, 2) + Math.pow(point1.y - point2.y, 2));
    };
    MyCardTeamTypeTab1.prototype.upgardeBack = function (evt) {
        var view = this;
        if (evt.data.ret) {
    ...
    MyCardTeamTypeTab1.prototype.getNetConstEventArr = function () {
        return [
            NetConst.DICE_USE, NetConst.DICE_UPGRADE
        ];
    };
    MyCardTeamTypeTab1.prototype.netEventCallBack = function (evt) {
        var view = this;
        switch (evt.type) {
    ...
    MyCardTeamTypeTab1.prototype.dispose = function () {
        var view = this;
        view._tipTxt = null;
        view._btn = null;
        view._iconbg = null;
    ...
    return MyCardTeamTypeTab1;
}(CommonViewTab));
__reflect(MyCardTeamTypeTab1.prototype, "MyCardTeamTypeTab1");
//# sourceMappingURL=MyCardTeamTypeTab1.js.map