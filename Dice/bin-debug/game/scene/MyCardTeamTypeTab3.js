 ...
 * author qianjun
 */
var MyCardTeamTypeTab3 = (function (_super) {
    __extends(MyCardTeamTypeTab3, _super);
    function MyCardTeamTypeTab3() {
    ...
    MyCardTeamTypeTab3.prototype.refreshWhenSwitchBack = function () {
        var view = this;
    ...
    MyCardTeamTypeTab3.prototype.initView = function () {
        var view = this;
    ...
    MyCardTeamTypeTab3.prototype.openChangeTeam = function (dice, width, height) {
        var view = this;
        view._curdice = dice;
        //打开编辑模式
        var line = Api.LineVoApi.getLineInfoById(view._teamid);
    ...
    MyCardTeamTypeTab3.prototype.useBack = function (evt) {
        var view = this;
        if (evt.data.ret) {
            var line = Api.LineVoApi.getLineInfoById(view._teamid);
            for (var i = 0; i < line.length; ++i) {
    ...
    MyCardTeamTypeTab3.prototype.setUseInfoShow = function (flag) {
        var view = this;
    ...
    MyCardTeamTypeTab3.prototype.createChangeTeamGroup = function (dice) {
        var view = this;
    ...
    MyCardTeamTypeTab3.prototype.touchHandler = function (e) {
        var view = this;
    ...
    MyCardTeamTypeTab3.prototype.checkCanUse = function () {
        var view = this;
        var line = Api.LineVoApi.getLineInfoById(view._teamid);
        for (var i = 0; i < line.length; ++i) {
            var item = view._scrollList.getItemByIndex(i);
    ...
    MyCardTeamTypeTab3.prototype.getDistance = function (point1, point2) {
        return Math.sqrt(Math.pow(point1.x - point2.x, 2) + Math.pow(point1.y - point2.y, 2));
    };
    MyCardTeamTypeTab3.prototype.upgardeBack = function (evt) {
        var view = this;
        if (evt.data.ret) {
    ...
    MyCardTeamTypeTab3.prototype.getNetConstEventArr = function () {
        return [
            NetConst.DICE_USE, NetConst.DICE_UPGRADE
        ];
    };
    MyCardTeamTypeTab3.prototype.netEventCallBack = function (evt) {
        var view = this;
        switch (evt.type) {
    ...
    MyCardTeamTypeTab3.prototype.dispose = function () {
        var view = this;
        view._tipTxt = null;
        view._btn = null;
        view._iconbg = null;
    ...
    return MyCardTeamTypeTab3;
}(CommonViewTab));
__reflect(MyCardTeamTypeTab3.prototype, "MyCardTeamTypeTab3");
//# sourceMappingURL=MyCardTeamTypeTab3.js.map