...
(function (App) {
    ...
    (function (DocumentUtil) {
         ...
         * 创建资源加载失败提示框
         */
        function showLoadResFailDiv(callback, callbackThisObj) {
        ...
        DocumentUtil.showLoadResFailDiv = showLoadResFailDiv;
        function hideLoadResFailDiv() {
            var divId = "gameloadresfaildiv";
            var element = document.getElementById(divId);
            if (element) {
        ...
        DocumentUtil.hideLoadResFailDiv = hideLoadResFailDiv;
        function loadResFailDivCallback() {
            DocumentUtil.hideLoadResFailDiv();
            if (callbackList) {
                while (callbackList.length > 0) {
                    var callbackObj = callbackList.shift();
    ...
    })(DocumentUtil = App.DocumentUtil || (App.DocumentUtil = {}));
})(App || (App = {}));
