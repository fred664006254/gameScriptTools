 ...
 * author qianjun
 */
var DiceLevelUpView = (function (_super) {
    __extends(DiceLevelUpView, _super);
    function DiceLevelUpView() {
    ...
    // 打开该面板时，需要传参数msg
    DiceLevelUpView.prototype.initView = function () {
        var view = this;
        ...
        if (App.CommonUtil.check_dragon()) {
            ...
            var xunhuan = App.DragonBonesUtil.getLoadDragonBones("box_effect_xunhuan", 0, "box_effect_xunhuan_" + pizhiarr[dicecfg.quality]);
        ...
        var diceIcon = App.CommonUtil.getDiceIconById(diceid, 1, true);
        group.addChild(diceIcon);
        App.DisplayUtil.setLayoutPosition(LayoutConst.horizontalCenter, diceIcon, group, [0, 0]);
        var diceNameTxt = ComponentMgr.getTextField(diceCfg.name, TextFieldConst.SIZE_40);
        ...
        var diceLevelTxt = ComponentMgr.getTextField(LangMger.getlocal("shopgetboxlv", [curlv.toString()]), TextFieldConst.SIZE_36, ColorEnums.white);
        ...
        var btn = ComponentMgr.getButton(ButtonConst.BTN_CONFIRM, LangMger.getlocal("sysconfirm"), this.closeHandler, this);
        group.addChild(btn);
    ...
    DiceLevelUpView.prototype.resetBgSize = function () {
    ...
    DiceLevelUpView.prototype.isTouchMaskClose = function () {
        return false;
    };
    DiceLevelUpView.prototype.clickConHandler = function (data) {
    ...
    DiceLevelUpView.prototype.getBgName = function () {
        return "public_ab_scenebg";
    };
    DiceLevelUpView.prototype.getTitleBgName = function () {
        return null;
    };
    DiceLevelUpView.prototype.getTitleStr = function () {
        return null;
    };
    DiceLevelUpView.prototype.getShowHeight = function () {
        return GameConfig.stageHeigth;
    };
    DiceLevelUpView.prototype.getCloseBtnName = function () {
        return null; //this.param.data.needClose === 1 ? 
    };
    DiceLevelUpView.prototype.hide = function () {
        var param = this.param;
        if (param.data.callback) {
            param.data.callback.apply(param.data.handler, [this]);
        }
    ...
    DiceLevelUpView.prototype.getResourceList = function () {
        var array = [];
    ...
    DiceLevelUpView.prototype.dispose = function () {
        this._diceid = null;
        this._isinuse = false;
        _super.prototype.dispose.call(this);
    };
    return DiceLevelUpView;
}(PopupView));
__reflect(DiceLevelUpView.prototype, "DiceLevelUpView");
//# sourceMappingURL=DiceLevelUpView.js.map