...
var ViewTab = (function (_super) {
    ...
    ViewTab.prototype.addTabbarGroupBg = function () {
        return false;
    };
    Object.defineProperty(ViewTab.prototype, "uiType", {
        get: function () {
            return "";
        },
        enumerable: true,
    ...
    ViewTab.prototype.setBigFameY = function (y) {
        if (this.bigframe) {
            this.bigframe.y = y;
     ...
     * 切换页签
     */
    ViewTab.prototype.refreshWhenSwitchBack = function (bool) {
    ...
    ViewTab.prototype.getViewBg = function () {
        var className = this.getClassName();
        className = this.getClassName().substring(0, className.indexOf("Tab"));
        var view = ViewController.getInstance().getView(className);
