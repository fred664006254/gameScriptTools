...
var TabBarScrollGroup = (function (_super) {
    ...
    TabBarScrollGroup.prototype.buildTabTar = function () {
        ...
        if (lineCount > 1) {
            var arrow_leftBtn = ComponentMgr.getButton("btn_leftpage", "", this.switchHandler, this, ["left"]);
            ...
            var arrow_rightBtn = ComponentMgr.getButton("btn_leftpage", "", this.switchHandler, this, ["right"]);
