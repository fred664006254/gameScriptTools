...
var RewardFly = (function (_super) {
    ...
    RewardFly.prototype.init = function (icon, message, itemtype, subNode, isHalve, itemVo) {
        ...
        var msgTF = ComponentMgr.getBitmapText(message, TextFieldConst.FONTNAME_ITEMTIP, NaN, TextFieldConst.SIZE_TITLE_COMMON);
        ...
        if (isHalve) {
            var halve = ComponentMgr.getTextField(LangMger.getlocal("halve"), TextFieldConst.SIZE_CONTENT_COMMON);
