...
var PowerFly = (function (_super) {
    ...
    PowerFly.prototype.init = function (power) {
        ...
        if (PlatMgr.checkIsThSp() || PlatMgr.checkIsRuSp()) {
            BaseBitmap.release(numBg);
        ...
        var message = LangMger.getlocal("powerAdd") + power;
        var msgTF = ComponentMgr.getBitmapText(message, "crit_fnt", NaN, TextFieldConst.SIZE_TITLE_COMMON);
        if (PlatMgr.checkIsThSp() || PlatMgr.checkIsRuSp()) {
            msgTF = msgTF;
            msgTF.bold = true;
        }
...
//# sourceMappingURL=PowerFly.js.map