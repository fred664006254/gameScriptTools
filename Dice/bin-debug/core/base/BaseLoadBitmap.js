...
var BaseLoadBitmap = (function (_super) {
    ...
    function BaseLoadBitmap(res, rect, loadCompleteCallback) {
        ...
        if (res) {
            _this.initLoadRes(res, rect, loadCompleteCallback);
        }
        return _this;
    }
    BaseLoadBitmap.prototype.setload = function (res, rect, loadCompleteCallback) {
        ...
        this.initLoadRes(res, rect, loadCompleteCallback);
    };
    BaseLoadBitmap.prototype.isLoaded = function () {
        return this._isloaded;
    };
    BaseLoadBitmap.prototype.initLoadRes = function (res, rect, loadCompleteCallback) {
        if (!res) {
            return;
        }
        this._resurl = res;
        ...
        this.loadRes();
        var sz = ResMgr.getImgSize(res);
        if (sz) {
            this.width = sz.w;
            this.height = sz.h;
        }
    };
    BaseLoadBitmap.prototype.getRect = function () {
        return this._rect;
    };
    BaseLoadBitmap.prototype.loadRes = function () {
        this.addUseCount();
        if (!ResMgr.getRes(this._resurl) || BaseLoadBitmap._LoadNum[this._resurl] == 1) {
            if (RES.hasRes(this._resurl)) {
                this._groupName = ResMgr.loadResources([this._resurl], [], this.dalyLoadComplete, null, this);
                // ResourceManager.loadItem(this._resurl,this.loadComplete,this);
            }
            else {
                if (this._resurl.indexOf(".") > -1) {
                    ResMgr.loadItemByUrl(this._resurl, this.loadComplete, this, RES.ResourceItem.TYPE_IMAGE);
                }
            }
        }
        else {
    ...
    BaseLoadBitmap.prototype.loadComplete = function (data) {
        ...
        if (data) {
            ...
            this.texture = ResMgr.getRes(this._resurl);
        }
    ...
    BaseLoadBitmap.create = function (res, rect, loadCompleteCallback) {
        ...
        if (!baseLoadBitmap) {
            ...
            baseLoadBitmap.initLoadRes(res, rect, loadCompleteCallback);
        }
