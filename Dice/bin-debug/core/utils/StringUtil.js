...
(function (App) {
    var StringUtil = (function () {
        ...
        */
         ...
         *
         */
        StringUtil.formatIntToStringWith6figure = function (num) {
            var numLength = num.toString().length;
            var strNum = num.toString();
            if (numLength <= 6) {
                return strNum;
         ...
         *
         */
        StringUtil.formatIntToStringWith3figure = function (num, start) {
            var numLength = num.toString().length;
            var strNum = num.toString();
            if (numLength > start) {
                var integerNum = numLength - 3;
                var decimalNum = 1;
