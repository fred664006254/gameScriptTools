namespace App
{
 	...
 	export class MainTaskHandUtil 
	{
         ...
         */
        public static addHandNode(parentNode:egret.DisplayObjectContainer, posX:number, posY:number, touchTarget:Array<any>, questType:number, once:boolean, secondConditionCb:()=>boolean, secondConditionCbThis:any):string {
            ...
            egret.Tween.get(_taskHand,{loop:true})
                .to({y:_taskHand.y +35,scaleX:1.3,scaleY:1.3}, 500)
                .to({y:_taskHand.y ,scaleX:1.0,scaleY:1.0}, 500)
