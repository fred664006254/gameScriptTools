...
class GodLogin extends BaseDisplayObjectContainer
{
	...
	private showWord():void
	{
		...
		this._tipWord.setPosition(this._tipBg.x,this._tipBg.y - this._tipBg.height / 2 + this._tipWord.height / 2 + 55);
	...
	private showName():void
	{
		...
		nameTF.alpha = 0;
		nameTF.setPosition(this._tipBg.x,this._tipBg.y + this._tipBg.height / 2 - nameTF.height / 2 - 16);
