...
class FourRechargeShowView  extends CommonView
{
	private _nodeContainer:BaseDisplayObjectContainer;
    private _curTabIdx:number;
    private _mySkinTitleTxt:BaseTextField;
    private _mySkinProTxtList = [];
    private wifeSkinId:number;
    private servantSkinId:number;
    ...
    private createNode()
    {
        ...
        let rewardItemVoList = GameData.formatRewardItem(cfg72.getReward);
