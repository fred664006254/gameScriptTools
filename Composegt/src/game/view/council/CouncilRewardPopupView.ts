...
class CouncilRewardPopupView extends CommonView
{
    ...
    protected initView():void
	{
        ...
        let txt_name = LanguageManager.getlocal(`discussViewEventName${data.eventId}_${data.randevent}`);
        let txt_rank = "" + data.rank;
        let councilReward_txt =  ComponentManager.getTextField(LanguageManager.getlocal(`councilReward_txt`, [txt_name,txt_rank]), 20); 
