...
class WifeGetChildView extends BaseView
{
	...
	protected initView():void
	{
        ...
        let getPic:BaseLoadBitmap = BaseLoadBitmap.create(sexPicStr,rect);
		getPic.width = rect.width;
		getPic.height = rect.height;
        ...
        let noBtn:BaseButton = ComponentManager.getButton(ButtonConst.BTN_NORMAL_BLUE, "wifeLookChildNo" ,this.noBtnClick,this);
