class AtkracecrossActivityRewardViewTab1 extends CommonViewTab
{
	...
	private get cfg() : Config.AcCfg.CrossServerAtkRaceCfg{
		let vo2 = Api.acVoApi.getActivityVoByAidAndCode("crossServerAtkRace");
	...
	protected initView():void
	{
		...
		let winBottomBg = BaseBitmap.create("public_9v_bg02");
		...
		let txt1 = ComponentManager.getTextField(LanguageManager.getlocal("atkracecrossActivityRewardTxt1"),24,TextFieldConst.COLOR_BROWN);
		...
		if(zrankinfo.length == 2){
			...
			let failBottomBg = BaseBitmap.create("public_9v_bg02");
