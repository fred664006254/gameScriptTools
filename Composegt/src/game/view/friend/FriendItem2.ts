...
class FriendItem2 extends BaseDisplayObjectContainer
{
	...
	public init(bottomH:number):void
	{
		...
		let tarWidth = 350;
		let tarHeight = 40;
		let inputTF = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE,18,tarWidth,tarHeight,"public_tc_srkbg05",LanguageManager.getlocal("friends_searchTxt"),TextFieldConst.COLOR_WHITE);
        inputTF.x = 80;
		inputTF.y = 30;
		...
		let searchBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_BLUE,"friendsBtnTxt15",this.searchBtnHandler,this);
		...
		let suggestTxt = ComponentManager.getTextField("",24,TextFieldConst.COLOR_LIGHT_YELLOW);
		...
		let applyBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_BLUE,"friendsBtnTxt4",this.applyBtnHandler,this);
		...
		let refreshBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW,"friendsBtnTxt5",this.refreshBtnHandler,this);
