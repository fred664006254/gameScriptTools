...
class SearchStoryView extends CommonView
{
	...
	private _newServant: boolean = false;
	private _newIcon: BaseBitmap;
	...
	{	
		...
		// 	this._newIcon.setPosition(
		// 		(GameConfig.stageWidth - this._newIcon.width)/2,
		// 		100
		// 	);
		// }
	...
	private showPage():void
	{
		...
		if (this._curDialogConfig.dialogueID) {
			...
			if (this._curDialogConfig.personPic == "1" || this._curDialogConfig.personPic == "999" ) {
				...
				} else if (this._curDialogConfig.personPic == "story_man2") {
					// 老村民
					width = 405;
					height = 467;
					scale = 1;
