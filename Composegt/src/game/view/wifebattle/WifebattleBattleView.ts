...
class WifebattleBattleView  extends BaseView
{
    ...
    private overRound(){
        ...
        switch(curRoundData[10]){
            case 0:
                ...
                this._myCurProgress.tweenTo(0,500);
                this._enemyCurProgress.tweenTo(curRoundData[11]/enemyWifeInfo.talent,500);
                break;
            case 1:
                ...
                this._myCurProgress.tweenTo(curRoundData[11]/myWifeInfo.talent,500);
                this._enemyCurProgress.tweenTo(0,500);
                break;
            case 2:
                if(this._myCurWife){
                    egret.Tween.get(this._myCurWife)
        ...
        if(nextRoundData){
            ...
            this._myBProgress.tweenTo(nextRoundData[8]/this._myMaxTalent, 500);
            //敌方数据初始化
            ...
            this._enemyBProgress.tweenTo(nextRoundData[9]/this._enemyMaxTalent,500);
        } else {
            ...
            this._myBProgress.tweenTo(myTotal/this._myMaxTalent, 500);
            //敌方数据初始化
            ...
            this._enemyBProgress.tweenTo(enemyTotal/this._enemyMaxTalent,500);
        }
        egret.Tween.removeTweens(this);
        egret.Tween.get(this)
        .wait(900 + timePlus)
    ...
    private createCard(wifeId:number,index:number,isMy:boolean):BaseDisplayObjectContainer{
        ...
        let name = ComponentManager.getTextField(wifeInfo.getName(info.sexflag && info.sexflag >= 1),nameSize,TextFieldConst.COLOR_BROWN);
