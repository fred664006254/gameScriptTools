 ...
 * author jiangliuyang
 */
class WifeTalentUpPopupView extends PopupView
{
	// 滑动列表
    ...
    // App.MessageHelper.addEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_WIFE_AWARD),this.useWifeCallback,this);
		...
		let bookBg = BaseBitmap.create("public_line4");
		bookBg.width = 487;
		// bookBg.height = 245;
        ...
        let startX = this.viewBg.width/2 - this._caiyi.width/2;
        ...
        let tip:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalentUpPopupViewUseItem"),22,TextFieldConst.COLOR_BROWN_NEW);
        ...
        let itemDesc1 = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalentUpPopupViewItem1"),18,TextFieldConst.COLOR_BROWN_NEW);
        ...
        let itemDesc2 = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalentUpPopupViewItem2"),18,TextFieldConst.COLOR_BROWN_NEW);
        ...
        let itemDesc3 = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalentUpPopupViewItem3"),18,TextFieldConst.COLOR_BROWN_NEW);
    ...
    private refreshUI():void
    {
        ...
        let arr = Api.wifebattleVoApi.wifebattleVo.info.tmpattr.wifeadd_arr;
        arr = arr?arr:[];
        let data = null;
	...
	private getWifestatusIcon(wifeId:string):BaseDisplayObjectContainer
	{
		...
		let nameTF = ComponentManager.getTextField(wifeCfg.name,18,TextFieldConst.COLOR_WARN_YELLOW_NEW);
