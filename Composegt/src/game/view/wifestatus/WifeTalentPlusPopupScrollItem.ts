...
class WifeTalentPlusPopupScrollItem extends ScrollListItem
{
	public constructor() {
		super();
	}
	...
	protected initItem(index:number,data:any)
    {
        ...
        let nameTxt = ComponentManager.getTextField(data.num,TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BROWN_NEW);
		nameTxt.x = 230 - nameTxt.width/2
        nameTxt.y =  this.height/2 - nameTxt.height/2;;
        this.addChild(nameTxt);

		let scoreTxt = ComponentManager.getTextField(data.effect+"%",TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BROWN_NEW);
