 ...
 */
class QuestionnairePopupView  extends PopupView
{   
	...
	private _q2aList:Array<CheckBox>=[];
	private _q3aList:Array<CheckBox>=[];
	private q1Index:number;
	private q2Index:number;
	private q3Index:number;

	private _q2a1CheckBox:CheckBox;
	private _q2a2CheckBox:CheckBox;
	...
	protected initView():void
	{
		...
		let nameText = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireGetTip"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		...
		let q1Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ1"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q1Text.x = 70;
		q1Text.y = qbg1.y + qbg1.height/2 - q1Text.height/2;
		this.addChildToContainer(q1Text);


		let q1a1checkbox = ComponentManager.getCheckBox();
		q1a1checkbox.x = 150;
		...
		let q1a1Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ1A1"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q1a1Text.x = q1a1checkbox.x + q1a1checkbox.width + 5;
		q1a1Text.y = q1a1checkbox.y + 5;
		this.addChildToContainer(q1a1Text);

		let q1a2checkbox = ComponentManager.getCheckBox();
		...
		let q1a2Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ1A2"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q1a2Text.x = q1a2checkbox.x + q1a2checkbox.width + 5;
		q1a2Text.y = q1a1Text.y;
		this.addChildToContainer(q1a2Text);

		let qbg2 = BaseBitmap.create("public_tc_bg05");
		qbg2.width = 510;
		qbg2.height = 40;
		...
		let q2Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ2"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q2Text.x = q1Text.x;
		q2Text.y = qbg2.y + qbg2.height/2 - q2Text.height/2;
		this.addChildToContainer(q2Text);

		let q2a1checkbox = ComponentManager.getCheckBox();
		...
		let q2a1Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ2A1"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q2a1Text.x = q2a1checkbox.x + q2a1checkbox.width + 5;
		q2a1Text.y = q2a1checkbox.y + 5;
		this.addChildToContainer(q2a1Text);

		let q2a2checkbox = ComponentManager.getCheckBox();
		...
		let q2a2Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ2A2"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q2a2Text.x = q2a2checkbox.x + q2a2checkbox.width + 5;
		q2a2Text.y = q2a2checkbox.y + 5;
		this.addChildToContainer(q2a2Text);

		let q2a3checkbox = ComponentManager.getCheckBox();
		...
		let q2a3Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ2A3"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q2a3Text.x = q2a3checkbox.x + q2a3checkbox.width + 5;
		q2a3Text.y = q2a3checkbox.y + 5;
		this.addChildToContainer(q2a3Text);

		let q2a4checkbox = ComponentManager.getCheckBox();
		...
		let q2a4Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ2A4"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q2a4Text.x = q2a4checkbox.x + q2a4checkbox.width + 5;
		q2a4Text.y = q2a4checkbox.y + 5;
		this.addChildToContainer(q2a4Text);

		let q2a5checkbox = ComponentManager.getCheckBox();
		...
		let q2a5Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ2A5"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q2a5Text.x = q2a5checkbox.x + q2a5checkbox.width + 5;
		q2a5Text.y = q2a5checkbox.y + 5;
		this.addChildToContainer(q2a5Text);

		let q2a6checkbox = ComponentManager.getCheckBox();
		...
		let q2a6Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ2A6"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q2a6Text.x = q2a6checkbox.x + q2a6checkbox.width + 5;
		q2a6Text.y = q2a6checkbox.y + 5;
		this.addChildToContainer(q2a6Text);

		let q2a7checkbox = ComponentManager.getCheckBox();
		...
		let q2a7Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ2A7"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q2a7Text.x = q2a7checkbox.x + q2a7checkbox.width + 5;
		q2a7Text.y = q2a7checkbox.y + 5;
		this.addChildToContainer(q2a7Text);

		let q2a8checkbox = ComponentManager.getCheckBox();
		...
		let q2a8Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ2A8"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q2a8Text.x = q2a6Text.x ;
		q2a8Text.y = q2a8checkbox.y + 5;
		this.addChildToContainer(q2a8Text);
		
		///qqqq3
		let qbg3 = BaseBitmap.create("public_tc_bg05");
		qbg3.width = 510;
		qbg3.height = 40;
		...
		let q3Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ3"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q3Text.x = q1Text.x;
		q3Text.y = qbg3.y + qbg3.height/2 - q3Text.height/2;
		this.addChildToContainer(q3Text);


		let q3a1checkbox = ComponentManager.getCheckBox();
		...
		let q3a1Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ3A1"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q3a1Text.x = q3a1checkbox.x + q3a1checkbox.width + 5;
		q3a1Text.y = q3a1checkbox.y + 5;
		this.addChildToContainer(q3a1Text);

		let q3a2checkbox = ComponentManager.getCheckBox();
		...
		let q3a2Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ3A2"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q3a2Text.x = q2a2Text.x ;
		q3a2Text.y = q3a2checkbox.y + 5;
		this.addChildToContainer(q3a2Text);

		let qbg4 = BaseBitmap.create("public_tc_bg05");
		qbg4.width = 510;
		qbg4.height = 40;
		...
		let q4Text = ComponentManager.getTextField(LanguageManager.getlocal("questionnaireQ4"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
		q4Text.x = q1Text.x;
		q4Text.y = qbg4.y + qbg4.height/2 - q4Text.height/2;
		this.addChildToContainer(q4Text);
		
		
		let inputTF = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL,466,134,"public_tc_srkbg05",LanguageManager.getlocal("questionnaireQ4Tip"),TextFieldConst.COLOR_WHITE);

		inputTF.y = qbg4.y + qbg4.height + 15;
		this.addChildToContainer(inputTF);
		this._inputMsg = <BaseTextField>inputTF.getChildByName("textField");
		this._inputMsg.y = 10;
