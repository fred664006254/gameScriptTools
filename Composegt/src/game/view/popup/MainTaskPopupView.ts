...
class MainTaskPopupView  extends PopupView
{
	...
	// private _nameLine1:BaseBitmap;
	// private _nameLine2:BaseBitmap;
	...
	protected initView():void
	{
		...
		let taskRewardTxt = ComponentManager.getTextField(LanguageManager.getlocal("taskReward"),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_BROWN_NEW);
	...
	protected refreshUIInfo()
	{
		...
		let tarColor = TextFieldConst.COLOR_WARN_RED_NEW;
		...
		let sWidth = 10;
		let rewardWidth = rewardArr.length * 106 + (rewardArr.length - 1) * sWidth;
