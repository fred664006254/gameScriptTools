...
class AllianceBossAttackedPopupView extends PopupView
{
	...
	{	
		...
		if (dataInfo.type == 3) { 
			let descTxt:BaseTextField=ComponentManager.getTextField(LanguageManager.getlocal("allianceBossHasKill"),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_WHITE);
		...
		let rightScoreTxt:BaseTextField=ComponentManager.getTextField(LanguageManager.getlocal("allianceBuildGet3")+App.StringUtil.formatStringColor("+"+dataInfo.exp,TextFieldConst.COLOR_WARN_GREEN2),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_WARN_GREEN2);
