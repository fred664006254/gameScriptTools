...
{   
	...
	protected initView():void
	{
		...
		let nameStr = LanguageManager.getlocal("allianceInfoName2",[allianceVo.name])
		...
		let info2TF:BaseTextField = ComponentManager.getTextField(info2Str,TextFieldConst.FONTSIZE_CONTENT_SMALL);
		...
		let info3Str = LanguageManager.getlocal("allianceInfoLevel2",[allianceVo.level.toString(),allianceVo.exp.toString(), allianceCfg.exp.toString()])
		...
		let inputTF2 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_CONTENT_SMALL,500,45,"public_tc_srkbg05",LanguageManager.getlocal("allianceCreateWeixinholder"),TextFieldConst.COLOR_WHITE,allianceVo.cweixin);
		inputTF2.x = 60;
		...
		let inputTF3 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_CONTENT_SMALL,500,45,"public_tc_srkbg05",LanguageManager.getlocal("allianceCreateQQholder"),TextFieldConst.COLOR_WHITE,allianceVo.cqq);
		...
		let inputTF4 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_CONTENT_SMALL,500,100,"public_tc_srkbg05",LanguageManager.getlocal("allianceCreateMsgholder"),TextFieldConst.COLOR_WHITE,allianceVo.message);
		...
		let inputTF5 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_CONTENT_SMALL,500,100,"public_tc_srkbg05",LanguageManager.getlocal("allianceCreateMsgholder"),TextFieldConst.COLOR_WHITE,allianceVo.intro);
