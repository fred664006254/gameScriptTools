...
class ConquestInfoPopupView extends PopupView
{
	...
	{	
        ...
        let titleFntSize = TextFieldConst.FONTSIZE_BUTTON_COMMON;
        let contentFntSize = TextFieldConst.FONTSIZE_CONTENT_COMMON
        if(PlatformManager.checkIsViSp()){
            titleFntSize = TextFieldConst.FONTSIZE_CONTENT_SMALL;
            contentFntSize = TextFieldConst.FONTSIZE_ACTIVITY_COMMON
        }
        let _windesTxt =ComponentManager.getTextField("",titleFntSize,TextFieldConst.COLOR_WHITE);
        ...
        if(this.strArr.length>0)
        {
            ...
            {
                let _desTxt =	ComponentManager.getTextField("0",contentFntSize,TextFieldConst.COLOR_WARN_GREEN2);
