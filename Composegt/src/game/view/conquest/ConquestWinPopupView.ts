...
{	
	...
	protected initView():void
	{
		...
		let fontSize = TextFieldConst.FONTSIZE_TITLE_SMALL;
		if(PlatformManager.checkIsViSp())
		{
			fontSize = TextFieldConst.FONTSIZE_CONTENT_SMALL;
		}

		let titleTxt:BaseTextField=ComponentManager.getTextField(titleStr,fontSize,TextFieldConst.COLOR_WHITE);
		...
		{	
			...
			let descTxt:BaseTextField=ComponentManager.getTextField(str,fontSize,TextFieldConst.COLOR_WARN_GREEN2);
	...
	{	
		...
		let tempsPos1:egret.Point = egret.Point.create(GameConfig.stageWidth/2  - winText.width/2*scale1, bgHeight - winText.height/2*scale1 +30 - 70);
		let tempsPos2:egret.Point = egret.Point.create(GameConfig.stageWidth/2  - winText.width/2*scale2, bgHeight - winText.height/2*scale2 - 70);
		let realPos:egret.Point = egret.Point.create(GameConfig.stageWidth/2  - winText.width/2, bgHeight - winText.height/2 - 70);
