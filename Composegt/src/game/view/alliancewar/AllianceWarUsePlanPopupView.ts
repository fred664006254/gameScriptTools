...
class AllianceWarUsePlanPopupView extends PopupView {
	...
	public initView(): void {
		...
		let tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("allianceWarUsePlanPopupViewTip", [itemCfg.name]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
		if (tipTxt.width > 480) {
			tipTxt.width = 480;
		}
