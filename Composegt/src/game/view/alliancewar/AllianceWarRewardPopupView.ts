...
class AllianceWarRewardPopupView extends PopupView {
	...
	public initView(): void {
		...
		if(tinfo.name)
		{
			let rzid = Api.mergeServerVoApi.getAfterMergeSeverName(null,true,tinfo.zid);
		...
		//帮会奖励相关
		let bg1 = BaseBitmap.create("public_listbg");
		bg1.width = 520;
		bg1.height = 246;
		bg1.setPosition(bg.x + 10, bg.y + 10);
		this.addChildToContainer(bg1);

		let leftBg = BaseBitmap.create("public_up3");
		leftBg.width = 510;
		leftBg.height = 30;
		leftBg.x = bg1.x+6;
		leftBg.y = bg1.y+5.5;
		...
		//个人奖励相关
		let bg2 = BaseBitmap.create("public_listbg");
		bg2.width = 520;
		bg2.height = 222;
		bg2.setPosition(bg.x + 10, bg1.y + bg1.height + 10);
		this.addChildToContainer(bg2);

		let leftBg2 = BaseBitmap.create("public_up3");
		...
		//帮派提示相关
		let tipTitleTxt1 = ComponentManager.getTextField(LanguageManager.getlocal("allianceWarRewardPopupViewRewardTitle1") + ":", 20, 0xfff000);
		...
		//个人提示相关
		let tipTitleTxt2 = ComponentManager.getTextField(LanguageManager.getlocal("allianceWarRewardPopupViewRewardTitle2")  + ":", 20, 0xfff000);
		...
		let buttomTip = ComponentManager.getTextField(LanguageManager.getlocal("allianceWarRewardPopupViewButtomTip"),TextFieldConst.FONTSIZE_BUTTON_COMMON,TextFieldConst.COLOR_BROWN);
