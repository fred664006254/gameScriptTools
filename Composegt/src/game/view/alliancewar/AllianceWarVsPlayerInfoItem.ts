...
class AllianceWarVsPlayerInfoItem extends ScrollListItem
{
    ...
    {	
        ...
        let maskbg = BaseBitmap.create(data.alliname == Api.playerVoApi.getPlayerAllianceName() ? `awnamebg2` :  `awnamebg1`);
		...
		view.setLayoutPosition(LayoutConst.leftverticalCenter, serverTxt, maskbg, [40,0]);
        // view.setLayoutPosition(LayoutConst.horizontalCenterverticalCenter, serverTxt, maskbg);
        ...
        if(data.uid == Api.playerVoApi.getPlayerID()){
            serverTxt.textColor = nameTxt.textColor = 0x47c5ff;//TextFieldConst.COLOR_QUALITY_BLUE; 
        }
