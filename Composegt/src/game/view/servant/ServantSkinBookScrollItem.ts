...
class ServantSkinBookScrollItem extends BaseDisplayObjectContainer 
{
	...
	public init(skinId:string|number,index:number,serId:string):void
	{
		...
		let bnameTxt =   ComponentManager.getTextField("",22,TextFieldConst.COLOR_BROWN_NEW);
		...
		let bnameTypeTxt =   ComponentManager.getTextField("",22,TextFieldConst.COLOR_BROWN_NEW);
