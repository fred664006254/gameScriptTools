...
class WelfareView extends CommonView
{
	...
	public initView():void
	{
		...
		let leftBg2:BaseBitmap = BaseBitmap.create("common_left_bg");
	...
	protected initTabbarGroup():void
	{
		...
		let scrollH = GameConfig.stageHeigth - this.container.y+10 - 80;
	...
	private checkTabbarGroupState():void
	{
		...
		//防诈骗红点 
		let antideceptionIndex:number = this._functionConfig.indexOf("antideception");
	...
	private tick() {
		...
		let functionMonthCardIndex:number = this._functionConfig.indexOf("MonthCard");
