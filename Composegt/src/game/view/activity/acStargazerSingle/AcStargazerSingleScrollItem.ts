...
class AcStargazerSingleScrollItem extends BaseDisplayObjectContainer
{
    ...
    // {
		...
		let auraList = Config.ServantCfg.getServantItemById(AcStargazerScrollItem.servantId).aura || [];
		let skin_auraList = [];
	...
	{	
		let servantId = AcStargazerScrollItem.servantId;
