 ...
 * desc:个人排行榜单item
*/
class AcCorssImacyPRank2Item extends ScrollListItem
{
	public constructor() {
		super();
	}
	...
	protected initItem(index:number,data:any)
    {
        ...
        let serverTxt = ComponentManager.getTextField(sidname,TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BROWN);
