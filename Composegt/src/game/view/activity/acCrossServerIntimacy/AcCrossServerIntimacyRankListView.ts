...
{	
    ...
    public initView():void
	{
		...
		let name:BaseTextField = ComponentManager.getTextField(Api.playerVoApi.getPlayerName(),20,TextFieldConst.COLOR_QUALITY_GREEN);
		...
		let socreText:BaseTextField = ComponentManager.getTextField((LanguageManager.getlocal(`croessImacyScore-${this.vo.code}`)+': '), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
