...
class AcLanternTaskPopupViewTab4 extends PopupViewTab
{
   ...
   public showList(): void 
   {
	   ...
	   {
			let dayTaskList = this.vo.getSortTask(4);//this.cfg.getTaskListById(1);
	...
	{
		if(this._scrollList){
			let dayTaskList = this.vo.getSortTask(4);
			dayTaskList.sort((a:Config.AcCfg.LanternTaskItemCfg,b:Config.AcCfg.LanternTaskItemCfg) =>{return a.sortId - b.sortId});
