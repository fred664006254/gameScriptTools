/**
  ...
  */
class AcLanternDetailPopupView extends PopupView {
	...
	public initView()
	{
		...
		let bg = BaseLoadBitmap.create(this.getDefaultRes("aclanternview_detailcontext"));
		bg.width = 548;
		bg.height = 504;
		...
		let acDesc = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acLanternViewDetailDesc"),[String(maxDrawNum)]),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_BROWN);
		acDesc.width = 450;
		...
		let detailText1 = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acLanternViewDetailDescText1"),[String(sceneItemCfg.wifeBathingGlamour)]),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_WHITE);
		...
		let detailText2 = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acLanternViewDetailDescText2"),[String(sceneItemCfg.wifeBathingExpRate * 100)+"%"]),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_WHITE);
