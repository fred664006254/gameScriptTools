...
class Celebration3ScrollItem  extends ScrollListItem
{
    ...
    {	
		...
		let taskTxt = ComponentManager.getTextField("",TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_LIGHT_YELLOW);
		...
		needTxt.x = this._goBtn3.x + this._goBtn3.width/2 - needTxt.width/2;
