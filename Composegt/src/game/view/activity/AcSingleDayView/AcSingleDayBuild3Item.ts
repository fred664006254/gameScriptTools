class AcSingleDayBuild3Item extends ScrollListItem{
    ...
    protected initItem(index:number,data:any, item):void{
        ...
        let bg:BaseBitmap=BaseBitmap.create("public_dj_bg01");//public_dj_bg01  public_9_probiginnerbg
        bg.width=172;
        bg.height=280;
        bg.setPosition(3,3);
        view.addChild(bg);
        ...
        //原价
        let originTxt = ComponentManager.getTextField(LanguageManager.getlocal('originalPriceTitle') + "：", 20, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        let originPriceTxt = ComponentManager.getTextField(itemCfg.price.toString(), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
