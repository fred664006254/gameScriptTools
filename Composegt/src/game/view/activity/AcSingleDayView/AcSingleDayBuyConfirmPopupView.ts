...
class AcSingleDayBuyConfirmPopupView extends PopupView
{
	...
	protected initView():void
	{
		...
		let descTxt1 = ComponentManager.getTextField(LanguageManager.getlocal('acSingleDayCouponUseTip1', [Math.ceil(data.price).toString(),itemcfg.name]), 22, TextFieldConst.COLOR_LIGHT_YELLOW);
		...
		let descTxt2 = ComponentManager.getTextField(LanguageManager.getlocal('acSingleDayCouponUseTip2'), 20, TextFieldConst.COLOR_BROWN);
		...
		if(coupon.length){
			...
			let emptyTxt = ComponentManager.getTextField(LanguageManager.getlocal('acSingleDayGetTip2'), 18, TextFieldConst.COLOR_BROWN);
		...
		let descTxt5 = ComponentManager.getTextField(LanguageManager.getlocal('acSingleDayCouponUseTip5',['50']), 18, TextFieldConst.COLOR_QUALITY_RED);
	...
	protected clickConfirmHandler(data:any):void
	{
		...
		let itemid = param.id;
		let itemcfg = Config.ItemCfg.getItemCfgById(param.itemid);
