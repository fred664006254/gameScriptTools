 ...
 * author yanyuling
 */
class AcMoonlightRewardPopupView  extends PopupView
{
    private code:string;
    private aid:string;
	public initView():void
	{
        ...
        let _acvo:AcMoonlightVo =  <AcMoonlightVo>Api.acVoApi.getActivityVoByAidAndCode(this.param.data.aid, this.param.data.code);
        ...
        //谢礼:
        let txt3  = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acMoonlightRewardPopupViewT")), 20,TextFieldConst.COLOR_LIGHT_YELLOW);
		txt3.x = bg1.x + 20;
		txt3.y = bg1.y + 20;
