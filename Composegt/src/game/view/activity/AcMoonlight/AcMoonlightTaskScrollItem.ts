class AcMoonlightTaskScrollItem extends ScrollListItem
{
	private _itemData:Config.AcCfg.MoonlightTaskItemCfg= null;
	...
	private get cfg()
	{
		return <Config.AcCfg.MoonlightCfg>Config.AcCfg.getCfgByActivityIdAndCode(this._aidAndCode.aid, this._aidAndCode.code);
	}
	...
	public initItem(index:number,data:any,itemParam:any):void
	{
		...
		let vo = <AcMoonlightVo>Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
	...
	{
		let vo = <AcMoonlightVo>Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
		let cfg = <Config.AcCfg.MoonlightCfg>Config.AcCfg.getCfgByActivityIdAndCode(this._aidAndCode.aid, this._aidAndCode.code);
		let openType = this._itemData.openType;
		//任务进度
		let taskNum = vo.gettTaskNum(this._itemData.questType);
