...
class AcRansackTraitorSPScrollItem extends BaseDisplayObjectContainer
{
    ...
    // {
		...
		let auraList = Config.ServantCfg.getServantItemById(AcRansackTraitorSPScrollItem.servantId).aura || [];
		let skin_auraList = [];
	...
	{	
		let servantId = AcRansackTraitorSPScrollItem.servantId;
