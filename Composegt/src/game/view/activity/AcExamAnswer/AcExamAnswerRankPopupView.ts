 ...
 * 问卷答题
 */
class AcExamAnswerRankPopupView extends PopupView	
{
    ...
    public initView():void
	{
		...
		//擂台分数
		let scoreText:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal("answer_rankscrore"),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        let answer_rankTip:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal("answer_rankTip"),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BROWN);
