...
class AcNewYearView extends AcCommonView
{
	...
	public initView():void
	{
		...
		{
			let titletxt = BaseBitmap.create("acnewyear_titletxt-10");
        ...
        let topBg:BaseLoadBitmap = BaseLoadBitmap.create("acnewyear_topbg_"+this.code);
        ...
        let topBg2:BaseLoadBitmap = BaseLoadBitmap.create("acnewyear_topbg2_"+this.code);
