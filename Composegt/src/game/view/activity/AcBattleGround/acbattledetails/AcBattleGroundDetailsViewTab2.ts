//
class AcBattleGroundDetailsViewTab2 extends CommonViewTab
{


	private _allinameText: BaseTextField;
	...
	private _comeBtn:BaseButton;

	private _innerTitle:BaseBitmap;
	private _innerBottom:BaseBitmap;
	...
	public initView():void
	{
		...
		let rankText = ComponentManager.getTextField(LanguageManager.getlocal("acBattlerank1"),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_LIGHT_YELLOW);
		let memberText = ComponentManager.getTextField(LanguageManager.getlocal("allianceMemberPopupViewTitle"),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_LIGHT_YELLOW);
		let poText = ComponentManager.getTextField(LanguageManager.getlocal("alliance_po"),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_LIGHT_YELLOW);
		let valueText = ComponentManager.getTextField(LanguageManager.getlocal("acBattlerank4"),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_LIGHT_YELLOW);
		...
		let innerTitle = BaseBitmap.create("public_up3");
		...
		let innerBottom = BaseBitmap.create("public_up3");
	...
	private allianCallback(data : any) :void
	{
		...
		// ]
			...
			let allianceList = data.data.data.data.allianceList;
			allianceList.sort((a,b)=>{
				if(b.value != a.value){
	...
	// private _myValue:BaseTextField;
			...
			let poStr = myData ? LanguageManager.getlocal("allianceMemberPo" + myData.po) : "--";
	...
	// private _warn2:BaseTextField;
			...
			let myAlliData = this.vo.getMyAlliData();
			// _innerTitle
			let alliNameText = ComponentManager.getTextField(myAlliData.name,20,TextFieldConst.COLOR_BROWN);
			...
			let playerRank =  ComponentManager.getTextField(LanguageManager.getlocal("acBattleRankPopupViewPlayerRank",[String(this.vo.getMyRank())]),18,TextFieldConst.COLOR_LIGHT_YELLOW);
			...
			let allRank =  ComponentManager.getTextField(LanguageManager.getlocal("acBattleRankPopupViewAllRank",[String(this.vo.getRankAllRank())]),18,TextFieldConst.COLOR_LIGHT_YELLOW);
			allRank.x = GameConfig.stageWidth/2 - allRank.width/2;
			allRank.y = playerRank.y + playerRank.height + 5;
			this.addChild(allRank);		

			
			let liveNum =  ComponentManager.getTextField(LanguageManager.getlocal("acBattleRankPopupViewAllPlayerNum",[myAlliData.alivemn]),18,TextFieldConst.COLOR_LIGHT_YELLOW);
