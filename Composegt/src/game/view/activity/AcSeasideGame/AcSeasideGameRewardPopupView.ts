 ...
 * author yanyuling
 */
class AcSeasideGameRewardPopupView  extends PopupView
{
    private code:string;
    private aid:string;
	public initView():void
	{
        ...
        //谢礼:
        let txt3  = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acseasidegamerewardPopupViewT")), 20,TextFieldConst.COLOR_LIGHT_YELLOW);
		txt3.x = bg1.x + 20;
		txt3.y = bg1.y + 20;
