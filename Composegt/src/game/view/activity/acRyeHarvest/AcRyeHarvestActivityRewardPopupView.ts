 ...
 */
class AcRyeHarvestActivityRewardPopupView extends PopupView {
	...
	private refreashView() {
		...
		let cfg = <Config.AcCfg.RyeHarvestCfg>Config.AcCfg.getCfgByActivityIdAndCode(this.param.data.aid, this.param.data.code);
		let vo = <AcRyeHarvestVo>Api.acVoApi.getActivityVoByAidAndCode(this.param.data.aid, this.param.data.code);
	...
	private showTaskUI() {
		...
		let tabarArr = ["acRyeHarvestActivityRewardTaskTab1-" + this.param.data.code, "acRyeHarvestActivityRewardTaskTab2-" + this.param.data.code, "acRyeHarvestActivityRewardTaskTab3-" + this.param.data.code];
	...
	private showShopUI() {
		...
		let itemGem3 = BaseLoadBitmap.create("itemicon2011");
		itemGem3.width = 100;
		itemGem3.height = 100;
