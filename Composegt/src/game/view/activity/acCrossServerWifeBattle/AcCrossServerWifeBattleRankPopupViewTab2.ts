//
class AcCrossServerWifeBattleRankPopupViewTab2 extends CommonViewTab
{
	...
	protected initView():void
	{
        ...
        let scrollList = ComponentManager.getScrollList(AcCrossServerWifeBattleRankScrollItem2,rankList,rect2,{aid:this.param.data.aid,code:this.param.data.code});
		scrollList.x = 41;
		scrollList.y = 110;
