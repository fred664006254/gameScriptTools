class AcCrossServerWifeBattleResultView extends BaseView
{
	...
	protected initView():void
	{
        ...
        let scoreTip = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerWifeBattleResultScoreTip",[String(point)]),24,0x17f925);
        ...
        let rankBtn = ComponentManager.getButton("btn_common","sysConfirm",this.hide,this);
