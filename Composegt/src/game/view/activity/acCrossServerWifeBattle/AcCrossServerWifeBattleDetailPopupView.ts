...
class AcCrossServerWifeBattleDetailPopupView extends PopupView
{
	...
	protected initView():void
	{
		...
		//区服排名
		let serverRank:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal(`acCrossServerWifeBattleOpenDesc3-${this.vo.code}`), TextFieldConst.FONTSIZE_TITLE_SMALL,TextFieldConst.COLOR_LIGHT_YELLOW);
