...
class AcWipeBossAttackedPopupView extends PopupView
{
	...
	{	
		...
		let rightScoreTxt1:BaseTextField=ComponentManager.getTextField(LanguageManager.getlocal('acwipeBossBattleScore1',[dataInfo.attackexp]),20,TextFieldConst.COLOR_WARN_GREEN2);
