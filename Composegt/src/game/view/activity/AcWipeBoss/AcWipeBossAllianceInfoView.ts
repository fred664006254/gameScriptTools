...
class AcWipeBossAllianceInfoView extends PopupView{
	...
	protected initView():void{	
		...
		let gemTxt = ComponentManager.getTextField(LanguageManager.getlocal('acwipeBossAllInfoNum', [view.api.getAllianceInfoNum().toString(), view.cfg.maxShare.toString()]),22,TextFieldConst.COLOR_BROWN);
