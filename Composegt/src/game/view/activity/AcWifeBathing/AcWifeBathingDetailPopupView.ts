/**
  ...
  */
class AcWifeBathingDetailPopupView extends PopupView {
	...
	public initView()
	{
		...
		let bg = BaseLoadBitmap.create(this.getDefaultRes("acwifebathingview_detailcontext"));
		bg.width = 548;
		bg.height = 504;
		...
		let acDesc = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acWifeBathingViewDetailDesc")),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_BROWN);
		acDesc.width = 450;
		...
		let sceneItemCfg:Config.WifeBathSceneItemCfg =Config.WifebathsceneCfg.getSceneCfgById(this.cfg.wifeBathingId)

		let detailText1 = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acWifeBathingViewDetailDescText1"),[String(sceneItemCfg.wifeBathingGlamour)]),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_WHITE);
		...
		let detailText2 = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acWifeBathingViewDetailDescText2"),[String(sceneItemCfg.wifeBathingExpRate * 100)+"%"]),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_WHITE);
