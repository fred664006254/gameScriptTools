...
class AcCarnivalNightTaskPopupViewTab3 extends PopupViewTab
{
   ...
   public showList(): void 
   {
	   ...
	   {
			let dayTaskList = this.vo.getAcSortTask(3);//this.cfg.getTaskListById(3);
			// this._taskList = dayTaskList;
			dayTaskList.sort((a:Config.AcCfg.CarnivalNightTaskItemCfg2,b:Config.AcCfg.CarnivalNightTaskItemCfg2) =>{return a.sortId - b.sortId});
	...
	{
		if(this._scrollList){
			let dayTaskList = this.vo.getAcSortTask(3);
			dayTaskList.sort((a:Config.AcCfg.CarnivalNightTaskItemCfg2,b:Config.AcCfg.CarnivalNightTaskItemCfg2) =>{return a.sortId - b.sortId});
