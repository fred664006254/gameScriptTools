...
class AcWifeSkininheritAVGView extends CommonView
{
    ...
    private get vo() : AcWifeSkinInheritVo{
        return <AcWifeSkinInheritVo>Api.acVoApi.getActivityVoByAidAndCode(this.aid, this.code);
    }
	...
	{	
        ...
        let guidePic:string[] = [];
        let allAvg = this.vo.getAvgConfig(this.param.data.buidId,this.param.data.code);
	...
	{	
		...
		this._guideTipContainer.dispose();
