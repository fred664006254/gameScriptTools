//
class AcCrossServerWipeBossRankViewTab3 extends CommonViewTab
{
	...
	protected initView():void
	{
		...
		// }
		let rankList = [];
		let allimem = view.api.getMyServerInfo();
		if(allimem.length){
			rankList = allimem;
		}
        ...
        let scrollList = ComponentManager.getScrollList(AcCrossServerWipeBossRankScrollItem3,rankList,rect2);
		scrollList.x = 41;
		scrollList.y = 110;
