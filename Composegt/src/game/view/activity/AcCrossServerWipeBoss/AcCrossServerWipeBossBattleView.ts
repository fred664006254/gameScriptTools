...
class AcCrossServerWipeBossBattleView extends BaseBattleView
{
	...
	private _bossConfig : Config.AcCfg.CrossServerWipeBossFoeItemCfg = null;
	...
	private _attackExp:number = 0;
	private _killExp:number = 0;
	...
	private _powerTxt:BaseTextField = null;
	private _powerBg: BaseBitmap = null;
	...
	{	
		...
		//boss getBgName
        let tipBg:BaseBitmap=BaseBitmap.create("accrossserverwipeboss_enemynamebg");
        tipBg.width = 300;
		...
		let servantName:BaseTextField = ComponentManager.getTextField(view._bossConfig.npcName,TextFieldConst.FONTSIZE_TITLE_SMALL,0xfbdb38);
		...
		let selectBg = BaseBitmap.create("public_icontimebg");
		selectBg.scaleX = 2;
		selectBg.scaleY = 1.5;
		...
		let selecTxt = ComponentManager.getTextField(LanguageManager.getlocal("clickChooseServant"),18,TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        let shopBtn = ComponentManager.getButton('accrossserverwipeboss_activeshopbtn', '', ()=>{
        ...
        let studyatk_upbg =  BaseBitmap.create("public_itemtipbg2");
