 ...
 * author qianjun
 */
class AcCrossServerWipeBossKillInfoView extends PopupView
{
	// 滑动列表
	public constructor() 
	{
	...
	public initView():void{		
        ...
        let scrollList = ComponentManager.getScrollList(AcCrossServerWipeBossKillInfoScrollItem,rankList,rect2,view.param.data.code);
