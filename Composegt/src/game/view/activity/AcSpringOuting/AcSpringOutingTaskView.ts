...
class AcSpringOutingTaskView extends CommonView {
	...
	public initView()
	{
		...
		taskData.sort((a:Config.AcCfg.SpringOutingTaskItemCfg,b:Config.AcCfg.SpringOutingTaskItemCfg) =>{return a.sortId - b.sortId});
	...
	private refreshData(event:egret.Event)
	{
		...
		let vo  = <AcSpringOutingVo>Api.acVoApi.getActivityVoByAidAndCode(this.aid, this.code);
