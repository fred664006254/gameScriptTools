class AcSpringOutingTaskScrollItem extends ScrollListItem
{
	private _itemData:Config.AcCfg.SpringOutingTaskItemCfg= null;
	...
	private get cfg()
	{
		return <Config.AcCfg.SpringOutingCfg>Config.AcCfg.getCfgByActivityIdAndCode(this._aidAndCode.aid, this._aidAndCode.code);
	}
	...
	public initItem(index:number,data:any,itemParam:any):void
	{
		...
		let vo = <AcSpringOutingVo>Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
	...
	{
		let vo = <AcSpringOutingVo>Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
		let cfg = <Config.AcCfg.SpringOutingCfg>Config.AcCfg.getCfgByActivityIdAndCode(this._aidAndCode.aid, this._aidAndCode.code);
		let openType = this._itemData.openType;
		//任务进度
		let taskNum = vo.gettTaskNum(this._itemData.questType);
