...
class AcPunishReportView extends BaseView
{
	...
	protected initView():void
	{
		...
		let descTf:BaseTextField = ComponentManager.getTextField( LanguageManager.getlocal("acPunishReportDesc-"+ this.param.data.code),TextFieldConst.FONTSIZE_CONTENT_SMALL);
