...
class AcPunishRankAllianceRewardScrollItem extends ScrollListItem
{
	...
	public initItem(index:number,data:any):void
	{
		...
		let rank1TF = ComponentManager.getTextField(LanguageManager.getlocal("acRank_alliance_masterget1"),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BROWN);
		rank1TF.x = 10;
		rank1TF.y = 80;
		...
		let rank2TF = ComponentManager.getTextField(LanguageManager.getlocal("acRank_alliance_memberget"),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BROWN);
		rank2TF.x = 10;
