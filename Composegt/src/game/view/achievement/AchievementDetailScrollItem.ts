...
class AchievementDetailScrollItem extends ScrollListItem
{
	...
	public initItem(index:number,achIndex:number):void
	{
		...
		let nameTF = ComponentManager.getTextField(nameStr,TextFieldConst.FONTSIZE_CONTENT_COMMON,0x794916);
		nameTF.x = 20
		nameTF.y = 30;
		...
		let rewardTF = ComponentManager.getTextField(rewardStr,TextFieldConst.FONTSIZE_CONTENT_COMMON,0x007e00);
		rewardTF.x = 50;
		rewardTF.y = 60;
		...
		let nn2 =  App.StringUtil.changeIntToText(achCfg.value[achIndex]);
