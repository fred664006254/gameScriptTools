...
{   
	...
	protected initView():void
	{
		...
		let cor11 = BaseBitmap.create("public_tcdw_bg01");
		cor11.x = bg1.x;
		cor11.y = bg1.y + 2;
		this.addChildToContainer(cor11);

		let descText = ComponentManager.getTextField(LanguageManager.getlocal("adultChooseTypeDesc"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
		descText.x = bg1.x + bg1.width/2 - descText.width/2;
		descText.y = 15;
		this.addChildToContainer(descText);

		let cor22 = BaseBitmap.create("public_tcdw_bg02");
		...
		let have1TF = ComponentManager.getTextField(have1Str, TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
		...
		let have2TF = ComponentManager.getTextField(have2Str, TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
		have2TF.x = cost1TF.x;
		have2TF.y = selecte2dIconBg.y + 70;
		this.addChildToContainer(have2TF);
		
        let choose1Btn = ComponentManager.getButton(ButtonConst.BTN_SMALL_BLUE,"adultChoose",this.choose1Handler,this);
		choose1Btn.x = 415;
		...
		this.addChildToContainer(choose1Btn);
		 ...
		 let choose2Btn = ComponentManager.getButton(ButtonConst.BTN_SMALL_BLUE,"adultChoose",this.choose2Handler,this);
		choose2Btn.x = 415;
