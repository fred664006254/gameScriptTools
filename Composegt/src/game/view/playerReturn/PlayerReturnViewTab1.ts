...
class PlayerReturnViewTab1 extends CommonViewTab
{
	...
	{	
		...
		//提示
		let tipTxt = ComponentManager.getTextField(LanguageManager.getlocal(`PlayerReturnTip1`), 22, TextFieldConst.COLOR_LIGHT_YELLOW);
		...
		// });
 		let tmpRect =  new egret.Rectangle(0,0,608,view.height - 50);
