...
namespace App
{
	export class MathUtil 
	{
		...
		public static distance(ox:number, oy:number,nx:number,ny:number):number
		{
			let p1=egret.Point.create(ox,oy);
			let p2=egret.Point.create(nx,ny);
		 ...
		 * @param precision 
		 */
		public static strip(num, precision = 12) {
