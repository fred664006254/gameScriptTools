namespace App
{
    export namespace FrameUtil
    {
        ...
        export function startCheck():void
        {
            ...
            {
                hasEvt=true;
                GameConfig.stage.addEventListener(egret.Event.ENTER_FRAME,checkStopEffect,FrameUtil);
            }
        }
        ...
        {
            hasEvt=false;
            GameConfig.stage.removeEventListener(egret.Event.ENTER_FRAME,checkStopEffect,FrameUtil);
        }
        ...
        export function checkLowFrameRate():boolean
        {
            return isEnough;
        }
    }
