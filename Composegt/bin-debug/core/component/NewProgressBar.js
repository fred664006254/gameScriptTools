 ...
 * @class ProgressBar
 */
var NewProgressBar = (function (_super) {
    __extends(NewProgressBar, _super);
     ...
     */
    NewProgressBar.prototype.init = function (progressBar, progressBarBg, barWidth, barHeight) {
    ...
    NewProgressBar.prototype.initUI = function () {
    ...
    NewProgressBar.prototype.checkScale9Rect = function () {
     ...
     */
    NewProgressBar.prototype.setPercentage = function (percent, textStr, textColor) {
    ...
    NewProgressBar.prototype.checkDragIcon = function (percent) {
        if (percent < 0) {
            percent = 0;
    ...
    NewProgressBar.prototype.resetIconPosition = function (xPosition) {
        this._dragIcon.x = xPosition;
    };
    NewProgressBar.prototype.setIconVisible = function (flag) {
        this._dragIcon.visible = flag;
    };
    NewProgressBar.prototype.getBgWidth = function () {
        return this._progressBarBg ? this._progressBarBg.width : 0;
    };
    NewProgressBar.prototype.getBgHeight = function () {
        return this._progressBarBg ? this._progressBarBg.height : 0;
    };
    Object.defineProperty(NewProgressBar.prototype, "percent", {
        get: function () {
    ...
    NewProgressBar.prototype.getPercent = function () {
        return this.percents;
    };
    /**
     * 设置文字大小
     * @param s 文字大小
     */
    NewProgressBar.prototype.setTextSize = function (s) {
     ...
     * @param textStr 	文字
     */
    NewProgressBar.prototype.setText = function (textStr) {
     ...
     * @param textColor 文字颜色
     */
    NewProgressBar.prototype.setTextColor = function (textColor) {
     ...
     * 进度条添加动画
     */
    NewProgressBar.prototype.TweenTxt = function (time) {
        var self = this;
     ...
     */
    NewProgressBar.prototype.tweenTo = function (endPercent, time, stepNum, callback, callbackThisObj, type) {
        if (stepNum) {
            var ths_1 = this;
    ...
    NewProgressBar.prototype.tweenNext = function (time, endPercent, stepNum, callback, callbackThisObj) {
        var ths = this;
    ...
    NewProgressBar.prototype.setDragIcon = function (resstr) {
    ...
    NewProgressBar.prototype.changeRes = function (res, res2, isClip, clipNum, duration, width, height) {
        if (isClip === void 0) { isClip = false; }
        if (isClip) {
            if (!this.progressBarClip) {
                var progressFire = ComponentManager.getCustomMovieClip(res, clipNum, duration);
    ...
    NewProgressBar.prototype.dispose = function () {
...
__reflect(NewProgressBar.prototype, "NewProgressBar");
