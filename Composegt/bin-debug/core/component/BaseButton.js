...
var BaseButton = (function (_super) {
     ...
     * @param 是否加粗
     */
    BaseButton.prototype.setBold = function (bold) {
    ...
    BaseButton.prototype.touchCallback = function (event) {
        var touchCallback = this._touchCallbackObj;
    ...
    /**文本相对按钮的x坐标偏移量 */
    BaseButton.prototype.setTextOffX = function (textOffX) {
    ...
    */
     ...
     * @param callbackObj
     */
    BaseButton.prototype.setTouchCallback = function (callback, callbackObj) {
        if (callback) {
