...
var DinnerOpenedView = (function (_super) {
    ...
    DinnerOpenedView.prototype.initView = function () {
        ...
        var openSuccess = ComponentManager.getTextField(LanguageManager.getlocal("openSuccessDesc", [dinnerType]), TextFieldConst.FONTSIZE_TITLE_SMALL, TextFieldConst.COLOR_WHITE);
        ...
        var playerId = ComponentManager.getTextField(LanguageManager.getlocal("playerId", [Api.playerVoApi.getPlayerID().toString()]), TextFieldConst.FONTSIZE_TITLE_SMALL, TextFieldConst.COLOR_WARN_GREEN2);
        playerId.setPosition(GameConfig.stageWidth / 2 - playerId.width / 2, descBg.y - 52 + descBg.height);
        this.addChild(playerId);
        var shareDinner = ComponentManager.getTextField(LanguageManager.getlocal("shareDinnerDesc"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_QUALITY_ORANGE);
