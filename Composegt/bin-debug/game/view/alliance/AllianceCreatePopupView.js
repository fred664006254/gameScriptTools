...
var AllianceCreatePopupView = (function (_super) {
    ...
    AllianceCreatePopupView.prototype.initView = function () {
        ...
        //联盟名称
        var inputTF1 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 45, "public_tc_srkbg05", LanguageManager.getlocal("allianceCreateNameholder"), TextFieldConst.COLOR_WHITE);
        ...
        var inputTF2 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 45, "public_tc_srkbg05", LanguageManager.getlocal("allianceCreateWeixinholder"), TextFieldConst.COLOR_WHITE);
        ...
        var inputTF3 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 45, "public_tc_srkbg05", LanguageManager.getlocal("allianceCreateQQholder"), TextFieldConst.COLOR_WHITE);
        ...
        var inputTF5 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 134, "public_tc_srkbg05", LanguageManager.getlocal("allianceCreateMsgholder"), TextFieldConst.COLOR_WHITE);
        ...
        var color = TextFieldConst.COLOR_WARN_GREEN2;
        // if(this._type == ""){
        this._type = "ON";
        // }
        // if(this._type != "ON"){
        ...
        var gemBg = BaseBitmap.create("public_icon1");
        // gemBg.setScale(0.5);
        gemBg.x = 230;
        gemBg.y = bg.y + bg.height + 5;
        this.addChildToContainer(gemBg);
        var gem = Config.AlliancebaseCfg.createNeedGem;
        var gemText = ComponentManager.getTextField(gem.toString(), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
        gemText.x = 280;
