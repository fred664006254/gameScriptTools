...
var AllianceFindPopupView = (function (_super) {
    ...
    AllianceFindPopupView.prototype.initView = function () {
        ...
        var inputTF = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 500, 44, "public_tc_srkbg05", LanguageManager.getlocal("allianceFindInputHolder"), TextFieldConst.COLOR_WHITE);
    ...
    AllianceFindPopupView.prototype.showFindInfo = function () {
        ...
        var nameStr = LanguageManager.getlocal("allianceFindInfo12", [this._allianceInfo.name, this._allianceInfo.level]);
