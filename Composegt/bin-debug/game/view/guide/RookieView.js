...
var RookieView = (function (_super) {
    ...
    RookieView.prototype.isShowOpenAni = function () {
        return false;
    };
    ...
    RookieView.prototype.showPage = function () {
        ...
        if (this._curConfig.clickRect) {
            ...
            var xx = this._clickRect.x;
            var yy = this._clickRect.y;
        ...
        if (this._curConfig.moveHand) {
            var moveClip = ComponentManager.getCustomMovieClip("guidearr", 3, 300);
            ...
            var moveHand = BaseBitmap.create("guide_hand");
            ...
            var moveHand = this.container.getChildByName("moveHand");
            if (moveHand) {
                this.container.removeChild(moveHand);
                moveHand = null;
            }
            var moveClip = this.container.getChildByName("moveClip");
            if (moveClip) {
    ...
    RookieView.prototype.clickSelectedManHandler = function (event) {
        this._skipBtn.visible = true;
    ...
    RookieView.prototype.clickSelectedWomanHandler = function (event) {
        this._skipBtn.visible = true;
    ...
    RookieView.prototype.hideScene = function () {
        return false;
    };
