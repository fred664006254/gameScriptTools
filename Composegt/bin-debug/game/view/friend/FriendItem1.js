...
var FriendItem1 = (function (_super) {
    ...
    FriendItem1.prototype.init = function (bottomH) {
        ...
        var collectBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_BLUE, "friendsBtnTxt1", this.collectBtnHandler, this);
        ...
        var sendBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW, "friendsBtnTxt2", this.sendBtnHandler, this);
    ...
    FriendItem1.prototype.doRefreshList = function () {
        ...
        if ((Api.switchVoApi.checkopenSadun() && dataList.length == 2)) {
            if (!this._emptyTipNode) {
                ...
                var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("friends_emptyTip1"), 20, TextFieldConst.COLOR_WHITE);
