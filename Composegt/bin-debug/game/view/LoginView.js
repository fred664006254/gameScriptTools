...
var LoginView = (function (_super) {
    ...
    LoginView.prototype.initView = function () {
        ...
        if (GameData.getCountry() != "cn" && App.DeviceUtil.CheckWebglRenderMode() && !PlatformManager.checkIsKRNewSp()) {
            var starBoneNode = App.DragonBonesUtil.getLoadDragonBones("loginviewbone");
        ...
        if (PlatformManager.checkIsViSp()) {
            var logo18 = BaseBitmap.create("loginres_vi18");
            logo18.x = 40;
    ...
    LoginView.prototype.playBgMusic = function (event) {
        if (event) {
            //屏幕点击特效
    ...
    LoginView.prototype.showLogoAndLoginBtn = function () {
        ...
        if (PlatformManager.getAppid() != "1014001001") {
            ...
            if (PlatformManager.checkIsJPSp()) {
                var newyearEffect = ComponentManager.getCustomMovieClip("loginanim_oneyear", 9, 150);
        ...
        var txt1 = ComponentManager.getTextField("背景故事纯属虚构，并非真实历史故事", 14, TextFieldConst.COLOR_WHITE);
        ...
        if (PlatformManager.checkIsWxSp() || PlatformManager.checkIsWxmgSp()) {
            var ageTip = ComponentManager.getTextField("适龄提示：本游戏适合年满18周岁以上用户使用", 14, TextFieldConst.COLOR_WHITE);
    ...
    LoginView.prototype.isShowOpenAni = function () {
        return false;
    };
    LoginView.prototype.initTestTouch = function () {
        ...
        var leftMk = BaseBitmap.create("testbg");
        leftMk.width = 60;
        leftMk.height = 130;
    ...
    LoginView.prototype.userCenterHandler = function (param) {
