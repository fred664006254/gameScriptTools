...
var AchievementScrollItem = (function (_super) {
    ...
    AchievementScrollItem.prototype.initItem = function (index, achInfoVo) {
        ...
        var bgBg = BaseBitmap.create("achievement_bg");
        ...
        var nameTF = ComponentManager.getTextField(achInfoVo.name, TextFieldConst.FONTSIZE_TITLE_COMMON, 0x420e00);
        ...
        var nn2 = App.StringUtil.changeIntToText(curValue);
