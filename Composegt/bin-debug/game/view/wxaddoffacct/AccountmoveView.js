 ...
 */
var AccountmoveView = (function (_super) {
    __extends(AccountmoveView, _super);
    function AccountmoveView() {
        var _this = _super.call(this) || this;
        _this._ranksData = null;
        return _this;
    }
    AccountmoveView.prototype.initView = function () {
        // this.height = 750;
        ...
        var titleTxt1 = ComponentManager.getTextField(LanguageManager.getlocal("accountmoveViewDesc1"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
        titleTxt1.width = 450;
        titleTxt1.x = GameConfig.stageWidth / 2 - titleTxt1.width / 2;
        titleTxt1.y = 30 + 30;
        this.addChildToContainer(titleTxt1);
        var rbg11 = BaseBitmap.create("public_tc_bg04");
        rbg11.width = 450;
        rbg11.height = 40;
        rbg11.x = GameConfig.stageWidth / 2 - rbg11.width / 2;
        rbg11.y = titleTxt1.y + titleTxt1.height + 20;
        this.addChildToContainer(rbg11);
        var titleTxt2 = ComponentManager.getTextField(LanguageManager.getlocal("accountmoveViewDesc2"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
        // titleTxt2.width= 450;
        ...
        var titleTxt3 = ComponentManager.getTextField(LanguageManager.getlocal("accountmoveViewDesc3"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
        // titleTxt3.width= 450;
        ...
        var titleTxt4 = ComponentManager.getTextField(LanguageManager.getlocal("accountmoveViewDesc4"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        // titleTxt4.width= 450;
        titleTxt4.x = GameConfig.stageWidth / 2 - titleTxt4.width / 2;
        titleTxt4.y = bg11.y + 20;
        this.addChildToContainer(titleTxt4);
        var titleTxt5 = ComponentManager.getTextField(this._ranksData.pidtoken, TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        //复制按钮
        var copyBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW, "accountmoveViewDesc5", this.copyBtnHandler, this);
        ...
        var titleTxt7 = ComponentManager.getTextField(this._ranksData.pidencrypturl, TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
        titleTxt7.width = 470;
        titleTxt7.x = GameConfig.stageWidth / 2 - titleTxt7.width / 2;
        titleTxt7.y = bg1.y + bg1.height + 30;
        this.addChildToContainer(titleTxt7);
        //下载按钮
        var downloadBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW, "accountmoveViewDesc6", this.downloadBtnHandler, this);
    ...
    AccountmoveView.prototype.copyBtnHandler = function () {
    ...
    AccountmoveView.prototype.downloadBtnHandler = function () {
        if (App.DeviceUtil.IsHtml5()) {
     ...
     * 获取活动配置
     */
    AccountmoveView.prototype.getRequestData = function () {
        return { requestType: NetRequestConst.REQUEST_OTHERINFO_GETPIDENCRYPT, requestData: {} };
    };
    AccountmoveView.prototype.receiveData = function (data) {
    ...
    // 	return 680;
    // }
    AccountmoveView.prototype.dispose = function () {
        this._ranksData = null;
        _super.prototype.dispose.call(this);
    };
    return AccountmoveView;
}(PopupView));
__reflect(AccountmoveView.prototype, "AccountmoveView");
