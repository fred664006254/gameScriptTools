...
var SearchStoryView = (function (_super) {
    __extends(SearchStoryView, _super);
    function SearchStoryView() {
        ...
        _this._newServant = false;
        _this._params = null;
        return _this;
    }
    SearchStoryView.prototype.getResourceList = function () {
        // test code
        ...
        this._params = this.param.data.params;
        this._newServant = !!this.param.data.newServant;
        var guidePic = [];
        ...
        return guidePic.concat([
            ...
            "searchstoryview_newservant"
        ]);
    };
    SearchStoryView.prototype.getTitleBgName = function () {
        return null;
    };
    SearchStoryView.prototype.getTitleStr = function () {
        return null;
    };
    SearchStoryView.prototype.getCloseBtnName = function () {
        return null;
    };
    SearchStoryView.prototype.getBgName = function () {
        return null;
    };
    SearchStoryView.prototype.isShowMask = function () {
        return true;
    };
    SearchStoryView.prototype.preInit = function () {
    ...
    SearchStoryView.prototype.init = function () {
        ...
        if (this._newServant) {
            this._newIcon = BaseBitmap.create("searchstoryview_newservant");
            this.addChild(this._newIcon);
            this._newIcon.setPosition((GameConfig.stageWidth - this._newIcon.width) / 2, 100);
        }
        // 开始游戏
        var btnName;
        btnName = "skip_btn1";
    ...
    SearchStoryView.prototype.clickPage = function (evt) {
    ...
    SearchStoryView.prototype.doNextStep = function (step) {
    ...
    SearchStoryView.prototype.createChoose = function () {
    ...
    SearchStoryView.prototype.showPage = function () {
        //this.doStepHandle();
        //需要跳转到下一个信息界面
        if (this._isJumpNext) {
        ...
        if (this._curDialogConfig.dialogueID) {
            ...
            if (this._curDialogConfig.personPic == "1" || this._curDialogConfig.personPic == "999") {
                ...
                var scale = 1;
                var startY = 0;
                if (this._curDialogConfig.personPic.substring(0, 4) == "wife") {
                    width = 640;
                    height = 840;
                    scale = 0.8;
    ...
    SearchStoryView.prototype.clickSelectedHandler = function (event, branchBtn, nextId) {
    ...
    SearchStoryView.prototype.changeBgCallBack = function () {
    ...
    SearchStoryView.prototype.showShakeAnim = function () {
    ...
    SearchStoryView.prototype.shakeScreen = function () {
    ...
    SearchStoryView.prototype.showFogAnim = function () {
        this._myBg.y = 0;
    ...
    SearchStoryView.prototype.textShootAnim = function () {
    ...
    SearchStoryView.prototype.textAnim = function (t) {
    ...
    SearchStoryView.prototype.skipAnim = function () {
        this.hide();
     ...
     * 收到通知 下一步
     */
    SearchStoryView.prototype.noticeNextStep = function () {
        this.doNextStep();
    };
    SearchStoryView.prototype.initView = function () {
    };
    SearchStoryView.prototype.getParent = function () {
        return LayerManager.maskLayer;
    };
    SearchStoryView.prototype.hide = function (isDispose) {
        var tempObj = this._target;
        var tempFunc = this._callback;
        if (!isDispose) {
            if (tempObj && tempFunc) {
                if (this._params) {
                    tempFunc.apply(tempObj, [this._params]);
                }
                else {
                    tempFunc.apply(tempObj);
                }
    ...
    SearchStoryView.prototype.doStepHandle = function () {
        if (this._curIdx == "1") {
    ...
    SearchStoryView.prototype.dispose = function () {
    ...
    return SearchStoryView;
}(CommonView));
__reflect(SearchStoryView.prototype, "SearchStoryView");
