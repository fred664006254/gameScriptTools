...
var AtkracecrossView = (function (_super) {
    ...
    //根据资源名字得到完整资源名字
    AtkracecrossView.prototype.getDefaultRes = function (resName, defaultCode) {
    ...
    AtkracecrossView.prototype.initView = function () {
        ...
        var crossVo = Api.acVoApi.getActivityVoByAidAndCode("crossServerAtkRace");
        var cfg = Config.AcCfg.getCfgByActivityIdAndCode("crossServerAtkRace", crossVo.code);
        ...
        var _ruleBg = BaseBitmap.create("commonview_titlebg02");
        _ruleBg.x = 0;
        _ruleBg.y = 0;
    ...
    AtkracecrossView.prototype.resetInfo = function () {
        ...
        if (this._fightflag == false) {
            //对话框
            var wordsBg = BaseBitmap.create("public_9v_bg11_2");
            wordsBg.width = 260;
            wordsBg.height = 78;
            ...
            if (myAtkInfo && myAtkInfo.mesid && myAtkInfo.mesid.sid) {
                ...
                var crossVo = Api.acVoApi.getActivityVoByAidAndCode("crossServerAtkRace");
                //出战次数
                var itemCfg = Config.AcCfg.getCfgByActivityIdAndCode("crossServerAtkRace", crossVo.code);
                ...
                if (myNum >= maxCount) {
                    ...
                    var extraCoefficient = Config.AcCfg.getCfgByActivityIdAndCode("crossServerAtkRace", crossVo.code).getParameter1();
                    ...
                    this._countDownTime = myInfo.lasttime + Config.AcCfg.getCfgByActivityIdAndCode("crossServerAtkRace", crossVo_1.code).getIntervalTime() - GameData.serverTime;
    ...
    AtkracecrossView.prototype.clickDialog = function () {
        var crossVo = Api.acVoApi.getActivityVoByAidAndCode("crossServerAtkRace");
        var itemId = Config.AcCfg.getCfgByActivityIdAndCode("crossServerAtkRace", crossVo.code).getFightAdd();
        var needNum = 1;
    ...
    AtkracecrossView.prototype.createSpecial = function (y) {
        var crossVo = Api.acVoApi.getActivityVoByAidAndCode("crossServerAtkRace");
        var cfg = Config.AcCfg.getCfgByActivityIdAndCode("crossServerAtkRace", crossVo.code);
        var rewardItemVo = GameData.formatRewardItem(cfg.specialReward);
    ...
    AtkracecrossView.prototype.detailBtnClick = function () {
        var crossVo = Api.acVoApi.getActivityVoByAidAndCode("crossServerAtkRace");
        var cfg = Config.AcCfg.getCfgByActivityIdAndCode("crossServerAtkRace", crossVo.code);
    ...
    AtkracecrossView.prototype.initCannotJoin = function () {
        ...
        var notJoinStr = "atkracecrossNotJoin";
        ...
        var rcannotJoinDesc = ComponentManager.getTextField(LanguageManager.getlocal(notJoinStr), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
    ...
    AtkracecrossView.prototype.initResult = function () {
        ...
        var rewardStr = "atkracecrossRewardDesc";
        ...
        var rewardDesc = ComponentManager.getTextField(LanguageManager.getlocal(rewardStr, [servername]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
    ...
    AtkracecrossView.prototype.initBottom = function () {
        ...
        //来访消息 
        var visitBg = ComponentManager.getButton("mainui_bottombtnbg", null, this.visitHandle, this, null, 0);
        visitBg.setPosition(24, GameConfig.stageHeigth - 200);
        this.addChild(visitBg);
        var visitIcon = BaseBitmap.create("atkracecross_laifa");
        visitIcon.setPosition(visitBg.width / 2 - visitIcon.width / 2, visitBg.height / 2 - visitIcon.height / 2);
        visitBg.addChild(visitIcon);
        var visitText = BaseBitmap.create("atkracecross_laifa_text");
        ...
        var awardText = BaseBitmap.create("punish_reward_name");
    ...
    AtkracecrossView.prototype.fightendCallback = function () {
        var tipStr = "atkracecrossFightEndTip";
