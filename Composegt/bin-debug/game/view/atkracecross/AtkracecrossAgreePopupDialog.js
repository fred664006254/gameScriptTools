...
var AtkracecrossAgreePopupDialog = (function (_super) {
    ...
    AtkracecrossAgreePopupDialog.prototype.isShowOpenAni = function () {
        return false;
    };
    ...
    AtkracecrossAgreePopupDialog.prototype.initView = function () {
        ...
        // let blackBg:BaseBitmap = BaseBitmap.create("public_tc_hd01");
        // blackBg.width = 523;
        // blackBg.height = 60;
        // blackBg.alpha = 0.4;
        // blackBg.setPosition(this.viewBg.width/2 - blackBg.width/2, 348);
        // this.addChildToContainer(blackBg); 
        ...
        // descText.setPosition(this.viewBg.width/2 - descText.width/2 , servantFullImg.y+servantFullImg.height-30 );
        ...
        for (var i = 0; i < btnArray.length; i++) {
            ...
            btnBg.width = 556;
            btnBg.height = 55;
            // btnBg.setPosition(GameConfig.stageWidth/2 - btnBg.width/2,  GameConfig.stageHeigth/2 + 300 + i*65);
    ...
    AtkracecrossAgreePopupDialog.prototype.getShowHeight = function () {
        return 650;
    };
