...
var AtkracecrossActivityRewardViewTab1 = (function (_super) {
    ...
    Object.defineProperty(AtkracecrossActivityRewardViewTab1.prototype, "cfg", {
        get: function () {
            var vo2 = Api.acVoApi.getActivityVoByAidAndCode("crossServerAtkRace");
            return Config.AcCfg.getCfgByActivityIdAndCode("crossServerAtkRace", vo2.code);
        },
        enumerable: true,
        configurable: true
    });
    ...
    AtkracecrossActivityRewardViewTab1.prototype.initView = function () {
        ...
        var txt1 = ComponentManager.getTextField(LanguageManager.getlocal("atkracecrossActivityRewardTxt1"), 24, TextFieldConst.COLOR_BROWN);
        ...
        if (zrankinfo.length == 2) {
            ...
            for (var index = 0; index < rList.length; index++) {
                ...
                var winBottomBg_1 = BaseBitmap.create("rechargevie_db_01");
                winBottomBg_1.width = 628;
                winBottomBg_1.y = scroStartY;
                winBottomBg_1.x = 6;
                this._nodeContainer.addChild(winBottomBg_1);
                var winbg_1 = BaseBitmap.create("public_9v_bg02");
                winbg_1.width = 628;
                winbg_1.height = 60;
                winbg_1.visible = false;
