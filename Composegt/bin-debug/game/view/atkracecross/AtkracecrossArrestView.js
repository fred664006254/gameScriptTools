...
var AtkracecrossArrestView = (function (_super) {
    ...
    AtkracecrossArrestView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            ...
            "atkrace_one_key", "atkrace_temp_property", "atkrace_text_bg", "progress_type1_red", "progress_type1_bg2",
            "progress_type3_bg",
            "progress_type3_red",
            "arena_detailbg",
            "atkrace_namebg",
    ...
    AtkracecrossArrestView.prototype.getBgName = function () {
    ...
    AtkracecrossArrestView.prototype.initView = function () {
        ...
        // tempProperty.setPosition(419,500);
        ...
        this._playerScore = ComponentManager.getTextField(LanguageManager.getlocal("atkrace_score", [Api.playerVoApi.getPlayerName(), Api.atkracecrossVoApi.getPoint().toString()]), TextFieldConst.FONTSIZE_TITLE_SMALL, TextFieldConst.COLOR_WARN_YELLOW_NEW);
        ...
        var servantLv = ComponentManager.getTextField(LanguageManager.getlocal("atkrace_level", [servantName, myInfo.lv.toString()]), TextFieldConst.FONTSIZE_TITLE_SMALL, TextFieldConst.COLOR_WARN_YELLOW_NEW);
    ...
    AtkracecrossArrestView.prototype.resetServantInfo = function () {
        ...
        for (var key in myAtkInfo.fids) {
            ...
            // 	snamebg.y = cardbg.y + cardbg.height-10 ;
            ...
            // container.addChild(servantImg);
            // let sernamebg =  BaseBitmap.create("public_servantskin_namebg2");
    ...
    AtkracecrossArrestView.prototype.getNameQualityColor = function (clv) {
    ...
    AtkracecrossArrestView.prototype.vsClick = function (event, key) {
        ...
        if (myAtkInfo.fightnum == 0 && this._isShowBuy == false && (myAtkInfo.tmpattr == null || (myAtkInfo.tmpattr.atk == 0 && myAtkInfo.tmpattr.blood == 0))) {
            ...
            var itemCfg = Config.AcCfg.getCfgByActivityIdAndCode("crossServerAtkRace", vo.code);
