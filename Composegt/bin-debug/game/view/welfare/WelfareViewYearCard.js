...
var WelfareViewYearCard = (function (_super) {
    ...
    WelfareViewYearCard.prototype.initNewUi = function () {
        // this._offsetY = this.bottomBg.y+20;
        this._scrollContiner = new BaseDisplayObjectContainer();
        // this._scrollContiner = new BaseDisplayObjectContainer();
        ...
        var uiBg = BaseBitmap.create("yearcard_newBg");
        uiBg.x = 0;
        uiBg.y = 0;
        ...
        var topBanner = BaseBitmap.create("yearcard_banner" + this._strWx);
        topBanner.x = 0;
        topBanner.y = 0;
        ...
        if (isBuy == true) {
            ...
            if (rechargeItemCfg || rechargeItemCurrentCfg) {
                ...
                if (acDiscountVo && rechargeItemCurrentCfg) {
                    ...
                    this._openDialogDiscountEnabled = false;
                    if (rechargeItemCfg) {
                        var str = App.CommonUtil.getMoneyString(g8Cost);
                        goToRechargeBtn.setText(str, false);
                    }
                }
            }
        }
        var downBottomDes = ComponentManager.getTextField(LanguageManager.getlocal("newYearDesc1"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
        ...
        var downBottomDes2 = ComponentManager.getTextField(LanguageManager.getlocal("newYearDesc2"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
    ...
    WelfareViewYearCard.prototype.creatCellByIndex = function (indexNum) {
        var x = 0;
        var y = 250;
        var nameStr = "";
        var descStr = "";
        ...
        if (indexNum == 1) {
            //元宝特权
            var cfg = Config.RechargeCfg.getRechargeItemCfgByKey("g8");
            if (!cfg) {
        ...
        var cell_bg = BaseBitmap.create("yearcard_cell_bg");
        cell_bg.x = x;
        cell_bg.y = y;
    ...
    WelfareViewYearCard.prototype.tick = function () {
        ...
        if (acDiscountVo) {
            ...
            if (Api.switchVoApi.checkOpenNewMonthCardAndYearCard() && this._acTimeTF != null) {
                var timeStr = App.DateUtil.getFormatBySecond(acDiscountVo.et - GameData.serverTime, 1);
    ...
    WelfareViewYearCard.prototype.showText = function () {
        //年卡有效期
        var cardTimedeTxt = ComponentManager.getTextField(LanguageManager.getlocal("lifecarTimeddes"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
