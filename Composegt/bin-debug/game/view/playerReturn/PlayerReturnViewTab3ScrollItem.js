...
var PlayerReturnViewTab3ScrollItem = (function (_super) {
    ...
    PlayerReturnViewTab3ScrollItem.prototype.initItem = function (index, data, itemparam) {
        ...
        //进度条
        view._progress = ComponentManager.getProgressBar("progress_type3_yellow", "progress_type3_bg", 570);
        ...
        // view.setLayoutPosition(LayoutConst.rightverticalCenter, lqBtn, wordsBg, [10, 0]);
        view.setLayoutPosition(LayoutConst.righttop, lqBtn, view, [10, 55]);
        view.addChild(lqBtn);
        view._lqBtn = lqBtn;
        ...
        view._lqImg = lqimg;
        //前往
        view._goBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW, "acRechargeBoxPopupViewGoRecharge", view.goRechargeHandler, view);
