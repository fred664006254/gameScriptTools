        ...
        for (var index = 0; index < rewardArr.length; index++) {
            ...
            if (index >= (rewardArr.length - data.getRewardVIP.split('|').length)) {
                if (view.cfg.needVip != 0) {
                    ...
                    var vipTxt = ComponentManager.getTextField(LanguageManager.getlocal('PlayerReturnVipCondition', [view.cfg.needVip.toString()]), 16, TextFieldConst.COLOR_LIGHT_YELLOW);
