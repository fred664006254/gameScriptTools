...
var SkinLevelDetailPopupView = (function (_super) {
    __extends(SkinLevelDetailPopupView, _super);
    function SkinLevelDetailPopupView() {
    ...
    SkinLevelDetailPopupView.prototype.initView = function () {
        ...
        var icon = this.getWifestatusIcon(iconStr, this._skinCfg.name);
        ...
        var titleBg = BaseBitmap.create("popupview_bg4");
        titleBg.x = this.viewBg.width / 2 - titleBg.width / 2;
        titleBg.y = tBg.y + tBg.height - titleBg.height + 21;
        this.addChildToContainer(titleBg);
        line.y = titleBg.y;
        var curLvText = ComponentManager.getTextField(LanguageManager.getlocal("skincurLv"), 22, TextFieldConst.COLOR_WARN_YELLOW_NEW);
        curLvText.setPosition(100 + titleBg.x, titleBg.y + 25);
        this.addChildToContainer(curLvText);
        var nextLvText = ComponentManager.getTextField(LanguageManager.getlocal("skinnextLv"), 22, TextFieldConst.COLOR_WARN_YELLOW_NEW);
        nextLvText.setPosition(titleBg.x + titleBg.width - nextLvText.width - 80, curLvText.y);
        this.addChildToContainer(nextLvText);
        var topBottom = BaseBitmap.create("public_9v_bg12");
        topBottom.width = 530;
        ...
        var bottom = BaseBitmap.create("public_9v_bg12");
        bottom.width = 530;
        bottom.height = 152;
        bottom.x = this.viewBg.width / 2 - bottom.width / 2;
        bottom.y = scrollView.y + scrollView.height + 15;
        this.addChildToContainer(bottom);
        var descText1 = ComponentManager.getTextField(LanguageManager.getlocal("skinLvupTiptxt1"), 18, TextFieldConst.COLOR_BROWN);
        descText1.width = 480;
    ...
    SkinLevelDetailPopupView.prototype.getWifestatusIcon = function (iconStr, nameText) {
        ...
        var nameTF = ComponentManager.getTextField(nameText, 18, TextFieldConst.COLOR_WARN_YELLOW_NEW);
    ...
    SkinLevelDetailPopupView.prototype.setScrollItem = function (index, valueType, type, value, valueO) {
        ...
        var nameText = ComponentManager.getTextField(LanguageManager.getlocal("skinLvuptxt" + valueType), 20, TextFieldConst.COLOR_BROWN);
        nameText.setPosition(60, containerBg.height / 2 - nameText.height / 2);
        scrollContiner.addChild(nameText);
        var value1 = ComponentManager.getTextField("", 20, TextFieldConst.COLOR_BROWN);
        value1.setPosition(180, nameText.y);
        scrollContiner.addChild(value1);
        var value2 = ComponentManager.getTextField("", 20, TextFieldConst.COLOR_WARN_GREEN);
    ...
    SkinLevelDetailPopupView.prototype.getBgExtraHeight = function () {
        return 25;
    };
    SkinLevelDetailPopupView.prototype.getTitleStr = function () {
        return "detail";
    };
    SkinLevelDetailPopupView.prototype.getResourceList = function () {
    ...
    SkinLevelDetailPopupView.prototype.dispose = function () {
    ...
    return SkinLevelDetailPopupView;
}(PopupView));
__reflect(SkinLevelDetailPopupView.prototype, "SkinLevelDetailPopupView");
