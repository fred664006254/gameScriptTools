...
var CouncilEventSelectSearvantItem = (function (_super) {
    ...
    CouncilEventSelectSearvantItem.prototype.initItem = function (index, info) {
        ...
        var iconBgBt = BaseLoadBitmap.create(data.qualityBoxImgPath, null, { callback: function () {
                ...
                var nameTxt = ComponentManager.getTextField(data.servantName, 22, TextFieldConst.COLOR_BROWN);
                view.setLayoutPosition(LayoutConst.horizontalCenterverticalCenter, nameTxt, namebg);
                view.addChild(nameTxt);
                var levelTxt = ComponentManager.getTextField(LanguageManager.getlocal('discussServantLevel', [data.level.toString()]), 20, TextFieldConst.COLOR_BROWN);
                ...
                var mainatrText = ComponentManager.getTextField(LanguageManager.getlocal(attr, [mainAtr]), 20, TextFieldConst.COLOR_BROWN);
        ...
        var selectBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, 'allianceTaskSendBtnTxt', view.selectClick, view);
