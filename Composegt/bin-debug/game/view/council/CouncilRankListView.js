...
var CouncilRankListView = (function (_super) {
    ...
    CouncilRankListView.prototype.initView = function () {
        var view = this;
        var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("councilRankListTip1"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
        ...
        var rankBg2 = BaseBitmap.create("public_tc_bg03");
        ...
        var scroRect = new egret.Rectangle(rankBg.x, rankBg.y, rankBg.width, rankBg2.height - 20);
