...
var AtkraceVisitViewTab3 = (function (_super) {
    ...
    AtkraceVisitViewTab3.prototype.initView = function () {
        ...
        //黑色长条背景
        var blackBgRect = BaseBitmap.create("playerview_centerinfobg");
        ...
        //追杀文字
        var atkraceTracingdesTxt = ComponentManager.getTextField(LanguageManager.getlocal("atkraceTracingdescription"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WARN_YELLOW_NEW);
