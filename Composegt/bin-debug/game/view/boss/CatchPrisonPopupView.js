...
var CatchPrisonPopupView = (function (_super) {
    ...
    CatchPrisonPopupView.prototype.isShowOpenAni = function () {
        return false;
    };
    CatchPrisonPopupView.prototype.initView = function () {
        ...
        prisonHead.x = this.viewBg.width / 2 - 400 * 0.8 / 2;
        // prisonHead.y+=15;
        prisonHead.y = 25;
    ...
    CatchPrisonPopupView.prototype.hide = function () {
    ...
    CatchPrisonPopupView.prototype.dispose = function () {
        ...
        App.MessageHelper.dispatchEvent(MessageConst.MESSAGE_NOTICE_CLOSE_CHALLENGE);
