...
var StudyatkBookScrollItem = (function (_super) {
    ...
    StudyatkBookScrollItem.prototype.initItem = function (index, data) {
        ...
        var startX = nameBg.x;
        var startY = nameBg.y + nameBg.height / 2;
        var bookTxt1 = ComponentManager.getTextField("", 20, TextFieldConst.COLOR_QUALITY_GREEN);
        ...
        for (var index = 1; index < 3; index++) {
            var bookTxt1_1 = ComponentManager.getTextField("", 20, TextFieldConst.COLOR_BROWN);
            bookTxt1_1.text = strCfg[index].txt;
            bookTxt1_1.x = startX;
            bookTxt1_1.y = startY - bookTxt1_1.height / 2;
            bookTxt1_1.name = "bookTxt" + index;
            this.addChild(bookTxt1_1);
            startY += 28;
        }
