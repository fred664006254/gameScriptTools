...
var AllianceWarUsePlanPopupView = (function (_super) {
    ...
    AllianceWarUsePlanPopupView.prototype.initView = function () {
        ...
        var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("allianceWarUsePlanPopupViewTip", [itemCfg.name]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        if (tipTxt.width > 480) {
            tipTxt.width = 480;
        }
            ...
            if (info && info.servant != null) {
                ...
                if (itemCfg.id != "2201") {
                    ...
                    for (var key in servantInfoVoList) {
                        ...
                        var servantInfo = { servantId: item.servantId, servantName: item.servantName, level: item.level, fightValue: fightValue, qualityBoxImgPath: item.qualityBoxImgPath, halfImgPath: item.halfImgPath };
