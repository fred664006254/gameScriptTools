...
var AllianceWarView = (function (_super) {
    ...
    AllianceWarView.prototype.initView = function () {
        ...
        var scoreBtntxt = BaseBitmap.create("awscorerank_txt");
        ...
        var tsize1 = TextFieldConst.FONTSIZE_CONTENT_COMMON;
        ...
        var rewardBtntxt = BaseBitmap.create("awawardbtn_txt");
        ...
        this._sendBtn = btn;
        var sendBtntxt = BaseBitmap.create("awsend_txt");
