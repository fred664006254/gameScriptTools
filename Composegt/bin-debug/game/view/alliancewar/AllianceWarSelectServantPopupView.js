...
var AllianceWarSelectServantPopupView = (function (_super) {
    ...
    AllianceWarSelectServantPopupView.prototype.showTip = function () {
        App.CommonUtil.showTip(LanguageManager.getlocal("allianceWarSelectServantTip"));
        this.hide();
    };
    AllianceWarSelectServantPopupView.prototype.showPlanTip = function () {
        App.CommonUtil.showTip(LanguageManager.getlocal("allianceWarSelectPlanTip"));
        this.hide();
    };
    AllianceWarSelectServantPopupView.prototype.showCancelTip = function () {
