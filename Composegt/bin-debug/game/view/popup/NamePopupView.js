...
var NamePopupView = (function (_super) {
    ...
    NamePopupView.prototype.initView = function () {
        ...
        //输入框
        var inputTF = ComponentManager.getInputTextField(TextFieldConst.COLOR_INPUT, TextFieldConst.FONTSIZE_TITLE_SMALL, 220, 45, "public_tc_srkbg06");
        ...
        if (this._type == 1) {
            ...
            var changeName1 = ComponentManager.getTextField("", TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN_NEW);
            ...
            var numTf = ComponentManager.getTextField("", TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WARN_GREEN_NEW);
            ...
            var changeName2 = ComponentManager.getTextField("", TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN_NEW);
            ...
            var totalWidth = changeName1.width + 20 + gemIcon.width + 20 + changeName2.width;
            var startX = this.viewBg.width / 2 - totalWidth / 2;
    ...
    NamePopupView.prototype.getNameLength = function (type) {
