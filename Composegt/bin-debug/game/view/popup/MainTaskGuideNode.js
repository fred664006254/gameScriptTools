...
var MainTaskGuideNode = (function (_super) {
    ...
    MainTaskGuideNode.prototype.init = function () {
        ...
        var rbg = BaseBitmap.create("maintask_guidebg");
        rbg.setPosition(0, -rbg.height / 2);
        this.addChild(rbg);
        rbg.addTouchTap(this.bgHandler, this);
        this._rbg = rbg;
        var icon = BaseBitmap.create("maintask_guideicon");
        icon.x = rbg.x;
        ...
        var closeBtn = ComponentManager.getButton("maintask_guideclose", "", this.hide, this);
    ...
    MainTaskGuideNode.prototype.refreshUIInfo = function () {
        ...
        var cfg = MainTaskGuidePosCfg.poscfg[taskCfg.openType];
    ...
    MainTaskGuideNode.prototype.resetUIPos = function (uiName) {
        ...
        var cfg = MainTaskGuidePosCfg.poscfg[uiName];
        if (!this._taskId || !taskCfg || !cfg) {
            return;
        }
        this.x = cfg.x;
