...
var AcWifeSkininheritAVGView = (function (_super) {
    __extends(AcWifeSkininheritAVGView, _super);
    function AcWifeSkininheritAVGView() {
    ...
    Object.defineProperty(AcWifeSkininheritAVGView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcWifeSkininheritAVGView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcWifeSkininheritAVGView.prototype, "acTivityId", {
        get: function () {
    ...
    AcWifeSkininheritAVGView.prototype.getResourceList = function () {
        // test code
        ...
        var guidePic = [];
        var allAvg = this.vo.getAvgConfig(this.param.data.buidId, this.param.data.code);
    ...
    AcWifeSkininheritAVGView.prototype.getTitleBgName = function () {
        return null;
    };
    AcWifeSkininheritAVGView.prototype.getTitleStr = function () {
        return null;
    };
    AcWifeSkininheritAVGView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcWifeSkininheritAVGView.prototype.getBgName = function () {
        return null;
    };
    AcWifeSkininheritAVGView.prototype.isShowMask = function () {
        return true;
    };
    AcWifeSkininheritAVGView.prototype.preInit = function () {
    ...
    AcWifeSkininheritAVGView.prototype.init = function () {
    ...
    AcWifeSkininheritAVGView.prototype.clickPage = function (evt) {
    ...
    AcWifeSkininheritAVGView.prototype.doNextStep = function (step) {
        var view = this;
        var nextId = null;
        if (step) {
            nextId = step;
    ...
    AcWifeSkininheritAVGView.prototype.showPage = function () {
        //this.doStepHandle();
        if (this._showManTab) {
        ...
        if (this._curConfig.descId) {
            ...
            if (this._curConfig.clickContinue) {
                ...
                this._codonLength = 0;
                this._descText.text = "";
                if (LanguageManager.checkHasKey("acWifeSkinInheritAVGDialog" + this._curConfig.descId + codStr)) {
                    this._descContent = LanguageManager.getlocal("acWifeSkinInheritAVGDialog" + this._curConfig.descId + codStr);
                }
                else {
                    this._descContent = LanguageManager.getlocal("acWifeSkinInheritAVGDialog" + this._curConfig.descId + "_code1");
                }
                needShoot = true;
            }
            else {
                if (LanguageManager.checkHasKey("acWifeSkinInheritAVGDialog" + this._curConfig.descId + codStr)) {
                    this._descText.text = LanguageManager.getlocal("acWifeSkinInheritAVGDialog" + this._curConfig.descId + codStr);
                }
                else {
                    this._descText.text = LanguageManager.getlocal("acWifeSkinInheritAVGDialog" + this._curConfig.descId + "_code1");
                }
    ...
    AcWifeSkininheritAVGView.prototype.clickSelectedHandler = function (event, branchBtn, step) {
        switch (event.type) {
    ...
    AcWifeSkininheritAVGView.prototype.changeBgCallBack = function () {
    ...
    AcWifeSkininheritAVGView.prototype.showShakeAnim = function () {
    ...
    AcWifeSkininheritAVGView.prototype.shakeScreen = function () {
    ...
    AcWifeSkininheritAVGView.prototype.showFogAnim = function () {
        this._myBg.y = 0;
    ...
    AcWifeSkininheritAVGView.prototype.textShootAnim = function () {
    ...
    AcWifeSkininheritAVGView.prototype.textAnim = function (t) {
    ...
    AcWifeSkininheritAVGView.prototype.skipAnim = function () {
        this.hide();
     ...
     * 收到通知 下一步
     */
    AcWifeSkininheritAVGView.prototype.noticeNextStep = function () {
        this.doNextStep();
    };
    AcWifeSkininheritAVGView.prototype.initView = function () {
    };
    AcWifeSkininheritAVGView.prototype.getParent = function () {
        return LayerManager.maskLayer;
    };
    AcWifeSkininheritAVGView.prototype.hide = function (isDispose) {
        var tempObj = this._obj;
        var tempFunc = this._callbackF;
        if (!isDispose) {
            if (tempObj && tempFunc) {
    ...
    AcWifeSkininheritAVGView.prototype.doStepHandle = function () {
        if (this._curIdx == "1") {
    ...
    AcWifeSkininheritAVGView.prototype.dispose = function () {
    ...
    return AcWifeSkininheritAVGView;
}(CommonView));
__reflect(AcWifeSkininheritAVGView.prototype, "AcWifeSkininheritAVGView");
