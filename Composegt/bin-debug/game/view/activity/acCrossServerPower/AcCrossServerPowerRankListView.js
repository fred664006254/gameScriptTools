...
var AcCrossServerPowerRankListView = (function (_super) {
    ...
    AcCrossServerPowerRankListView.prototype.initView = function () {
        ...
        var scoreText = ComponentManager.getTextField(LanguageManager.getlocal("croessPowerScore-" + this.vo.code), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var socreText = ComponentManager.getTextField((LanguageManager.getlocal("croessPowerScore-" + this.vo.code) + ': '), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
        ...
        var servaername = Api.mergeServerVoApi.getAfterMergeSeverName(null, false, null);
