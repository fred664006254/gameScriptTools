 ...
 */
var AcRescueExScrollItem = (function (_super) {
    __extends(AcRescueExScrollItem, _super);
    function AcRescueExScrollItem() {
        return _super.call(this) || this;
    }
    AcRescueExScrollItem.prototype.initItem = function (index, data) {
    ...
    AcRescueExScrollItem.prototype.chooseBtnClick = function () {
        var acVo = Api.acVoApi.getActivityVoByAidAndCode(AcRescueBuyItemPopupView.aid, AcRescueBuyItemPopupView.code);
    ...
    AcRescueExScrollItem.prototype.buyCallback = function (event) {
        var data = event.data;
        if (data.data.ret == 0) {
            //领取成功
    ...
    AcRescueExScrollItem.prototype.refreshData = function (index) {
        var acVo = Api.acVoApi.getActivityVoByAidAndCode(AcRescueBuyItemPopupView.aid, AcRescueBuyItemPopupView.code);
        var maxNum = this._itemData.limit;
        var num = 0;
        if (acVo.shop[(index + 1).toString()]) {
    ...
    AcRescueExScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcRescueExScrollItem.prototype.getSpaceX = function () {
        return 9;
    };
    AcRescueExScrollItem.prototype.dispose = function () {
    ...
    return AcRescueExScrollItem;
}(ScrollListItem));
__reflect(AcRescueExScrollItem.prototype, "AcRescueExScrollItem");
