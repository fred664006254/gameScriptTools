...
var AcWifeBathingAVGView = (function (_super) {
    __extends(AcWifeBathingAVGView, _super);
    function AcWifeBathingAVGView() {
    ...
    Object.defineProperty(AcWifeBathingAVGView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcWifeBathingAVGView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcWifeBathingAVGView.prototype, "acTivityId", {
        get: function () {
    ...
    AcWifeBathingAVGView.prototype.isShowOpenAni = function () {
        return false;
    };
    AcWifeBathingAVGView.prototype.getResourceList = function () {
        // test code
    ...
    AcWifeBathingAVGView.prototype.getTitleBgName = function () {
        return null;
    };
    AcWifeBathingAVGView.prototype.getTitleStr = function () {
        return null;
    };
    AcWifeBathingAVGView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcWifeBathingAVGView.prototype.getBgName = function () {
        return null;
    };
    AcWifeBathingAVGView.prototype.isShowMask = function () {
        return true;
    };
    AcWifeBathingAVGView.prototype.preInit = function () {
    ...
    AcWifeBathingAVGView.prototype.init = function () {
    ...
    AcWifeBathingAVGView.prototype.clickPage = function (evt) {
    ...
    AcWifeBathingAVGView.prototype.doNextStep = function (step) {
        var view = this;
        var nextId = null;
        if (step) {
            nextId = step;
    ...
    AcWifeBathingAVGView.prototype.showPage = function () {
        //this.doStepHandle();
        if (this._showManTab) {
        ...
        if (this._curConfig.descId) {
            ...
            if (this._curConfig.clickContinue) {
                ...
                this._codonLength = 0;
                this._descText.text = "";
                if (LanguageManager.checkHasKey("acWifeBathingAVGDialog" + this._curConfig.descId + codStr)) {
                    this._descContent = LanguageManager.getlocal("acWifeBathingAVGDialog" + this._curConfig.descId + codStr);
                }
                else {
                    this._descContent = LanguageManager.getlocal("acWifeBathingAVGDialog" + this._curConfig.descId + "_code1");
                }
                needShoot = true;
            }
            else {
                if (LanguageManager.checkHasKey("acWifeBathingAVGDialog" + this._curConfig.descId + codStr)) {
                    this._descText.text = LanguageManager.getlocal("acWifeBathingAVGDialog" + this._curConfig.descId + codStr);
                }
                else {
                    this._descText.text = LanguageManager.getlocal("acWifeBathingAVGDialog" + this._curConfig.descId + "_code1");
                }
    ...
    AcWifeBathingAVGView.prototype.clickSelectedHandler = function (event, branchBtn, step) {
        switch (event.type) {
    ...
    AcWifeBathingAVGView.prototype.changeBgCallBack = function () {
    ...
    AcWifeBathingAVGView.prototype.showShakeAnim = function () {
    ...
    AcWifeBathingAVGView.prototype.shakeScreen = function () {
    ...
    AcWifeBathingAVGView.prototype.showFogAnim = function () {
        this._myBg.y = 0;
    ...
    AcWifeBathingAVGView.prototype.textShootAnim = function () {
    ...
    AcWifeBathingAVGView.prototype.textAnim = function (t) {
    ...
    AcWifeBathingAVGView.prototype.skipAnim = function () {
        this.hide();
     ...
     * 收到通知 下一步
     */
    AcWifeBathingAVGView.prototype.noticeNextStep = function () {
        this.doNextStep();
    };
    AcWifeBathingAVGView.prototype.initView = function () {
    };
    AcWifeBathingAVGView.prototype.getParent = function () {
        return LayerManager.maskLayer;
    };
    AcWifeBathingAVGView.prototype.hide = function (isDispose) {
        var tempObj = this._obj;
        var tempFunc = this._callbackF;
        if (!isDispose) {
            if (tempObj && tempFunc) {
    ...
    AcWifeBathingAVGView.prototype.doStepHandle = function () {
        if (this._curIdx == "1") {
    ...
    AcWifeBathingAVGView.prototype.dispose = function () {
    ...
    return AcWifeBathingAVGView;
}(CommonView));
__reflect(AcWifeBathingAVGView.prototype, "AcWifeBathingAVGView");
