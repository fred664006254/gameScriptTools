...
var AcDoubleSeventhAwardView = (function (_super) {
    ...
    AcDoubleSeventhAwardView.prototype.initView = function () {
        ...
        var scroRect = new egret.Rectangle(0, 0, 640, 680);
        var arr = [];
        ...
        var scrollList = ComponentManager.getScrollList(AcDoubleSeventhAwardScrollItem, arr, scroRect);
