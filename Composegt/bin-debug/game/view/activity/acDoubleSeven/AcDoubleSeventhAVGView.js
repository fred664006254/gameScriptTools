    ...
    AcDoubleSeventhAVGView.prototype.showPage = function () {
        ...
        if (this._curConfig.descId) {
            ...
            if (this._curConfig.clickContinue) {
                ...
                this._codonLength = 0;
                this._descText.text = "";
                this._descContent = LanguageManager.getlocal("DoubleSevenAVGDialog" + this._curConfig.descId + codStr);
                needShoot = true;
            }
            else {
                this._descText.text = LanguageManager.getlocal("DoubleSevenAVGDialog" + this._curConfig.descId + codStr);
