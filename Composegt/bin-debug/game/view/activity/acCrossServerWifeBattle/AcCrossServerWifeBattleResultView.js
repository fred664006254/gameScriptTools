...
var AcCrossServerWifeBattleResultView = (function (_super) {
    __extends(AcCrossServerWifeBattleResultView, _super);
    function AcCrossServerWifeBattleResultView() {
        var _this = _super.call(this) || this;
        _this._callback = null;
        _this._target = null;
        return _this;
    }
    AcCrossServerWifeBattleResultView.prototype.isTouchMaskClose = function () {
        return true;
    };
    AcCrossServerWifeBattleResultView.prototype.initView = function () {
        ...
        var scoreTip = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerWifeBattleResultScoreTip", [String(point)]), 24, 0x17f925);
    ...
    AcCrossServerWifeBattleResultView.prototype.getTitleStr = function () {
        return null;
    };
    // private rankBtnHandler():void
    // {
    // }
    AcCrossServerWifeBattleResultView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([]);
    };
    AcCrossServerWifeBattleResultView.prototype.hide = function () {
        if (this._target && this._callback) {
            this._callback.apply(this._target);
        }
        _super.prototype.hide.call(this);
    };
    AcCrossServerWifeBattleResultView.prototype.dispose = function () {
        this._callback = null;
        this._target = null;
        _super.prototype.dispose.call(this);
    };
    return AcCrossServerWifeBattleResultView;
}(BaseView));
__reflect(AcCrossServerWifeBattleResultView.prototype, "AcCrossServerWifeBattleResultView");
