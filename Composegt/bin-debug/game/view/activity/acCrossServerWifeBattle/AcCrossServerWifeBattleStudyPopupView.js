...
var AcCrossServerWifeBattleStudyPopupView = (function (_super) {
    __extends(AcCrossServerWifeBattleStudyPopupView, _super);
    function AcCrossServerWifeBattleStudyPopupView() {
        return _super.call(this) || this;
    }
    AcCrossServerWifeBattleStudyPopupView.prototype.initView = function () {
    ...
    AcCrossServerWifeBattleStudyPopupView.prototype.scrollPos = function () {
    ...
    AcCrossServerWifeBattleStudyPopupView.prototype.upgradeCallback = function (event) {
        var itemNum = Api.itemVoApi.getItemNumInfoVoById(Config.WifebattleCfg.itemCostID);
        this._tipTxt.text = LanguageManager.getlocal("wifeBattleStudy_tipTxt", [String(itemNum)]);
        var exp = Api.wifebattleVoApi.wifebattleVo.info.ylinfo ? Api.wifebattleVoApi.wifebattleVo.info.ylinfo.upexp : 0;
        this._tipTxt1.text = LanguageManager.getlocal("wifeBattleStudy_tipTxt1", [String(exp)]);
        ...
        if (event) {
            ...
            if (rData.ret == 0) {
                App.CommonUtil.showTip(LanguageManager.getlocal('wifeBattleStudy_successTip', [AcCrossServerWifeBattleStudyPopupView.lastUpgradeId]));
            }
            else {
                App.CommonUtil.showTip(LanguageManager.getlocal('wifeBattleStudy_failedTip', [AcCrossServerWifeBattleStudyPopupView.lastUpgradeId]));
            }
        }
    };
    AcCrossServerWifeBattleStudyPopupView.prototype.getShowHeight = function () {
        return 851.5;
    };
    ...
    // 	return 70;
    // }
    AcCrossServerWifeBattleStudyPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "public_unlock",
        ]);
    };
    AcCrossServerWifeBattleStudyPopupView.prototype.dispose = function () {
        ...
        this._tipTxt = null;
        this._tipTxt1 = null;
        AcCrossServerWifeBattleStudyPopupView.lastUpgradeId = null;
        _super.prototype.dispose.call(this);
    };
    AcCrossServerWifeBattleStudyPopupView.lastUpgradeId = "0";
    return AcCrossServerWifeBattleStudyPopupView;
}(PopupView));
__reflect(AcCrossServerWifeBattleStudyPopupView.prototype, "AcCrossServerWifeBattleStudyPopupView");
