 ...
 */
var AcCrossServerWifeBattleStudyScrollItem = (function (_super) {
    __extends(AcCrossServerWifeBattleStudyScrollItem, _super);
    function AcCrossServerWifeBattleStudyScrollItem() {
        var _this = _super.call(this) || this;
        _this._idx = 0;
        return _this;
    }
    AcCrossServerWifeBattleStudyScrollItem.prototype.initItem = function (index, data) {
    ...
    AcCrossServerWifeBattleStudyScrollItem.prototype.refreshUI = function () {
        // let lv = Api.studyatkVoApi.getStudySkillInfoLv();
    ...
    AcCrossServerWifeBattleStudyScrollItem.prototype.btnHandler = function () {
    ...
    AcCrossServerWifeBattleStudyScrollItem.prototype.getStars = function (num) {
    ...
    AcCrossServerWifeBattleStudyScrollItem.prototype.upgradeCallback = function (event) {
    ...
    // 	return 20;
    // }
    AcCrossServerWifeBattleStudyScrollItem.prototype.dispose = function () {
    ...
    AcCrossServerWifeBattleStudyScrollItem.lastUpgradeBookId = "";
    AcCrossServerWifeBattleStudyScrollItem.lastUpgradeIdx = -1;
    return AcCrossServerWifeBattleStudyScrollItem;
}(ScrollListItem));
__reflect(AcCrossServerWifeBattleStudyScrollItem.prototype, "AcCrossServerWifeBattleStudyScrollItem");
