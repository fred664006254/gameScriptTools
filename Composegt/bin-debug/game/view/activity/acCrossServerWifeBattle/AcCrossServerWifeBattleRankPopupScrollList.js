...
var AcCrossServerWifeBattleRankPopupScrollList = (function (_super) {
    __extends(AcCrossServerWifeBattleRankPopupScrollList, _super);
    function AcCrossServerWifeBattleRankPopupScrollList() {
        return _super.call(this) || this;
    }
    AcCrossServerWifeBattleRankPopupScrollList.prototype.initItem = function (index, data) {
        this.width = 510;
        this.height = 40;
        var rankTxt;
        if (index % 2 == 1) {
    ...
    AcCrossServerWifeBattleRankPopupScrollList.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcCrossServerWifeBattleRankPopupScrollList;
}(ScrollListItem));
__reflect(AcCrossServerWifeBattleRankPopupScrollList.prototype, "AcCrossServerWifeBattleRankPopupScrollList");
