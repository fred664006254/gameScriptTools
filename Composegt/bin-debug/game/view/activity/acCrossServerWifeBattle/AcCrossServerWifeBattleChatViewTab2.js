...
var AcCrossServerWifeBattleChatViewTab2 = (function (_super) {
    __extends(AcCrossServerWifeBattleChatViewTab2, _super);
    function AcCrossServerWifeBattleChatViewTab2(param) {
    ...
    Object.defineProperty(AcCrossServerWifeBattleChatViewTab2.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWifeBattleChatViewTab2.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerWifeBattleChatViewTab2.prototype.initView = function () {
        var view = this;
    ...
    AcCrossServerWifeBattleChatViewTab2.prototype.selectHandler1 = function () {
        // this.request(NetRequestConst.REQUEST_CHAT_BLOCKSHARE,{dtype:2});
    };
    Object.defineProperty(AcCrossServerWifeBattleChatViewTab2.prototype, "activeId", {
        get: function () {
    ...
    AcCrossServerWifeBattleChatViewTab2.prototype.refreshChatByScroll = function () {
    ...
    AcCrossServerWifeBattleChatViewTab2.prototype.getMsgBack = function (evt) {
        var view = this;
    ...
    AcCrossServerWifeBattleChatViewTab2.prototype.refreshChat = function () {
        var isButtom = this._scrollList.checkIsAtButtom();
        if (isButtom) {
            var chatList = Api.chatVoApi.getacCrossList();
            this._scrollList.refreshData(chatList);
    ...
    AcCrossServerWifeBattleChatViewTab2.prototype.checkShowMoreTip = function () {
        var moreBtn = this.getChildByName("moreBtn");
        if (this._scrollList && this._scrollList.checkIsAtButtom()) {
            if (moreBtn) {
                moreBtn.visible = false;
    ...
    AcCrossServerWifeBattleChatViewTab2.prototype.scrollToButtom = function () {
        this._scrollList.moveToButtom();
        this.refreshChat();
    };
    AcCrossServerWifeBattleChatViewTab2.prototype.sentBtnClick = function () {
        if (!this.vo.isCanJoin) {
    ...
    AcCrossServerWifeBattleChatViewTab2.prototype.sendMsgBack = function (evt) {
        var view = this;
        if (evt.data.data.ret < 0) {
            return;
        }
    ...
    // 	// App.LogUtil.log(22);
    // }
    AcCrossServerWifeBattleChatViewTab2.prototype.refreshTrans = function () {
        var isButtom = this._scrollList.checkIsAtButtom();
    ...
    AcCrossServerWifeBattleChatViewTab2.prototype.dispose = function () {
    ...
    return AcCrossServerWifeBattleChatViewTab2;
}(CommonViewTab));
__reflect(AcCrossServerWifeBattleChatViewTab2.prototype, "AcCrossServerWifeBattleChatViewTab2");
