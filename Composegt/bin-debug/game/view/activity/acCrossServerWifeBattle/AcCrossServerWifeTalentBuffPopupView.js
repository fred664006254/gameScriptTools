...
var AcCrossServerWifeTalentBuffPopupView = (function (_super) {
    ...
    AcCrossServerWifeTalentBuffPopupView.prototype.initView = function () {
        ...
        var rankText = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalent_bufftxt3"), 20, TextFieldConst.COLOR_BROWN);
        rankText.setPosition(120 - rankText.width / 2, bg2.y + bg2.height / 2 - rankText.height / 2);
        this.addChildToContainer(rankText);
        this._rankText = rankText;
        var nameText = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalent_bufftxt4"), 20, TextFieldConst.COLOR_BROWN);
        nameText.setPosition(250 - nameText.width / 2, rankText.y);
        this.addChildToContainer(nameText);
        this._nameText = nameText;
        var scoreText = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalent_bufftxt5"), 20, TextFieldConst.COLOR_BROWN);
