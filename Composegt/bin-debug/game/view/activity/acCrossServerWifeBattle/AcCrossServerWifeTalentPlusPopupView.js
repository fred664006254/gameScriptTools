...
var AcCrossServerWifeTalentPlusPopupView = (function (_super) {
    ...
    // 	this.initView();
    // }
    AcCrossServerWifeTalentPlusPopupView.prototype.tick = function () {
        // if(!this._acVo){
    ...
    AcCrossServerWifeTalentPlusPopupView.prototype.getTabbarTextArr = function () {
    ...
    AcCrossServerWifeTalentPlusPopupView.prototype.getTabbarName = function () {
        return ButtonConst.BTN_WINTAB_OLD;
    };
    AcCrossServerWifeTalentPlusPopupView.prototype.getTabbarGroupX = function () {
        return 17;
    };
    AcCrossServerWifeTalentPlusPopupView.prototype.getTabbarGroupY = function () {
        return 180;
    };
    ...
    AcCrossServerWifeTalentPlusPopupView.prototype.initView = function () {
        ...
        var view = this;
        var add = this.vo.wifebattlecross.info.tmpattr.statusadd; //Api.wifebattleVoApi.wifebattleVo.info.tmpattr.statusadd;
        ...
        var plusDesc = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalentPlusPopupViewCurPlus1", [String(statusadd)]), 20, TextFieldConst.COLOR_BROWN);
        ...
        if (this.checkHaveBuff()) {
            ...
            var baseWifeBattleBuff = this.cfg.wifeBattleBuff;
            var wifeBattleBuff = [];
            for (var i = 0; i < baseWifeBattleBuff.length; i++) {
                var temp = { artistryRange: baseWifeBattleBuff[i]["artistryRange"], rankBuff: App.MathUtil.accMul(baseWifeBattleBuff[i]["rankBuff"], this.vo.buff) };
            ...
            maxV += 1;
            //才情当前等级txt1
            var lvtxt1 = ComponentManager.getTextField(lvStr, 18, TextFieldConst.COLOR_BROWN);
            lvtxt1.setPosition(80, 20);
            this.addChildToContainer(lvtxt1);
            var lvtxt2 = ComponentManager.getTextField(lvStr2, 18, TextFieldConst.COLOR_BROWN);
        ...
        if (this.checkHaveBuff()) {
            ...
            var acTime = this.vo.getAcLocalTime(); //this.getAcVo().getAcLocalTime();
            ...
            var infoList2 = this.vo.wifebattlecross.info.tmpattr.wifeadd_arr;
        ...
        if (this.checkHaveBuff()) {
            ...
            var descText2 = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalentPlusPopupViewDesc2"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
