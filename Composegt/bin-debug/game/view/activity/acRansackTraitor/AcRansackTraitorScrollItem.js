...
var AcRansackTraitorScrollItem = (function (_super) {
    __extends(AcRansackTraitorScrollItem, _super);
    function AcRansackTraitorScrollItem() {
    ...
    AcRansackTraitorScrollItem.prototype.init = function (data) {
        // }
        ...
        var auraList = Config.ServantCfg.getServantItemById(AcRansackTraitorScrollItem.servantId).aura || [];
        var skin_auraList = [];
    ...
    AcRansackTraitorScrollItem.prototype.refreshAfterLv = function (event) {
        var servantId = AcRansackTraitorScrollItem.servantId;
    ...
    AcRansackTraitorScrollItem.prototype.doRequest = function () {
    ...
    AcRansackTraitorScrollItem.prototype.goBtnHandler = function () {
    ...
    AcRansackTraitorScrollItem.prototype.dispose = function () {
    ...
    AcRansackTraitorScrollItem.servantId = "";
    return AcRansackTraitorScrollItem;
}(BaseDisplayObjectContainer));
__reflect(AcRansackTraitorScrollItem.prototype, "AcRansackTraitorScrollItem");
