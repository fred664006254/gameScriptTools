...
var AcRansackTraitorGuidStoryView = (function (_super) {
    __extends(AcRansackTraitorGuidStoryView, _super);
    function AcRansackTraitorGuidStoryView() {
    ...
    AcRansackTraitorGuidStoryView.prototype.decode = function () {
    ...
    AcRansackTraitorGuidStoryView.prototype.getResourceList = function () {
        return ["prisonview_1", "skip_btn1",
        ];
    };
    AcRansackTraitorGuidStoryView.prototype.initView = function () {
        ...
        if (isfll) {
            this._txtKeyList.push("acRansackTraitor_story20_1" + "code" + this.decode());
            this._txtKeyList.push("acRansackTraitor_story20_2" + "code" + this.decode());
        }
        else {
            if (this._isFind) {
                AcFanliGuidStoryView._storyRandIdx2 = AcFanliGuidStoryView._storyRandIdx2 % 3 + 1;
                var idx = Math.ceil(this._acvo.chipnum / 6);
                this._txtKeyList.push("acRansackTraitor_story" + idx + "_1" + "code" + this.decode());
                this._txtKeyList.push("acRansackTraitor_story" + idx + "_2" + "code" + this.decode());
                AcFanliGuidStoryView._storyRandIdx2++;
            }
            else {
                AcFanliGuidStoryView._storyRandIdx = AcFanliGuidStoryView._storyRandIdx % 2 + 10;
                this._txtKeyList.push("acRansackTraitor_story" + AcFanliGuidStoryView._storyRandIdx + "_1" + "code" + this.decode());
                this._txtKeyList.push("acRansackTraitor_story" + AcFanliGuidStoryView._storyRandIdx + "_2" + "code" + this.decode());
                AcFanliGuidStoryView._storyRandIdx++;
            }
        }
        this.clickPage();
    };
    AcRansackTraitorGuidStoryView.prototype.textAnim = function (t) {
    ...
    AcRansackTraitorGuidStoryView.prototype.clickPage = function () {
    ...
    AcRansackTraitorGuidStoryView.prototype.callback = function () {
        if (this._obj && this._callbackF) {
            this._callbackF.apply(this._obj);
        }
        this.hide();
    };
    AcRansackTraitorGuidStoryView.prototype.getBgName = function () {
        return null;
    };
    AcRansackTraitorGuidStoryView.prototype.getTitleStr = function () {
        return null;
    };
    AcRansackTraitorGuidStoryView.prototype.getButtomLineBg = function () {
        return null;
    };
    AcRansackTraitorGuidStoryView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcRansackTraitorGuidStoryView.prototype.getTitleBgName = function () {
        return null;
    };
    AcRansackTraitorGuidStoryView.prototype.dispose = function () {
    ...
    AcRansackTraitorGuidStoryView._storyRandIdx = 0;
    AcRansackTraitorGuidStoryView._storyRandIdx2 = 0;
    return AcRansackTraitorGuidStoryView;
}(BaseView));
__reflect(AcRansackTraitorGuidStoryView.prototype, "AcRansackTraitorGuidStoryView");
