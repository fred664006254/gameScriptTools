...
var AcSeasideGameAVGView = (function (_super) {
    __extends(AcSeasideGameAVGView, _super);
    function AcSeasideGameAVGView() {
    ...
    Object.defineProperty(AcSeasideGameAVGView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcSeasideGameAVGView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcSeasideGameAVGView.prototype, "acTivityId", {
        get: function () {
    ...
    AcSeasideGameAVGView.prototype.getResourceList = function () {
        // test code
    ...
    AcSeasideGameAVGView.prototype.getTitleBgName = function () {
        return null;
    };
    AcSeasideGameAVGView.prototype.getTitleStr = function () {
        return null;
    };
    AcSeasideGameAVGView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcSeasideGameAVGView.prototype.getBgName = function () {
        return null;
    };
    AcSeasideGameAVGView.prototype.isShowMask = function () {
        return true;
    };
    AcSeasideGameAVGView.prototype.preInit = function () {
    ...
    AcSeasideGameAVGView.prototype.init = function () {
        ...
        this._myBg = BaseLoadBitmap.create('acseasidegame_bg-1');
    ...
    AcSeasideGameAVGView.prototype.clickPage = function (evt) {
    ...
    AcSeasideGameAVGView.prototype.doNextStep = function (step) {
        var view = this;
        var nextId = null;
        if (step) {
            nextId = step;
    ...
    AcSeasideGameAVGView.prototype.showPage = function () {
        //this.doStepHandle();
        if (this._showManTab) {
        ...
        if (this._curConfig.descId) {
            ...
            if (this._curConfig.clickContinue) {
                ...
                this._codonLength = 0;
                this._descText.text = "";
                if (LanguageManager.checkHasKey("acSeasideGameAVGDialog" + this._curConfig.descId + codStr)) {
                    this._descContent = LanguageManager.getlocal("acSeasideGameAVGDialog" + this._curConfig.descId + codStr);
                }
                else {
                    this._descContent = LanguageManager.getlocal("acSeasideGameAVGDialog" + this._curConfig.descId + "_code1");
                }
                needShoot = true;
            }
            else {
                if (LanguageManager.checkHasKey("acSeasideGameAVGDialog" + this._curConfig.descId + codStr)) {
                    this._descText.text = LanguageManager.getlocal("acSeasideGameAVGDialog" + this._curConfig.descId + codStr);
                }
                else {
                    this._descText.text = LanguageManager.getlocal("acSeasideGameAVGDialog" + this._curConfig.descId + "_code1");
                }
    ...
    AcSeasideGameAVGView.prototype.clickSelectedHandler = function (event, branchBtn, step) {
        switch (event.type) {
    ...
    AcSeasideGameAVGView.prototype.changeBgCallBack = function () {
    ...
    AcSeasideGameAVGView.prototype.showShakeAnim = function () {
    ...
    AcSeasideGameAVGView.prototype.shakeScreen = function () {
    ...
    AcSeasideGameAVGView.prototype.showFogAnim = function () {
        this._myBg.y = 0;
    ...
    AcSeasideGameAVGView.prototype.textShootAnim = function () {
    ...
    AcSeasideGameAVGView.prototype.textAnim = function (t) {
    ...
    AcSeasideGameAVGView.prototype.skipAnim = function () {
        this.hide();
     ...
     * 收到通知 下一步
     */
    AcSeasideGameAVGView.prototype.noticeNextStep = function () {
        this.doNextStep();
    };
    AcSeasideGameAVGView.prototype.initView = function () {
    };
    AcSeasideGameAVGView.prototype.getParent = function () {
        return LayerManager.maskLayer;
    };
    AcSeasideGameAVGView.prototype.hide = function (isDispose) {
        var tempObj = this._obj;
        var tempFunc = this._callbackF;
        if (!isDispose) {
            if (tempObj && tempFunc) {
    ...
    AcSeasideGameAVGView.prototype.doStepHandle = function () {
        if (this._curIdx == "1") {
    ...
    AcSeasideGameAVGView.prototype.dispose = function () {
    ...
    return AcSeasideGameAVGView;
}(CommonView));
__reflect(AcSeasideGameAVGView.prototype, "AcSeasideGameAVGView");
