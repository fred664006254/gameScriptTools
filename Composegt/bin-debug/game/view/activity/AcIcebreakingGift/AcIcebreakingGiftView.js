...
var AcIcebreakingGiftView = (function (_super) {
    __extends(AcIcebreakingGiftView, _super);
    function AcIcebreakingGiftView() {
    ...
    Object.defineProperty(AcIcebreakingGiftView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcIcebreakingGiftView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcIcebreakingGiftView.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcIcebreakingGiftView.prototype, "code", {
        get: function () {
    ...
    AcIcebreakingGiftView.prototype.initView = function () {
    ...
    AcIcebreakingGiftView.prototype.getRequestData = function () {
        return { requestType: NetRequestConst.REQUEST_ACTIVITY_ICEBREAKINGGIFTINDEX, requestData: { activeId: this.aid + "-" + this.code } };
    };
    AcIcebreakingGiftView.prototype.receiveData = function (data) {
    ...
    AcIcebreakingGiftView.prototype.initScroll = function () {
        ...
        if (!this.loginfo || !this.loginfo.length) {
            var emptyText = ComponentManager.getTextField(LanguageManager.getlocal("acIcebreakingGiftEmpty"), 20, 0xe7d98f);
        ...
        for (var i = 0; i < this.loginfo.length; i++) {
            ...
            var nameText = ComponentManager.getTextField(LanguageManager.getlocal("acIcebreakingGiftLoop", [infoObj["lname"], infoObj["gemnum"].toString()]), 20, 0xe7d98f);
            nameText.x = 40;
    ...
    AcIcebreakingGiftView.prototype.refreshUI = function () {
        this._isClose = this.vo.isClose;
        if (!this.sendgemnum) {
            this.sendgemnum = 0;
        }
    ...
    AcIcebreakingGiftView.prototype.initBg = function () {
     ...
     * 仅适用于新的分享
     */
    AcIcebreakingGiftView.prototype.getCloseBtnName = function () {
        return "btn_lantern";
    };
    /**
     * 重置背景的高度 主要设置 btn的位置
     * 仅适用于新的分享
     */
    AcIcebreakingGiftView.prototype.resetBgSize = function () {
    ...
    AcIcebreakingGiftView.prototype.getTitleStr = function () {
        return null;
    };
    AcIcebreakingGiftView.prototype.goHandler = function () {
        var t = this.vo.et - GameData.serverTime;
        if (t < 0) {
    ...
    AcIcebreakingGiftView.prototype.goBtnCallback = function (event) {
    ...
    AcIcebreakingGiftView.prototype.getHandler = function () {
        var t = this.vo.et - GameData.serverTime;
        if (t < 0) {
            App.CommonUtil.showTip(LanguageManager.getlocal("acChristmasActiveOver"));
            return;
    ...
    AcIcebreakingGiftView.prototype.getBtnCallback = function (event) {
        if (event.data.data.ret == 0) {
            var num = event.data.data.data.addgem;
            var n = num ? num : 0;
            if (n > 0) {
    ...
    AcIcebreakingGiftView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "firstchargebutton01", "activity_fnt"
        ]);
    };
    AcIcebreakingGiftView.prototype.tick = function () {
        var t = this.vo.et - GameData.serverTime;
        if (t < 0) {
            t = 0;
            ...
            var t_1 = this.vo.et - GameData.serverTime;
            if (t_1 < 0) {
                t_1 = 0;
            }
    ...
    AcIcebreakingGiftView.prototype.dispose = function () {
    ...
    return AcIcebreakingGiftView;
}(PopupView));
__reflect(AcIcebreakingGiftView.prototype, "AcIcebreakingGiftView");
