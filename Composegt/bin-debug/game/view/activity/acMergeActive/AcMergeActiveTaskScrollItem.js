...
var AcMergeActiveTaskScrollItem = (function (_super) {
    __extends(AcMergeActiveTaskScrollItem, _super);
    function AcMergeActiveTaskScrollItem() {
    ...
    Object.defineProperty(AcMergeActiveTaskScrollItem.prototype, "cfg", {
        get: function () {
     ...
     * 初始化itemview
     */
    AcMergeActiveTaskScrollItem.prototype.initItem = function (index, data, itemParam) {
        this._itemData = data;
     ...
     * 领取奖励Click
     */
    AcMergeActiveTaskScrollItem.prototype.reviceBtnClick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
        if (!vo.isInActivity()) {
     ...
     * 刷新UI
     */
    AcMergeActiveTaskScrollItem.prototype.refreshView = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
     ...
     * 前往的Click
     */
    AcMergeActiveTaskScrollItem.prototype.goBtnClick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
        if (!vo.isInActivity()) {
            App.CommonUtil.showTip(LanguageManager.getlocal('acPunishEnd'));
            return;
     ...
     * 获得
     */
    AcMergeActiveTaskScrollItem.prototype.getTitleStr = function (type) {
        var strTop = null;
    ...
    AcMergeActiveTaskScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcMergeActiveTaskScrollItem.prototype.dispose = function () {
        this._itemData = null;
    ...
    return AcMergeActiveTaskScrollItem;
}(ScrollListItem));
__reflect(AcMergeActiveTaskScrollItem.prototype, "AcMergeActiveTaskScrollItem");
