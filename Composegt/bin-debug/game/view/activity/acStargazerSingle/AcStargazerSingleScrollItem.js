...
var AcStargazerSingleScrollItem = (function (_super) {
    __extends(AcStargazerSingleScrollItem, _super);
    function AcStargazerSingleScrollItem() {
    ...
    AcStargazerSingleScrollItem.prototype.init = function (data) {
        // }
    ...
    AcStargazerSingleScrollItem.prototype.refreshAfterLv = function (event) {
    ...
    AcStargazerSingleScrollItem.prototype.doRequest = function () {
    ...
    AcStargazerSingleScrollItem.prototype.goBtnHandler = function () {
    ...
    AcStargazerSingleScrollItem.prototype.dispose = function () {
    ...
    AcStargazerSingleScrollItem.servantId = "";
    return AcStargazerSingleScrollItem;
}(BaseDisplayObjectContainer));
__reflect(AcStargazerSingleScrollItem.prototype, "AcStargazerSingleScrollItem");
