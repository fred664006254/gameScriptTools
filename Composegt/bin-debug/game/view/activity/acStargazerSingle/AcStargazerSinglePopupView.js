 ...
 * 奸臣皮肤兑换
 */
var AcStargazerSinglePopupView = (function (_super) {
    __extends(AcStargazerSinglePopupView, _super);
    function AcStargazerSinglePopupView() {
        return _super.call(this) || this;
    }
    AcStargazerSinglePopupView.prototype.initView = function () {
        ...
        txt.text = LanguageManager.getlocal("acStargazer_gettxt2");
        if (this.param.data.isFind) {
            txt.text = LanguageManager.getlocal("acStargazer_gettxt1");
        }
        ...
        txt2.text = LanguageManager.getlocal("acStargazer_gettxt3");
        txt2.y = rbg.y + 15;
        txt2.x = rbg.x + 15;
    ...
    AcStargazerSinglePopupView.prototype.hide = function () {
    ...
    AcStargazerSinglePopupView.prototype.getTitleStr = function () {
        return "itemUseConstPopupViewTitle";
    };
    AcStargazerSinglePopupView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcStargazerSinglePopupView;
}(PopupView));
__reflect(AcStargazerSinglePopupView.prototype, "AcStargazerSinglePopupView");
