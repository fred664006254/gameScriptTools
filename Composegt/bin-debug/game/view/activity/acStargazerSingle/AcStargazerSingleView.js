 ...
 * 奸臣皮肤兑换
 */
var AcStargazerSingleView = (function (_super) {
    __extends(AcStargazerSingleView, _super);
    function AcStargazerSingleView() {
    ...
    AcStargazerSingleView.prototype.decode = function () {
    ...
    //根据资源名字得到完整资源名字
    AcStargazerSingleView.prototype.getDefaultRes = function (resName, defaultCode) {
    ...
    AcStargazerSingleView.prototype.getDefaultCn = function (cnName, defaultCode) {
        defaultCode = defaultCode || "1";
    ...
    Object.defineProperty(AcStargazerSingleView.prototype, "cfg", {
        get: function () {
            if (!this._cfg) {
    ...
    AcStargazerSingleView.prototype.getBgName = function () {
        return this.getDefaultRes("acstargazer_bg");
    };
    AcStargazerSingleView.prototype.initBg = function () {
        var _this = this;
    ...
    AcStargazerSingleView.prototype.initView = function () {
        ...
        var titleFont = BaseBitmap.create(this.getDefaultRes("acstargazersingle_titletxt"));
    ...
    AcStargazerSingleView.prototype.initCircle = function () {
        ...
        var skincfg = Config.ServantskinCfg.getServantSkinItemById(cfg.TraitorSkinId);
        ...
        starMap.addChild(nameTF);
        // this._starMap
        var allCount = cfg.RansackItemNum; //shopItem["proofNum"];
        var itemCount = this._acvo.getItemNumByIndex(String(cfg.RansackItemID));
        var isOwn = Api.servantVoApi.isOwnSkinOfSkinId(String(cfg.TraitorSkinId));
    ...
    AcStargazerSingleView.prototype.rechargeClick = function () {
    ...
    AcStargazerSingleView.prototype.refreshUIInfos = function () {
        ...
        var searchAll = this._acvo.isFineAll();
        if (searchAll) {
    ...
    AcStargazerSingleView.prototype.rewardLookClick = function () {
        if (!this.acVo.isStart) {
            App.CommonUtil.showTip(LanguageManager.getlocal('acPunishEnd'));
            return;
        }
    ...
    AcStargazerSingleView.prototype.searchHandler = function (param) {
        // if(1==1){
        // 	this.showStarLine();
        // 	return;
        // }
        ...
        if (this.acVo["attacknum"] < param) {
            var rewardStr = LanguageManager.getlocal("acStargazer_notEnough", [this.acVo["attacknum"]]);
    ...
    AcStargazerSingleView.prototype.searchHandlerNetBack = function (event) {
        var _this = this;
        ...
        if (event.data.data.ret === 0) {
            ...
            var itemStr = "6_" + RansackItemID + "_1";
    ...
    AcStargazerSingleView.prototype.showStarLine = function (findItemIndex, isFind) {
        var _this = this;
        // private showStarLine():void {
        var pos = null;
        if (findItemIndex > -1) {
            var RansackItemID = this.acVo.config.RansackItemID;
            var itemId = RansackItemID;
    ...
    AcStargazerSingleView.prototype.checkReward = function (findItemIndex, isFind) {
    ...
    AcStargazerSingleView.prototype.showReward = function (findItemIndex, isFind) {
        this._aniPlaying = false;
        // this.resetCircle();
        // let isFind = false;
    ...
    AcStargazerSingleView.prototype.showText = function () {
        //顶部背景图片
        ...
        var people = BaseBitmap.create(this.getDefaultRes("acstargazersingle_show"));
        ...
        var cdStrK = "acStargazerSingle_acCD";
        ...
        var cfg = this.acVo.config;
        var skincfg = Config.ServantskinCfg.getServantSkinItemById(cfg.TraitorSkinId);
        var servantCfg = Config.ServantCfg.getServantItemById(cfg.TraitorId);
        //规则
    ...
    AcStargazerSingleView.prototype.rewardBoxHandler = function () {
    };
    AcStargazerSingleView.prototype.tick = function () {
        var deltaT = this.acVo.et - GameData.serverTime;
        var cdStrK = "acStargazerSingle_acCD";
        if (this._acCDTxt && deltaT > 0) {
            this._acCDTxt.text = LanguageManager.getlocal(cdStrK, [App.DateUtil.getFormatBySecond(deltaT, 8)]);
    ...
    AcStargazerSingleView.prototype.getResourceList = function () {
    ...
    AcStargazerSingleView.prototype.getTitleBgName = function () {
        return "acrechargeboxspview_title_bg7";
    };
    AcStargazerSingleView.prototype.getTitleStr = function () {
        return "";
    };
    ...
    // }
    AcStargazerSingleView.prototype.getRuleParam = function () {
        var cfg = this.acVo.config;
        return [cfg.cost, cfg.RansackItemNum, cfg.RansackItemNum];
    };
    AcStargazerSingleView.prototype.dispose = function () {
    ...
    return AcStargazerSingleView;
}(AcCommonView));
__reflect(AcStargazerSingleView.prototype, "AcStargazerSingleView");
