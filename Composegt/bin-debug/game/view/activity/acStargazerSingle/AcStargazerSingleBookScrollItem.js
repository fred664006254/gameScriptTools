...
var AcStargazerSingleBookScrollItem = (function (_super) {
    __extends(AcStargazerSingleBookScrollItem, _super);
    function AcStargazerSingleBookScrollItem() {
        var _this = _super.call(this) || this;
        _this._skincfg = undefined;
        _this._skinId = undefined;
        return _this;
    }
    AcStargazerSingleBookScrollItem.prototype.init = function (skinId, index, serId) {
    ...
    AcStargazerSingleBookScrollItem.prototype.bookTouchHandler = function (obj, param) {
        var bid = param;
        var uidata = {
            aid: bid,
            bookId: bid,
    ...
    AcStargazerSingleBookScrollItem.prototype.getServantBookStars = function (num) {
    ...
    AcStargazerSingleBookScrollItem.prototype.collectHandlerCallBack = function (event) {
    ...
    AcStargazerSingleBookScrollItem.prototype.dispose = function () {
    ...
    return AcStargazerSingleBookScrollItem;
}(BaseDisplayObjectContainer));
__reflect(AcStargazerSingleBookScrollItem.prototype, "AcStargazerSingleBookScrollItem");
