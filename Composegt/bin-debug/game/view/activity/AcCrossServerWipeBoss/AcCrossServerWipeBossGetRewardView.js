...
var AcCrossServerWipeBossGetRewardView = (function (_super) {
    __extends(AcCrossServerWipeBossGetRewardView, _super);
    function AcCrossServerWipeBossGetRewardView() {
        return _super.call(this) || this;
    }
    Object.defineProperty(AcCrossServerWipeBossGetRewardView.prototype, "api", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWipeBossGetRewardView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWipeBossGetRewardView.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerWipeBossGetRewardView.prototype.initView = function () {
    ...
    AcCrossServerWipeBossGetRewardView.prototype.doWaitAni = function (tmpNode, waitT) {
        tmpNode.alpha = 0;
        egret.Tween.get(tmpNode, { loop: false }).wait(waitT).to({ alpha: 1 }, 500);
    };
    AcCrossServerWipeBossGetRewardView.prototype.getShowHeight = function () {
        var re_data = this.param.data;
        //"6_1150_4|6_1710_1";
        var rewardTab = re_data.split('|');
        return rewardTab.length > 4 ? 528 : 300;
    };
    AcCrossServerWipeBossGetRewardView.prototype.getResourceList = function () {
    ...
    AcCrossServerWipeBossGetRewardView.prototype.initTitle = function () {
        return null;
    };
    AcCrossServerWipeBossGetRewardView.prototype.isTouchMaskClose = function () {
        return true;
    };
    AcCrossServerWipeBossGetRewardView.prototype.dispose = function () {
        App.MessageHelper.dispatchEvent(MessageConst.MESSAGE_MAYDAY_FRESHTURNTABLE);
        _super.prototype.dispose.call(this);
    };
    return AcCrossServerWipeBossGetRewardView;
}(BaseView));
__reflect(AcCrossServerWipeBossGetRewardView.prototype, "AcCrossServerWipeBossGetRewardView");
