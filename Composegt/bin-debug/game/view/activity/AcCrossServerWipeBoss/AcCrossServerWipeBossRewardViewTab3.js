...
//
var AcCrossServerWipeBossRewardViewTab3 = (function (_super) {
    __extends(AcCrossServerWipeBossRewardViewTab3, _super);
    function AcCrossServerWipeBossRewardViewTab3(param) {
    ...
    Object.defineProperty(AcCrossServerWipeBossRewardViewTab3.prototype, "api", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWipeBossRewardViewTab3.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWipeBossRewardViewTab3.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerWipeBossRewardViewTab3.prototype.getListType = function () {
        return 3;
    };
    AcCrossServerWipeBossRewardViewTab3.prototype.initView = function () {
        ...
        for (var index = 0; index < rankList.length; index++) {
            ...
            var rank = rItem.rank;
            var txt = ComponentManager.getTextField(rItem.type == 1 ? rItem.npcName : "accrossserverwipeBossKillBox" + (key - 7), 22, TextFieldConst.COLOR_BROWN);
            txt.x = GameConfig.stageWidth / 2 - txt.width / 2;
            txt.y = winbg.y + winbg.height / 2 - txt.height / 2;
            this._nodeContainer.addChild(txt);
            var alltxt = ComponentManager.getTextField(LanguageManager.getlocal('accrossserverwipeBossKillBasicReward'), 22, TextFieldConst.COLOR_BROWN);
            ...
            var scoreImg = BaseBitmap.create("accrossserverwipeboss_scoreicon2");
            ...
            var scoreImg2 = BaseBitmap.create("accrossserverwipeboss_scoreicon1");
            ...
            var ordtxt = ComponentManager.getTextField(LanguageManager.getlocal('accrossserverwipeBossKillPoolReward'), 22, TextFieldConst.COLOR_BROWN);
    ...
    AcCrossServerWipeBossRewardViewTab3.prototype.getCountTimeStr = function (time) {
        if (time < 0) {
            time = 0;
        }
        return App.DateUtil.getFormatBySecond(time);
    };
    AcCrossServerWipeBossRewardViewTab3.prototype.dispose = function () {
    ...
    return AcCrossServerWipeBossRewardViewTab3;
}(CommonViewTab));
__reflect(AcCrossServerWipeBossRewardViewTab3.prototype, "AcCrossServerWipeBossRewardViewTab3");
