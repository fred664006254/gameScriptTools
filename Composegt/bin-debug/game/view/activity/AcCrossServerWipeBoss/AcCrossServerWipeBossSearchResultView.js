 ...
 * desc:围剿鳌拜探索结果界面
*/
var AcCrossServerWipeBossSearchResultView = (function (_super) {
    __extends(AcCrossServerWipeBossSearchResultView, _super);
    function AcCrossServerWipeBossSearchResultView() {
    ...
    Object.defineProperty(AcCrossServerWipeBossSearchResultView.prototype, "api", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWipeBossSearchResultView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWipeBossSearchResultView.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerWipeBossSearchResultView.prototype.getResourceList = function () {
    ...
    AcCrossServerWipeBossSearchResultView.prototype.isShowMask = function () {
        return true;
    };
    AcCrossServerWipeBossSearchResultView.prototype.initTitle = function () {
        return null;
    };
    AcCrossServerWipeBossSearchResultView.prototype.getBgName = function () {
        // return `guide_createuserbg`;
        return "accrossserverwipeboss_bg2";
    };
    AcCrossServerWipeBossSearchResultView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcCrossServerWipeBossSearchResultView.prototype.initBg = function () {
    ...
    AcCrossServerWipeBossSearchResultView.prototype.getTitleStr = function () {
        return null;
    };
    AcCrossServerWipeBossSearchResultView.prototype.initView = function () {
        var view = this;
        ...
        var midTxt = ComponentManager.getTextField(LanguageManager.getlocal("accrossserverwipeBossSearchTip" + resultInfo.type, [name]), 22);
        App.DisplayUtil.setLayoutPosition(LayoutConst.horizontalCentertop, midTxt, descbg, [0, 40]);
        infoGroup.addChild(midTxt);
        //按钮
        var cancelBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_BLUE, 'accrossserverwipeBossSearchCancel', view.hide, view);
        App.DisplayUtil.setLayoutPosition(LayoutConst.leftbottom, cancelBtn, descbg, [100, 55]);
        infoGroup.addChild(cancelBtn);
        var confirmBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW, resultInfo.type == 1 ? 'sysConfirm' : 'accrossserverwipeBossSearchOpen', view.confirmClick, view);
        ...
        if (resultInfo.type == 2) {
            ...
            var keyTxt = ComponentManager.getTextField("" + LanguageManager.getlocal("accrossserverwipeBossKillKey" + boxId) + keynum + "/1", 22, TextFieldConst.COLOR_LIGHT_YELLOW);
    ...
    AcCrossServerWipeBossSearchResultView.prototype.attackCallback = function (evt) {
        var view = this;
        var data = view.param.data;
    ...
    AcCrossServerWipeBossSearchResultView.prototype.confirmClick = function () {
        var view = this;
        var data = view.param.data;
        var resultInfo = view.cfg.getBossNpcItemCfgById(data.foeId);
    ...
    AcCrossServerWipeBossSearchResultView.prototype.moreClick = function () {
        var _this = this;
        var view = this;
        var data = view.param.data;
        var resultInfo = view.cfg.getBossNpcItemCfgById(data.foeId);
        ...
        ViewController.getInstance().openView(ViewConst.POPUP.COSTGEMBUYITEMPOPUPVIEW, {
            ...
            confirmCallback: function () {
                ...
                if (Api.playerVoApi.getPlayerLevel() < _this.cfg.needLv) {
                    App.CommonUtil.showTip(LanguageManager.getlocal("accrossserverwipeBossOpenTip", [Api.playerVoApi.getPlayerOfficeByLevel(_this.cfg.needLv)]));
                    return;
                }
    ...
    AcCrossServerWipeBossSearchResultView.prototype.update = function () {
        var view = this;
        var data = view.param.data;
        var resultInfo = view.cfg.getBossNpcItemCfgById(data.foeId);
        if (resultInfo.type == 2) {
    ...
    AcCrossServerWipeBossSearchResultView.prototype.dispose = function () {
        var view = this;
        view._keyText = null;
    ...
    return AcCrossServerWipeBossSearchResultView;
}(CommonView));
__reflect(AcCrossServerWipeBossSearchResultView.prototype, "AcCrossServerWipeBossSearchResultView");
