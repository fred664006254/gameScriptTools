...
var AcCrossServerWipeBossBattleView = (function (_super) {
    __extends(AcCrossServerWipeBossBattleView, _super);
    function AcCrossServerWipeBossBattleView() {
    ...
    AcCrossServerWipeBossBattleView.prototype.getResourceList = function () {
        ...
        return tempArray.concat([
            ...
            "accrossserverwipeboss_enemynamebg",
            "accrossserverwipeboss_activeshopbtn",
            "accrossserverwipeboss_activeshoptxt"
        ]);
    };
    Object.defineProperty(AcCrossServerWipeBossBattleView.prototype, "api", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWipeBossBattleView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWipeBossBattleView.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerWipeBossBattleView.prototype.getBgName = function () {
        return "accrossserverwipeboss_bg2";
    };
    // 标题背景名称
    AcCrossServerWipeBossBattleView.prototype.initTitle = function () {
        return null;
    };
    // 标题背景名称
    AcCrossServerWipeBossBattleView.prototype.getTitleStr = function () {
        return null;
    };
    AcCrossServerWipeBossBattleView.prototype.initBg = function () {
    ...
    AcCrossServerWipeBossBattleView.prototype.findBestServant = function (bossLife) {
        if (!bossLife) {
            bossLife = 0;
        }
        var servantId;
    ...
    //重置默认选中的门客 和 当前属性
    AcCrossServerWipeBossBattleView.prototype.resetTopKey = function () {
    ...
    AcCrossServerWipeBossBattleView.prototype.initView = function () {
        var view = this;
        App.MessageHelper.addEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_WIPEBOSS_ATTACK), view.intoBossBattle, view);
        ...
        //boss getBgName
        var tipBg = BaseBitmap.create("accrossserverwipeboss_enemynamebg");
        tipBg.width = 300;
        ...
        this._downHero.y = GameConfig.stageHeigth - this._downHero.serImgHeight * this._downHero.scaleY - 60; //- this.getTitleButtomY();
        ...
        this._powerBg = BaseBitmap.create("accrossserverwipeboss_enemynamebg");
        ...
        var shopBtn = ComponentManager.getButton('accrossserverwipeboss_activeshopbtn', '', function () {
    ...
    AcCrossServerWipeBossBattleView.prototype.refreshSkinName = function () {
        if (!this.snamebg) {
    ...
    AcCrossServerWipeBossBattleView.prototype.freshTxt = function () {
        var view = this;
        var scrollStart = 10;
        ...
        if (arr.length) {
            for (var i in arr) {
                ...
                if (scoreTxt) {
                    scoreTxt.text = LanguageManager.getlocal("accrossserverwipeBossAllDamgeDesc", [view._bossConfig.npcName, unit.score]);
                }
                else {
                    scoreTxt = ComponentManager.getTextField(LanguageManager.getlocal("accrossserverwipeBossAllDamgeDesc", [view._bossConfig.npcName, unit.score]), 20);
    ...
    AcCrossServerWipeBossBattleView.prototype.getRequestData = function () {
        var view = this;
        return { requestType: NetRequestConst.REQUEST_WIPEBOSS_GETBOSSHP, requestData: {
                activeId: view.vo.aidAndCode,
                bosstype: view.param.data.foeId,
                bosskey: view.param.data.bosskey,
            } };
    };
    AcCrossServerWipeBossBattleView.prototype.receiveData = function (data) {
        var view = this;
    ...
    AcCrossServerWipeBossBattleView.prototype.requestGetBossLog = function () {
    ...
    AcCrossServerWipeBossBattleView.prototype.showBossLog = function (event) {
    ...
    AcCrossServerWipeBossBattleView.prototype.showMoreHandle = function () {
        if (this.touchBoo) {
    ...
    AcCrossServerWipeBossBattleView.prototype.closeList = function () {
        this.touchBoo = false;
    ...
    AcCrossServerWipeBossBattleView.prototype.clickChangeHero = function () {
        ...
        ViewController.getInstance().openView(ViewConst.POPUP.SERVANTSELECTEDPOPUPVIEW, { type: ServantSelectedPopupView.TYPE_CROSSSERVERWIPEBOSS, "info": showTab, callback: this.sendRequest, handler: this, code: this.param.data.code });
    };
    AcCrossServerWipeBossBattleView.prototype.sendRequest = function (params) {
    ...
    AcCrossServerWipeBossBattleView.prototype.btnClick = function () {
    ...
    AcCrossServerWipeBossBattleView.prototype.btnAnim = function () {
        if (this._gameBtn) {
            egret.Tween.get(this._gameBtn).to({ scaleX: 0.9, scaleY: 0.9 }, 600).to({ scaleX: 1, scaleY: 1 }, 600).call(this.btnAnim, this);
        }
    };
    AcCrossServerWipeBossBattleView.prototype.intoBossBattle = function (p) {
        if (p.data.ret == true) {
            this.atk = true;
            ...
            if (this._hasKill == 1) {
                ViewController.getInstance().openView(ViewConst.POPUP.ACCROSSSERVERWIPEBOSSATTACKEDPOPUPVIEW, { type: 3, index: this._idx, damage: this._dps, exp: this._exp, attackexp: this._attackExp, killexp: this._killExp, rewards: this._rewards, f: this.hide, o: this, aid: this.param.data.aid, code: this.param.data.code });
                return;
            }
    ...
    AcCrossServerWipeBossBattleView.prototype.gameBegin = function () {
        this.attackHandle(1, this._dps);
    };
    AcCrossServerWipeBossBattleView.prototype.attackHandle = function (area, damage, isCrit) {
    ...
    AcCrossServerWipeBossBattleView.prototype.setTopProgress = function (value, maxValue, progressWidth, type) {
    ...
    AcCrossServerWipeBossBattleView.prototype.showEndGame = function () {
        // 
    };
    AcCrossServerWipeBossBattleView.prototype.atkEndCallback = function () {
        this._upHero.setScale(0.8);
        this._upHero.x = GameConfig.stageWidth / 2 - this._upHero.serImgWith * this._upHero.scaleX / 2;
        if (this._isAttackWin) {
            ...
            ViewController.getInstance().openView(ViewConst.POPUP.ACCROSSSERVERWIPEBOSSATTACKEDPOPUPVIEW, { type: 1, index: index, damage: this._dps, exp: this._exp, attackexp: this._attackExp, killexp: this._killExp, rewards: this._rewards, f: this.hide, o: this, aid: this.param.data.aid, code: this.param.data.code });
        }
        else {
            var index = null;
            if (this._eliteidx == null) {
            ...
            ViewController.getInstance().openView(ViewConst.POPUP.ACCROSSSERVERWIPEBOSSATTACKEDPOPUPVIEW, { type: 2, index: index, damage: this._dps, exp: this._exp, attackexp: this._attackExp, killexp: this._killExp, aid: this.param.data.aid, code: this.param.data.code });
    ...
    AcCrossServerWipeBossBattleView.prototype.showGameBtn = function () {
        if (this._gameBtn) {
            this._gameBtn.visible = (this._curKey != null);
        }
    };
    AcCrossServerWipeBossBattleView.prototype.hide = function () {
    ...
    AcCrossServerWipeBossBattleView.prototype.showList = function () {
    ...
    AcCrossServerWipeBossBattleView.prototype.showText = function () {
    ...
    AcCrossServerWipeBossBattleView.prototype.refreshText = function () {
    ...
    AcCrossServerWipeBossBattleView.prototype.update = function () {
        var view = this;
    ...
    AcCrossServerWipeBossBattleView.prototype.dispose = function () {
        var view = this;
        App.MessageHelper.removeEventListener(MessageConst.MESSAGE_CROSSSERVERWIPEBOSS_REFRESH, view.update, view);
        App.MessageHelper.removeEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_WIPEBOSS_ATTACK), view.intoBossBattle, view);
    ...
    return AcCrossServerWipeBossBattleView;
}(BaseBattleView));
__reflect(AcCrossServerWipeBossBattleView.prototype, "AcCrossServerWipeBossBattleView");
