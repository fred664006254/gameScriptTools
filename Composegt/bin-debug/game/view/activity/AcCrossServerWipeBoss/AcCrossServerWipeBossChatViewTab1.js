...
var AcCrossServerWipeBossChatViewTab1 = (function (_super) {
    __extends(AcCrossServerWipeBossChatViewTab1, _super);
    function AcCrossServerWipeBossChatViewTab1(param) {
    ...
    Object.defineProperty(AcCrossServerWipeBossChatViewTab1.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWipeBossChatViewTab1.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerWipeBossChatViewTab1.prototype.initView = function () {
    ...
    // }
    AcCrossServerWipeBossChatViewTab1.prototype.refreshChat = function () {
    ...
    AcCrossServerWipeBossChatViewTab1.prototype.refreshChat2 = function () {
        var chatList = Api.chatVoApi.getWorldList();
        this._scrollList.refreshData(chatList);
        this._scrollList.moveToButtom();
    };
    AcCrossServerWipeBossChatViewTab1.prototype.checkShowMoreTip = function () {
    ...
    AcCrossServerWipeBossChatViewTab1.prototype.scrollToButtom = function () {
        this._scrollList.moveToButtom();
        this.refreshChat();
    };
    AcCrossServerWipeBossChatViewTab1.prototype.sentBtnClick = function () {
        if (!this.vo.isCanJoin()) {
    ...
    AcCrossServerWipeBossChatViewTab1.prototype.receiveData = function (data) {
        if (data.ret == false) {
            return;
        }
    ...
    AcCrossServerWipeBossChatViewTab1.prototype.dispose = function () {
    ...
    return AcCrossServerWipeBossChatViewTab1;
}(CommonViewTab));
__reflect(AcCrossServerWipeBossChatViewTab1.prototype, "AcCrossServerWipeBossChatViewTab1");
