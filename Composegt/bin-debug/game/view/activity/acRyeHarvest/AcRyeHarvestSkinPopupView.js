 ...
 * author 钱竣
 */
var AcRyeHarvestSkinPopupView = (function (_super) {
    __extends(AcRyeHarvestSkinPopupView, _super);
    function AcRyeHarvestSkinPopupView() {
        return _super.call(this) || this;
    }
    Object.defineProperty(AcRyeHarvestSkinPopupView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcRyeHarvestSkinPopupView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcRyeHarvestSkinPopupView.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcRyeHarvestSkinPopupView.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcRyeHarvestSkinPopupView.prototype, "code", {
        get: function () {
    ...
    AcRyeHarvestSkinPopupView.prototype.getUiCode = function () {
        var code = '';
    ...
    AcRyeHarvestSkinPopupView.prototype.initView = function () {
        var view = this;
        var obj = {
            1: 'wife',
            2: 'wife'
        };
        var isWifeskin = obj[view.code] == "wife";
        if (isWifeskin) {
            ...
            if ((!Api.switchVoApi.checkCloseBone()) && boneName && RES.hasRes(boneName) && App.CommonUtil.check_dragon()) {
                ...
                wife.setScale(0.7);
                App.DisplayUtil.setLayoutPosition(LayoutConst.lefttop, wife, bg, [270, 460]);
            }
            else {
            ...
            var topDesc = ComponentManager.getTextField(LanguageManager.getlocal("acRyeHarvestSKinTip1-" + view.getUiCode(), [view.cfg.bigPrize.needValue.toString(), Config.WifeskinCfg.getWifeCfgById(view.cfg.getSkin(view.code)).name]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
            ...
            topbg.setPosition(this.viewBg.x + this.viewBg.width / 2 - topbg.width / 2, 0);
            this.addChildToContainer(topbg);
            var topDesc = ComponentManager.getTextField(LanguageManager.getlocal("acRyeHarvestSKinTip1-" + this.getUiCode(), [view_1.cfg.bigPrize.needValue.toString(), view_1.cfg.getSkinName(view_1.code)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
            topDesc.setPosition(topbg.x + topbg.width / 2 - topDesc.width / 2, topbg.y + topbg.height / 2 - topDesc.height / 2);
            this.addChildToContainer(topDesc);
            var skinnamebg = BaseBitmap.create("skin_detail_namebg");
            skinnamebg.setPosition(bg.x, bg.y + 20);
    ...
    AcRyeHarvestSkinPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "skin_detail_namebg", "servant_star",
            "servant_infoPro1", "servant_infoPro2", "servant_infoPro3", "servant_infoPro4",
        ]);
    };
    AcRyeHarvestSkinPopupView.prototype.getTitleStr = function () {
        return "dailyTaskRewardPreviewPopuiViewTitle";
    };
    // protected getShowHeight() {
    // 	return 760;
    // }
    AcRyeHarvestSkinPopupView.prototype.getBgExtraHeight = function () {
        return 20;
    };
    AcRyeHarvestSkinPopupView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcRyeHarvestSkinPopupView;
}(PopupView));
__reflect(AcRyeHarvestSkinPopupView.prototype, "AcRyeHarvestSkinPopupView");
