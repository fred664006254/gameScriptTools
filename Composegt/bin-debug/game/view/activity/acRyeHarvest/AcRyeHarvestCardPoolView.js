 ...
 * author qianjun
 */
var AcRyeHarvestCardPoolView = (function (_super) {
    __extends(AcRyeHarvestCardPoolView, _super);
    function AcRyeHarvestCardPoolView() {
        return _super.call(this) || this;
    }
    Object.defineProperty(AcRyeHarvestCardPoolView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcRyeHarvestCardPoolView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcRyeHarvestCardPoolView.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcRyeHarvestCardPoolView.prototype, "aid", {
        get: function () {
    ...
    AcRyeHarvestCardPoolView.prototype.getUiCode = function () {
        var code = '';
    ...
    AcRyeHarvestCardPoolView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([]);
    };
    AcRyeHarvestCardPoolView.prototype.initView = function () {
        // let tabName = ["acPunishRankRewardTab1"];
        var view = this;
        var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("motherdaypooltip-" + view.getUiCode()), 20, TextFieldConst.COLOR_BLACK);
    ...
    AcRyeHarvestCardPoolView.prototype.getShowHeight = function () {
        return 560;
    };
    AcRyeHarvestCardPoolView.prototype.getTitleStr = function () {
        return "motherdaypoolreward-" + this.getUiCode();
    };
    AcRyeHarvestCardPoolView.prototype.dispose = function () {
        var view = this;
        _super.prototype.dispose.call(this);
    };
    return AcRyeHarvestCardPoolView;
}(PopupView));
__reflect(AcRyeHarvestCardPoolView.prototype, "AcRyeHarvestCardPoolView");
