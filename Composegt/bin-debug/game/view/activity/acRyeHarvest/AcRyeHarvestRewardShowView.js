...
var AcRyeHarvestRewardShowView = (function (_super) {
    __extends(AcRyeHarvestRewardShowView, _super);
    function AcRyeHarvestRewardShowView() {
        return _super.call(this) || this;
    }
    AcRyeHarvestRewardShowView.prototype.initView = function () {
    ...
    AcRyeHarvestRewardShowView.prototype.doWaitAni = function (tmpNode, waitT) {
        tmpNode.alpha = 0;
        egret.Tween.get(tmpNode, { loop: false }).wait(waitT).to({ alpha: 1 }, 500);
    };
    AcRyeHarvestRewardShowView.prototype.hide = function () {
        if (this.param.data.callback) {
            this.param.data.callback.apply(this.param.data.callobj);
        }
        _super.prototype.hide.call(this);
    };
    AcRyeHarvestRewardShowView.prototype.getShowHeight = function () {
        var re_data = this.param.data;
        //"6_1150_4|6_1710_1";
        var rewardTab = re_data.split('|');
        return rewardTab.length > 5 ? 528 : 300;
    };
    AcRyeHarvestRewardShowView.prototype.getTitleStr = function () {
        return null;
    };
    AcRyeHarvestRewardShowView.prototype.getResourceList = function () {
    ...
    AcRyeHarvestRewardShowView.prototype.isTouchMaskClose = function () {
        return true;
    };
    AcRyeHarvestRewardShowView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcRyeHarvestRewardShowView;
}(BaseView));
__reflect(AcRyeHarvestRewardShowView.prototype, "AcRyeHarvestRewardShowView");
