...
/**
  ...
  */
var AcRyeHarvestActivityRewardChargeScrollItem = (function (_super) {
    __extends(AcRyeHarvestActivityRewardChargeScrollItem, _super);
    function AcRyeHarvestActivityRewardChargeScrollItem() {
     ...
     * 初始化itemview
     */
    AcRyeHarvestActivityRewardChargeScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        this._itemData = data;
        ...
        var titleBg = BaseBitmap.create(vo.getChargeNum(data.questType) >= data.needGem ? "accarnivalview_tab_green" : "accarnivalview_tab_red");
        titleBg.y = 7;
        titleBg.x = 3;
        // bottom2.width =170;
        this.addChild(titleBg);
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acRyeHarvestActivityRewardChargeScrollItemTitle-" + this._aidAndCode.code, [String(data.needGem)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        if (vo.isGetRecharge(data.id)) {
            ...
            if (vo.getChargeNum(data.questType) >= data.needGem) {
                ...
                var chargeBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, "taskGoBtn", function () {
                    var v = Api.acVoApi.getActivityVoByAidAndCode(_this._aidAndCode.aid, _this._aidAndCode.code);
    ...
    AcRyeHarvestActivityRewardChargeScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcRyeHarvestActivityRewardChargeScrollItem.prototype.dispose = function () {
        this._itemData = null;
        _super.prototype.dispose.call(this);
    };
    return AcRyeHarvestActivityRewardChargeScrollItem;
}(ScrollListItem));
__reflect(AcRyeHarvestActivityRewardChargeScrollItem.prototype, "AcRyeHarvestActivityRewardChargeScrollItem");
