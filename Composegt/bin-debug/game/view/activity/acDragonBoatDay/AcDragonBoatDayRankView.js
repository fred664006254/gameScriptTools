...
var AcDragonBoatDayRankView = (function (_super) {
    ...
    AcDragonBoatDayRankView.prototype.initView = function () {
        ...
        var bottomBg = BaseBitmap.create("public_tc_bg03"); //public_tc_bg01
        bottomBg.width = 510;
        bottomBg.height = 100;
        ...
        var myRankStr = LanguageManager.getlocal("acRank_myrank1", [rankV]);
        ...
        var rank_biao = BaseBitmap.create("rank_biao");
        rank_biao.width = 480;
        rank_biao.x = 55;
        rank_biao.y = 83;
