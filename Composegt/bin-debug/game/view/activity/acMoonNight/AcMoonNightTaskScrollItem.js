...
var AcMoonNightTaskScrollItem = (function (_super) {
    __extends(AcMoonNightTaskScrollItem, _super);
    function AcMoonNightTaskScrollItem() {
    ...
    Object.defineProperty(AcMoonNightTaskScrollItem.prototype, "cfg", {
        get: function () {
     ...
     * 初始化itemview
     */
    AcMoonNightTaskScrollItem.prototype.initItem = function (index, data, itemParam) {
        this._itemData = data;
     ...
     * 领取奖励Click
     */
    AcMoonNightTaskScrollItem.prototype.reviceBtnClick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
        if (!vo.isInActivity()) {
        ...
        NetManager.request(NetRequestConst.REQUEST_ACTIVITY2S_GETMOONNIGHTTASKREWARD, { "activeId": activityId, "taskId": this._itemData.id });
    };
    /**
     * 刷新UI
     */
    AcMoonNightTaskScrollItem.prototype.refreshView = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
     ...
     * 前往的Click
     */
    AcMoonNightTaskScrollItem.prototype.goBtnClick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
        if (!vo.isInActivity()) {
            App.CommonUtil.showTip(LanguageManager.getlocal('acPunishEnd'));
            return;
     ...
     * 获得
     */
    AcMoonNightTaskScrollItem.prototype.getTitleStr = function (type) {
        var strTop = null;
    ...
    AcMoonNightTaskScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcMoonNightTaskScrollItem.prototype.dispose = function () {
        this._itemData = null;
    ...
    return AcMoonNightTaskScrollItem;
}(ScrollListItem));
__reflect(AcMoonNightTaskScrollItem.prototype, "AcMoonNightTaskScrollItem");
