...
var AcLimitedRewardDetailScrollItem = (function (_super) {
    ...
    AcLimitedRewardDetailScrollItem.prototype.initItem = function (index, data) {
        ...
        bg.height = 148;
        this.addChild(bg);
        var bgtitle = BaseBitmap.create("public_up3");
        bgtitle.width = 510;
        bgtitle.height = 40;
        bgtitle.x = 5;
        bgtitle.y = 5;
        this.addChild(bgtitle);
        var rewardGradeTF = ComponentManager.getTextField(LanguageManager.getlocal("rewardGradeNum", [this._limitedRewardInfoVo.id.toString()]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
        rewardGradeTF.x = 20;
        rewardGradeTF.y = 15;
        ...
        var conditonTF = ComponentManager.getTextField("", TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
