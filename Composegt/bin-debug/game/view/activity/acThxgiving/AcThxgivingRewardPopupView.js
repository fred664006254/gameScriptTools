 ...
 */
var AcThxgivingRewardPopupView = (function (_super) {
    __extends(AcThxgivingRewardPopupView, _super);
    function AcThxgivingRewardPopupView() {
        return _super.call(this) || this;
    }
    AcThxgivingRewardPopupView.prototype.getDefaultCn = function (cnName, defaultCode) {
    ...
    AcThxgivingRewardPopupView.prototype.initView = function () {
        ...
        var lockTxt = this.getDefaultCn("acThxgvingRewardCase");
        if (rewardId == 9) {
        ...
        var rewardArr = GameData.formatRewardItem(mustStr);
    ...
    AcThxgivingRewardPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([]);
    };
    AcThxgivingRewardPopupView.prototype.dispose = function () {
        this._nodeContainer = null;
        _super.prototype.dispose.call(this);
    };
    return AcThxgivingRewardPopupView;
}(PopupView));
__reflect(AcThxgivingRewardPopupView.prototype, "AcThxgivingRewardPopupView");
