...
/**
  ...
  */
var AcThxgivingDetailPopupView = (function (_super) {
    __extends(AcThxgivingDetailPopupView, _super);
    function AcThxgivingDetailPopupView() {
        return _super.call(this) || this;
    }
    Object.defineProperty(AcThxgivingDetailPopupView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcThxgivingDetailPopupView.prototype, "vo", {
        get: function () {
     ...
     *
     */
    AcThxgivingDetailPopupView.prototype.initBg = function () {
    ...
    AcThxgivingDetailPopupView.prototype.resetBgSize = function () {
    ...
    AcThxgivingDetailPopupView.prototype.initView = function () {
        this.aid = this.param.data.aid;
        this.code = this.param.data.code;
        var bg = BaseLoadBitmap.create(this.getDefaultRes("acthxgivingview_detailcontext"));
        bg.width = 548;
        bg.height = 504;
        bg.setPosition(this.viewBg.x + this.viewBg.width / 2 - bg.width / 2, this.viewBg.y + 25 + 50);
        this.addChildToContainer(bg);
        var acDesc = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acThxgvingViewDetailDesc")), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
        acDesc.width = 450;
        ...
        var detailText1 = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acThxgvingViewDetailDescText1"), [String(sceneItemCfg.wifeBathingGlamour)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        ...
        var detailText2 = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acThxgvingViewDetailDescText2"), [String(sceneItemCfg.wifeBathingExpRate * 100) + "%"]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
    ...
    // }
    // 关闭按钮图标名称
    AcThxgivingDetailPopupView.prototype.getCloseBtnName = function () {
        return "load_closebtn";
    };
    // 背景图名称
    AcThxgivingDetailPopupView.prototype.getBgName = function () {
        return null;
    };
    AcThxgivingDetailPopupView.prototype.getTitleStr = function () {
        return this.getDefaultCn("acThxgvingViewDetailTitle", this.param.data.code);
    };
    AcThxgivingDetailPopupView.prototype.getDefaultCn = function (cnName, defaultCode) {
    ...
    //根据资源名字得到完整资源名字
    AcThxgivingDetailPopupView.prototype.getDefaultRes = function (resName, defaultCode) {
        defaultCode = defaultCode || "1";
    ...
    AcThxgivingDetailPopupView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcThxgivingDetailPopupView;
}(PopupView));
__reflect(AcThxgivingDetailPopupView.prototype, "AcThxgivingDetailPopupView");
