...
var AcSingleDayBuild1ViewTab2ScrollItem = (function (_super) {
    ...
    AcSingleDayBuild1ViewTab2ScrollItem.prototype.initItem = function (index, data, itemParm) {
        ...
        this.addChild(bg);
        var titleTxt = ComponentManager.getTextField(LanguageManager.getlocal("acSingleDayBuild1ViewTab2ItemTitle", [data.needGem]), TextFieldConst.FONTSIZE_CONTENT_COMMON, 0xa87e00);
