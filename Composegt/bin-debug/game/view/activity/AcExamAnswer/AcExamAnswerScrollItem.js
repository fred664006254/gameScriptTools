...
var AcExamAnswerScrollItem = (function (_super) {
    __extends(AcExamAnswerScrollItem, _super);
    function AcExamAnswerScrollItem() {
        return _super.call(this) || this;
    }
    AcExamAnswerScrollItem.prototype.initItem = function (index, data) {
        this.width = 502;
        this.height = 52;
        if (index % 2 == 1) {
    ...
    AcExamAnswerScrollItem.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcExamAnswerScrollItem;
}(ScrollListItem));
__reflect(AcExamAnswerScrollItem.prototype, "AcExamAnswerScrollItem");
