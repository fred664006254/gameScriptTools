 ...
 * 问卷答题
 */
var AcAnswerRankPopupView = (function (_super) {
    __extends(AcAnswerRankPopupView, _super);
    function AcAnswerRankPopupView() {
    ...
    AcAnswerRankPopupView.prototype.initView = function () {
        ...
        //擂台分数
        var scoreText = ComponentManager.getTextField(LanguageManager.getlocal("acAnswerRankScore"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var answer_rankTip = ComponentManager.getTextField(LanguageManager.getlocal("acAnswerRankTip"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
    ...
    AcAnswerRankPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "rankinglist_line", "rankinglist_rankbg",
            "rank_1", "rank_2", "rank_3", "rank_biao",
        ]);
    };
    AcAnswerRankPopupView.prototype.dispose = function () {
        this._scrollList = null;
        this._infoList = null;
        this._merank = 0;
        _super.prototype.dispose.call(this);
    };
    return AcAnswerRankPopupView;
}(PopupView));
__reflect(AcAnswerRankPopupView.prototype, "AcAnswerRankPopupView");
