...
var AcLuckBagRewardPopupView = (function (_super) {
    __extends(AcLuckBagRewardPopupView, _super);
    function AcLuckBagRewardPopupView() {
        return _super.call(this) || this;
    }
    AcLuckBagRewardPopupView.prototype.initView = function () {
        ...
        giveDes.y = bottomBg.y + 8;
        this.addChildToContainer(giveDes);
    ...
    AcLuckBagRewardPopupView.prototype.doWaitAni = function (tmpNode, waitT) {
        tmpNode.alpha = 0;
        egret.Tween.get(tmpNode, { loop: false }).wait(waitT).to({ alpha: 1 }, 500);
    };
    AcLuckBagRewardPopupView.prototype.getShowHeight = function () {
        var re_data = this.param.data;
        //"6_1150_4|6_1710_1";
        var rewardTab = re_data.split('|');
        return rewardTab.length > 4 ? 528 : 300;
    };
    AcLuckBagRewardPopupView.prototype.getResourceList = function () {
    ...
    AcLuckBagRewardPopupView.prototype.isTouchMaskClose = function () {
        return true;
    };
    AcLuckBagRewardPopupView.prototype.dispose = function () {
        App.MessageHelper.dispatchEvent(MessageConst.MESSAGE_LUCKBAG_REFRESHBAG);
        _super.prototype.dispose.call(this);
    };
    return AcLuckBagRewardPopupView;
}(BaseView));
__reflect(AcLuckBagRewardPopupView.prototype, "AcLuckBagRewardPopupView");
