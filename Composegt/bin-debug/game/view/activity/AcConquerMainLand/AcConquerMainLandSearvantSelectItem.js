...
var AcConquerMainLandSearvantSelectItem = (function (_super) {
    ...
    AcConquerMainLandSearvantSelectItem.prototype.initServantIcon = function (data) {
        ...
        view._icon = iconBt;
        //兵力数目
        var numbg = BaseBitmap.create("mainland_servantitem_numbg");
        numbg.width = 100;
        ...
        var costTxt = ComponentManager.getTextField("" + costObj.cost, 18, TextFieldConst.COLOR_QUALITY_GREEN_NEW);
        ...
        var freeTxt = ComponentManager.getTextField(LanguageManager.getlocal("acConquerMainLandArmyFree-" + code, [costObj.freeNum.toString()]), 18, TextFieldConst.COLOR_BROWN_NEW);
        ...
        var flag = BaseBitmap.create(attend == data.army ? "mlservant_selectitem_inselect-" + view.getUiCode() : "mlservant_selectitem_inbattle-" + view.getUiCode());
        view.addChild(flag);
        view._flag = flag;
    ...
    AcConquerMainLandSearvantSelectItem.prototype.refreshData = function (data) {
        ...
        var tmpx = (108 - view._costIcon.width - 3 - view._costTxt.textWidth) / 2;
