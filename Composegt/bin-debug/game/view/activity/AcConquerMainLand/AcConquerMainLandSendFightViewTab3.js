...
author : qinajun
*/
var AcConquerMainLandSendFightViewTab3 = (function (_super) {
    __extends(AcConquerMainLandSendFightViewTab3, _super);
    function AcConquerMainLandSendFightViewTab3(data) {
    ...
    Object.defineProperty(AcConquerMainLandSendFightViewTab3.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcConquerMainLandSendFightViewTab3.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcConquerMainLandSendFightViewTab3.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcConquerMainLandSendFightViewTab3.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcConquerMainLandSendFightViewTab3.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcConquerMainLandSendFightViewTab3.prototype, "uiCode", {
        get: function () {
    ...
    AcConquerMainLandSendFightViewTab3.prototype.initView = function () {
        var view = this;
        var army = view._army;
        var baseview = ViewController.getInstance().getView('AcConquerMainLandSendFightView');
    ...
    AcConquerMainLandSendFightViewTab3.prototype.checkTeamAllFightNum = function (servantList) {
        var totalNum = 0;
    ...
    //消耗元宝提示
    AcConquerMainLandSendFightViewTab3.prototype.costConfirm = function () {
        var view = this;
    ...
    //门客数提示
    AcConquerMainLandSendFightViewTab3.prototype.servantnumConfirm = function () {
        var view = this;
        var code = view.uiCode;
    ...
    AcConquerMainLandSendFightViewTab3.prototype.checkBuzhen = function (event) {
        var data = event.data;
        var view = this;
    ...
    AcConquerMainLandSendFightViewTab3.prototype.freshServant = function () {
        var view = this;
        var arr = [];
    ...
    AcConquerMainLandSendFightViewTab3.prototype.getTotalNum = function () {
        var view = this;
        var num = 0;
        for (var i in view._servantSelect) {
    ...
    AcConquerMainLandSendFightViewTab3.prototype.refreshWhenSwitchBack = function () {
        var view = this;
        var servantObj = [];
    ...
    AcConquerMainLandSendFightViewTab3.prototype.update = function () {
        var view = this;
        var code = view.uiCode;
        var army = view._army;
        //开战消耗
    ...
    //出战花费
    AcConquerMainLandSendFightViewTab3.prototype.checkCost = function () {
        var view = this;
        var code = view.uiCode;
        var num = 0;
        for (var i in view._servantSelect) {
    ...
    AcConquerMainLandSendFightViewTab3.prototype.sendCallBack = function (evt) {
        var view = this;
        if (!view.param) {
            return;
        }
    ...
    AcConquerMainLandSendFightViewTab3.prototype.useItemCallback = function (evt) {
        var view = this;
        var code = view.uiCode;
        if (evt.data.data) {
    ...
    AcConquerMainLandSendFightViewTab3.prototype.cancelCallBack = function (evt) {
        var view = this;
        var code = view.uiCode;
    ...
    AcConquerMainLandSendFightViewTab3.prototype.dispose = function () {
        var view = this;
    ...
    return AcConquerMainLandSendFightViewTab3;
}(CommonViewTab));
__reflect(AcConquerMainLandSendFightViewTab3.prototype, "AcConquerMainLandSendFightViewTab3");
