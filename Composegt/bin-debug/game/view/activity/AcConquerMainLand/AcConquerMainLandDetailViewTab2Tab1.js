...
var AcConquerMainLandDetailViewTab2Tab1 = (function (_super) {
    ...
    AcConquerMainLandDetailViewTab2Tab1.prototype.initView = function () {
        ...
        var rList = this.cfg.prankList;
        var scrollrect = new egret.Rectangle(0, 0, 620, this.height - bottomBg.height - 55);
        var scrollList = ComponentManager.getScrollList(AcConquerMainLandDetailViewTab2Tab1ScrollItem, rList, scrollrect, { aid: this.aid, code: this.code });
        scrollList.x = 10;
        scrollList.y = 0;
        this.addChild(scrollList);
    };
    AcConquerMainLandDetailViewTab2Tab1.prototype.getRequestData = function () {
        return {
