...
var AcConquerMainLandDetailViewTab1 = (function (_super) {
    ...
    AcConquerMainLandDetailViewTab1.prototype.initView = function () {
        ...
        var Bg = BaseBitmap.create("mainland_detailtab1_topbg");
        Bg.width = view.width;
        view.addChild(Bg);
        var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("acConquerMainLandDetailDesc-" + view.uiCode), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var viewbg = App.CommonUtil.getCommonBorderFrame(this.height - Bg.height + 20);
        viewbg.y = Bg.height - 10;
        view.addChild(viewbg);
        var tmpRect = new egret.Rectangle(0, 0, GameConfig.stageWidth, viewbg.height - 70);
