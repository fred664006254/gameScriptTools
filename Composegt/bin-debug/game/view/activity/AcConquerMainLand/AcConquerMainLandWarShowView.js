...
var AcConquerMainLandWarShowView = (function (_super) {
    ...
    AcConquerMainLandWarShowView.prototype.initView = function () {
        ...
        var titleImg = BaseBitmap.create("mainland_warshow_title-" + this.code);
        ...
        var crossservantrulevs = BaseBitmap.create("mainland_warshow_fight-" + this.uiCode);
        ...
        var cityTxt = ComponentManager.getTextField(LanguageManager.getlocal("acConquerMainWarShowBattleName-" + this.code, [view.param.data.cityName]), 24, TextFieldConst.COLOR_WARN_YELLOW);
    ...
    AcConquerMainLandWarShowView.prototype.createWarInfo = function (type) {
        ...
        var nameStr = Api.mergeServerVoApi.getAfterMergeSeverName(null, true, wardata.zid) + "   " + wardata.name;
        var teamNameTxt = ComponentManager.getTextField(nameStr, 20);
        ...
        var titleImg = null;
        var titleId = wardata.titleid;
        if (titleId) {
            var titleStr = Config.TitleCfg.getTitleIcon3WithLv(titleId, wardata.titlelv);
        ...
        var aureoleClip = ComponentManager.getCustomMovieClip("mainlandlighteffect", 10, 70);
        var aureoleBM = BaseBitmap.create("mainlandlighteffect1");
        ...
        var descTxt = ComponentManager.getTextField(str, 20, TextFieldConst.COLOR_BROWN_NEW);
        descTxt.width = 200;
        ...
        var playernamebg = BaseBitmap.create("mainland_warshow_sernamebg-" + this.uiCode);
        ...
        var progress = ComponentManager.getProgressBar("progress_blood", "progress_bloodbg", 260);
    ...
    AcConquerMainLandWarShowView.prototype.showRoundAnti = function (type, func, obj, showskin, showskinfunc) {
        ...
        var alvImg = view["_servantAlvImg" + type];
        if (roundData) {
            ...
            var servantVo = Api.servantVoApi.getServantObj(data_1.servantId);
            ...
            if (view._round == 1) {
                ...
                egret.Tween.get(rolegroup).to({ x: isOnleft ? -248 : 508, y: view._rolePosY }, 250).call(function () {
                    ...
                    role.setload(img);
                    if (data_1.clv > 0) {
                        alvImg.setload("servant_alv_" + data_1.clv);
                        alvImg.visible = true;
                    }
                    else {
        ...
        if (view._round == 1) {
            if (view._flag) {
                ...
                egret.Tween.get(view._topGroup).to({ y: 0 }, 300).wait(3600).call(function () {
                    ...
                    var upgradeClip = ComponentManager.getCustomMovieClip("mainlandpkduizhan", 17, 100);
