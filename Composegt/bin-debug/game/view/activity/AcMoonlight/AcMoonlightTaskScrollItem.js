...
var AcMoonlightTaskScrollItem = (function (_super) {
    __extends(AcMoonlightTaskScrollItem, _super);
    function AcMoonlightTaskScrollItem() {
    ...
    Object.defineProperty(AcMoonlightTaskScrollItem.prototype, "cfg", {
        get: function () {
     ...
     * 初始化itemview
     */
    AcMoonlightTaskScrollItem.prototype.initItem = function (index, data, itemParam) {
        this._itemData = data;
     ...
     * 领取奖励Click
     */
    AcMoonlightTaskScrollItem.prototype.reviceBtnClick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
        if (!vo.isInActivity()) {
        ...
        NetManager.request(NetRequestConst.REQUEST_ACTIVITY2S_GETMOONLIGHTTASKREWARD, { "activeId": activityId, "taskId": this._itemData.id });
    };
    /**
     * 刷新UI
     */
    AcMoonlightTaskScrollItem.prototype.refreshView = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
     ...
     * 前往的Click
     */
    AcMoonlightTaskScrollItem.prototype.goBtnClick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
        if (!vo.isInActivity()) {
            App.CommonUtil.showTip(LanguageManager.getlocal('acPunishEnd'));
            return;
     ...
     * 获得
     */
    AcMoonlightTaskScrollItem.prototype.getTitleStr = function (type) {
        var strTop = null;
    ...
    AcMoonlightTaskScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcMoonlightTaskScrollItem.prototype.dispose = function () {
        this._itemData = null;
    ...
    return AcMoonlightTaskScrollItem;
}(ScrollListItem));
__reflect(AcMoonlightTaskScrollItem.prototype, "AcMoonlightTaskScrollItem");
