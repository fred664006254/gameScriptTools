 ...
 * author yanyuling
 */
var AcMoonlightRewardPopupView = (function (_super) {
    __extends(AcMoonlightRewardPopupView, _super);
    function AcMoonlightRewardPopupView() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AcMoonlightRewardPopupView.prototype.initView = function () {
        ...
        var txt = "";
        if (n > 0) {
            txt = LanguageManager.getlocal(this.getDefaultCn("acMoonlightReward_detail"), [String(needNum)]);
        }
        else {
            txt = LanguageManager.getlocal(this.getDefaultCn("acMoonlightReward_detail2"));
        }
        var ofy = 51;
        ...
        //谢礼:
        var txt3 = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acMoonlightRewardPopupViewT")), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
        txt3.x = bg1.x + 20;
        txt3.y = bg1.y + 20;
    ...
    AcMoonlightRewardPopupView.prototype.getDefaultCn = function (cnName, defaultCode) {
    ...
    AcMoonlightRewardPopupView.prototype.getTitleStr = function () {
        return "acWifeSkinInheritRewardPopupViewTitle";
    };
    AcMoonlightRewardPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([]);
    };
    AcMoonlightRewardPopupView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcMoonlightRewardPopupView;
}(PopupView));
__reflect(AcMoonlightRewardPopupView.prototype, "AcMoonlightRewardPopupView");
