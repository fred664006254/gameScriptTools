...
var AcCrossServerIntimacyView = (function (_super) {
    ...
    AcCrossServerIntimacyView.prototype.isShowOpenAni = function () {
        return false;
    };
    ...
    AcCrossServerIntimacyView.prototype.initView = function () {
        ...
        var flagword = "crossserverinti_flagword";
        var crossserverinti_flagword = null;
    ...
    AcCrossServerIntimacyView.prototype.createSpecial = function (y) {
    ...
    AcCrossServerIntimacyView.prototype.detailBtnClick = function () {
        var rewardItemVo = GameData.formatRewardItem(this.cfg.specialReward);
