...
var AcWifeComeView = (function (_super) {
    ...
    AcWifeComeView.prototype.initView = function () {
        ...
        var wifeid = "";
        var dragonScale = 1;
        var dragonY = this._contentImg.y + 1000;
        var imgScale = 0.6;
        var imgY = this._contentImg.y + 390;
        var fY = this._contentImg.y + 1136 - 267 + 80;
        switch (this.code + "") {
            case "1":
                wifeid = "213";
                break;
        ...
        if (App.CommonUtil.check_dragon() && ResourceManager.hasRes("wife_full_" + wifeid + "_ske") && Api.wifeVoApi.isHaveBone("wife_full_" + wifeid + "_ske")) {
            var droWifeIcon = App.DragonBonesUtil.getLoadDragonBones("wife_full_" + wifeid);
            ...
            // wife 的 图片
            var wifeBM = BaseLoadBitmap.create("wife_full_" + wifeid);
            wifeBM.width = 640;
            wifeBM.height = 840;
        ...
        //网红名字
        var nameTF = ComponentManager.getTextField(LanguageManager.getlocal("acWifeComeName_" + this.code), TextFieldConst.FONTSIZE_TITLE_COMMON, TextFieldConst.COLOR_BLACK);
        ...
        //花
        var flowerImg = BaseBitmap.create(this.getDefaultRes("acwifecomeview_flower"));
    ...
    // 不使用组件的关闭按钮
    AcWifeComeView.prototype.getCloseBtnName = function () {
        return null;
    };
    //根据资源名字得到完整资源名字
    AcWifeComeView.prototype.getDefaultRes = function (resName, defaultCode) {
