 ...
 * author jiangliuyang
 */
var AcLanternRewardPopupView = (function (_super) {
    __extends(AcLanternRewardPopupView, _super);
    function AcLanternRewardPopupView() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AcLanternRewardPopupView.prototype.initView = function () {
        ...
        var boxcfg = config.lanternNum[this.param.data.boxid - 1];
        var getReward = boxcfg.getReward;
        var needNum = boxcfg.needNum;
        var curNum = 0; //_acvo.ainfo.score;
        ...
        //谢礼:
        var txt3 = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acLanternRewardPopupViewT")), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
        txt3.x = bg1.x + 20;
        txt3.y = bg1.y + 20;
    ...
    AcLanternRewardPopupView.prototype.getDefaultCn = function (cnName, defaultCode) {
    ...
    AcLanternRewardPopupView.prototype.getTitleStr = function () {
        return "acWifeSkinInheritRewardPopupViewTitle";
    };
    AcLanternRewardPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([]);
    };
    AcLanternRewardPopupView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcLanternRewardPopupView;
}(PopupView));
__reflect(AcLanternRewardPopupView.prototype, "AcLanternRewardPopupView");
