...
var AcStargazerBookScrollItem = (function (_super) {
    __extends(AcStargazerBookScrollItem, _super);
    function AcStargazerBookScrollItem() {
        var _this = _super.call(this) || this;
        _this._skincfg = undefined;
        _this._skinId = undefined;
        return _this;
    }
    AcStargazerBookScrollItem.prototype.init = function (skinId, index, serId) {
    ...
    AcStargazerBookScrollItem.prototype.bookTouchHandler = function (obj, param) {
        var bid = param;
        var uidata = {
            aid: bid,
            bookId: bid,
    ...
    AcStargazerBookScrollItem.prototype.getServantBookStars = function (num) {
    ...
    AcStargazerBookScrollItem.prototype.collectHandlerCallBack = function (event) {
    ...
    AcStargazerBookScrollItem.prototype.dispose = function () {
    ...
    return AcStargazerBookScrollItem;
}(BaseDisplayObjectContainer));
__reflect(AcStargazerBookScrollItem.prototype, "AcStargazerBookScrollItem");
