 ...
 * 奸臣皮肤兑换
 */
var AcStargazerExchangePopupView = (function (_super) {
    __extends(AcStargazerExchangePopupView, _super);
    function AcStargazerExchangePopupView() {
    ...
    Object.defineProperty(AcStargazerExchangePopupView.prototype, "cfg", {
        get: function () {
    ...
    AcStargazerExchangePopupView.prototype.initView = function () {
        ...
        this._ownTxt.text = LanguageManager.getlocal("acStargazer_ownTxt", [this._acvo.getItemNumByIndex(String(exchangeShopItem.itemID)) + "/" + exchangeShopItem["proofNum"]]);
        ...
        var isexcge = this._acvo.checkCanExchangeByIndex(this._skinIdIndex);
        if (isexcge) {
    ...
    //根据资源名字得到完整资源名字
    AcStargazerExchangePopupView.prototype.getDefaultRes = function (resName, defaultCode) {
    ...
    AcStargazerExchangePopupView.prototype.getDefaultCn = function (cnName, defaultCode) {
        defaultCode = defaultCode || "1";
    ...
    AcStargazerExchangePopupView.prototype.leftBtnHandler = function () {
        this._skinIdIndex--;
    ...
    AcStargazerExchangePopupView.prototype.rightBtnHandler = function () {
        this._skinIdIndex++;
    ...
    AcStargazerExchangePopupView.prototype.refreshView = function () {
        var exchangeShopItem = this.cfg.getRewardSkinIdByIndex(this._skinIdIndex);
        var skincfg = Config.ServantskinCfg.getServantSkinItemById(exchangeShopItem.skinID);
    ...
    AcStargazerExchangePopupView.prototype.exchangeBtnHandler = function () {
        ...
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACTIVITY2S_STAZEREXCHANGE, this.searchHandlerNetBack, this);
        var _activeId = this.param.data.aid + "-" + this.param.data.code;
        NetManager.request(NetRequestConst.REQUEST_ACTIVITY2S_STAZEREXCHANGE, { activeId: _activeId, shopid: this._skinIdIndex + 1 });
    };
    AcStargazerExchangePopupView.prototype.searchHandlerNetBack = function (event) {
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACTIVITY2S_STAZEREXCHANGE, this.searchHandlerNetBack, this);
    ...
    AcStargazerExchangePopupView.prototype.showDBDragon = function (skinId, tarY) {
        if (tarY) {
            this._tarY = tarY;
        }
        else {
        ...
        if (!Api.switchVoApi.checkServantCloseBone() && boneName && RES.hasRes(boneName) && App.CommonUtil.check_dragon()) {
            ...
            this._droWifeIcon.mask = new egret.Rectangle(-292, -680, 584, 600);
    ...
    AcStargazerExchangePopupView.prototype.getResourceList = function () {
    ...
    // 	return 40;
    // }
    AcStargazerExchangePopupView.prototype.getTitleStr = function () {
        return null;
    };
    AcStargazerExchangePopupView.prototype.getBgName = function () {
        // return "ransackTraitor_bg2";
        return this.getDefaultRes("acstargazer_changefb");
    };
    AcStargazerExchangePopupView.prototype.dispose = function () {
        this._ownTxt = null;
    ...
    return AcStargazerExchangePopupView;
}(PopupView));
__reflect(AcStargazerExchangePopupView.prototype, "AcStargazerExchangePopupView");
