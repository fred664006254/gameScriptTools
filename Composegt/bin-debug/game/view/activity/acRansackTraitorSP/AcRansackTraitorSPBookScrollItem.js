...
var AcRansackTraitorSPBookScrollItem = (function (_super) {
    __extends(AcRansackTraitorSPBookScrollItem, _super);
    function AcRansackTraitorSPBookScrollItem() {
        var _this = _super.call(this) || this;
        _this._skincfg = undefined;
        _this._skinId = undefined;
        return _this;
    }
    AcRansackTraitorSPBookScrollItem.prototype.init = function (skinId, index, serId) {
    ...
    AcRansackTraitorSPBookScrollItem.prototype.bookTouchHandler = function (obj, param) {
        var bid = param;
        var uidata = {
            aid: bid,
            bookId: bid,
    ...
    AcRansackTraitorSPBookScrollItem.prototype.getServantBookStars = function (num) {
    ...
    AcRansackTraitorSPBookScrollItem.prototype.collectHandlerCallBack = function (event) {
    ...
    AcRansackTraitorSPBookScrollItem.prototype.dispose = function () {
    ...
    return AcRansackTraitorSPBookScrollItem;
}(BaseDisplayObjectContainer));
__reflect(AcRansackTraitorSPBookScrollItem.prototype, "AcRansackTraitorSPBookScrollItem");
