...
var AcRansackTraitorSPScrollItem = (function (_super) {
    __extends(AcRansackTraitorSPScrollItem, _super);
    function AcRansackTraitorSPScrollItem() {
    ...
    AcRansackTraitorSPScrollItem.prototype.init = function (data) {
        // }
        ...
        var auraList = Config.ServantCfg.getServantItemById(AcRansackTraitorSPScrollItem.servantId).aura || [];
        var skin_auraList = [];
    ...
    AcRansackTraitorSPScrollItem.prototype.refreshAfterLv = function (event) {
        var servantId = AcRansackTraitorSPScrollItem.servantId;
    ...
    AcRansackTraitorSPScrollItem.prototype.doRequest = function () {
    ...
    AcRansackTraitorSPScrollItem.prototype.goBtnHandler = function () {
    ...
    AcRansackTraitorSPScrollItem.prototype.dispose = function () {
        ...
        AcRansackTraitorSPScrollItem.servantId = "";
        this._auarKey = "";
        this._levelupTipStr = "";
        this._itemList = [];
    ...
    AcRansackTraitorSPScrollItem.servantId = "";
    return AcRansackTraitorSPScrollItem;
}(BaseDisplayObjectContainer));
__reflect(AcRansackTraitorSPScrollItem.prototype, "AcRansackTraitorSPScrollItem");
