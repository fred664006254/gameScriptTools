...
var AcBuildingWorshipAVGView = (function (_super) {
    __extends(AcBuildingWorshipAVGView, _super);
    function AcBuildingWorshipAVGView() {
    ...
    Object.defineProperty(AcBuildingWorshipAVGView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcBuildingWorshipAVGView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcBuildingWorshipAVGView.prototype, "acTivityId", {
        get: function () {
    ...
    AcBuildingWorshipAVGView.prototype.isShowOpenAni = function () {
        return false;
    };
    AcBuildingWorshipAVGView.prototype.getResourceList = function () {
        // test code
    ...
    AcBuildingWorshipAVGView.prototype.getTitleBgName = function () {
        return null;
    };
    AcBuildingWorshipAVGView.prototype.getTitleStr = function () {
        return null;
    };
    AcBuildingWorshipAVGView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcBuildingWorshipAVGView.prototype.getBgName = function () {
        return null;
    };
    AcBuildingWorshipAVGView.prototype.isShowMask = function () {
        return true;
    };
    AcBuildingWorshipAVGView.prototype.preInit = function () {
    ...
    AcBuildingWorshipAVGView.prototype.init = function () {
        ...
        this._titleBg.setPosition(114 - this._titleBg.width / 2, this._tipBB.y - 50);
    ...
    AcBuildingWorshipAVGView.prototype.clickPage = function (evt) {
    ...
    AcBuildingWorshipAVGView.prototype.doNextStep = function (step) {
        var view = this;
        var nextId = null;
        if (step) {
            nextId = step;
    ...
    AcBuildingWorshipAVGView.prototype.showPage = function () {
        //this.doStepHandle();
        if (this._showManTab) {
        ...
        var needShoot = false;
        var codStr = "_code" + AcBuildingWorshipView.CODE;
        //底部 描述
        if (this._curConfig.descId) {
            ...
            if (this._curConfig.clickContinue) {
                ...
                this._codonLength = 0;
                this._descText.text = "";
                if (LanguageManager.checkHasKey("acBuildingWorshipAVGDialog" + this._curConfig.descId + codStr)) {
                    this._descContent = LanguageManager.getlocal("acBuildingWorshipAVGDialog" + this._curConfig.descId + codStr);
                }
                else {
                    this._descContent = LanguageManager.getlocal("acBuildingWorshipAVGDialog" + this._curConfig.descId + "_code1");
                }
                needShoot = true;
            }
            else {
                if (LanguageManager.checkHasKey("acBuildingWorshipAVGDialog" + this._curConfig.descId + codStr)) {
                    this._descText.text = LanguageManager.getlocal("acBuildingWorshipAVGDialog" + this._curConfig.descId + codStr);
                }
                else {
                    this._descText.text = LanguageManager.getlocal("acBuildingWorshipAVGDialog" + this._curConfig.descId + "_code1");
                }
    ...
    AcBuildingWorshipAVGView.prototype.clickSelectedHandler = function (event, branchBtn, step) {
        switch (event.type) {
    ...
    AcBuildingWorshipAVGView.prototype.changeBgCallBack = function () {
    ...
    AcBuildingWorshipAVGView.prototype.showShakeAnim = function () {
    ...
    AcBuildingWorshipAVGView.prototype.shakeScreen = function () {
    ...
    AcBuildingWorshipAVGView.prototype.showFogAnim = function () {
        this._myBg.y = 0;
    ...
    AcBuildingWorshipAVGView.prototype.textShootAnim = function () {
    ...
    AcBuildingWorshipAVGView.prototype.textAnim = function (t) {
    ...
    AcBuildingWorshipAVGView.prototype.skipAnim = function () {
        this.hide();
     ...
     * 收到通知 下一步
     */
    AcBuildingWorshipAVGView.prototype.noticeNextStep = function () {
        this.doNextStep();
    };
    AcBuildingWorshipAVGView.prototype.initView = function () {
    };
    AcBuildingWorshipAVGView.prototype.getParent = function () {
        return LayerManager.maskLayer;
    };
    AcBuildingWorshipAVGView.prototype.hide = function (isDispose) {
        var tempObj = this._obj;
        var tempFunc = this._callbackF;
        if (!isDispose) {
            if (tempObj && tempFunc) {
    ...
    AcBuildingWorshipAVGView.prototype.doStepHandle = function () {
        if (this._curIdx == "1") {
    ...
    AcBuildingWorshipAVGView.prototype.dispose = function () {
    ...
    return AcBuildingWorshipAVGView;
}(CommonView));
__reflect(AcBuildingWorshipAVGView.prototype, "AcBuildingWorshipAVGView");
