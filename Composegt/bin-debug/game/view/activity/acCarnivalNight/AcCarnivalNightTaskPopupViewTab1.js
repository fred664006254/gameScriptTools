...
var AcCarnivalNightTaskPopupViewTab1 = (function (_super) {
    __extends(AcCarnivalNightTaskPopupViewTab1, _super);
    function AcCarnivalNightTaskPopupViewTab1(param) {
    ...
    AcCarnivalNightTaskPopupViewTab1.prototype.initView = function () {
    ...
    Object.defineProperty(AcCarnivalNightTaskPopupViewTab1.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCarnivalNightTaskPopupViewTab1.prototype, "vo", {
        get: function () {
    ...
    AcCarnivalNightTaskPopupViewTab1.prototype.showList = function () {
        if (this._scrollList == null) {
            var dayTaskList = this.vo.getSortTask(1); //this.cfg.getTaskListById(1);
    ...
    AcCarnivalNightTaskPopupViewTab1.prototype.refreshData = function () {
        if (this._scrollList) {
            var dayTaskList = this.vo.getSortTask(1);
            dayTaskList.sort(function (a, b) { return a.sortId - b.sortId; });
            this._scrollList.refreshData(dayTaskList, { aid: this.aid, code: this.code });
        }
    };
    AcCarnivalNightTaskPopupViewTab1.prototype.dispose = function () {
    ...
    return AcCarnivalNightTaskPopupViewTab1;
}(PopupViewTab));
__reflect(AcCarnivalNightTaskPopupViewTab1.prototype, "AcCarnivalNightTaskPopupViewTab1");
