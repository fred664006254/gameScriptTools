...
//  * desc : 累计充值itemrender
//  */
// class AcJarukaiChargeItem  extends ScrollListItem
// {
//     //item数据
...
//     private _rechargeItem : any = null;
//     public constructor()
//     {
//         super();
//     }
//     private get cfg() : Config.AcCfg.JarukaiCfg{
//         return Config.AcCfg.getCfgByActivityIdAndCode(this.aid, this.code);
//     }
//     private get vo() : AcJarukaiVo{
//         return <AcJarukaiVo>Api.acVoApi.getActivityVoByAidAndCode(this.aid, this.code);
//     }
//     private get acTivityId() : string{
//         return `${this.aid}-${this.code}`;
//     }
//     private get aid() : string{
//         return AcConst.AID_JARUKAI;
//     }
