 ...
 * author qianjun
 */
var AcChaseBanditChargeItem = (function (_super) {
    __extends(AcChaseBanditChargeItem, _super);
    function AcChaseBanditChargeItem() {
    ...
    Object.defineProperty(AcChaseBanditChargeItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcChaseBanditChargeItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcChaseBanditChargeItem.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcChaseBanditChargeItem.prototype, "code", {
        get: function () {
    ...
    AcChaseBanditChargeItem.prototype.getUiCode = function () {
        var code = '';
    ...
    Object.defineProperty(AcChaseBanditChargeItem.prototype, "acTivityId", {
        get: function () {
    ...
    AcChaseBanditChargeItem.prototype.initItem = function (index, data, itemParam) {
        var view = this;
        view._data = data;
        view.width = 518;
     ...
     * 获得
     */
    AcChaseBanditChargeItem.prototype.getTitleStr = function (type) {
        var strTop = null;
    ...
    AcChaseBanditChargeItem.prototype.buyHandler = function (param) {
        var view = this;
        if (!view.vo.isInActivity()) {
    ...
    AcChaseBanditChargeItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcChaseBanditChargeItem.prototype.dispose = function () {
        var view = this;
        view._data = null;
    ...
    return AcChaseBanditChargeItem;
}(ScrollListItem));
__reflect(AcChaseBanditChargeItem.prototype, "AcChaseBanditChargeItem");
