...
var AcSpringOutingAVGView = (function (_super) {
    __extends(AcSpringOutingAVGView, _super);
    function AcSpringOutingAVGView() {
    ...
    Object.defineProperty(AcSpringOutingAVGView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcSpringOutingAVGView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcSpringOutingAVGView.prototype, "acTivityId", {
        get: function () {
            return AcSpringOutingView.AID + "-" + AcSpringOutingView.CODE;
        },
        enumerable: true,
        configurable: true
    });
    AcSpringOutingAVGView.prototype.isShowOpenAni = function () {
        return false;
    };
    AcSpringOutingAVGView.prototype.getResourceList = function () {
        // test code
    ...
    AcSpringOutingAVGView.prototype.getTitleBgName = function () {
        return null;
    };
    AcSpringOutingAVGView.prototype.getTitleStr = function () {
        return null;
    };
    AcSpringOutingAVGView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcSpringOutingAVGView.prototype.getBgName = function () {
        return null;
    };
    AcSpringOutingAVGView.prototype.isShowMask = function () {
        return true;
    };
    AcSpringOutingAVGView.prototype.preInit = function () {
    ...
    AcSpringOutingAVGView.prototype.init = function () {
    ...
    AcSpringOutingAVGView.prototype.clickPage = function (evt) {
    ...
    AcSpringOutingAVGView.prototype.doNextStep = function (step) {
        var view = this;
        var nextId = null;
        if (step) {
            nextId = step;
    ...
    AcSpringOutingAVGView.prototype.showPage = function () {
        //this.doStepHandle();
        if (this._showManTab) {
        ...
        var needShoot = false;
        var codStr = "_code" + AcSpringOutingView.CODE;
        //底部 描述
        if (this._curConfig.descId) {
            ...
            if (this._curConfig.clickContinue) {
                ...
                this._codonLength = 0;
                this._descText.text = "";
                if (LanguageManager.checkHasKey("acSpringOutingAVGDialog" + this._curConfig.descId + codStr)) {
                    this._descContent = LanguageManager.getlocal("acSpringOutingAVGDialog" + this._curConfig.descId + codStr);
                }
                else {
                    this._descContent = LanguageManager.getlocal("acSpringOutingAVGDialog" + this._curConfig.descId + "_code1");
                }
                needShoot = true;
            }
            else {
                if (LanguageManager.checkHasKey("acSpringOutingAVGDialog" + this._curConfig.descId + codStr)) {
                    this._descText.text = LanguageManager.getlocal("acSpringOutingAVGDialog" + this._curConfig.descId + codStr);
                }
                else {
                    this._descText.text = LanguageManager.getlocal("acSpringOutingAVGDialog" + this._curConfig.descId + "_code1");
                }
    ...
    AcSpringOutingAVGView.prototype.clickSelectedHandler = function (event, branchBtn, step) {
        switch (event.type) {
    ...
    AcSpringOutingAVGView.prototype.changeBgCallBack = function () {
    ...
    AcSpringOutingAVGView.prototype.showShakeAnim = function () {
    ...
    AcSpringOutingAVGView.prototype.shakeScreen = function () {
    ...
    AcSpringOutingAVGView.prototype.showFogAnim = function () {
        this._myBg.y = 0;
    ...
    AcSpringOutingAVGView.prototype.textShootAnim = function () {
    ...
    AcSpringOutingAVGView.prototype.textAnim = function (t) {
    ...
    AcSpringOutingAVGView.prototype.skipAnim = function () {
        this.hide();
     ...
     * 收到通知 下一步
     */
    AcSpringOutingAVGView.prototype.noticeNextStep = function () {
        this.doNextStep();
    };
    AcSpringOutingAVGView.prototype.initView = function () {
    };
    AcSpringOutingAVGView.prototype.getParent = function () {
        return LayerManager.maskLayer;
    };
    AcSpringOutingAVGView.prototype.hide = function (isDispose) {
        var tempObj = this._obj;
        var tempFunc = this._callbackF;
        if (!isDispose) {
            if (tempObj && tempFunc) {
    ...
    AcSpringOutingAVGView.prototype.doStepHandle = function () {
        if (this._curIdx == "1") {
    ...
    AcSpringOutingAVGView.prototype.dispose = function () {
    ...
    return AcSpringOutingAVGView;
}(CommonView));
__reflect(AcSpringOutingAVGView.prototype, "AcSpringOutingAVGView");
