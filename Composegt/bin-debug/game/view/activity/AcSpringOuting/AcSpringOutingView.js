 ...
 * jiangliuyang
 */
var AcSpringOutingView = (function (_super) {
    __extends(AcSpringOutingView, _super);
    function AcSpringOutingView() {
        ...
        _this._numBg = null;
        _this._animMap = null;
        _this._luckAnim = null;
        _this._resiTimeText = null;
        _this._progressAnim = null;
        _this._taskHand = null;
        _this._baseX = 0;
        _this._baseY = 0;
        _this._luckText = null;
        _this._luckValueText = null;
        _this._tiliText = null;
    ...
    Object.defineProperty(AcSpringOutingView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcSpringOutingView.prototype, "acVo", {
        get: function () {
    ...
    AcSpringOutingView.prototype.isShowOpenAni = function () {
        return false;
    };
    AcSpringOutingView.prototype.initView = function () {
        ...
        if (this.code == "1" || this.code == "2") {
            var titleFont = BaseLoadBitmap.create(this.getDefaultRes("acspringouting_titletxt"));
            titleFont.width = 181;
            titleFont.height = 64;
            titleFont.x = GameConfig.stageWidth / 2 - titleFont.width / 2;
            titleFont.y = 4;
            this.addChild(titleFont);
            var timeBg = BaseLoadBitmap.create(this.getDefaultRes("acspringouting_titlebg"));
            timeBg.width = 640;
            timeBg.height = 71;
            timeBg.x = 0;
            timeBg.y = 72;
            this.addChild(timeBg);
            var timeText = ComponentManager.getTextField(LanguageManager.getlocal("acSpringOutingTime", [this.acVo.acTimeAndHour]), 20, TextFieldConst.COLOR_WHITE);
            timeText.x = 20;
            ...
            var taskBtnText = BaseBitmap.create(this.getDefaultRes("acspringouting_taskname"));
            ...
            var countBg = BaseBitmap.create(this.getDefaultRes("acspringouting_countbg"));
            App.DisplayUtil.setLayoutPosition(LayoutConst.righttop, countBg, timeBg, [10, timeBg.height + 40]);
            this.addChild(countBg);
            var countIcon = BaseBitmap.create(this.getDefaultRes("acspringouting_icon"));
            ...
            if (this.code == "1" && App.CommonUtil.check_dragon() && RES.hasRes("yinghuapiaopiao_ske")) {
                var flowerBoneNode = App.DragonBonesUtil.getLoadDragonBones("yinghuapiaopiao"); //xuehua_piaopiao actigertrappass
            ...
            if (App.CommonUtil.check_dragon() && !Api.switchVoApi.checkCloseBone() && RES.hasRes("wife_full3_1071_ske")) {
                var droWifeIcon = App.DragonBonesUtil.getLoadDragonBones("wife_full3_1071");
                ...
                // wife 的 图片
                var scaleNum = 0.7;
                var wifeBM = BaseLoadBitmap.create("wife_skin_1071");
                wifeBM.width = 640;
                wifeBM.height = 840;
            ...
            var talkBg = BaseBitmap.create("public_9v_bg11_2");
            talkBg.width = 180;
            talkBg.height = 120;
            talkBg.scaleX = -1;
            ...
            var talk = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acSpringOutingPeople")), 18, TextFieldConst.COLOR_BROWN);
            talk.width = 150;
            ...
            var bottomTip = BaseBitmap.create("public_9_bg8");
            ...
            var bottomTipText = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acSpringOutingBottomTipText"), [this.cfg.getRechargeCost() + "", "1"]), 22, TextFieldConst.COLOR_LIGHT_YELLOW);
            ...
            var luckBg = BaseBitmap.create(this.getDefaultRes("acspringouting_rightbg"));
            ...
            var luckText = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acSpringOutingLuckText")), 20, TextFieldConst.COLOR_WHITE);
            ...
            var onceBtn = ComponentManager.getButton(ButtonConst.BTN_BIG_BLUE, this.getDefaultCn("acSpringOutingOnceText"), this.onceBtnClick, this);
            App.DisplayUtil.setLayoutPosition(LayoutConst.leftbottom, onceBtn, bottom, [60, 7]);
            this.addChild(onceBtn);
            var tenBtn = ComponentManager.getButton(ButtonConst.BTN_BIG_YELLOW, this.getDefaultCn("acSpringOutingTenText"), this.tenBtnClick, this);
            App.DisplayUtil.setLayoutPosition(LayoutConst.rightbottom, tenBtn, bottom, [60, 7]);
            this.addChild(tenBtn);
            var onceIcon = BaseBitmap.create(this.getDefaultRes("acspringouting_icon"));
            onceIcon.setScale(0.8);
            var onceText = ComponentManager.getTextField(this.cfg.cost + "", 20, TextFieldConst.COLOR_LIGHT_YELLOW);
            ...
            var tenIcon = BaseBitmap.create(this.getDefaultRes("acspringouting_icon"));
            tenIcon.setScale(0.8);
            var tenText = ComponentManager.getTextField(this.cfg.cost * 10 + "", 20, TextFieldConst.COLOR_LIGHT_YELLOW);
            ...
            for (var i = 0; i < this.cfg.lotteryNum.length; i++) {
                ...
                var imgresbg = this.getDefaultRes("acspringouting_heartbg");
                var imgres = this.getDefaultRes("acspringouting_heart");
                var lightres = "";
                ...
                var boxImgBg = BaseBitmap.create(imgresbg);
                var boxImg = BaseBitmap.create(imgres);
                var lightClip = ComponentManager.getCustomMovieClip(lightres, 6, 200);
            ...
            this.addChild(this._resiTimeText);
            var descText = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acSpringOutingDesc")), 20, TextFieldConst.COLOR_WHITE);
            descText.width = 600;
            ...
            if (App.CommonUtil.check_dragon() && !Api.switchVoApi.checkCloseBone() && RES.hasRes("wife_full3_2201_ske")) {
                var droWifeIcon = App.DragonBonesUtil.getLoadDragonBones("wife_full3_2201");
                ...
                // wife 的 图片
                var scaleNum = 0.6;
                var wifeBM = BaseLoadBitmap.create("wife_skin_2201");
                wifeBM.width = 640;
                wifeBM.height = 840;
                wifeBM.setScale(scaleNum);
                wifeBM.x = 0;
            ...
            var bottom = BaseBitmap.create(this.getDefaultRes("acspringouting_bottombg"));
            bottom.name = "bottom";
            bottom.x = 0;
            bottom.y = GameConfig.stageHeigth - bottom.height;
            this.addChild(bottom);
            var talkBg = BaseBitmap.create(this.getDefaultRes("acspringouting_talkbg"));
            // talkBg.width = 180;
            // talkBg.height = 120;
            // talkBg.scaleX = -1;
            talkBg.x = 320;
            ...
            this.addChild(luckBg);
            var luckText = ComponentManager.getTextField(LanguageManager.getlocal(this.getDefaultCn("acSpringOutingLuckText")), 18, TextFieldConst.COLOR_WHITE);
            ...
            var onceBtn = ComponentManager.getButton(this.getDefaultRes("acspringouting_bluebtn"), this.getDefaultCn("acSpringOutingOnceText"), this.onceBtnClick, this);
            ...
            this.addChild(onceBtn);
            var tenBtn = ComponentManager.getButton(this.getDefaultRes("acspringouting_yellowbtn"), this.getDefaultCn("acSpringOutingTenText"), this.tenBtnClick, this);
            ...
            this.addChild(tenBtn);
            var line = BaseBitmap.create(this.getDefaultRes("acspringouting_line"));
            ...
            this.addChild(tenText);
            this._animMap = {};
            var maxDrawNum = this.cfg.lotteryNum[this.cfg.lotteryNum.length - 1]["needNum"];
            // 宝箱
            for (var i = 0; i < this.cfg.lotteryNum.length; i++) {
                var tmprcfg = this.cfg.lotteryNum[i];
                var rStatus = 1;
                ...
                var imgres = this.getDefaultRes("acspringouting_bag1");
                if (rStatus == 3) {
    ...
    AcSpringOutingView.prototype.refreshData = function () {
        if (this.code == "1" || this.code == "2") {
            ...
            for (var i = 0; i < this.cfg.lotteryNum.length; i++) {
                var boxImg = this.getChildByName("boxImg" + i);
                var lightImg = this.getChildByName("lightImg" + i); //this.getChildByName("lightClip"+i);
                var tmprcfg = this.cfg.lotteryNum[i];
                var rStatus = 1;
                if (this.acVo.ainfo.stageinfo[i + 1]) {
                    rStatus = 3; // 已领取
    ...
    AcSpringOutingView.prototype.startNumShow = function () {
        if (!this._numBg) {
    ...
    // 关闭按钮图标名称
    AcSpringOutingView.prototype.getCloseBtnName = function () {
        if (this.code == "1" || this.code == "2") {
    ...
    AcSpringOutingView.prototype.refreshNum = function () {
        var _this = this;
        // if(this.code == "1" || this.code == "2"){
        this._numText.text = this.acVo.getLotteryNum() + "";
        ...
        egret.Tween.get(this._numBg)
            ...
            .wait(5000)
            .call(function () {
            egret.Tween.removeTweens(_this._numBg);
        }, this);
        egret.Tween.get(this._numText)
            ...
            .wait(5000)
            .call(function () {
            egret.Tween.removeTweens(_this._numText);
            _this.refreshNum();
        }, this);
        // } else if(this.code == "3"){
        //     this._luckValueText.text = this.acVo.getLotteryNum()+"";
    ...
    AcSpringOutingView.prototype.taskBtnClick = function () {
    ...
    AcSpringOutingView.prototype.onceBtnClick = function () {
        this.doClick(1);
    };
    AcSpringOutingView.prototype.tenBtnClick = function () {
        this.doClick(10);
    };
    AcSpringOutingView.prototype.doClick = function (count) {
        if (!this.acVo.isInActivity()) {
            App.CommonUtil.showTip(LanguageManager.getlocal('acPunishEnd'));
            return;
        }
    ...
    AcSpringOutingView.prototype.boxClick = function (event, index) {
        if (!this.acVo.isInActivity()) {
            App.CommonUtil.showTip(LanguageManager.getlocal('acPunishEnd'));
            return;
        }
    ...
    // 获得奖励
    AcSpringOutingView.prototype.getRewardHandler = function (event) {
        var _this = this;
        if (this.code == "1" || this.code == "2") {
            if (event.data.data.cmd === NetRequestConst.REQUEST_ACTIVITY_GETSPRINGOUTINGREWARD) {
                if (event.data.data.ret === 0) {
                    ...
                    egret.setTimeout(function () {
                        _this._luckAnim.visible = false;
                        ViewController.getInstance().openView(ViewConst.POPUP.ACSPRINGOUTINGLUCKUPPOPUPVIEW, {
                            data: {
                                rewards: data_1.rewards,
                                otherRewards: data_1.otherrewards,
                                isPlayAni: true,
                                showTip: data_1.isluck > 0 ? LanguageManager.getlocal("acHuLaoBaoji") : null,
                            },
                            callback: _this.showReward,
                            target: _this
                        });
                    }, this, 300);
                }
    ...
    AcSpringOutingView.prototype.showReward = function (data) {
        ViewController.getInstance().openView(ViewConst.POPUP.COMMONREWARDPOPUPVIEW, data);
    };
    // 获得宝箱奖励
    AcSpringOutingView.prototype.getNumRewardHandler = function (event) {
    ...
    AcSpringOutingView.prototype.showFirstDialog = function () {
        if (!this.acVo.getFirstOpen()) {
            var posX = this._baseX;
            var posY = this._baseY;
    ...
    // 大门客说话
    AcSpringOutingView.prototype.showDialog = function (index) {
        var _this = this;
        if (this.acVo.getAvgConfig(index, this.code)) {
            ViewController.getInstance().openView(ViewConst.BASE.ACSPRINGOUTINGAVGVIEW, {
                f: function () {
                    NetManager.request(NetRequestConst.REQUEST_ACTIVITY_GETSPRINGOUTINGBOXREWARD, { "activeId": _this.aid + "-" + _this.code, "gid": index + 1 });
                },
                o: this,
                idx: 1,
                buidId: index,
    ...
    //标题背景
    AcSpringOutingView.prototype.getTitleBgName = function () {
        return this.getDefaultRes("acspringouting_title");
    };
    //根据资源名字得到完整资源名字
    AcSpringOutingView.prototype.getDefaultRes = function (resName, defaultCode) {
    ...
    AcSpringOutingView.prototype.getDefaultCn = function (cnName, defaultCode) {
        defaultCode = defaultCode || "1";
    ...
    AcSpringOutingView.prototype.getTitleStr = function () {
        return null;
    };
    AcSpringOutingView.prototype.tick = function () {
        if (this.code == "1" || this.code == "2") {
            var deltaT = this.acVo.et - GameData.serverTime;
    ...
    //放礼花
    AcSpringOutingView.prototype.showLihua = function () {
    ...
    AcSpringOutingView.prototype.createLihua = function () {
        ...
        var x = 100 + Math.floor(Math.random() * 440);
        var y = Math.floor(Math.random() * this._buildCountainer.height - 102 * scale / 2);
    ...
    // 背景图名称
    AcSpringOutingView.prototype.getBgName = function () {
        return this.getDefaultRes("acspringouting_bg");
    };
    AcSpringOutingView.prototype.initBg = function () {
    ...
    AcSpringOutingView.prototype.getResourceList = function () {
        if (this.code == "1" || this.code == "2") {
    ...
    AcSpringOutingView.prototype.dispose = function () {
    ...
    AcSpringOutingView.AID = null;
    AcSpringOutingView.CODE = null;
    return AcSpringOutingView;
}(AcCommonView));
__reflect(AcSpringOutingView.prototype, "AcSpringOutingView");
