...
var FourRechargeShowView = (function (_super) {
    __extends(FourRechargeShowView, _super);
    function FourRechargeShowView() {
        var _this = _super.call(this) || this;
        _this._mySkinProTxtList = [];
        return _this;
    }
    FourRechargeShowView.prototype.getDefaultCn = function (cnName, defaultCode) {
        return cnName;
    };
    FourRechargeShowView.prototype.initView = function () {
        ...
        var infobg = { y: 0 };
        var tabList = [];
        tabList.push(this.getDefaultCn("fourRechargeShowViewTab1"));
        tabList.push(this.getDefaultCn("fourRechargeShowViewTab2"));
    ...
    FourRechargeShowView.prototype.createNode = function () {
        var cfg72 = Config.RechargeCfg.getRechargeItemCfgByKey("g72");
        var rewardItemVoList = GameData.formatRewardItem(cfg72.getReward);
        var type19Id = 1;
        var type16Id = 1;
        ...
        this.wifeSkinId = type16Id;
        this.servantSkinId = type19Id;
        this.createWife();
        this.createServant();
    };
    FourRechargeShowView.prototype.createWife = function () {
        ...
        wifeSkincfg = Config.WifeskinCfg.getWifeCfgById(this.wifeSkinId);
        ...
        if (!Api.switchVoApi.checkCloseBone() && bone && boneName && RES.hasRes(boneName) && App.CommonUtil.check_dragon()) {
    ...
    FourRechargeShowView.prototype.createServant = function () {
        ...
        skinW = 640;
        skinH = 482;
        serSkincfg = Config.ServantskinCfg.getServantSkinItemById(this.servantSkinId);
    ...
    FourRechargeShowView.prototype.tabBtnClickHandler2 = function (params) {
    ...
    FourRechargeShowView.prototype.refreshSkinInfo = function () {
    ...
    FourRechargeShowView.prototype.getServantBookStars = function (num) {
    ...
    FourRechargeShowView.prototype.getResourceList = function () {
    ...
    FourRechargeShowView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return FourRechargeShowView;
}(CommonView));
__reflect(FourRechargeShowView.prototype, "FourRechargeShowView");
