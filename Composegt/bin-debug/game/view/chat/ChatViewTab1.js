...
var ChatViewTab1 = (function (_super) {
    ...
    ChatViewTab1.prototype.selectHandler1 = function () {
    ...
    ChatViewTab1.prototype.refreshChat2 = function () {
        var chatList = Api.chatVoApi.getWorldList();
        this._scrollList.refreshData(chatList);
        this._scrollList.moveToButtom();
    };
    ...
    ChatViewTab1.prototype.receiveData = function (data) {
        if (data.ret == false) {
            return;
        }
        ...
        if (PlatformManager.checkIsWxmgSp() && data.data.data.msg && data.data.data.msg && data.data.data.msg.data && data.data.data.msg.data.result == 1) {
            App.CommonUtil.showTip(LanguageManager.getlocal("chatShieldTip"));
            return;
        }
        ...
        if (PlatformManager.checkIsWxmgSp() || PlatformManager.checkIsJPSp() || PlatformManager.checkIsWdSp()) {
            ...
            this._lastMsg = null;
            PlatformManager.analytics37JPPoint("custom_social", "local_send_msg", 1);
