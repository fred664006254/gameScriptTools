...
var ChatScrollItem = (function (_super) {
    ...
    ChatScrollItem.prototype.initItem = function (index, chatData) {
        ...
        var posStr = "head_circle_bg"; //chatData.content.headID;
        ...
        var head = this._posContainer.getChildByName("myHead");
        ...
        var isKing = (chatData.content.ket > 0);
        if (isKing) {
        ...
        //时间
        var timeDis = GameData.serverTime;
        if (chatData.ts) {
        ...
        var timeTF = ComponentManager.getTextField(App.DateUtil.getFormatBySecond(timeDis, 4), TextFieldConst.FONTSIZE_CONTENT_SMALL);
    ...
    ChatScrollItem.prototype.initShareInfo = function (itemBg, isself) {
        ...
        var iconBg = BaseBitmap.create("chat_share_bg_" + ((this._stype == 3) ? this._chatData.content.sinfo.sex : "3"));
        ...
        if (this._stype == 1) {
            ...
            var icon = BaseLoadBitmap.create(this._chatData.content.sinfo.dtype == "1" ? "itemicon1501" : "itemicon1511");
        ...
        var goTo = ComponentManager.getTextField("", TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_QUALITY_RED);
        goTo.textFlow = new Array({ text: lineStr, style: { "underline": true } });
    ...
    ChatScrollItem.prototype.requiestCallback2 = function (p) {
        ...
        var checkChatTime = this._chatData.ts;
