...
(function (App) {
    ...
    var ShareGuideUtil = (function () {
        ...
        ShareGuideUtil.SHARETYPE_SHARE_HAIZI = "share_haizi"; //情景强弹分享第一次生孩子弹出
        ShareGuideUtil.SHARETYPE_SHARE_RICHANG = "share_richang"; //府邸常驻每日5次分享
        ShareGuideUtil.SHARETYPE_SHARE_MEIREN = "share_meiren"; //情景强弹分享第一次迎娶非小怜红颜弹出
        ShareGuideUtil.SHARETYPE_SHARE_MENKE = "share_menke"; //情景强弹分享第一次获得门客弹出
        ShareGuideUtil.SHARETYPE_SHARE_GUIDE = "share_guide"; //新手引导阶段送v3的强弹分享
        ShareGuideUtil.SHARETYPE_SHARE_LVUP = "share_lvup"; //情景强弹分享官品提升弹出
        ShareGuideUtil.SHARETYPE_SHARE_MENKEAUTO = "share_menke.auto"; //获得门客时默认勾选的自动分享
        ShareGuideUtil.SHARETYPE_SHARE_MEIRENAUTO = "share_meiren.auto"; //获得红颜时默认勾选的自动分享
        ShareGuideUtil.SHARETYPE_SHARE_INVITE = "share_invite"; //邀请好友分享
        ShareGuideUtil.SHARETYPE_SHARE_SEVENDAYAUTO = "share_sevenday.auto"; //七天自动分享
        ShareGuideUtil.SHARETYPE_SHARE_GUANKA = "share_guanka"; //关卡分享
        ShareGuideUtil.SHARETYPE_SHARE_JINGYING = "share_jingying"; //经营分享
        ShareGuideUtil.SHARETYPE_SHARE_TWITTERDAILY = "share_twitterdaily"; //twitter每日分享
        /** 官位提升 */
