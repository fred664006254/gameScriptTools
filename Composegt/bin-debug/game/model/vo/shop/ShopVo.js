...
var ShopVo = (function (_super) {
    ...
    function ShopVo() {
        ...
        _this.specialShopInfoVoObj = null;
        /**vip奖励领取信息
        ...
        _this.opentime = 0;
        _this.mergezonetime = 0;
        _this.secondRateCharge = 0;
        _this.threeCharge = 0;
        _this.fourCharge = 0;
        return _this;
    }
    ...
    ShopVo.prototype.dispose = function () {
        ...
        if (this.specialShopInfoVoObj) {
            for (var key in this.specialShopInfoVoObj) {
