...
var AcCrossServerWipeBossVo = (function (_super) {
    __extends(AcCrossServerWipeBossVo, _super);
    function AcCrossServerWipeBossVo() {
    ...
    AcCrossServerWipeBossVo.prototype.initData = function (data) {
        ...
        this.iscanjoin = data.iscanjoin;
        App.MessageHelper.dispatchEvent(MessageConst.MESSAGE_CROSSSERVERWIPEBOSS_REFRESH);
    };
    AcCrossServerWipeBossVo.prototype.dispose = function () {
        this.ainfo = null;
        this.binfo = null;
        this.cinfo = null;
        this.buysearch = 0;
    ...
    //是否有资格
    AcCrossServerWipeBossVo.prototype.isCanJoin = function () {
        return this.iscanjoin == 1;
    };
    AcCrossServerWipeBossVo.prototype.getServantFightInfo = function (servantId) {
    ...
    Object.defineProperty(AcCrossServerWipeBossVo.prototype, "cfg", {
        get: function () {
    ...
    AcCrossServerWipeBossVo.prototype.getpublicRedhot1 = function () {
        var flag = false;
        //有探索次数
    ...
    AcCrossServerWipeBossVo.prototype.getpublicRedhot2 = function () {
        var flag = false;
        //有可积分兑换的
    ...
    AcCrossServerWipeBossVo.prototype.getBuySearchNum = function () {
        return this.buysearch;
    };
    Object.defineProperty(AcCrossServerWipeBossVo.prototype, "isShowRedDot", {
        get: function () {
            for (var i = 1; i < 3; ++i) {
     ...
     * 鳌拜活动 今日加成
    */
    AcCrossServerWipeBossVo.prototype.getMyAdd = function () {
        var effect = this.cfg.actMarket[0].effect;
        var num = this.ainfo[1] || 0;
        return num * 100 * effect;
    };
    Object.defineProperty(AcCrossServerWipeBossVo.prototype, "acTimeAndHour", {
        get: function () {
    ...
    AcCrossServerWipeBossVo.prototype.getCountDownTime = function () {
        var et = this.et - 86400;
        return et - GameData.serverTime;
    };
    AcCrossServerWipeBossVo.prototype.isInActivity = function () {
        return GameData.serverTime >= this.st && GameData.serverTime < this.et;
    };
    AcCrossServerWipeBossVo.prototype.isInTansuoTime = function () {
        return GameData.serverTime >= this.st && GameData.serverTime < this.et - 86400;
    };
    AcCrossServerWipeBossVo.prototype.isInFightTime = function () {
        var cfg = this.cfg;
    ...
    AcCrossServerWipeBossVo.prototype.getNextOpenTime = function () {
        var cfg = this.cfg;
        var today0 = App.DateUtil.getWeeTs(GameData.serverTime);
        var time = 0;
    ...
    AcCrossServerWipeBossVo.prototype.getArr = function (key) {
        var arr = [];
    ...
    //获取元宝商店限购物品次数
    AcCrossServerWipeBossVo.prototype.getShopBuyLimitnum = function (id) {
        var info = this.ainfo;
        var buyNum = 0;
        if (info && info[id]) {
            buyNum += info[id];
    ...
    //获取积分兑换物品次数
    AcCrossServerWipeBossVo.prototype.getPointChangeLimitnum = function (id) {
        var info = this.binfo;
        var buyNum = 0;
        if (info && info[id]) {
            buyNum += info[id];
    ...
    AcCrossServerWipeBossVo.prototype.getActPoints = function () {
    ...
    */
    AcCrossServerWipeBossVo.prototype.getTanSuoNum = function () {
        var obj = {};
        ...
        var killAll = Api.crossServerWipeBossVoApi.getIsKillAll();
        obj['killAll'] = killAll;
        if (num > 0) {
            obj['num'] = num;
        }
     ...
     * 鳌拜活动 宝箱钥匙
    */
    AcCrossServerWipeBossVo.prototype.getWipeBossBoxKeyNum = function (boxId) {
        var itemid = this.cfg.getBossNpcItemCfgById(boxId).needKey;
        return Api.itemVoApi.getItemNumInfoVoById(itemid);
    };
    /**
     */
    AcCrossServerWipeBossVo.prototype.getWipeBossMaxHp = function (id) {
        if (this.bossMaxHp) {
    ...
    return AcCrossServerWipeBossVo;
}(AcBaseVo));
__reflect(AcCrossServerWipeBossVo.prototype, "AcCrossServerWipeBossVo");
