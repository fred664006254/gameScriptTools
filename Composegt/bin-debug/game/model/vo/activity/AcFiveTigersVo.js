...
var AcFiveTigersVo = (function (_super) {
    __extends(AcFiveTigersVo, _super);
    function AcFiveTigersVo() {
    ...
    AcFiveTigersVo.prototype.initData = function (data) {
        for (var key in data) {
            this[key] = data[key];
        }
        App.MessageHelper.dispatchEvent(MessageConst.MESSAGE_FIVETIGERS_REFRESHVO);
    };
    Object.defineProperty(AcFiveTigersVo.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcFiveTigersVo.prototype, "acCountDown", {
        get: function () {
    ...
    Object.defineProperty(AcFiveTigersVo.prototype, "isShowRedDot", {
        get: function () {
            if (!this.cfg) {
                return false;
            }
    ...
    AcFiveTigersVo.prototype.checkBoxCollected = function (boxIndex) {
        if (this.stageinfo[boxIndex + 1]) {
            return true;
        }
        return false;
    };
    AcFiveTigersVo.prototype.maxHelmetNeedNum = function () {
        return this.cfg.exchangeNum;
    };
    Object.defineProperty(AcFiveTigersVo.prototype, "acTimeAndHour", {
        get: function () {
            var et = this.et;
    ...
    AcFiveTigersVo.prototype.isInActivity = function () {
        return GameData.serverTime >= this.st && GameData.serverTime < this.et;
    };
    AcFiveTigersVo.prototype.dispose = function () {
        this.v = null;
        // 红莲勇士 玩家本次活动获得头盔数
        this.thenum = null;
        // 红莲勇士 玩家剩余可突击次数
    ...
    return AcFiveTigersVo;
}(AcBaseVo));
__reflect(AcFiveTigersVo.prototype, "AcFiveTigersVo");
