...
var AcDailyChargeExtraVo = (function (_super) {
    __extends(AcDailyChargeExtraVo, _super);
    function AcDailyChargeExtraVo() {
    ...
    AcDailyChargeExtraVo.prototype.initData = function (data) {
        var oldV = this.v;
        for (var key in data) {
            this[key] = data[key];
        }
    ...
    Object.defineProperty(AcDailyChargeExtraVo.prototype, "isShowRedDot", {
        get: function () {
    ...
    AcDailyChargeExtraVo.prototype.getLjNum = function (isSpecial) {
    ...
    Object.defineProperty(AcDailyChargeExtraVo.prototype, "maxSwitchNum", {
        //当前开关最大档位
        get: function () {
            var _maxNumb = 0;
    ...
    AcDailyChargeExtraVo.prototype.dispose = function () {
        this.v = 0;
        this.flags = {};
    };
    return AcDailyChargeExtraVo;
}(AcBaseVo));
__reflect(AcDailyChargeExtraVo.prototype, "AcDailyChargeExtraVo");
