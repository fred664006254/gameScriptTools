...
(function (Config) {
    var AcCfg;
    (function (AcCfg) {
        var StargazerSingleCfg = (function () {
            function StargazerSingleCfg() {
                //搜查奸臣配置
                //充值X元宝获得1次搜查次数
                this.cost = undefined;
                //单次搜查证物分布空间
            ...
            StargazerSingleCfg.prototype.formatData = function (data) {
                for (var key in data) {
            ...
            StargazerSingleCfg.prototype.getRewardSkinId = function () {
                return this.TraitorSkinId;
                // return this.RansackReward.split("_")[1];
            };
            return StargazerSingleCfg;
        }());
        AcCfg.StargazerSingleCfg = StargazerSingleCfg;
        __reflect(StargazerSingleCfg.prototype, "Config.AcCfg.StargazerSingleCfg");
