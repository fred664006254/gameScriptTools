...
var SearchVoApi = (function (_super) {
    ...
    SearchVoApi.prototype.checkNpcMessage = function () {
        return this.getSearchNum() > 0 && this.isShowNpc();
    };
    /**
     * 根据personid获取红颜获取进度
     * @param personId
    ...
    SearchVoApi.prototype.getPersonValueLocalStr = function (personId) {
        ...
        if (itemCfg.servantId && itemCfg.value) {
            ...
            var descStr = "";
            if (value <= 0.3) {
                descStr = "searchServantDesc1";
            }
            else if (value > 0.3 && value <= 0.6) {
                descStr = "searchServantDesc2";
            }
            else if (value > 0.6 && value < 1) {
                descStr = "searchServantDesc3";
            }
            else if (value) {
                descStr = "searchServantDesc4";
            }
            return LanguageManager.getlocal(descStr, [itemCfg.name]);
        }
        return "";
    ...
    SearchVoApi.prototype.isShowNpc = function () {
        return Api.composemapVoApi.getMaxLv() >= Config.SearchbaseCfg.needLv;
        // return true
    };
    SearchVoApi.prototype.getLockedString = function () {
        return LanguageManager.getlocal("composeUnlockFuncDesc", [Config.SearchbaseCfg.needLv + ""]);
    };
    SearchVoApi.prototype.getUnlockPersonLimit = function () {
        return Config.SearchbaseCfg.needLv;
    };
    /**
     * 检测是否可以一键寻访了
     */
    SearchVoApi.prototype.checkOneKey = function () {
        ...
        return Api.playerVoApi.getPlayerVipLevel() >= needVip;
        // } 
