...
var FriendVoApi = (function (_super) {
    ...
    FriendVoApi.prototype.checkNpcMessage = function () {
        // return true;
        if (this.friendVo && GameConfig.config.friendCfg.needLv <= Api.playerVoApi.getPlayerLevel()) {
            return true;
        }
        return false;
    };
    ...
    FriendVoApi.prototype.getGetFriendVo = function () {
    ...
    FriendVoApi.prototype.isShowRedForItem3 = function () {
        // return false;
        return this.friendVo && this.friendVo.receive && Object.keys(this.friendVo.receive).length > 0;
    };
    FriendVoApi.prototype.getFriendsCount = function () {
        return this.friendVo.info && Object.keys(this.friendVo.info).length;
    };
    FriendVoApi.prototype.getApplyCount = function () {
        return this.friendVo.apply && Object.keys(this.friendVo.apply).length;
    };
