...
var Main = (function (_super) {
    ...
    Main.prototype.onAddToStage = function (event) {
        ...
        if (App.DeviceUtil.IsHtml5()) {
            var realResetStageText_1 = egret.web["HTML5StageText"].prototype.$resetStageText;
            egret.web["HTML5StageText"].prototype.$resetStageText = function () {
                realResetStageText_1.call(this);
        ...
        if (App.DeviceUtil.isRuntime2()) {
            ...
            var logoUrl = "loading/loading.png";
            var loginLogo_1 = BaseLoadBitmap.create(logoUrl, null, { callback: function () {
                    loginLogo_1.setScale(1.5);
                    loginLogo_1.setPosition((GameConfig.stageWidth - loginLogo_1.width * loginLogo_1.scaleX) * 0.5, 200 + GameData.layerPosY);
...
window.addEventListener('orientationchange', function () {
    ...
    if (window.orientation + "" != "0") {
        ...
        var txt = ComponentManager.getTextField("竖屏游戏获得更好的体验", TextFieldConst.FONTSIZE_BUTTON_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
