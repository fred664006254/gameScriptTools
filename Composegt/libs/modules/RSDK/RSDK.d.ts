declare namespace RSDK
{
    ...
    function share(content:{shareType:string,title:string,desc:string,imageurl?:string,link?:string,ext?:string},callback:(code:string,data:any)=>void):void;
    function getAppid():string;
    function getChannelId():string;
    function customerService(data?:{showMessageCard:boolean, sendMessageTitle:string, sendMessageImg:string}):void;
    function checkFollow():boolean;
    function requestFollow(callback?:(data:any)=>void):void;
    function setShareInfo(content:{shareType:string,title:string,desc:string,imageurl?:string,link?:string,ext?:string},uid:string):void;
    ...
    function startPush(callback:(data:any)=>void):void;
}
declare namespace rsdkclientplugin
{
    ...
    function sqSDKPresentUserCenterView():void;
}
