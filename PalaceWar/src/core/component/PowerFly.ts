...
class PowerFly extends BaseDisplayObjectContainer
{
	...
	{	
		...
		let msgTF:BaseBitmapText|BaseTextField = ComponentManager.getBitmapText(message,"crit_fnt",TextFieldConst.COLOR_LIGHT_YELLOW,TextFieldConst.FONTSIZE_TITLE_BIG);
		if(PlatformManager.checkIsThSp()||PlatformManager.checkIsRuSp() )
		{
