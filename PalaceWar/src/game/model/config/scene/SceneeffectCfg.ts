namespace Config
{
    export namespace SceneeffectCfg 
	{
        let effectCfg:any = {
            "202":{
                "childa":[{"pos":{"x":397,"y":575},"frames":6}], //帮会门前的小孩
                "oldsmoker":[{"pos":{"x":136,"y":594},"frames":6}], //排行榜前的蓝衣抽烟老男人
                "oldman":[{"pos":{"x":112,"y":602},"frames":6}], //排行榜前的黄衣男人
                "cop":[{"pos":{"x":166,"y":592},"frames":1,"timeinter":[10,20]},{"frames":6,"endcall":true}], //排行榜前的捕快
                //城门守卫
             ...
             "203":{
                "childa":[{"pos":{"x":451,"y":728},"frames":6}], //帮会门前的小孩
                "oldsmoker":[{"pos":{"x":157,"y":622},"frames":6}], //排行榜前的蓝衣抽烟老男人
                "cop":[{"pos":{"x":213,"y":612},"frames":1,"timeinter":[10,20]},{"frames":6,"endcall":true}], //排行榜前的捕快
                "walkman":[{"pos":{"x":0,"y":677},"pos2":{"x":471,"y":578},"frames":6,"movetime":47},{"pos":{"x":471,"y":578},"pos2":{"x":0,"y":677},"frames":6,"movetime":47},],
             },
             "204":{
                 "oldman":[{"pos":{"x":190,"y":622},"frames":6}], //排行榜前的黄衣男人
                ...
                //  "stevedore":[{"pos":{"x":385,"y":393},"frames":12}], 
             },
              "303":{
        ...
        let showCfg:any = {
            ...
            "204":{
                "s1":["oldman","dageng_1","dageng_2","debate"],//,"stevedore"
            },
            "303":{
        ...
        export function getEffectCfg(key:string,sceneId:string):any[]
	    {
            return effectCfg[sceneId][key];
        }

        export function getShowCfg(key:string,sceneId:string):string[]
	    {   
            if (!showCfg[sceneId])
            {
                return [];
        ...
        export function getCommonCfg(sceneId:string):Object
	    {   
        ...
        export function hasSceneEffect(sceneId:string):boolean
	    {
            return showCfg[sceneId] || boneCfg[sceneId];//
        }

        export function hasCommonEff(sceneId:string):boolean
	    {
            let cfg = {
                kr : {},
                th : {102 : 1, 103 : 1},
            ...
            let spid = PlatformManager.getSpid();
            if(cfg[spid]){
                if(cfg[spid][sceneId]){
                    return true;//
                }
        ...
        export function hasSceneBone(key:string,sceneId:string):boolean
	    {
            return  boneCfg[sceneId] && boneCfg[sceneId]["s"+key];
        }

         export function getBoneCfg(key:string,sceneId:string):string
	    {
