namespace Config
{
	export namespace AcCfg
	{
		export class MarryCfg 
		{
            ...
            private battleUseItemCfgList:BattleUseItemCfg[]= [];

            private battleItemCfgList:BattleItemCfg[] = [];
            /**
             * 初始化数据
             */
             ...
             * 宝箱
             */
            public getBattleItemCfgList():BattleItemCfg[]
            {
                return this.battleItemCfgList;
            }

            public getBattleUseItemCfgList():BattleUseItemCfg[]
            {
         ...
         * 消耗的
         */
        export class BattleUseItemCfg extends BaseItemCfg
		{
            /**ID */
			public id:string;
			/**
        ...
        export class BattleItemCfg extends BaseItemCfg
		{
            /**iD */
			public id:string;
			/**
