...
class AtkraceCrossFengyunRankListView extends PopupView
{	
    ...
    public initView():void
	{
		...
		let tabName = ["crossAtkraceRankListViewTab1","crossAtkraceRankListViewTab2"];

		let tabbarGroup = this.tabbarGroup;

		let rankBg:BaseBitmap = BaseBitmap.create("public_9_bg93");
		rankBg.width = 530;
		rankBg.height = 586;
