//助威
class AcCrossAtkraceCheerViewTab2 extends CommonViewTab
{
	...
	protected initView():void
	{
        ...
        let flagNum = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossAtkraceCheerflag", this.getUiCode()) ,[String(fNum)]),24,TextFieldConst.COLOR_WHITE);
        ...
        let info = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossAtkraceCheerInfo", this.getUiCode())),TextFieldConst.FONTSIZE_CONTENT_COMMON ,TextFieldConst.COLOR_WHITE);
        info.width = 600;
        info.lineSpacing = 5;
        info.x = scoreNum.x;
        ...
        let redPlusTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossAtkraceCheerAddPower", this.getUiCode())),20,TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        let playerAddTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossAtkraceCheerSelfNum", this.getUiCode())),20,TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        let list:any[] = [];
        let rankData = Api.atkracecrossVoApi.flagRankInfo;
        if (rankData){
            list = rankData;
        }
        let listH = detailBg.y - redBg.y - redBg.height - 5;
        let rect = new egret.Rectangle(0,0, 620, listH);
        let scrollList = ComponentManager.getScrollList(AcCrossAtkraceCheerViewScrollItem2, list, rect, {aid:this.aid,code:this.code});
