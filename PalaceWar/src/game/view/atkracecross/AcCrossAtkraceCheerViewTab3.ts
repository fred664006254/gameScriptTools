//任务
class AcCrossAtkraceCheerViewTab3 extends CommonViewTab
{
	...
	protected initView():void
	{
		...
		let scrollList = ComponentManager.getScrollList(AcCrossAtkraceCheerViewScrollItem3, dataList, tmpRect, {aid:this.aid, code:this.code});
