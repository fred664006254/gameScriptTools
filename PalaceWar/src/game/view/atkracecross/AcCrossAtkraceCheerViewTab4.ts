//人气商店
class AcCrossAtkraceCheerViewTab4 extends CommonViewTab
{
	...
	protected initView():void
	{
        ...
        let scrollList = ComponentManager.getScrollList(AcCrossAtkraceCheerViewScrollItem4, [], tmpRect, {aid:this.aid, code:this.code});
