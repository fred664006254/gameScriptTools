class NewAtkracecrossDetailScrollItem extends ScrollListItem
{
    public constructor() 
	{
		super();
	...
	public initItem(index:number,cfg:any,info:any):void
    {
		...
		let str1 = LanguageManager.getlocal("newatkracecross_buffdetail_desc",[String(index+1),String(cfg.needAbility),String(cfg.servantNum)]);
