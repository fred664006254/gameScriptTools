class NewAtkracecrossActivityRewardViewTab1 extends CommonViewTab
{
	...
	private _text3:BaseTextField = null;
	...
	private get cfg() : Config.AcCfg.CrossServerAtkRaceCfg{
		let acode:number =  Api.acVoApi.getActivityVoByAidAndCode("newCrossServerAtkRace").code;
	...
	protected initView():void
	{
		...
		this.tick();
		let crossVo:AcCrossServerAtkRaceVo = <AcCrossServerAtkRaceVo>Api.acVoApi.getActivityVoByAidAndCode("newCrossServerAtkRace");
	...
	public tick():void
	{	
		let vo = <AcNewCrossServerAtkRaceVo>Api.acVoApi.getActivityVoByAidAndCode("newCrossServerAtkRace");
		if(this._collectBtn){
