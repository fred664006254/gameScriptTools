...
{	
	...
	{
		let view = this;
		let tipTxt:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal("councilRankListTip1"),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BLACK);
		...
		let scroRect = new egret.Rectangle(rankBg.x, rankBg.y, rankBg.width,rankBg.height - 16);
