 ...
 * 
 */
class SixSection1BattleAddScrollItem  extends ScrollListItem
{
    public constructor()
    {
        super();
    ...
    protected initItem(index:number,data:any)
    {
        ...
        let zizhi = ComponentManager.getTextField(LanguageManager.getlocal("sixSection1BattleDetail_zizhi",[String(data.needv)]),18,TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        let strr:string = LanguageManager.getlocal("sixSection1BattleDetail_itembuff"+data.type,[String(vv)]);
