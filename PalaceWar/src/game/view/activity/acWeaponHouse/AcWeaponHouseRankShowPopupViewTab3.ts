 ...
 */
class AcWeaponHouseRankShowPopupViewTab3 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let rankDatalist = baseView.getAllirank();
        let rankData = baseView.getAllMask();
        ...
        let _titleTF = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponHouse_rankPlayName_title", this.getTypeCode())),titleTxt1.size,TextFieldConst.COLOR_LIGHT_YELLOW)
        _titleTF.x = bg2.x+210;
        _titleTF.y = titleTxt1.y;
        this.addChild(_titleTF);

        let titleTxt3 = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponHouse_rankPlayUp_title", this.getTypeCode())),titleTxt1.size,TextFieldConst.COLOR_LIGHT_YELLOW)
        ...
        let scrollList = ComponentManager.getScrollList(AcWeaponHouseRankShowPopupItem3, rankDatalist, rect, {aid:this.aid, code:this.code});
        ...
        let myRankTF = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponHouse_name_title", this.getTypeCode()), [String(nickName)]),TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        myRankTF.setPosition(bottomBg.x + 40, bottomBg.y + 30);
        this.addChild(myRankTF);
    
        //排名
        let myScoreTF = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponHouse_rankShow_title", this.getTypeCode()), [String(myRank)]),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_LIGHT_YELLOW);
        myScoreTF.setPosition(myRankTF.x, myRankTF.y + myRankTF.height + 15);
        this.addChild(myScoreTF);

        //分数
        let myScore = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponHouse_rankPlayUpDes_title", this.getTypeCode()), [String(score)]),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_LIGHT_YELLOW);
        myScore.setPosition(bottomBg.x + bottomBg.width - myScore.width - 20, myRankTF.y + myRankTF.height + 15);
        this.addChild(myScore);

        //介绍
        let destext = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponHouse_rank_upDes", this.getTypeCode()), [50+""]),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_LIGHT_YELLOW);
