 ...
 */
class AcWeaponHouseRankShowPopupViewTab1 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let rankDatalist = baseView.getRankList();
        ...
        let scrollList = ComponentManager.getScrollList(AcWeaponHouseRankShowPopupItem1, rankDatalist, rect, {aid:this.aid, code:this.code});
        ...
        //分数
        let myScore = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponHouse_rankGrade_title", this.getTypeCode()), [String(score)]),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_LIGHT_YELLOW);
        myScore.setPosition(bottomBg.x + bottomBg.width - myScore.width - 20, myRankTF.y + myRankTF.height + 15);
        this.addChild(myScore);

        //介绍
        let destext = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponHouse_rank_oneDes", this.getTypeCode()), [this.cfg.limitScore]),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_LIGHT_YELLOW);
