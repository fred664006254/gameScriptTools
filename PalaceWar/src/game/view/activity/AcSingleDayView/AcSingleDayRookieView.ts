...
class AcSingleDayRookieView extends CommonView
{
	...
	{	
        ...
        let guidePic:string[] = [];
        let allAvg = view.cfg.AVGDialog[view.getUiCode()];
	...
	{	
		...
		let bgName = `acsingleday_bg${view.getUiCode()}`;
	...
	private showPage():void
	{
		...
		if (this._curConfig.descId) {
			let timeSt = App.DateUtil.formatSvrHourByLocalTimeZone(this.cfg.startTime/3600).hour;
			let timeEt = App.DateUtil.formatSvrHourByLocalTimeZone(this.cfg.endTime/3600).hour;
			//描述 
