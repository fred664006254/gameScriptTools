 ...
 */
class AcDestroySameChargeItem  extends ScrollListItem
{
    //item数据
    ...
    private _rechargeItem : Config.AcCfg.DSRechargeItemCfg = null;
    ...
    {	
        ...
        let str = `1029_0_${this._rechargeItem.specialGift}_${this.getUiCode()}|` + this._rechargeItem.getReward;
