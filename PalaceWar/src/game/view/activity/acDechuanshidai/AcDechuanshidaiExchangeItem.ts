class AcDechuanshidaiExchangeItem extends BaseDisplayObjectContainer 
{ 
    private _cfg:Config.AcCfg.DeChuanExchangeItemCfg = null;
    ...
    public init(data:Config.AcCfg.DeChuanExchangeItemCfg,itemparam:any,f:Function,o:any)
    {
        let view = this;
        ...
        let arrow:BaseBitmap = BaseBitmap.create(`dechuanchangearrow-${code}`);
