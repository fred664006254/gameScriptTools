 ...
 * author qianjun
 */
class AcDechuanshidaiRewardPoolView extends PopupView
{
	public constructor(){
		super();
	}
	...
	public initView():void{		
		...
		let tipTxt = ComponentManager.getTextField(LanguageManager.getlocal(`acDechuanshidaitip6-${view.getUiCode()}`), 20, TextFieldConst.COLOR_BLACK);
