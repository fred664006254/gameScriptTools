 ...
 */
class AcDechuanshidaiChargeItem  extends ScrollListItem
{
    //item数据
    ...
    private _rechargeItem : Config.AcCfg.DeChuanRechargeItemCfg = null;
	...
	protected initItem(index:number,data:Config.AcCfg.DeChuanRechargeItemCfg,itemparam:any)
    {	
        let view = this;
