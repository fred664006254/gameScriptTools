...
class AcNewYearCrackerAVGView extends CommonView
{
	...
	protected getResourceList():string[]{	
        ...
        let guidePic:string[] = [];
        let allAvg = view.AVGDialog[view._code][view._key][view._curIdx];
	...
	{	
		...
		let bgname = `accrackertbg1-` + this._code;
	...
	private showPage():void
	{
		...
		if (this._curConfig.descId) {
			...
			if (1) {
                ...
                let str = `acNewYearCrackerTalk${this._key}_${this._curConfig.descId}-${this.param.data.code}`;
