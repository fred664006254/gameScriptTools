 ...
 * author qianjun
 */
class AcCrossServerWifeTalentViewTab3 extends CommonViewTab {
	...
	public initView():void
	{
		...
		let tiptxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCrossLeagueCn(`acCrossServerWifeBattleTip1`,this.vo.isCrossLeague())), 20, TextFieldConst.COLOR_BLACK);
