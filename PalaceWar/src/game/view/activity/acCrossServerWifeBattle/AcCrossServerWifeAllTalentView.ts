...
class AcCrossServerWifeAllTalentView  extends CommonView
{
	...
	public initView():void
	{
        ...
        let topInBg = BaseBitmap.create("wifetalentnumbg");
		...
		if(isHaveBuff){
			...
			let acTime = this.vo.getAcLocalTime();
	...
	// private _opTxt:BaseTextField = null;
		...
		let list = this.vo.test ? [] : this.vo.wifebattlecross.info.tmpattr.wifeadd_arr;  //Api.wifebattleVoApi.wifebattleVo.info.tmpattr.wifeadd_arr;
		list = list?list:[];
		list.sort((a,b)=>{
