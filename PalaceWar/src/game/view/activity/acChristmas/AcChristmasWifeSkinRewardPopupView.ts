 ...
 */
class AcChristmasWifeSkinRewardPopupView extends PopupView {
	public constructor() {
		super();
	}
	private aid: any;
	...
	protected initView(): void {
		...
		let skinid = acCfg.skin;
		let bgpic = "acchristmasview_rewardmidbg_" + this.code;
		if (this.code == "2")
		{
			skinid = 1071;
		...
		let bg = BaseLoadBitmap.create(bgpic);
		bg.width = 544;
		bg.height = 400;
