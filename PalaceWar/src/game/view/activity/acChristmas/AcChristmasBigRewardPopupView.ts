 ...
 */
class AcChristmasBigRewardPopupView extends PopupView {
	public constructor() {
		super();
	}
	private aid: any;
	...
	protected initView(): void {
		...
		let skinCfg = Config.ServantskinCfg.getServantSkinItemById(acCfg.skin);
		...
		let topDesc = ComponentManager.getTextField(LanguageManager.getlocal("acChristmasBigRewardPopupViewTopDesc"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
