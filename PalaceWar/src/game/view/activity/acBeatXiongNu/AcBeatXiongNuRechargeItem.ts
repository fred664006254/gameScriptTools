 ...
 */
class AcBeatXiongNuRechargeItem  extends ScrollListItem
{
    //item数据
    ...
    private _rechargeItem : Config.AcCfg.BeatXiongNuRechargeItemCfg = null;
	...
	protected initItem(index:number,data:Config.AcCfg.BeatXiongNuRechargeItemCfg,itemparam:any)
    {	
        let view = this;
        ...
        let str = `1051_1_${data.specialGift}`;
