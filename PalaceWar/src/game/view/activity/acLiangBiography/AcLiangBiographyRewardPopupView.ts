 ...
 */
class AcLiangBiographyRewardPopupView extends PopupView {
	...
	public initView(): void {
		...
		let topTF = ComponentManager.getTextField(LanguageManager.getlocal("acLiangBiographyRewardPopupViewTopDesc-" + code), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BLACK);
