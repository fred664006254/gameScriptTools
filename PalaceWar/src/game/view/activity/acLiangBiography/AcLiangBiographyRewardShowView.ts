class AcLiangBiographyRewardShowView extends BaseView {
    public constructor() {
        super();
    }
    ...
    protected initView(): void {
        ...
        let useNum = this.param.data.useNum;
        ...
        let tipTF = ComponentManager.getTextField(LanguageManager.getlocal("acLiangBiographyRewardShowViewTip-" + code, [String(useNum)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_WHITE);
