 ...
 */
class AcSkyArmorRewardPopViewTab2 extends AcCommonViewTab{
    ...
    public initView():void{
        ...
        let scrollList = ComponentManager.getScrollList(AcSkyArmorRewardTab2ScrollItem, dataList, rect, {id:id,aid:this.aid, code:this.code});
