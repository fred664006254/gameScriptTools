/**
  ...
  */
 class AcThrowStoneRewardTab1ScrollItem extends ScrollListItem {
	...
	public initItem(index: number, data: any, itemParam: any): void {
		...
		let vo = <AcThrowStoneVo>Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
		...
		let titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acthrowstoneChargeItemMsg", [String(this._itemData.needGem)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
		...
		let progressStr = LanguageManager.getlocal("acthrowstoneChargeNum", [String(currChargeGem), String(data.needGem)]);
