 ...
 */
class AcMidAutumnRewardPopupView extends PopupView {
	...
	public initView(): void {
		...
		let cfg = <Config.AcCfg.MidAutumnCfg>Config.AcCfg.getCfgByActivityIdAndCode(aid, code);
		let topTF = ComponentManager.getTextField(LanguageManager.getlocal("acMidAutumnRewardPopupViewTitle-" + code), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BLACK);
