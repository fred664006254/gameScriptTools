...
*/
class AcMouseComeDetailPopupViewTab2 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let scrollList = ComponentManager.getScrollList(AcMouseComeDetailScrollItem2, dataList, rect, {aid:this.aid, code:this.code, id: this.param.data.id});
