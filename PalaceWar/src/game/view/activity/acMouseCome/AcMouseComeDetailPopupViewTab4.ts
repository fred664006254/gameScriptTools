 ...
 */
class AcMouseComeDetailPopupViewTab4 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let topStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acMouseComeSkinTopMsg", this.getTypeCode()), [""+toolItemVo.num, toolItemVo.name]);
        ...
        let exchangeBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, App.CommonUtil.getCnByCode("acMouseComeDetailSkinget", this.getTypeCode()), this.exchangeBtnClick, this);
