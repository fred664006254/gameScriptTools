 ...
 */
class AcWeaponPrisonPopupViewTab4 extends CommonViewTab {
    ...
    private initMultiWeapon():void
    {
        ...
        let topDesc = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponPrisonDetailPreviewInfo", this.getTypeCode()), [""+coreNeed]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        topDesc.setPosition(topbg.x + topbg.width / 2 - topDesc.width / 2, topbg.y + topbg.height / 2 - topDesc.height / 2 + 2);
        this.addChild(topDesc);
    ...
    private switchHandler(param:any)
    {
        ...
        this.showWeaponById(String(weaponId),param);
    }
