...
* date 2020.7.29
* author sl
* @name AcWeaponPrisonPopupViewTab2
*/
class AcWeaponPrisonPopupViewTab2 extends CommonViewTab{
    ...
    public initView():void{
        ...
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_WEAPONPRISON_GETACHIEVEMENT, this.requestCallback, this);
        ...
        let scrollList = ComponentManager.getScrollList(AcWeaponPrisonPopupScrollItem2, dataList, rect, {aid:this.aid, code:this.code, id: this.param.data.id,uicode:this.param.data.uicode});
    ...
    public dispose():void{
        ...
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_WEAPONPRISON_GETACHIEVEMENT, this.requestCallback, this);
