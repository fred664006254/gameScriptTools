/**
  ...
  * @author shaoliang
  * date 2020/7/16
  * @class WeaponPrisonRewardNode
  */

 class WeaponPrisonRewardNode extends BaseDisplayObjectContainer 
 {   
     ...
     public init(data:any,code:string,f:Function,o:any):void
     {
         ...
         let rewardbg1 = BaseBitmap.create(App.CommonUtil.getResByCode("weaponprison_reward",code));
         rewardbg1.setPosition(0,25);
         this.addChild(rewardbg1);
         this._bg= rewardbg1;
 
         let rewardbg2 = BaseBitmap.create(App.CommonUtil.getResByCode("weaponprison_timesbg",code));
     ...
     public setShowType(type:number):void
     {
         ...
         {
             this._bg.texture = ResourceManager.getRes(App.CommonUtil.getResByCode("weaponprison_reward2",this._code));
         }
