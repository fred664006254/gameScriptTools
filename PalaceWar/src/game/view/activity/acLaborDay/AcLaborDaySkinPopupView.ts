 ...
 * @author qianjun
 */
class AcLaborDaySkinPopupView extends PopupView {
	public constructor() {
		super();
	}
	...
	protected initView(): void {
		...
		let topDesc = ComponentManager.getTextField(LanguageManager.getlocal(`acLaborichargetip1-` + this.code, [view.cfg.rankNeed.toString()]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
