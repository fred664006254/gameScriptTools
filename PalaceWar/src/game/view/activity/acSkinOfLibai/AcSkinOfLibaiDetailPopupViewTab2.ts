 ...
 */
class AcSkinOfLibaiDetailPopupViewTab2 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let scrollList = ComponentManager.getScrollList(AcSkinOfLibaiDetailTab2ScrollItem, dataList, rect, {aid:this.aid, code:this.code, id: id});
