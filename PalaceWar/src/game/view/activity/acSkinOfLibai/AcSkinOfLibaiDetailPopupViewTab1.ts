 ...
 */
class AcSkinOfLibaiDetailPopupViewTab1 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let scrollList = ComponentManager.getScrollList(AcSkinOfLibaiDetailTab1ScrollItem, dataList, rect, {aid:this.aid, code:this.code});
