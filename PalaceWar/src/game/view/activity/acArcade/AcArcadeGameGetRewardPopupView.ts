...
class AcArcadeGameGetRewardPopupView extends BaseView {
    ...
    private initBuffers(buffers: any) {
        ...
        let wealthLuckTxt1 = ComponentManager.getTextField(LanguageManager.getlocal("acArcadeGameRewardViewBufferType1-" + this.param.data.code, [String(cyhtNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        ...
        let wealthLuckTxt2 = ComponentManager.getTextField(LanguageManager.getlocal("acArcadeGameRewardViewBufferType2-" + this.param.data.code, [String(tjhcNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        ...
        let wealthLuckTxt3 = ComponentManager.getTextField(LanguageManager.getlocal("acArcadeGameRewardViewBufferType3-" + this.param.data.code, [String(csjdNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
