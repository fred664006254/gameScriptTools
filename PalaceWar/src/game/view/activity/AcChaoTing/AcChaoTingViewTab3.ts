 ...
 * date 2020.3.24
 */
class AcChaoTingViewTab3 extends AcCommonViewTab{
    ...
    public initView():void{
        ...
        let data = this.vo.getSortTaskCfg();
        let rect = new egret.Rectangle(0, 0, GameConfig.stageWidth, showHeight - 10);
        let scrollList = ComponentManager.getScrollList(AcChaoTingViewTabScrollItem3, data, rect, {aid: this.aid, code: this.code});
        ...
        let key = "firstin"+Api.playerVoApi.getPlayerID()+this.vo.aidAndCode+this.vo.et;
    ...
    {   
        ...
        if(this._maskPanel == null)
        {
            ...
            //锁
            let lockBgStr = ResourceManager.hasRes("acchaoting_lock-"+this.getTypeCode()) ? "acchaoting_lock-"+this.getTypeCode() : "acchaoting_lock-1";
            ...
            let dalogBgStr = ResourceManager.hasRes("acchaoting_tasklockbg-"+this.getTypeCode()) ? "acchaoting_tasklockbg-"+this.getTypeCode() : "acchaoting_tasklockbg-1";
            ...
            //解锁条件
            let dialogText = ComponentManager.getTextField(LanguageManager.getlocal("acChaotingTaskUnlockInfo-"+this.getTypeCode(), [""+this.cfg.recharge1]), TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_BROWN);
            ...
            //充值
            let rechargeTxt = ComponentManager.getTextField(LanguageManager.getlocal("acChaotingTaskUnlockTitle-"+this.getTypeCode()), TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_BROWN);
            ...
            let currRechargeNumStr = LanguageManager.getlocal("acCourtDutyRechargeNum-"+this.getTypeCode(),[""+currRechargeNum, ""+this.cfg.recharge1]);
            progress.setPercentage(currRechargeNum/this.cfg.recharge1, currRechargeNumStr);
            progress.name = "progress";

            let rechargeBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_RED,"taskGoBtn", this.rechargeHandler, this);
            ...
            let unlockBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "acChaotingTaskUnlock", this.unlockHandler, this);
    ...
    private refreshFetterPanel():void{
        if (this._lockDialog){
            ...
            let currNumStr = LanguageManager.getlocal("acCourtDutyRechargeNum-"+this.getTypeCode(),[""+currNum, ""+this.cfg.recharge1]);
