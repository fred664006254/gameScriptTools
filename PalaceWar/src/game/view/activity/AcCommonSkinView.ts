 ...
 * @author qianjun
 */
class AcCommonSkinView extends PopupView {
    public constructor() {
		super();
	}
	...
	protected initView(): void {
		...
		if(isWifeskin){
			...
			let str = LanguageManager.getlocal(view.param.data.needTxt ? view.param.data.needTxt : `acCommonSkinGet2`, [view.param.data.need, skinCfg.name]);
