//赛季阵营
class AcThreeKingdomsRewardViewTab2 extends CommonViewTab
{
	...
	protected initView():void{
		...
		let tipTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode(`acThreeKingdomsRanktip19`, code), [view.vo.acTimeAndHour]), 20, TextFieldConst.COLOR_BROWN);
		...
		let rankList = view.cfg.kingdom2;
		let tmpX = 20;
		let scroStartY = 3;
		...
		//赛季排名
		let rankstr = ``;
		let rankV = view.vo.getMyZrankSeason();
