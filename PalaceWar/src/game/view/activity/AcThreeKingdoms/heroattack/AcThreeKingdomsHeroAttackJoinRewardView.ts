//神将突袭参与奖励
class AcThreeKingdomsHeroAttackJoinRewardView  extends PopupView
{
    public constructor() {
		super();
    }
    ...
    protected resetBgSize():void{
        ...
        let tailor_get_word = BaseBitmap.create("threekingdomsheroattackrewardtitle");
        ...
        //提示
        let tipTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode(`acthreekingdomsheroattacktip1`,code)), 22);
        tipTxt.width = 590;
        ...
        //"6_1150_4|6_1710_1";
        //奖励
        let rewardTab = view.cfg.officer1.split('|');
