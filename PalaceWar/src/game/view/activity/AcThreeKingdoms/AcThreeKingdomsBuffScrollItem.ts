...
class AcThreeKingdomsBuffScrollItem extends ScrollListItem
{
	public constructor() {
		super();
	}

	protected initItem(index:number,data:Config.AcCfg.ThreeKingdomsTroop1Cfg,param:any)
    {
        this.width = 510;
        this.height = 47;
        ...
        let nameTxt = ComponentManager.getTextField(App.StringUtil.changeIntToText(data.needNum * 100000000),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BROWN);
		nameTxt.x = 200 - nameTxt.width/2
        nameTxt.y =  this.height/2 - nameTxt.height/2;;
        this.addChild(nameTxt);

		let scoreTxt = ComponentManager.getTextField(data.addAtk.toString(),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BROWN);
