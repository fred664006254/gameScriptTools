...
class AcThreeKingdomsBattleView extends BaseBattleView
{
...
*/
    ...
    private createInfoGroup(type : number):BaseDisplayObjectContainer{
        ...
        let totalTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode(`acThreeKingdomsbattlearmynum`, code),[army.toString()]),22);
        ...
        let servantcount = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode(`acThreeKingdomsbattleservantnum`, code),[servantnum.toString()]),22,TextFieldConst.COLOR_LIGHT_YELLOW);
