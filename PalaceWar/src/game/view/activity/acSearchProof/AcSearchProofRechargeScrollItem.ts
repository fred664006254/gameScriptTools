/**
  ...
  */
class AcSearchProofRechargeScrollItem extends ScrollListItem {
	private _itemData: Config.AcCfg.SearchProofRechargeItemCfg = null;
	...
	public initItem(index: number, data: any, itemParam: any): void {
		...
		let vo = <AcSearchProofVo>Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
