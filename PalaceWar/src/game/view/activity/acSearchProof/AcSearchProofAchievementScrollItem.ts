 ...
 */
class AcSearchProofAchievementScrollItem extends ScrollListItem {
	...
	public initItem(index: number, data: any, itemParam: any): void {
		...
		let id = itemParam.id;
		let vo = <AcSearchProofVo>Api.acVoApi.getActivityVoByAidAndCode(aid, code);
		...
		let titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acSearchProofAchievementPopupViewItemTitle-" + code, [String(data.needNum)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
		...
		let titelTxt = ComponentManager.getTextField(LanguageManager.getlocal("acSearchProofAchievementPopupViewItemProgress-" + code), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BLACK);
