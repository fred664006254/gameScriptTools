 ...
 */
class AcLotusDetailPopupViewTab4 extends CommonViewTab{
    public _exchangeContainer:BaseDisplayObjectContainer = null;
    ...
    public initView():void{
        ...
        let topStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acLotusSkinTopMsg", this.getTypeCode()), [""+toolItemVo.num, toolItemVo.name]);
        ...
        let exchangeBg = BaseBitmap.create(App.CommonUtil.getResByCode("aclotus_skinprocessbg", this.getTypeCode()));
        ...
        let exchangeBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, App.CommonUtil.getCnByCode("acLotusDetailSkinget", this.getTypeCode()), this.exchangeBtnClick, this);
