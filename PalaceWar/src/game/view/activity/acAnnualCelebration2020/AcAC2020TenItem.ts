class AcAC2020TenItem  extends ScrollListItem
{
    public constructor() 
	{
		super();
    ...
    {	
        ...
        let desc3 = ComponentManager.getTextField(LanguageManager.getlocal("acAC2020GetValue"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
