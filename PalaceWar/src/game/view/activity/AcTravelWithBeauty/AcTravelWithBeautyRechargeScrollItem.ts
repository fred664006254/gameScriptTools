/**
  ...
  */
 class AcTravelWithBeautyRechargeScrollItem extends ScrollListItem {
	...
	public initItem(index: number, data: any, itemParam: any): void {
		...
		let vo = <AcTravelWithBeautyVo>Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
		...
		let titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acTravelWithBeautyRechargeNumTitle-"+this.getTypeCode(), [String(this._itemData.needGem)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
		...
		let progressStr = LanguageManager.getlocal("acTravelWithBeautyRechargeNum-"+this.getTypeCode(), [String(currChargeGem), String(data.needGem)]);
