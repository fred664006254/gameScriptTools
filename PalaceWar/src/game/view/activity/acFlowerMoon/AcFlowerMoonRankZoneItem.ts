class AcFlowerMoonRankZoneItem extends ScrollListItem
{
    ...
    public initItem(index:number, data:any, itemParam:any)
    {
        ...
        let name = ComponentManager.getTextField(LanguageManager.getlocal("ranserver2",[data.zid+""]), TextFieldConst.FONTSIZE_CONTENT_COMMON, tarColor);
        name.x = 250 - name.width/2;
