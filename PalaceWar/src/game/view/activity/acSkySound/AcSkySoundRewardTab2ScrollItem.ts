class AcSkySoundRewardTab2ScrollItem extends ScrollListItem {
    ...
    protected initItem(index: number, data: any, itemParam: any) {
        ...
        //title txt
        let titleTxtStr = LanguageManager.getlocal("acSkySoundAchievementItemInfo", [""+data.needNum]);
        ...
        if (this.vo.isGetAchievementById(data.id)) {
            ...
            let reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", () => {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACSKYSOUND_GETSOUNDNUM, { activeId: this.vo.aidAndCode, rkey: data.id}); 
            }, this);
