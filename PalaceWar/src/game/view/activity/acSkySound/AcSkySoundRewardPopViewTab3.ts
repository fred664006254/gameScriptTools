 ...
 */
class AcSkySoundRewardPopViewTab3 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let topBgStr = ResourceManager.hasRes("skysoundtab3-"+this.getTypeCode()) ? "skysoundtab3-"+this.getTypeCode() : "skysoundtab3-1";
