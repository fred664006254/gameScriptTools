class AcNewYearViewTab2 extends AcCommonViewTab
{
	//滑动列表
	...
	protected initView():void
	{
		...
		let curr_acNewYearVo = <AcNewYearVo>Api.acVoApi.getActivityVoByAidAndCode(AcConst.AID_ACNEWYEAR,this.code);
	...
	private showBtn():void
	{
		...
		let scrollList = ComponentManager.getScrollList(NewYear2ScrollItem,arr,tmpRect,this.code);
