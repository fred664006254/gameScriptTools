 ...
 * author qianjun
 */
class AcRabbitComingRankView extends PopupView
{
	// 滑动列表
	...
	protected resetBgSize():void{
		super.resetBgSize();
		let tipTxt = ComponentManager.getTextField(LanguageManager.getlocal(`loctombranktip-1`),22,TextFieldConst.COLOR_LIGHT_YELLOW);
