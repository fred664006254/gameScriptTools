 ...
 * author 钱竣
 */
class AcLuckyDrawSkinPopupView extends PopupView {
	public constructor() {
		super();
	}
	...
	protected initView(): void {
		...
		let isWifeskin = obj[this.code] == `wife`;
		if(isWifeskin){
			...
			let topDesc = ComponentManager.getTextField(LanguageManager.getlocal(`acLuckyDrawAwardTip1-${view.code}`,[view.cfg.getTotalProgress().toString(), Config.WifeskinCfg.getWifeCfgById(view.cfg.getSkin(view.code)).name]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
