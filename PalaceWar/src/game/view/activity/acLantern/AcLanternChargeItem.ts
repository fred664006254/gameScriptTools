 ...
 */
class AcLanternChargeItem  extends ScrollListItem
{
    //item数据
    ...
    private _rechargeItem : Config.AcCfg.LanternRechargeItemCfg = null;
	...
	protected initItem(index:number,data:Config.AcCfg.LanternRechargeItemCfg,itemparam:any)
    {	
        let view = this;
