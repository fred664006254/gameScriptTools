 ...
 */
class AcWorshipRewardPopupView extends PopupView {
	...
	public initView(): void {
		...
		let topTF = ComponentManager.getTextField(LanguageManager.getlocal("acWorshipRewardPopupViewTopDesc-" + code), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BLACK);
