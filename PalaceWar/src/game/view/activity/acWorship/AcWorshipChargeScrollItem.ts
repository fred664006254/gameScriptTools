/**
  ...
  */
class AcWorshipChargeScrollItem extends ScrollListItem {
    ...
    protected initItem(index: number, data: any, itemParam: any) {
        ...
        let titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acWorshipChargePopupViewItemTitle-" + code, [String(data.needGem)]), TextFieldConst.FONTSIZE_TITLE_SMALL, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        if (vo.getChargeValue() >= data.needGem) {
            ...
            let rechargeBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_RED, "acWorshipChargePopupViewItemRecharge-" + itemParam.code, () => {
