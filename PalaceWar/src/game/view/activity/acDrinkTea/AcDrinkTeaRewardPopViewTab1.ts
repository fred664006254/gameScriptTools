 ...
 */
class AcDrinkTeaRewardPopViewTab1 extends AcCommonViewTab{
    ...
    public initView():void{
        ...
        let scrollList = ComponentManager.getScrollList(AcDrinkTeaRewardTab1ScrollItem, dataList, rect, {aid:this.aid, code:this.code});
