 ...
 */
class AcDrinkTeaRewardPopViewTab3 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let topBgStr = ResourceManager.hasRes("drinkteatab3-"+this.getTypeCode()) ? "drinkteatab3-"+this.getTypeCode() : "drinkteatab3-1";
