class AcDrinkTeaRewardTab2ScrollItem extends ScrollListItem 
{
    ...
    protected initItem(index: number, data: any, itemParam: any) {
        ...
        //title txt
        let titleTxtStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acDrinkTeaAchievementItemInfo", this.getTypeCode()), [""+data.needNum]);;
        ...
        let currNum = this.vo.getAchieveNum();
        ...
        if (this.vo.isGetAchievementById(data.id)) {
            ...
            let reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", () => {
                ...
                NetManager.request(NetRequestConst.REQUEST_DRINKTEA_GETACHIEVEMENT, { activeId: this.vo.aidAndCode, rkey: data.id}); 
            }, this);
