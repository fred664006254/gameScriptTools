class AcAskGodAchRewardScrollItem extends ScrollListItem {
    ...
    protected initItem(index: number, data: any, itemParam: any) {
        ...
        //title txt
        let titleTxtStr = LanguageManager.getlocal("acAskGodAchievementItemInfo-"+this.getTypeCode(), [""+data.needNum]);
        ...
        if (this.vo.isGetAchievementById(data.id)) {
            ...
            let reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", () => {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACASKGOD_GETNIGHTNUM, { activeId: this.vo.aidAndCode, rkey: data.id}); 
            }, this);
