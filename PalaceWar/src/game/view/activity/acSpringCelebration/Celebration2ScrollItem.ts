...
class Celebration2ScrollItem  extends ScrollListItem
{
	...
	protected initItem(index:number,data:any)
    {
		...
		this.addChild(numbg);
		let needIconTxt = ComponentManager.getTextField("",16,TextFieldConst.COLOR_WHITE);
		...
		numbg.name="numbg";
		numbg.setPosition(icon.x + icon.width-numbg.width-4,icon.y + icon.height - numbg.height - 4);
		needIconTxt.setPosition(icon.x + icon.width- needIconTxt.width-12, numbg.y+numbg.height/2-needIconTxt.height/2 );
