 ...
 */
class AcNewYearRedChargeItem  extends ScrollListItem
{
    //item数据
    ...
    private _rechargeItem : Config.AcCfg.NewYearRedRechargeItemCfg = null;
	...
	protected initItem(index:number,data:Config.AcCfg.NewYearRedRechargeItemCfg,itemparam:any)
    {	
        let view = this;
