 ...
 * author qianjun
 */
class AcMotherDayCardPoolView extends PopupView
{
	public constructor(){
		super();
	}
	...
	public initView():void{		
		...
		let tipTxt = ComponentManager.getTextField(LanguageManager.getlocal(`motherdaypooltip-${Number(code) == 7 ? `3` : code}`), 20, TextFieldConst.COLOR_BLACK);
