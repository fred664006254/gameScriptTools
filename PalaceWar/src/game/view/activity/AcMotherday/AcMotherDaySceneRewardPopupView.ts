/**
  ...
  */
class AcMotherDaySceneRewardPopupView extends PopupView {
    ...
    public initView(): void {
        ...
        let tipTxt = ComponentManager.getTextField(LanguageManager.getlocal(`changebg_servant_promote`, [servantCfg.name]), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
