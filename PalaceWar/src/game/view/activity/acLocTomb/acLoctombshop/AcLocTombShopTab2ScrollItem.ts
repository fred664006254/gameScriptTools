 ...
 * desc : 积分兑换itemrender
 */
class AcLocTombShopTab2ScrollItem extends ScrollListItem
{
    ...
    private get vo() : AcLocTombVo{
        return <AcLocTombVo>Api.acVoApi.getActivityVoByAidAndCode(AcConst.AID_LOCTOMB, this._code);
    }
    ...
    {	
		...
		let btn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW,"",view.buyHandler,view)
