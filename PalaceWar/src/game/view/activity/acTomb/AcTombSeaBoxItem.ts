 ...
 * author qianjun
 */
class AcTombSeaBoxItem  extends ScrollListItem
{
    ...
    protected initItem(index:number,data,itemparam)
    {
        ...
        */
        ...
        let iconStr = `teamiconstatus1-${code}`;
        ...
        icon.addTouchTap(()=>{
            ...
            if(!this.vo.getAttendQUality()){
                App.CommonUtil.showTip(LanguageManager.getlocal(`tombattend2-${code}`, [Api.playerVoApi.getPlayerOfficeByLevel(this.cfg.needLv)]));
                return;
            }
                ...
                */
                ...
                if(cfg.type == 2){
                    ...
                    if(finished){
                        ...
                        //宝箱飞出特效
                        view._icon.alpha = 0;
                        let icon = BaseBitmap.create(cfg.getnpcPic(code));
                        ...
                        let circle = BaseBitmap.create(`tombboxcircle${cfg.id}-${code}`);
    ...
    private playBoxEff(data : any):void{
        ...
        */
        let tombboxef = ComponentManager.getCustomMovieClip(`tombboxef${code}-`, 5, 70);
		tombboxef.width = 125;
        ...
        tombboxef.setEndCallBack(()=>{
            ...
            egret.Tween.get(tombboxef).wait(700).call(()=>{
                ...
                let tombdoor = ComponentManager.getCustomMovieClip(`tombdoor${code}-`, 7, 50);
                tombdoor.width = 218;
                tombdoor.height = 218;
                ...
                let tombdoorlight = BaseBitmap.create(`doorlight-${code}`);
                ...
                tombdoor.setFrameEvent(1,()=>{
                    ...
                    let tombbubble = ComponentManager.getCustomMovieClip(`tombbubble${code}-`, 18, 70);
                    tombbubble.width = 72;
    ...
    public update():void{
        ...
        if(data){
            ...
            if(status == 2){
                ...
                iconStr = `teamiconstatus${status}-${code}`
            }
        }
        view._icon.alpha = 1;
