//
class AcTombAllianceInfoViewTab1 extends CommonViewTab
{
	...
	protected initView():void
	{
		...
		view._sortType = 2;
        let scrollList = ComponentManager.getScrollList(AcTombAllianceInfoScrollItem, arr, tmpRect, view.param.data.code);
	...
	public getrewardCallback():void{
		let view = this;
		let item = <AcTombAllianceInfoScrollItem>view._list.getItemByIndex(view.vo.clickIdx);
		if(item){
			view.vo.clickIdx = -1;
