 ...
 * desc:活动商店
*/
class AcTombShopView extends PopupView{
    ...
    protected resetBgSize():void{
		...
		if(this.cfg.maxScore){	
			//增加提示
			let tipTxt = ComponentManager.getTextField( LanguageManager.getlocal("tombfloorbosstip6", [(this.cfg.maxScore - this.vo.gettotalShopScore()).toString()]), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
