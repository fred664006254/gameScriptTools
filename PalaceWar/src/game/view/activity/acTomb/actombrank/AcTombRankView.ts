 ...
 * author qianjun
 */
class AcTombRankView extends PopupView
{
	// 滑动列表
	...
	{		
		...
		let serverStr = ComponentManager.getTextField(LanguageManager.getlocal(`crossranserver`, [Api.mergeServerVoApi.getAfterMergeSeverName(null, true, Api.mergeServerVoApi.getTrueZid())]), 22, TextFieldConst.COLOR_LIGHT_YELLOW); 
	...
	// "acRankPop_title3_11":"积分",
        ...
        let titleTxt3 = ComponentManager.getTextField(LanguageManager.getlocal("rankServer"), titleTxt1.size, TextFieldConst.COLOR_LIGHT_YELLOW)
