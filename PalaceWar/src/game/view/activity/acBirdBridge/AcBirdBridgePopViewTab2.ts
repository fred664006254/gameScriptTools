...
*/
class AcBirdBridgePopViewTab2 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let dataList = this.vo.getSortAchievementOneCfg();
        let rect = new egret.Rectangle(0, 0, 530, 680);
        let scrollList = ComponentManager.getScrollList(AcBirdBridgeScrollItem2, dataList, rect, {aid:this.aid, code:this.code, id: this.param.data.id,uicode:this.param.data.uicode});
