...
*/
class AcBirdBridgePopViewTab3 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let dataList = this.vo.getSortAchievementAllCfg();
        let rect = new egret.Rectangle(0, 0, 530, 680);
        let scrollList = ComponentManager.getScrollList(AcBirdBridgeScrollItem3, dataList, rect, {aid:this.aid, code:this.code, id: this.param.data.id,uicode:this.param.data.uicode});
