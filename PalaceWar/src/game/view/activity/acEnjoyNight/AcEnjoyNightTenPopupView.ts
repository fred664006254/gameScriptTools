...
class AcEnjoyNightTenPopupView extends PopupView 
{
    ...
    protected initView(): void 
    {
        ...
        let scrollList = ComponentManager.getScrollList(AcEnjoyNightTenItem,newArr,rect,{code: this.code, aid: this.aid });
		scrollList.x =5+bg.x; 
		scrollList.y =5+bg.y; 
