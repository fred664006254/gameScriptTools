class AcEnjoyNightGetRewardView  extends BaseView
{
    public constructor() {
		super();
    }
    ...
    protected initView():void
	{
        ...
        let descbg = BaseBitmap.create("public_9_bg47");
        descbg.y = scroStartY-16;
        descbg.height = 40;
        rewardNode.addChild(descbg);

        let desc = ComponentManager.getTextField(LanguageManager.getlocal("acEnjoyNightRewardTip",[String(this.param.data.addValue)]),TextFieldConst.FONTSIZE_TITLE_SMALL,TextFieldConst.COLOR_LIGHT_YELLOW);
