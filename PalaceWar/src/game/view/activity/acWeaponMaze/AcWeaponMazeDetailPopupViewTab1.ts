 ...
 */
class AcWeaponMazeDetailPopupViewTab1 extends CommonViewTab{
    ...
    public initView():void{
        ...
        let scrollList = ComponentManager.getScrollList(AcWeaponMazeDetailPopupScrollItem1, dataList, rect, {aid:this.aid, code:this.code, id: this.param.data.id});
