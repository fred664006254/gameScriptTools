 ...
 * @author ycg
 */
class AcWeaponMazeDetailPopupScrollItem2 extends ScrollListItem {
    ...
    protected initItem(index: number, data: any, itemParam: any) {
        ...
        //title txt
        let titleTxtStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponMazeDetailAchieveItemInfo", this.getTypeCode()), [""+data.needNum]);;
        ...
        if (this.vo.isGetAchieveRewardById(data.id)) {
            ...
            let reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", () => {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACWEAPONMAZE_GETACHIEVT, { activeId: this.vo.aidAndCode, rkey: data.id}); 
            }, this);
