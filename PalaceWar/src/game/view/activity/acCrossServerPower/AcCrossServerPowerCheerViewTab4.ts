//人气商店
class AcCrossServerPowerCheerViewTab4 extends CommonViewTab
{
	...
	protected initView():void
	{
        ...
        let scoreIcon1 = BaseBitmap.create("itemicon"+needId);
        ...
        let scrollList = ComponentManager.getScrollList(AcCrossServerPowerCheerViewScrollItem4, [], tmpRect, {aid:this.aid, code:this.code});
