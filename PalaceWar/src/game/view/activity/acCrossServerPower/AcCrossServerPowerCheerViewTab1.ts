//衣装预览
class AcCrossServerPowerCheerViewTab1 extends CommonViewTab
{
	...
	protected initView():void
	{
        ...
        let bg = BaseLoadBitmap.create(App.CommonUtil.getResByCode(`crosspowerenterbg`, this.getUiCode()));
        this.addChild(bg);
        ...
        //skin info
        let skinGetInfo = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossServerPowerSkinGet", this.getUiCode(), "7")), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
        ...
        let exchangeTip = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossServerPowerSkinChangeInfo", this.getUiCode(), "7"), [""+toolItemVo.num, toolItemVo.name]), TextFieldConst.FONTSIZE_ACTIVITY_COMMON, TextFieldConst.COLOR_BROWN);
