//
class AcCrossServerHegemonyMatchViewTab1 extends CommonViewTab
{

	private _timeCdText:BaseTextField = null;
    private startCurMatchTime = (10 * 24 + 21) * 60 * 60;
    ...
    private createMatchMap():void
    {
        ...
        for(let i = 0; i < 8; i ++){
            ...
            let winTextUp = ComponentManager.getTextField("",22,TextFieldConst.COLOR_WARN_YELLOW);//COLOR_WARN_YELLOW2
            ...
            let textUp1 = ComponentManager.getTextField("",22,0x9adbff);//COLOR_WARN_YELLOW
            ...
            let upLine1 = BaseBitmap.create("accshegemony_matchline1_1");
            upLine1.x = 210 - upLine1.width/2;
            upLine1.y = startY + 62 - upLine1.height/2;
            this._mapContainer.addChild(upLine1);

            let upLine2 = BaseBitmap.create("accshegemony_matchline1_2");
            ...
            let upLine3 = BaseBitmap.create("accshegemony_matchline1_3");
            ...
            let downLine1 = BaseBitmap.create("accshegemony_matchline1_1");
            ...
            let downLine2 = BaseBitmap.create("accshegemony_matchline1_3");
            ...
            let downLine3 = BaseBitmap.create("accshegemony_matchline1_2");
    ...
    private initMatchMap():void
    {
        ...
        let dataList = Api.crossServerHegemonyVoApi.getDetailPkInfo(0);
        // let dataList = [];
