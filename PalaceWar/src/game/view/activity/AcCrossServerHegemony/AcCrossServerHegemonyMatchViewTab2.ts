//
class AcCrossServerHegemonyMatchViewTab2 extends CommonViewTab
{

	private _timeCdText:BaseTextField = null;
    private startCurMatchTime = (11 * 24 + 21) * 60 * 60;
	...
	protected initView():void
	{
        ...
        let matchName = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyMatchTab2"),24,TextFieldConst.COLOR_WARN_YELLOW2)
    ...
    private createMatchMap():void
    {
        ...
        for(let i = 0; i < 4; i ++){
            ...
            let upLine1 = BaseBitmap.create("accshegemony_matchline2_1");
            upLine1.x = 210 - upLine1.width/2;
            upLine1.y = startY + 118 - upLine1.height/2;
            this._mapContainer.addChild(upLine1);

            let upLine2 = BaseBitmap.create("accshegemony_matchline2_2");
            ...
            let upLine3 = BaseBitmap.create("accshegemony_matchline2_3");
            ...
            let downLine1 = BaseBitmap.create("accshegemony_matchline2_1");
            ...
            let downLine2 = BaseBitmap.create("accshegemony_matchline2_3");
            ...
            let downLine3 = BaseBitmap.create("accshegemony_matchline2_2");
    ...
    {
        let dataList = Api.crossServerHegemonyVoApi.getDetailPkInfo(1);
        // let dataList = [];
