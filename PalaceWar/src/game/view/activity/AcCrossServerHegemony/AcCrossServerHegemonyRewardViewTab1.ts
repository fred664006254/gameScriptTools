//
class AcCrossServerHegemonyRewardViewTab1 extends CommonViewTab
{
	...
	protected initView():void
	{
        ...
        let list = this.cfg.getQualifyingRewardList();
        let rect = new egret.Rectangle(0, 0, 610, GameConfig.stageHeigth - 89 - 60 - 60 - detailBg.height + 35 - 84);
        let scrollList = ComponentManager.getScrollList(AcCrossServerHegemonyRewardScrollItem1,list,rect);
        ...
        let listBtn = ComponentManager.getButton(ButtonConst.BTN2_BIG_YELLOW, "acCrossServerHegemonyRewardListBtn2",this.listBtnClick,this,null,null,null,TextFieldConst.COLOR_BLACK);
