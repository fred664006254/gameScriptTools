 ...
 */
class AcFindSameRewardPopViewTab3 extends AcCommonViewTab{
    ...
    public initView():void{
        ...
        let scrollList = ComponentManager.getScrollList(AcFindSameRewardTab4ScrollItem, dataList, rect, {aid:this.aid, code:this.code});
