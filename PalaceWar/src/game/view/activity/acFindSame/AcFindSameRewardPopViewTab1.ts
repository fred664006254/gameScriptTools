 ...
 */
class AcFindSameRewardPopViewTab1 extends AcCommonViewTab{
    ...
    public initView():void{
        ...
        let scrollList = ComponentManager.getScrollList(AcFindSameRewardTab1ScrollItem, dataList, rect, {aid:this.aid, code:this.code});
