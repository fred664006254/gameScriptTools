class AcDuanWuTab1Item  extends ScrollListItem
{
    //item数据
    ...
    private _rechargeItem : Config.AcCfg.DWRechargeItemCfg = null;
	...
	protected initItem(index:number,data:Config.AcCfg.DWRechargeItemCfg,itemparam:any)
    {	
        let view = this;
        ...
        let str = `1013_0_${this._rechargeItem.zongZiGet}_${this.uicode}|` + this._rechargeItem.getReward;
