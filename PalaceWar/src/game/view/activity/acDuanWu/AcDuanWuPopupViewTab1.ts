/*
    ...
    desc : 粽叶飘香-端午节活动 
*/
class AcDuanWuPopupViewTab1 extends AcCommonViewTab
{   
    //滑动列表
    ...
    protected initView():void
	{
		...
		let scrollList = ComponentManager.getScrollList(AcDuanWuTab1Item,arr,tmpRect,[view.code,view.getUiCode()]);
    ...
    private rewardCallBack(evt : egret.Event):void{
        ...
        let str = `1013_0_${rData.zongZiGet}_${this.getUiCode()}|` + rewards;
