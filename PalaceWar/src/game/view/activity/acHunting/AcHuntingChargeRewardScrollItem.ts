/**
  ...
  */
 class AcHuntingChargeRewardScrollItem extends ScrollListItem {
	private _itemData: Config.AcCfg.HuntingRecharageItem = null;
	...
	public initItem(index: number, data: any, itemParam: any): void {
		...
		let titleTF = ComponentManager.getTextField(LanguageManager.getlocal("achuntingRecharge", [String(this._itemData.needGem)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
