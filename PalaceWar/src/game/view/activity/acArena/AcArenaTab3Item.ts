 ...
 */
class AcArenaTab3Item extends ScrollListItem
{
 
	private _data : Config.AcCfg.ArenaTaskItemCfg = null; 
	...
	protected initItem(index:number,data:Config.AcCfg.ArenaTaskItemCfg,itemparam:any)
    {	
        let view = this;
		...
		let str = `1011_0_${this.cfg.task[this._curIdx].shuipiaoGet}_${view._code}|` + data.getReward;
