 ...
 */
class AcArenaTab1Item  extends ScrollListItem
{
    //item数据
    ...
    private _rechargeItem : Config.AcCfg.ArenaRechargeItemCfg = null;
	...
	protected initItem(index:number,data:Config.AcCfg.ArenaRechargeItemCfg,itemparam:any)
    {	
        let view = this;
        ...
        let str = `1011_0_${this._rechargeItem.specialItem}_${this.code}|` + this._rechargeItem.getReward;
