...
desc : 端午活动节日任务
*/
class AcArenaPopupViewTab3 extends AcCommonViewTab
{
	//滑动列表
	...
	{	
		...
		let scrollList = ComponentManager.getScrollList(AcArenaTab3Item,taskArr,tmpRect,view.code);
	...
	private rewardCallBack(evt : egret.Event):void{
        ...
        let str = `1011_0_${cfg.shuipiaoGet}_${this.code}|` + rewards;
