//风华群芳--提升才情tab3 item
class AcGroupWifeBattleTalentViewTab3Item extends ScrollListItem
{
    ...
    private upBtnClick(){
		...
		if(statusLv == `1`){
			...
			if(this._param){
				ViewController.getInstance().openView(ViewConst.POPUP.ACGROUPWIFEBATTLETALENTUPPOPUPVIEW,{
					d:this._data,
					aid:this._param.aid,
