 ...
 * author qianjun----wxz
 */
class AcGroupWifeBattleTalentViewTab1 extends ViewTab {
		// 滑动列表
		...
		{		
			...
			{
				let cefengBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_RED, "acGroupWifeBattleTalentBtn", () => 
				{
			...
			let plusDesc2:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal("acGroupWifeBattleTalentTab1Tip1"),20,TextFieldConst.COLOR_BROWN);
			...
			let scroRect = new egret.Rectangle(0, 0, title.width+10, 770-(1136-GameConfig.stageHeigth));
			let infoList:any[] =[];
			...
			let nameText:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal("acGroupWifeBattleTalentTab1Tip2"),TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_LIGHT_YELLOW);
