...
class AcGroupWifeBattleVisitView extends PopupView
{	
	...
	protected resetBgSize():void{
		super.resetBgSize();
		let tipTxt = ComponentManager.getTextField(LanguageManager.getlocal(`acGroupWifeBattleTip14-${this.getUiCode()}`, [Config.GameprojectCfg.deleteEmail.toString()]),22,TextFieldConst.COLOR_LIGHT_YELLOW);
		...
		this.tabbarGroup.y = this.titleTF.y+28;
	}
