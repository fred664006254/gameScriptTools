 ...
 * 衣装预览
 * date 2020.7.30
 * @class AcMouseTreasurePopupViewTab4
 */
class AcMouseTreasurePopupViewTab4 extends CommonViewTab{
    ...
    public initView():void{
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_MOUSETREASURE_EXCHANGE, this.exchangeCallback, this);
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_MOUSETREASURE_GETACHIEVEMENT , this.getRewardCallback, this);
        let view = this;
        ...
        let rewardstr:string = this.cfg.change["changeReward"];
        ...
        let topStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("mouseTreasureSkinTopMsg", this.getTypeCode()), [""+toolItemVo.num, toolItemVo.name]);
    ...
    private exchangeBtnClick():void{
        ...
        if (currNum >= toolItemVo.num){
            //兑换
            NetManager.request(NetRequestConst.REQUEST_MOUSETREASURE_EXCHANGE, {activeId: this.vo.aidAndCode});
        }
    }
    ...
    public dispose():void{
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_MOUSETREASURE_EXCHANGE, this.exchangeCallback, this);
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_MOUSETREASURE_GETACHIEVEMENT , this.getRewardCallback, this);
