 ...
 * author sl
 * date 2020.7.29
 * @class AcMouseTreasureRankDetailPopupView
 */
class AcMouseTreasureRankDetailPopupView extends PopupView{
    ...
    public initView():void{
		...
		let tip = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("mouseTreasureRankListTip", this.getTypeCode()), [""+this.cfg.needScore]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_LIGHT_YELLOW);
