 ...
 */
class AcWealthComingLuckScrollItem extends ScrollListItem {
	...
	public initItem(index: number, data: any, itemParam: any): void {
		...
		let titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acWealthComingLuckRewardPopupViewItemTitle", [String(data.value)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
		...
		let percent = vo.getLuckyValue() / data.value;
		let textStr = vo.getLuckyValue() + "/" + data.value;
