 ...
 */
class AcWealthComingSkinRewardPopupView extends PopupView {
	...
	protected resetBgSize() {
		...
		let bg = BaseLoadBitmap.create("acwealthcomingview_skinbg");
		bg.width = 615 ;
		bg.height = 559;
		bg.setPosition(GameConfig.stageWidth / 2 - bg.width / 2, GameConfig.stageHeigth / 2 - bg.height / 2);
		this.addChildToContainer(bg);

		let titlebg = BaseLoadBitmap.create("acwealthcomingview_skintitlebg");
		titlebg.width = 337;
		titlebg.height = 104;
