 ...
 */
class AcWealthComingGetRewardPopupView extends BaseView {
    ...
    private initBuffers(buffers: any) {
        ...
        let wealthLuckTxt2 = ComponentManager.getTextField(LanguageManager.getlocal("acWealthComingGetRewardPopupViewBufferType2", [String(tjhcNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
