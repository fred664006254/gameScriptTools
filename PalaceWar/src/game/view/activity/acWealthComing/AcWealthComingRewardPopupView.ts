 ...
 */
class AcWealthComingRewardPopupView extends PopupView {
	...
	public initView(): void {
		...
		let topTF = ComponentManager.getTextField(LanguageManager.getlocal("acWealthComingRewardPopupViewTopDesc"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BLACK);
		topTF.setPosition(this.viewBg.x + this.viewBg.width / 2 - topTF.width / 2, 15);
		this.addChildToContainer(topTF);

		let rewards = cfg.getWealthGod();
