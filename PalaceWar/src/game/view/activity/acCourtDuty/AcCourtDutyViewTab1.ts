 ...
 */
class AcCourtDutyViewTab1 extends AcCommonViewTab{
    ...
    public initView(){
        ...
        let dataList = this.vo.getSortYaMenTaskCfg();
        let rect =  new egret.Rectangle(0, 0, listBg.width - 10, listBg.height - 10);
        let scrollList = ComponentManager.getScrollList(AcCourtDutyViewTaskScrollItem, dataList, rect, {aid:this.aid, code:this.code, type:1});
    ...
    {   
        ...
        if(this._maskPanel == null)
        {
            ...
            let dialogText = ComponentManager.getTextField(LanguageManager.getlocal("acCourtDutyRechargeInfo1-"+this.getTypeCode(), [""+this.cfg.needRecharge1]), TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_BROWN);
            ...
            let currRechargeNumStr = LanguageManager.getlocal("acCourtDutyRechargeNum-"+this.getTypeCode(),[""+currRechargeNum, ""+this.cfg.needRecharge1]);
    ...
    private refreshFetterPanel():void{
        if (this._lockDialog){
            ...
            let currNumStr = LanguageManager.getlocal("acCourtDutyRechargeNum-"+this.getTypeCode(),[""+currNum, ""+this.cfg.needRecharge1]);
