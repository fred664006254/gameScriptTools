//任务
class AcCrossServerIntimacyCheerViewTab3 extends CommonViewTab
{
	...
	protected initView():void
	{
		...
		let scrollList = ComponentManager.getScrollList(AcCrossServerIntimacyCheerViewScrollItem3, dataList, tmpRect, {aid:this.aid, code:this.code});
