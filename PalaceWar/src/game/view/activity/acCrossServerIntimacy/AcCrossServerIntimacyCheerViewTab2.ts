//助威
class AcCrossServerIntimacyCheerViewTab2 extends CommonViewTab
{
	...
	protected initView():void
	{
        ...
        let flagNum = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverImacyCheerflag", this.getUiCode()) ,[String(fNum)]),24,TextFieldConst.COLOR_WHITE);
        ...
        let info = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverImacyCheerInfo", this.getUiCode())),TextFieldConst.FONTSIZE_CONTENT_COMMON ,TextFieldConst.COLOR_WHITE);
        info.width = 600;
        info.lineSpacing = 5;
        info.x = scoreNum.x;
        ...
        let redPlusTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverImacyCheerAddPower", this.getUiCode())),20,TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        let playerAddTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverImacyCheerSelfNum", this.getUiCode())),20,TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        let list:any[] = [];
        let rankData = Api.crossImacyVoApi.flagRankInfo;
        if (rankData){
            list = rankData;
        }
        let listH = detailBg.y - redBg.y - redBg.height - 5;
        let rect = new egret.Rectangle(0,0, 620, listH);
        let scrollList = ComponentManager.getScrollList(AcCrossServerIntimacyCheerViewScrollItem2, list, rect, {aid:this.aid,code:this.code});
