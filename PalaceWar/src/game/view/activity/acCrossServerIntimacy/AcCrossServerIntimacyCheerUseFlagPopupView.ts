 ...
 */
class AcCrossServerIntimacyCheerUseFlagPopupView  extends PopupView
{
	...
	protected initView():void
	{
        ...
        let confirmTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverImacyUseFlagConfirm", this.code) ,["1",this._name,String(this.cfg.flagScoreNum1)]),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_BROWN);
