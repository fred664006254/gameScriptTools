class AcCrossServerIntimacyCheerViewScrollItem3 extends ScrollListItem
{
	...
	public initItem(index:number,data:any,itemParam:any):void
	{
		...
		let vo = <AcCrossServerIntimacyVo>Api.acVoApi.getActivityVoByAidAndCode(this.aid, this.code);
		//任务进度
	...
	{
		let vo = <AcCrossServerIntimacyVo>Api.acVoApi.getActivityVoByAidAndCode(this.aid, this.code);
		let cfg = <Config.AcCfg.CrossServerIntimacyCfg>Config.AcCfg.getCfgByActivityIdAndCode(this.aid, this.code);
