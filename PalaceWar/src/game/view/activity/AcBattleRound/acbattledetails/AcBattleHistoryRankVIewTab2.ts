//
class AcBattleHistoryRankVIewTab2 extends CommonViewTab
{
	...
	protected initView():void
	{
		...
		let scrollList = ComponentManager.getScrollList(AcBattleHistoryARankScrollItem,arr,tmpRect,this.param.data.code);
