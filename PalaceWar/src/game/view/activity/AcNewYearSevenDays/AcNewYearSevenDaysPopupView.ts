 ...
 * 春节活动 奖励宝箱奖励预览弹板
 */
class AcNewYearSevenDaysPopupView  extends PopupView
{
	...
	{	
        ...
        if(this._name=="newYear1")
        {
            ...
            let curr_acNewYearVo = <AcNewYearSevenDaysVo>Api.acVoApi.getActivityVoByAidAndCode(AcConst.AID_ACNEWYEAR7DAYS,this._code);
