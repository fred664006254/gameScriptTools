...
{	
	...
	protected initView():void
	{
		...
		let bossName = LanguageManager.getlocal("dailybossName"+String(bossData.bossLv-1));
		let killTxt:BaseTextField=ComponentManager.getTextField(LanguageManager.getlocal("dailybossKillBoss1ResultDesc",[String(bossData.bossLv-1),bossName]),TextFieldConst.FONTSIZE_CONTENT_SMALL,TextFieldConst.COLOR_WHITE);
