//邀请好友
class WelfareViewNewInviteTab1 extends CommonViewTab{
	...
	protected initView():void{
		...
		let tipTxt = ComponentManager.getTextField(LanguageManager.getlocal(`newinviteTitle`), 22, TextFieldConst.COLOR_LIGHT_YELLOW);
		view.addChild(tipTxt);
		App.DisplayUtil.setLayoutPosition(LayoutConst.leftverticalCenter,tipTxt,tipBg,[15,0]);
		
		//邀请码状态
		let state = BaseBitmap.create("newinvitestate1");
		...
		let tipTxt2 = ComponentManager.getTextField(LanguageManager.getlocal(`newinvitecodetip10`), 20, TextFieldConst.COLOR_BLACK);
		...
		let list = ComponentManager.getScrollList(NewInviteTaskItem, [], new egret.Rectangle(0,0,480,GameConfig.stageHeigth - 268 - 50 - juzhou.height - 10));
