...
class CommonRewardPopupView  extends BaseView
{
    ...
    private _wordParam:string = null;
    public constructor() {
		super();
	}
	...
	protected initView():void
	{
        ...
        this._wordParam = this.param.data.wordParam;
        //"6_1150_4|6_1710_1";
        if(rewards_data)
        {
    ...
    //显示额外的文本
    private showOtherTxt()
    {
        let otherRewardBg =  BaseBitmap.create("public_9_bg47");
        otherRewardBg.width = 500;
        otherRewardBg.height = 70;
        ...
        let txt = ComponentManager.getTextField(this._wordParam,TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_LIGHT_YELLOW);
        txt.textAlign = egret.HorizontalAlign.CENTER;
        txt.lineSpacing = 5;
        txt.setPosition(otherRewardBg.x+otherRewardBg.width/2-txt.width/2,otherRewardBg.y+otherRewardBg.height/2-txt.height/2);
        this._otherContainer.addChild(txt);
