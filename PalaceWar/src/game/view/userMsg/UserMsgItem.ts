 ...
 * author shaoliang
 */
class UserMsgItem  extends ScrollListItem
{   
    ...
    protected initItem(index:number,data:any,itemParam?:any)
    {
        ...
        let name1 = ComponentManager.getTextField( String(data)+".",TextFieldConst.FONTSIZE_CONTENT_COMMON,TextFieldConst.COLOR_BROWN);
        this.addChild(name1);
        ...
        {   
            this._maxLength = 200;
            let inputTF2 = ComponentManager.getInputTextField(TextFieldConst.COLOR_LIGHT_YELLOW, TextFieldConst.FONTSIZE_TITLE_SMALL,535,90,"public_9_bg5",LanguageManager.getlocal(`acQuestionTip3-1`),0xb1b1b1);
