class ServantExileBuffDetailView extends PopupView
{
    public constructor() 
	{
		super();
    ...
    public initView():void
    {
        ...
        let list = Api.servantVoApi.getBaseBuffListById(info.id)
		let scrollList = ComponentManager.getScrollList(ServantExileDetailScrollItem,list,rect,info);
