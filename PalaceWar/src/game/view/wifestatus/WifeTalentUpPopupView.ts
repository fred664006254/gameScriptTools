...
class WifeTalentUpPopupView extends PopupView
{
    ...
    // App.MessageHelper.addEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_WIFE_AWARD),this.useWifeCallback,this);
        ...
        let innerBg = BaseBitmap.create("public_9_bg4");
        innerBg.width = 530;
        innerBg.height = 412;
		...
		let bookBg = BaseBitmap.create("public_scrollitembg");
        ...
        let itemDesc1 = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalentUpPopupViewItem1"),18,TextFieldConst.COLOR_BROWN);
        ...
        let itemDesc2 = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalentUpPopupViewItem2"),18,TextFieldConst.COLOR_BROWN);
        ...
        let itemDesc3 = ComponentManager.getTextField(LanguageManager.getlocal("wifeTalentUpPopupViewItem3"),18,TextFieldConst.COLOR_BROWN);
