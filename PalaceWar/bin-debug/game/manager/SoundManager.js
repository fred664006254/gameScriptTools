...
var SoundManager = /** @class */ (function (_super) {
    ...
    */
    ...
    SoundManager.resumeBg = function () {
        console.log("QAZ resumeBg  " + SoundManager.getSoundSwitch() + SoundManager.isInBackground + App.DeviceUtil.IsHtml5() + SoundManager.bgOn);
        if (!SoundManager.getSoundSwitch()) {
            return;
        }
        if (SoundManager.isInBackground) {
        ...
        //     console.log("QAZ playBg  "+SoundManager.currBg);
        ...
        // {
        //     TimerManager.doTimer(1000,1,SoundManager.playBg,SoundManager);
        // }
        // else
        // {
        SoundManager.playBg(SoundManager.currBg);
