...
var BubbleTip = (function (_super) {
    ...
    BubbleTip.prototype.init = function (name, length, isTrue) {
        ...
        var bubbleName = null;
        if (RES.hasRes("mainui_bubble_" + name + "_" + Api.otherInfoVoApi.getCurSceneId())) {
            bubbleName = "mainui_bubble_" + name + "_" + Api.otherInfoVoApi.getCurSceneId();
        }
        else if (RES.hasRes("mainui_bubble_" + name)) {
            bubbleName = "mainui_bubble_" + name;
        }
        if (bubbleName) {
