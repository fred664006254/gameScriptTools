...
var AllianceMemberInfoVo = (function (_super) {
    ...
    AllianceMemberInfoVo.prototype.initData = function (data) {
        if (data) {
            ...
            if (data.monthcardDonate) {
                this.monthcardDonate = data.monthcardDonate;
            }
            if (data.ptitle) {
