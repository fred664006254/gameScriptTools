...
var NewatkracecrossVo = (function (_super) {
    __extends(NewatkracecrossVo, _super);
    function NewatkracecrossVo() {
    ...
    NewatkracecrossVo.prototype.initData = function (data) {
        if (data) {
    ...
    NewatkracecrossVo.prototype.dispose = function () {
        this.point = 0;
        this.einfo = null;
        this.lastday = 0;
        this.isjoin = 0;
    ...
    return NewatkracecrossVo;
}(BaseVo));
__reflect(NewatkracecrossVo.prototype, "NewatkracecrossVo");
//# sourceMappingURL=NewatkracecrossVo.js.map