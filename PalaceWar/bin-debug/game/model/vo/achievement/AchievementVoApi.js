...
var AchievementVoApi = (function (_super) {
    ...
    AchievementVoApi.prototype.getSortAchInfoVo = function () {
        return this._achInfoVo;
    };
    AchievementVoApi.prototype.setSortAchInfoVo = function (achInfoVo) {
        this._achInfoVo = achInfoVo;
    };
    AchievementVoApi.prototype.getSortAchCfg = function () {
        return this._achCfg;
    };
    AchievementVoApi.prototype.setSortAchCfg = function (achCfg) {
        this._achCfg = achCfg;
    };
    AchievementVoApi.prototype.getSortStage = function () {
        return this._stage;
    };
    AchievementVoApi.prototype.setSortStage = function (stage) {
        this._stage = stage;
    };
    AchievementVoApi.prototype.getSortCurValue = function () {
        return this._curValue;
    };
    AchievementVoApi.prototype.setSortCurValue = function (curValue) {
        this._curValue = curValue;
    };
    AchievementVoApi.prototype.getSortValue = function () {
        return this._value;
    };
    AchievementVoApi.prototype.setSortValue = function (value) {
        this._value = value;
    };
    AchievementVoApi.prototype.getUIItemId = function () {
        return this._itemId;
    };
    AchievementVoApi.prototype.setUIItemId = function (itemId) {
        this._itemId = itemId;
    };
    /**
     * 获取成就列表
    ...
    AchievementVoApi.prototype.getAchDetailList = function (aid) {
        var _this = this;
        var achCfg = Api.achievementVoApi.getSortAchCfg();
        var arr = new Array();
        var length = achCfg.value.length;
    ...
    AchievementVoApi.prototype.getAchDetailState = function (aid, index) {
        var state = 3;
        var achInfoVo = Api.achievementVoApi.getSortAchInfoVo();
        var achCfg = Api.achievementVoApi.getSortAchCfg();
        var stage = Api.achievementVoApi.getSortStage();
        var curValue = Api.achievementVoApi.getSortCurValue();
        var curF = achInfoVo.f;
        if (index < stage - 1) {
            //不是最後一個
            state = 4;
        }
