...
var EmperorwarActiveVo = (function (_super) {
    ...
    EmperorwarActiveVo.prototype.initData = function (info) {
        var data = info.activeinfo;
        var periods = info.periods;
        if (data) {
            if (data.flag != null) {
    ...
    EmperorwarActiveVo.prototype.getPeriod = function (idx) {
...
//# sourceMappingURL=EmperorwarActiveVo.js.map