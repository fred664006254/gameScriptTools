...
var ItemInfoVo = (function (_super) {
    ...
    Object.defineProperty(ItemInfoVo.prototype, "isShowHechengBtn", {
        // 是否显示合成按钮
        get: function () {
            if (this.itemCfg) {
                return this.itemCfg.type == 2 && this.num >= this.itemCfg.costHeCheng;
            }
            return false;
        },
        enumerable: true,
    ...
    Object.defineProperty(ItemInfoVo.prototype, "costHecheng", {
        get: function () {
            if (this.itemCfg) {
                return this.itemCfg.costHeCheng;
            }
            return 0;
        },
        enumerable: true,
    ...
    Object.defineProperty(ItemInfoVo.prototype, "targetId", {
        get: function () {
            if (this.itemCfg) {
                return this.itemCfg.targetId;
            }
            return 0;
        },
        enumerable: true,
    ...
    Object.defineProperty(ItemInfoVo.prototype, "getRewards", {
        get: function () {
            if (this.itemCfg) {
                return this.itemCfg.getRewards;
            }
            return null;
        },
        enumerable: true,
    ...
    ItemInfoVo.prototype.descByNum = function (n) {
        return this.itemCfg.descByNum(n);
    };
...
//# sourceMappingURL=ItemInfoVo.js.map