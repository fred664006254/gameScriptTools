...
var AcWifeComeVo = (function (_super) {
    ...
    //倒计时
    AcWifeComeVo.prototype.getCountDown = function () {
    ...
    Object.defineProperty(AcWifeComeVo.prototype, "isShowRedDot", {
        get: function () {
            var acVo = Api.acVoApi.getActivityVoByAidAndCode(this.aid, String(this.code));
            var acCfg = Config.AcCfg.getCfgByActivityIdAndCode(this.aid, this.code);
            if (!acCfg) {
                return false;
            }
    ...
    AcWifeComeVo.prototype.isNotCanStart = function () {
    ...
    AcWifeComeVo.prototype.checkIsHasScene = function () {
        var acCfg = Config.AcCfg.getCfgByActivityIdAndCode(this.aid, this.code);
    ...
    AcWifeComeVo.prototype.checkIsHasWifeSkin = function () {
        var acCfg = Config.AcCfg.getCfgByActivityIdAndCode(this.aid, this.code);
    ...
    Object.defineProperty(AcWifeComeVo.prototype, "isShowIcon", {
        get: function () {
...
//# sourceMappingURL=AcWifeComeVo.js.map