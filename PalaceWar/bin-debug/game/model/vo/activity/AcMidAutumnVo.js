...
var AcMidAutumnVo = (function (_super) {
    ...
    Object.defineProperty(AcMidAutumnVo.prototype, "acTimeAndHour", {
        get: function () {
            var et = this.et - 86400;
    ...
    Object.defineProperty(AcMidAutumnVo.prototype, "acCountDown", {
        /**
         * 活动结束倒计时，格式：00：00：00
         */
        get: function () {
    ...
    AcMidAutumnVo.prototype.getRewardWife = function () {
        if (this.code == 5 || this.code == 6) {
            return "238";
        }
        return '223';
    };
    AcMidAutumnVo.prototype.getRewardServant = function () {
        if (this.code == 5 || this.code == 6) {
            return "1064";
        }
        return '1056';
...
//# sourceMappingURL=AcMidAutumnVo.js.map