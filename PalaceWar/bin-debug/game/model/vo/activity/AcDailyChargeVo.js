...
var AcDailyChargeVo = (function (_super) {
        ...
        get: function () {
            ...
            for (var key in list) {
                ...
                if (tmpCfg.isSpecial && tmpCfg.isSpecial == 1) {
                    ...
                    //getSwitchNum
                    if (!this.flags[key] && this.v >= list[key]["needGem"] && tmpCfg.isSpecial <= this.getSwitchNum()) {
                        return true;
                    }
                }
    ...
    AcDailyChargeVo.prototype.getSwitchNum = function () {
        var maxNumb = 0;
        for (var i = 1; i <= 12; i++) {
            if (Api.switchVoApi.checkSpecialState(String(i))) {
                maxNumb = i;
            }
        }
        return maxNumb;
...
//# sourceMappingURL=AcDailyChargeVo.js.map