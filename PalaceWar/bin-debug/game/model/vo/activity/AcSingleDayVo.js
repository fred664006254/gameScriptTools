...
var AcSingleDayVo = (function (_super) {
    ...
    /**是否买了这个皮肤 */
    AcSingleDayVo.prototype.isBuySkin = function (key) {
        if (this.skin[key]) {
    ...
    AcSingleDayVo.prototype.getpublicRedhot = function () {
        ...
        if (GameData.serverTime < this.et - 86400 && GameData.serverTime >= this.st) {
            for (var i = 1; i < 4; ++i) {
    ...
    Object.defineProperty(AcSingleDayVo.prototype, "isShowRedDot", {
        get: function () {
            ...
            // 	return false; 
            // }
            return this.getpublicRedhot() || this.getpublicRedhot2() || this.getpublicRedhot3();
        },
        enumerable: true,
        configurable: true
    });
    ...
    //倒计时
    AcSingleDayVo.prototype.getCountDown = function () {
    ...
    AcSingleDayVo.prototype.getCurNum = function () {
        var collectnum = 0;
        var cfg = this.cfg;
        var today0 = App.DateUtil.getWeeTs(GameData.serverTime);
        var st = today0 + cfg.startTime;
    ...
    //五虎战神
    AcSingleDayVo.prototype.getShowSkinIds = function (isSort) {
        if (this.code == 2 || this.code == 3) {
            // return [2017, 2016, 2015, 2018, 2014];
            return [2014, 2015, 2017, 2018, 2016];
        }
        return [];
    };
...
//# sourceMappingURL=AcSingleDayVo.js.map