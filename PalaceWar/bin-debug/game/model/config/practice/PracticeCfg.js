...
(function (Config) {
    ...
    var PracticeItemCfg = (function (_super) {
        ...
        PracticeItemCfg.prototype.getConditionList = function () {
            if (this.conditionList["1"] && this.conditionList["1"].conditionType == 1 && !Api.switchVoApi.checkOpenServantLevel450()) {
                var conditionList2 = {};
                var keys = Object.keys(this.conditionList);
                for (var index = 0; index < keys.length; index++) {
                    var key = keys[index];
                    var tmpCon = this.conditionList[key];
...
//# sourceMappingURL=PracticeCfg.js.map