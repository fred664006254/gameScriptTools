...
var PrestigeVoApi = (function (_super) {
    ...
    PrestigeVoApi.prototype.getPid = function () {
        return this.prestigeVo.info.pid;
    };
    PrestigeVoApi.prototype.getPValue = function () {
    ...
    PrestigeVoApi.prototype.getUnlockStr = function () {
        return LanguageManager.getlocal("prestige_unlockStr");
    };
    PrestigeVoApi.prototype.canEmperor = function () {
        return this.prestigeVo.canemper > 0;
    };
    PrestigeVoApi.prototype.getAinfo = function () {
        return this.prestigeVo.info.ainfo;
    };
    PrestigeVoApi.prototype.isBallLightUpEnable = function (id) {
        if (id === void 0) { id = -1; }
        if (id == -1) {
            id = this.getPid();
        }
        ...
        var cfg = Config.PrestigeCfg.getPrestigeCfgById(id);
        if (cfg) {
    ...
    PrestigeVoApi.prototype.isShowRedForPBottom = function () {
        if (this.isShowRedDot && Api.switchVoApi.checkOpenPrestige()) {
            return true;
        }
        return false;
    };
    PrestigeVoApi.prototype.isFirst = function () {
        var first = this.prestigeVo.info.first;
        if (!first || first == 1) {
            return true;
        }
        return false;
...
//# sourceMappingURL=PrestigeVoApi.js.map