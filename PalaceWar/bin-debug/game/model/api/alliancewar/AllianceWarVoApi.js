...
var AllianceWarVoApi = (function (_super) {
    ...
    */
    ...
    /**获得当前的是周几---指向派遣or战斗阶段 */
    AllianceWarVoApi.prototype.getWeeksWithDate = function () {
        var weekStr = null;
        //服务器返回周一的时间
        var mondayStr = this.getWeekStrbyWeek(App.DateUtil.getServerDate(this.monday).getDay());
        //服务器返回周三的时间
        var wednesdayStr = this.getWeekStrbyWeek(App.DateUtil.getServerDate(this.monday + 2 * 86400).getDay());
        //服务器返回周五的时间
        var fridayStr = this.getWeekStrbyWeek(App.DateUtil.getServerDate(this.monday + 4 * 86400).getDay());
        weekStr = mondayStr + ", " + wednesdayStr + ", " + fridayStr;
        return weekStr;
    };
    AllianceWarVoApi.prototype.getWeekStrbyWeek = function (week) {
        switch (week) {
            case 0:
                return LanguageManager.getlocal("sundayTitle");
            case 1:
                return LanguageManager.getlocal("mondayTitle");
            case 2:
                return LanguageManager.getlocal("tuesdayTitle");
            case 3:
                return LanguageManager.getlocal("wednesdayTitle");
            case 4:
                return LanguageManager.getlocal("thursdayTitle");
            case 5:
                return LanguageManager.getlocal("fridayTitle");
            case 6:
                return LanguageManager.getlocal("saturdayTitle");
        }
    };
...
//# sourceMappingURL=AllianceWarVoApi.js.map