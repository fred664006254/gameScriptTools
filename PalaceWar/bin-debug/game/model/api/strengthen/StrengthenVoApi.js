...
var StrengthenVoApi = (function (_super) {
    ...
    StrengthenVoApi.prototype.checkNpcMessage = function () {
        ...
        for (var i = 0; i < arr.length; i++) {
            var openType = arr[i];
            if (openType == "servant") {
                if ([openType + "VoApi"] && Api[openType + "VoApi"].checkRedPoint() && Config.GameprojectCfg.closeRedDot && Api.playerVoApi.getPlayerLevel() < Config.GameprojectCfg.closeRedDot) {
                    return true;
                }
            }
...
//# sourceMappingURL=StrengthenVoApi.js.map