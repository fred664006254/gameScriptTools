...
var MailVoApi = (function (_super) {
    ...
    MailVoApi.prototype.checkNpcMessage = function () {
    ...
    MailVoApi.prototype.hasInit = function () {
        return !!this.mailVo;
    };
    /**
     * 邮件总数
     ...
     * 获取所有未读邮件
     */
    MailVoApi.prototype.getAllNotReadMail = function () {
        var mailInfoArr = this.getMailInfoVoList();
        var arr = new Array();
        for (var i = 0; i < mailInfoArr.length; i++) {
...
//# sourceMappingURL=MailVoApi.js.map