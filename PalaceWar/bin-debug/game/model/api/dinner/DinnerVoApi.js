...
var DinnerVoApi = (function (_super) {
    ...
    DinnerVoApi.prototype.setShareTime = function (t) {
        if (!this.dinnerVo.other_info) {
            this.dinnerVo.other_info = {};
        }
        this.dinnerVo.other_info["isshare"] = t;
    };
    DinnerVoApi.prototype.isShowNpc = function () {
        return Api.playerVoApi.getPlayerLevel() >= Config.DinnerCfg.getNeedLv();
    };
    DinnerVoApi.prototype.checkNpcMessage = function () {
        if (this.dinnerVo.dtype && this.dinnerVo.end_time) {
            if (GameData.serverTime > this.dinnerVo.end_time) {
                return true;
            }
            var totalNum = Config.DinnerCfg.getFeastItemCfg(this.dinnerVo.dtype).contain;
            if (this.dinnerVo.jinfo.length >= totalNum) {
                return true;
            }
        }
        return false;
    ...
    DinnerVoApi.prototype.getTotalNumber = function () {
        return this.dinnerVo.totalNum;
    };
    DinnerVoApi.prototype.setTotalNumber = function (n) {
        this.dinnerVo.totalNum = n;
    };
    DinnerVoApi.prototype.getOneKeyNum = function () {
        if (this.dinnerVo.other_info && this.dinnerVo.other_info["oneKeyNum"]) {
            return this.dinnerVo.other_info["oneKeyNum"];
        }
        return 0;
    };
...
//# sourceMappingURL=DinnerVoApi.js.map