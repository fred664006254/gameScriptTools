...
var WifeORServantInfoPopupView = (function (_super) {
    ...
    WifeORServantInfoPopupView.prototype.initView = function () {
        ...
        var detalS = 1.2;
        iconBg.x = 30 + GameData.popupviewOffsetX;
        iconBg.y = 45;
        ...
        effectTitleTF.x = 171 + GameData.popupviewOffsetX;
        effectTitleTF.y = 29 + 20;
        ...
        if (PlatformManager.checkIsEnLang()) {
            effectDescTF.width = 265;
        }
        else if (PlatformManager.checkIsRuLang()) {
            effectDescTF.width = 250;
        }
        effectDescTF.text = effectDesc;
...
//# sourceMappingURL=WifeORServantInfoPopupView.js.map