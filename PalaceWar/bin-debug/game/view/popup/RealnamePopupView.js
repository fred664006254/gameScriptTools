...
var RealnamePopupView = /** @class */ (function (_super) {
    ...
    RealnamePopupView.prototype.initView = function () {
        ...
        var newnum = 0;
        for (var i = 0; i < l; i++) {
            var icon = GameData.getItemIcon(this.rewardArrList[i], true);
            var num = i % 5;
    ...
    RealnamePopupView.prototype.restBtnType = function () {
        ...
        RSDKHelper.ifRealNameAuth(function (result) {
            if (result) {
                ...
                App.MessageHelper.dispatchEvent(MessageConst.MESSAGE_REALNAME);
            }
        });
...
//# sourceMappingURL=RealnamePopupView.js.map