...
var SettingLangPopupView = (function (_super) {
    ...
    SettingLangPopupView.prototype.initView = function () {
        ...
        var i = 0;
        var bgMaxH = 0;
        var curKey = PlatformManager.getSpidKey();
        ...
        for (var key in arr) {
            if (arr.hasOwnProperty(key)) {
                ...
                var checkBox = ComponentManager.getCheckBox(GameConfig.localLangCfg[langItem]);
    ...
    SettingLangPopupView.prototype.changeLangHandler = function (target, params) {
        ...
        if (target.checkSelected()) {
            ViewController.getInstance().openView(ViewConst.POPUP.CONFIRMPOPUPVIEW, {
                msg: LanguageManager.getlocal("switchAreaLangTip"), title: "itemUseConstPopupViewTitle", needCancel: true, handler: this, callback: function () {
                    for (var key in list) {
