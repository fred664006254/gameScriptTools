...
var CouncilRewardRankItem = (function (_super) {
    ...
    CouncilRewardRankItem.prototype.initItem = function (index, data) {
        ...
        var bg = BaseBitmap.create('discussline');
        bg.width = view.width;
        bg.height = 38;
        ...
        this.addChild(txt);
        var serverTxt = ComponentManager.getTextField(LanguageManager.getlocal('councilRankListParam3', [data.exp]), TextFieldConst.FONTSIZE_CONTENT_COMMON);
        App.DisplayUtil.setLayoutPosition(LayoutConst.horizontalCentertop, serverTxt, bg, [0, bg.height + 10]);
        this.addChild(serverTxt);
        var scoreTxt = ComponentManager.getTextField(LanguageManager.getlocal('councilRankListParam4', [data.bookexp]), TextFieldConst.FONTSIZE_CONTENT_COMMON);
...
//# sourceMappingURL=CouncilRewardRankItem.js.map