...
var AllianceWarShowPlayerInfoItem = (function (_super) {
    ...
    AllianceWarShowPlayerInfoItem.prototype.initItem = function (index, data) {
        ...
        if (index == 0) {
            serverTxt.textColor = nameTxt.textColor = data.type == 'left' ? TextFieldConst.COLOR_QUALITY_BLUE : TextFieldConst.COLOR_QUALITY_YELLOW;
        }
    ...
    AllianceWarShowPlayerInfoItem.prototype.refreshTextColor = function () {
        var view = this;
        if (view.serverTxt) {
            view.serverTxt.textColor = view.nameTxt.textColor = this._data.type == 'left' ? TextFieldConst.COLOR_QUALITY_BLUE : TextFieldConst.COLOR_QUALITY_YELLOW;
        }
    };
...
//# sourceMappingURL=AllianceWarShowPlayerInfoItem.js.map