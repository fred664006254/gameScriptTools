...
var AllianceWarVsView = (function (_super) {
    ...
    AllianceWarVsView.prototype.createWarInfo = function (type) {
        ...
        if (title) {
            var titleinfo = App.CommonUtil.getTitleData(title);
        ...
        var isnew = Api.playerVoApi.getNewPalaceRole(lv);
        ...
        var servernameTxt = ComponentManager.getBitmapText(Api.mergeServerVoApi.getAfterMergeSeverName(null, true, wardata.server), TextFieldConst.FONTNAME_ITEMTIP);
...
//# sourceMappingURL=AllianceWarVsView.js.map