 ...
 * author qianjun
 */
var AllianceWarShowAntiView = (function (_super) {
    __extends(AllianceWarShowAntiView, _super);
    function AllianceWarShowAntiView() {
    ...
    Object.defineProperty(AllianceWarShowAntiView.prototype, "api", {
        get: function () {
    ...
    AllianceWarShowAntiView.prototype.getSoundBgName = function () {
        return 'music_atkrace';
    };
    AllianceWarShowAntiView.prototype.getRequestData = function () {
        var view = this;
    ...
    AllianceWarShowAntiView.prototype.receiveData = function (rdata) {
        if (!rdata.ret) {
            return;
        }
        var view = this;
        var test = view.param.data.ishistory;
        var testdata = view.param.data.test;
        var arr = ['left', 'right'];
    ...
    AllianceWarShowAntiView.prototype.getBgName = function () {
        return 'alliancewarbg2';
    };
    AllianceWarShowAntiView.prototype.initBg = function () {
    ...
    AllianceWarShowAntiView.prototype.initView = function () {
        var view = this;
    ...
    AllianceWarShowAntiView.prototype.createWarInfo = function (type) {
        var view = this;
    ...
    AllianceWarShowAntiView.prototype.beginWarLog = function () {
        var view = this;
        view._skinEquip = [];
    ...
    AllianceWarShowAntiView.prototype.calPlanEffect = function (sourceData, TargetData) {
        var view = this;
    ...
    AllianceWarShowAntiView.prototype.calExtraDamage = function (plan, curhp) {
        var view = this;
        var cfg = Config.AlliancewarCfg.getItemList();
        var extra = 0;
        if (plan) {
    ...
    AllianceWarShowAntiView.prototype.showRoundAnti = function (type, func, obj, showskin, showskinfunc) {
        var view = this;
    ...
    AllianceWarShowAntiView.prototype.showNext = function (type, skip, func, obj) {
        var view = this;
        var role = view["_servantRole" + type];
        var isOnleft = type == LayoutConst.left;
        var playerNameTxt = view["_playerNameTxt" + type];
    ...
    AllianceWarShowAntiView.prototype.showBuff2 = function (type, func, obj) {
        var view = this;
        var data = view._roundLog[view._round][type];
        var role = view["_servantRole" + type];
        var isOnleft = type == LayoutConst.left;
    ...
    AllianceWarShowAntiView.prototype.showBuff = function (type, func, obj) {
        var view = this;
        var data = view._roundLog[view._round][type];
        var role = view["_servantRole" + type];
        var isOnleft = type == LayoutConst.left;
    ...
    AllianceWarShowAntiView.prototype.freshPlanTxt = function (plan, type) {
        var view = this;
        var plangroup = view["_planGroup" + type];
        var param;
        var cfg = Config.AlliancewarCfg.getItemList();
    ...
    AllianceWarShowAntiView.prototype.skipFight = function () {
        var view = this;
        var score = 0;
    ...
    AllianceWarShowAntiView.prototype.freshText = function (type, param, isLeft) {
        var view = this;
    ...
    AllianceWarShowAntiView.prototype.startMove = function () {
        var _this = this;
        var view = this;
        //移动碰撞
        if (view.checkWin()) {
    ...
    AllianceWarShowAntiView.prototype.checkWin = function () {
        var view = this;
        var endFlag = true;
        var roundData = view._roundLog[view._round];
        if (roundData) {
    ...
    AllianceWarShowAntiView.prototype.tick = function () {
        var view = this;
    };
    AllianceWarShowAntiView.prototype.getResourceList = function () {
    ...
    AllianceWarShowAntiView.prototype.getRuleInfo = function () {
        return null;
    };
    AllianceWarShowAntiView.prototype.getTitleBgName = function () {
        return null;
    };
    AllianceWarShowAntiView.prototype.getTitleStr = function () {
        return null;
    };
    AllianceWarShowAntiView.prototype.getCloseBtnName = function () {
        return ButtonConst.POPUP_CLOSE_BTN_1;
    };
    AllianceWarShowAntiView.prototype.closeHandler = function () {
        var view = this;
        view.skipFight();
    };
    AllianceWarShowAntiView.prototype.showSkin = function (func) {
        var view = this;
        if (this._skinEquip.length) {
    ...
    AllianceWarShowAntiView.prototype.dispose = function () {
        var view = this;
    ...
    return AllianceWarShowAntiView;
}(CommonView));
__reflect(AllianceWarShowAntiView.prototype, "AllianceWarShowAntiView");
//# sourceMappingURL=AllianceWarShowAntiView.js.map