...
var AllianceWarResultView = (function (_super) {
    ...
    AllianceWarResultView.prototype.init = function () {
        ...
        if (view.param.data.wartype == 'countrywar') {
            var code = Math.abs(Api.countryWarVoApi.getCityResult(view.param.data.cityId));
        ...
        App.DisplayUtil.setLayoutPosition(LayoutConst.horizontalCentertop, battleFail, winText, [0, winText.height + (view.param.data.wartype == 'countrywar' ? 25 : 45)]);
...
//# sourceMappingURL=AllianceWarResultView.js.map