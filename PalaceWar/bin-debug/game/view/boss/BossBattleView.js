...
var BossBattleView = (function (_super) {
    ...
    function BossBattleView() {
        ...
        _this._emptyInfo = null;
        _this._emptyTime = null;
        return _this;
    }
    ...
    BossBattleView.prototype.initView = function () {
        ...
        var autoBattleNeedVipLv = Config.VipCfg.getAutoBossLevel();
    ...
    BossBattleView.prototype.autoBattleHandle = function () {
    ...
    BossBattleView.prototype.autoBattleCheck = function () {
    ...
    BossBattleView.prototype.autoBattleCallback = function () {
        if (this._autoBattleView) {
    ...
    BossBattleView.prototype.showEmptyInfo = function () {
        if (!this._emptyInfo) {
            ...
            var bg3 = BaseBitmap.create("public_9_wordbg2");
            bg3.width = GameConfig.stageWidth;
            this._emptyInfo.addChild(bg3);
            var lastTime = App.DateUtil.getWeeTs(GameData.serverTime) + 86400 - GameData.serverTime;
    ...
    BossBattleView.prototype.tick = function () {
        if (this._emptyTime) {
            var lastTime = App.DateUtil.getWeeTs(GameData.serverTime) + 86400 - GameData.serverTime;
            if (lastTime < 0) {
                lastTime = 0;
    ...
    BossBattleView.prototype.checkMessage = function () {
        var _this = this;
        var allKeys = Object.keys(this._allServantInfo);
        allKeys.sort(function (a, b) {
            var valueA = Api.challengeVoApi.getServantInfoValue(a);
    ...
    BossBattleView.prototype.hideEmptyInfo = function () {
        if (this._emptyInfo) {
...
//# sourceMappingURL=BossBattleView.js.map