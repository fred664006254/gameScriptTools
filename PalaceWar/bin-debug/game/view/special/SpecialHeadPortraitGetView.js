 ...
 * @author 张朝阳
 * date 2019/3/27
 * @class SpecialHeadPortraitGetView
 */
var SpecialHeadPortraitGetView = (function (_super) {
    __extends(SpecialHeadPortraitGetView, _super);
    function SpecialHeadPortraitGetView() {
    ...
    /**创建view */
    SpecialHeadPortraitGetView.prototype.createView = function (id) {
    ...
    /**同类型刷新view */
    SpecialHeadPortraitGetView.prototype.refreashView = function (id) {
        var titlecfg = Config.TitleCfg.getTitleCfgById(id);
        this._titleId = id;
        var titleInfo = this.dealAttrChangeInfo(titlecfg);
        var depth = 0;
        if (this._headPortrait) {
            ...
            this._headPortrait = Api.playerVoApi.getPlayerCircleHead(Api.playerVoApi.getPlayePicId(), titlecfg.id);
    ...
    SpecialHeadPortraitGetView.prototype.playAni = function () {
        var _this = this;
    ...
    SpecialHeadPortraitGetView.prototype.dealAttrChangeInfo = function (titlecfg) {
        var titleInfoList = [];
        for (var i = 1; i <= 4; i++) {
            var str = "";
            if (titlecfg.effect1) {
    ...
    /**特效 */
    SpecialHeadPortraitGetView.prototype.playHeadEffect = function (id) {
        var titlecfg = Config.TitleCfg.getTitleCfgById(id);
        //头像的bg
    ...
    SpecialHeadPortraitGetView.prototype.golookInfoBtnClick = function () {
        ...
        this.callBack();
        var itemview = ViewController.getInstance().getView(ViewConst.COMMON.ITEMVIEW_TAB4);
    ...
    SpecialHeadPortraitGetView.prototype.isShowBtn = function () {
        return true;
    };
    SpecialHeadPortraitGetView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "acluckycarpview_effect_lightpoint"
        ]);
    };
    SpecialHeadPortraitGetView.prototype.dispose = function () {
    ...
    return SpecialHeadPortraitGetView;
}(SpecialBaseView));
__reflect(SpecialHeadPortraitGetView.prototype, "SpecialHeadPortraitGetView");
//# sourceMappingURL=SpecialHeadPortraitGetView.js.map