 ...
 */
var SpecialTitle4GetView = (function (_super) {
    __extends(SpecialTitle4GetView, _super);
    function SpecialTitle4GetView() {
    ...
    SpecialTitle4GetView.prototype.createView = function (id) {
        var _this = this;
        ...
        var iconpic = titlecfg.titleIcon3;
        // if (titlecfg.isLvUp)
        // {
    ...
    SpecialTitle4GetView.prototype.refreashView = function (id) {
        var titlecfg = Config.TitleCfg.getTitleCfgById(id);
        this._titleId = id;
        var titleInfo = this.dealAttrChangeInfo(titlecfg);
        var iconpic = titlecfg.titleIcon3;
    ...
    SpecialTitle4GetView.prototype.dealAttrChangeInfo = function (titlecfg) {
        var titleInfoList = [];
        for (var i = 1; i <= 4; i++) {
            var str = "";
            if (titlecfg.effect1) {
    ...
    SpecialTitle4GetView.prototype.playAni = function () {
        var _this = this;
    ...
    SpecialTitle4GetView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "specialview_commoni_itembg"
        ]);
    };
    SpecialTitle4GetView.prototype.golookInfoBtnClick = function () {
    ...
    SpecialTitle4GetView.prototype.isShowBtn = function () {
        return true;
    };
    SpecialTitle4GetView.prototype.dispose = function () {
        egret.Tween.removeTweens(this._smallThorn1);
        egret.Tween.removeTweens(this._smallThorn2);
        egret.Tween.removeTweens(this._titleBM);
        egret.Tween.removeTweens(this._titleEffectBM);
    ...
    return SpecialTitle4GetView;
}(SpecialBaseView));
__reflect(SpecialTitle4GetView.prototype, "SpecialTitle4GetView");
//# sourceMappingURL=SpecialTitle4GetView.js.map