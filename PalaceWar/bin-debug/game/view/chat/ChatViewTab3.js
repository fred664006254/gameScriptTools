...
var ChatViewTab3 = (function (_super) {
    ...
    ChatViewTab3.prototype.isShowEmoticonBtn = function () {
    ...
    ChatViewTab3.prototype.refreshChatByScroll = function () {
    ...
    ChatViewTab3.prototype.emoticonBtnClick = function () {
        ...
        ViewController.getInstance().openView(ViewConst.COMMON.EMOTICONVIEW, { channel: Api.playerVoApi.getPlayerAllianceId(), type: 0 });
    };
    ChatViewTab3.prototype.refreshChat = function () {
        var isButtom = this._scrollList.checkIsAtButtom();
        if (isButtom) {
            var chatList = Api.chatVoApi.getAllianceList();
            this._scrollList.refreshData(chatList);
    ...
    ChatViewTab3.prototype.checkShowMoreTip = function () {
        var moreBtn = this.getChildByName("moreBtn");
        if (this._scrollList && this._scrollList.checkIsAtButtom()) {
            if (moreBtn) {
                moreBtn.visible = false;
    ...
    ChatViewTab3.prototype.scrollToButtom = function () {
        this._scrollList.moveToButtom();
        this.refreshChat();
    };
    ChatViewTab3.prototype.sentBtnClick = function () {
        if (Api.switchVoApi.checkCloseChat()) {
            App.CommonUtil.showTip(LanguageManager.getlocal("noChat"));
            return;
        }
    ...
    ChatViewTab3.prototype.requestChatCallBack = function (data) {
        if (this._sendBtn) {
            this._sendBtn.setEnable(true);
            this._sendBtn.setText("chatViewSend");
        }
    };
    ChatViewTab3.prototype.refreshTrans = function () {
        var isButtom = this._scrollList.checkIsAtButtom();
...
//# sourceMappingURL=ChatViewTab3.js.map