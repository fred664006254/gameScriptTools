...
var WifebattleBattleView = /** @class */ (function (_super) {
    __extends(WifebattleBattleView, _super);
    function WifebattleBattleView() {
        ...
        _this._animTime = 1000;
        return _this;
    }
    WifebattleBattleView.prototype.getCloseBtnName = function () {
        return null;
    };
    ...
    //     return true;
    // }
    WifebattleBattleView.prototype.hide = function () {
        if (this._target && this._callback) {
            this._callback.apply(this._target);
        }
        _super.prototype.hide.call(this);
    };
    WifebattleBattleView.prototype.initView = function () {
    ...
    WifebattleBattleView.prototype.initBg = function () {
    ...
    WifebattleBattleView.prototype.isShowOpenAni = function () {
        return false;
    };
    /**
     * 显示初始化View
     */
    WifebattleBattleView.prototype.initBottomView = function () {
        ...
        this._enemyWifeCount.x = GameConfig.stageWidth - 8 - this._enemyWifeCount.width;
    ...
    WifebattleBattleView.prototype.initCenterView = function () {
        ...
        if (PlatformManager.checkIsEnLang()) {
            this._enemyCurWifeName.setColor(TextFieldConst.COLOR_BLACK);
        }
        ...
        if (PlatformManager.checkIsEnLang()) {
            this._myCurWifeName.setColor(TextFieldConst.COLOR_BLACK);
        }
    ...
    WifebattleBattleView.prototype.beginRound = function () {
        ...
        if (myWifeInfo.skin || myWifeInfo.maleskin) {
            if (Api.switchVoApi.checkIsInBlueWife() && myWifeInfo.sexflag && myWifeInfo.sexflag >= 1) {
                if (myWifeInfo.maleskin && myWifeInfo.maleskin != "") {
                ...
                if (myWifeInfo.skin && myWifeInfo.skin != "") {
        ...
        this._enemyCurSkinName.visible = false;
        var isBlue = false;
        if (enemyWifeInfo.skin || (enemyWifeInfo.sexflag && enemyWifeInfo.sexflag >= 1 && enemyWifeInfo.maleskin)) {
            if (enemyWifeInfo.sexflag && enemyWifeInfo.sexflag >= 1 && enemyWifeInfo.maleskin) {
        ...
        if (PlatformManager.checkIsViSp()) {
            ...
            this._enemyCurWifeName.text = enemyWifeCfg.getName(enemyWifeInfo.sexflag && enemyWifeInfo.sexflag >= 1) + "(" + LanguageManager.getlocal("wifestatusTitle" + enemyWifeInfo.level + (isBlue ? "_blueType" : ""), null, true) + ")";
            // this._enemyCurWifeName.text = enemyWifeCfg.getName(enemyWifeInfo.sexflag && enemyWifeInfo.sexflag >= 1) + "("+LanguageManager.getlocal("wifestatusTitle"+enemyWifeInfo.level,null,isBlue)+")";
        }
    ...
    WifebattleBattleView.prototype.playRound = function () {
        var _this = this;
    ...
    WifebattleBattleView.prototype.enemyTalk = function (type) {
        var _this = this;
        var isBlue = false;
        var curRoundData = this._fightarr.info[this._curRound];
        var enemyWifeCfg = Config.WifeCfg.getWifeCfgById(curRoundData[1]);
        ...
        if (type == 1) {
            if (this._enemyCurWife) {
                var curRoundData_1 = this._fightarr.info[this._curRound];
                egret.Tween.get(this._enemyCurWife)
                    .call(function () {
            ...
            if (this._enemyCurWife) {
                var curRoundData_2 = this._fightarr.info[this._curRound];
                //1胜利  2平局  0负
                //干掉失败的形象
                var waitTime = 0;
                if (curRoundData_2[10] != 1) {
    ...
    WifebattleBattleView.prototype.myTalk = function (type) {
        var _this = this;
        if (!this._myTalkBg) {
    ...
    WifebattleBattleView.prototype.showWinBattle = function (ismy) {
        // let group = ismy ? this._myCurWifeContainer : this._enemyCurWifeContainer;
        var skinnamebg = ismy ? this._myNameBg : this._enemyNameBg;
        var descbg = BaseBitmap.create("specialview_commoni_namebg");
        var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("acConquerMainLandTip38-1", [Config.WifebattleCfg.battleTime + '']), 22);
        ...
        descbg.alpha = 0;
        tipTxt.alpha = 0;
        egret.Tween.get(descbg).to({ alpha: 1 }, 200).wait(500).to({ alpha: 0 }, 200).call(function () {
            descbg.dispose();
            descbg = null;
        }, this);
        egret.Tween.get(tipTxt).to({ alpha: 1 }, 200).wait(500).to({ alpha: 0 }, 200).call(function () {
            tipTxt.dispose();
            tipTxt = null;
        }, this);
    };
    WifebattleBattleView.prototype.overRound = function () {
        var _this = this;
        if (this._isPause) {
            return;
        }
    ...
    WifebattleBattleView.prototype.overRoundCardRun = function () {
    ...
    WifebattleBattleView.prototype.playNext = function () {
        this._curRound++;
        this.beginRound();
    };
    WifebattleBattleView.prototype.playOver = function () {
        this.stopBattle();
        this.battleOver();
    };
    WifebattleBattleView.prototype.initCards = function () {
        var myCardDataList = [];
    ...
    WifebattleBattleView.prototype.createCard = function (wifeId, index, isMy) {
        ...
        var iconStr = null;
        if (info.skin || (isblue && info.maleskin)) {
            //皮肤
        ...
        var name = ComponentManager.getTextField(wifeInfo.getName(isblue), nameSize, TextFieldConst.COLOR_BROWN);
        ...
        select.width = fg.width + 10;
        select.height = fg.height + 10;
        select.x = -5;
        select.y = -5;
    ...
    WifebattleBattleView.prototype.stepBtnHandler = function () {
        this.stopBattle();
        this.battleOver();
    };
    WifebattleBattleView.prototype.stopBattle = function () {
        this._isPause = true;
    };
    WifebattleBattleView.prototype.battleOver = function () {
        this.stopBattle();
        ViewController.getInstance().openView(ViewConst.COMMON.WIFEBATTLERESULTVIEW, {
            point: this._point,
    ...
    WifebattleBattleView.prototype.getResourceList = function () {
    ...
    WifebattleBattleView.prototype.dispose = function () {
        if (this) {
            egret.Tween.removeTweens(this);
        }
        this._fightarr = null;
    ...
    return WifebattleBattleView;
}(BaseView));
//# sourceMappingURL=WifebattleBattleView.js.map