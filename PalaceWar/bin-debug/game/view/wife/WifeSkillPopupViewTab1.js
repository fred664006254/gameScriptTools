 ...
 */
var WifeSkillPopupViewTab1 = /** @class */ (function (_super) {
    __extends(WifeSkillPopupViewTab1, _super);
    function WifeSkillPopupViewTab1() {
    ...
    WifeSkillPopupViewTab1.prototype.checkExchange = function () {
    ...
    WifeSkillPopupViewTab1.prototype.exchangeBtnClick = function () {
    ...
    WifeSkillPopupViewTab1.prototype.exchangeCallback = function (num2) {
    ...
    WifeSkillPopupViewTab1.prototype.refreshview = function () {
        var id = this.param.data.id;
        this._wifeInfoVo = Api.wifeVoApi.getWifeInfoVoById(id);
        var expStr = LanguageManager.getlocal("wifeExp") + " " + this._wifeInfoVo.exp.toString();
        this._wifeExp.text = expStr;
...
//# sourceMappingURL=WifeSkillPopupViewTab1.js.map