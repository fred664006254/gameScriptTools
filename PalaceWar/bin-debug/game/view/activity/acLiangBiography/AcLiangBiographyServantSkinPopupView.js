 ...
 */
var AcLiangBiographyServantSkinPopupView = (function (_super) {
    __extends(AcLiangBiographyServantSkinPopupView, _super);
    function AcLiangBiographyServantSkinPopupView() {
        return _super.call(this) || this;
    }
    AcLiangBiographyServantSkinPopupView.prototype.initView = function () {
        ...
        var topDesc = ComponentManager.getTextField(LanguageManager.getlocal("acLiangBiographyServantSkinPopupViewTopDesc-" + this.code), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
    ...
    AcLiangBiographyServantSkinPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "skin_detail_namebg", "servant_star",
            "servant_infoPro1", "servant_infoPro2", "servant_infoPro3", "servant_infoPro4",
        ]);
    };
    AcLiangBiographyServantSkinPopupView.prototype.getTitleStr = function () {
        return "acLiangBiographyServantSkinPopupViewTitle-" + this.param.data.code;
    };
    // protected getShowHeight() {
    // 	return 760;
    // }
    AcLiangBiographyServantSkinPopupView.prototype.getBgExtraHeight = function () {
        return 20;
    };
    AcLiangBiographyServantSkinPopupView.prototype.dispose = function () {
        this.aid = null;
        this.code = null;
        _super.prototype.dispose.call(this);
    };
    return AcLiangBiographyServantSkinPopupView;
}(PopupView));
__reflect(AcLiangBiographyServantSkinPopupView.prototype, "AcLiangBiographyServantSkinPopupView");
//# sourceMappingURL=AcLiangBiographyServantSkinPopupView.js.map