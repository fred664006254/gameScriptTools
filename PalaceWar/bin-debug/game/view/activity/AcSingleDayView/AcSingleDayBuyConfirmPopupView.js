...
var AcSingleDayBuyConfirmPopupView = (function (_super) {
    ...
    AcSingleDayBuyConfirmPopupView.prototype.initView = function () {
        ...
        var descTxt1 = ComponentManager.getTextField(LanguageManager.getlocal('acSingleDayCouponUseTip1', [Math.ceil(data.price).toString(), itemcfg.name]), 22, TextFieldConst.COLOR_BLACK);
        ...
        view._bg2 = bg2;
        var bg3 = BaseBitmap.create("public_9_bg41");
        bg3.width = 515;
        bg3.height = 30;
        App.DisplayUtil.setLayoutPosition(LayoutConst.horizontalCentertop, bg3, bg2);
        view.addChildToContainer(bg3);
        var descTxt2 = ComponentManager.getTextField(LanguageManager.getlocal('acSingleDayCouponUseTip2'), 22, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        if (coupon.length) {
            ...
            var emptyTxt = ComponentManager.getTextField(LanguageManager.getlocal('acSingleDayGetTip2'), 22);
    ...
    AcSingleDayBuyConfirmPopupView.prototype.resetBgSize = function () {
        ...
        var descTxt5 = ComponentManager.getTextField(LanguageManager.getlocal('acSingleDayCouponUseTip5', ['50']), 18, TextFieldConst.COLOR_LIGHT_YELLOW);
...
//# sourceMappingURL=AcSingleDayBuyConfirmPopupView.js.map