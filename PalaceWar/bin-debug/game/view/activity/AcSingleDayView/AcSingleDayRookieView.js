...
var AcSingleDayRookieView = (function (_super) {
    ...
    AcSingleDayRookieView.prototype.getResourceList = function () {
        ...
        var guidePic = [];
        var allAvg = view.cfg.AVGDialog[view.getUiCode()];
        view._curConfig = allAvg[1];
        return guidePic.concat([
            "guideNameBg", "acsingleday_bg" + view.getUiCode(),
    ...
    AcSingleDayRookieView.prototype.getUiCode = function () {
    ...
    AcSingleDayRookieView.prototype.init = function () {
        ...
        var bgName = "acsingleday_bg" + view.getUiCode();
        ...
        // }
        this._curConfig = view.cfg.AVGDialog[view.getUiCode()][this._curIdx]; //RookieCfg.getRookieCfg(this._curIdx);
        this.showPage();
    };
    ...
    AcSingleDayRookieView.prototype.showPage = function () {
        ...
        var needShoot = false;
        var codStr = this.getUiCode();
        //底部 描述
        if (this._curConfig.descId) {
            var timeSt = App.DateUtil.formatSvrHourByLocalTimeZone(this.cfg.startTime / 3600).hour;
            var timeEt = App.DateUtil.formatSvrHourByLocalTimeZone(this.cfg.endTime / 3600).hour;
            //描述 
            if (this._curConfig.clickContinue) {
                ...
                this._codonLength = 0;
                this._descText.text = "";
                this._descContent = LanguageManager.getlocal("acSingleDayRookie" + this._curConfig.descId + "-" + codStr, ["" + timeSt + ":00", "" + timeEt + ":00"]);
                needShoot = true;
            }
            else {
                this._descText.text = LanguageManager.getlocal("acSingleDayRookie" + this._curConfig.descId + "-" + codStr, ["" + timeSt + ":00", "" + timeEt + ":00"]);
...
//# sourceMappingURL=AcSingleDayRookieView.js.map