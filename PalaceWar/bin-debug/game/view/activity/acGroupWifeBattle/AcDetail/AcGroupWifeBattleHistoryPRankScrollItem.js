...
var AcGroupWifeBattleHistoryPRankScrollItem = /** @class */ (function (_super) {
    __extends(AcGroupWifeBattleHistoryPRankScrollItem, _super);
    function AcGroupWifeBattleHistoryPRankScrollItem() {
    ...
    AcGroupWifeBattleHistoryPRankScrollItem.prototype.initItem = function (index, data, code) {
        this.width = 640;
        this.height = 37;
        this._data = data;
    ...
    Object.defineProperty(AcGroupWifeBattleHistoryPRankScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcGroupWifeBattleHistoryPRankScrollItem.prototype, "vo", {
        get: function () {
    ...
    AcGroupWifeBattleHistoryPRankScrollItem.prototype.getSpaceY = function () {
        return -5;
    };
    AcGroupWifeBattleHistoryPRankScrollItem.prototype.getSpaceX = function () {
        return 0;
    };
    AcGroupWifeBattleHistoryPRankScrollItem.prototype.userShotCallback = function (event) {
    ...
    AcGroupWifeBattleHistoryPRankScrollItem.prototype.dispose = function () {
    ...
    return AcGroupWifeBattleHistoryPRankScrollItem;
}(ScrollListItem));
//# sourceMappingURL=AcGroupWifeBattleHistoryPRankScrollItem.js.map