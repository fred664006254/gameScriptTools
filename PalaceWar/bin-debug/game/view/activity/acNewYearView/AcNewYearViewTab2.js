...
var AcNewYearViewTab2 = (function (_super) {
    ...
    Object.defineProperty(AcNewYearViewTab2.prototype, "nowCode", {
        /**
        * 使用的code 仅仅使用资源，cn
        */
        get: function () {
    ...
    AcNewYearViewTab2.prototype.initView = function () {
        ...
        var curr_acNewYearVo = Api.acVoApi.getActivityVoByAidAndCode(AcConst.AID_ACNEWYEAR, this.code);
    ...
    AcNewYearViewTab2.prototype.showBtn = function () {
        ...
        taskTxt.text = LanguageManager.getlocal("acNewYeartab2des_" + this.nowCode);
        taskTxt.width = 400;
        taskTxt.x = 40;
        ...
        var scrollList = ComponentManager.getScrollList(NewYear2ScrollItem, arr, tmpRect, this.code);
...
//# sourceMappingURL=AcNewYearViewTab2.js.map