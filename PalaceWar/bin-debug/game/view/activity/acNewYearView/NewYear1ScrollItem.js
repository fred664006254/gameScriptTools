...
var NewYear1ScrollItem = (function (_super) {
    ...
    Object.defineProperty(NewYear1ScrollItem.prototype, "nowCode", {
        /**
         * 使用的code 仅仅使用资源，cn
         */
        get: function () {
    ...
    NewYear1ScrollItem.prototype.initItem = function (index, data, itemParam) {
        ...
        var curr_acNewYearVo = Api.acVoApi.getActivityVoByAidAndCode(AcConst.AID_ACNEWYEAR, this._code);
        ...
        var num = index + 1;
        var str = LanguageManager.getlocal("acNewYearfestivalDes" + num + "_" + this.nowCode);
        PackageTxt.text = str;
        PackageTxt.x = 170;
        PackageTxt.y = 60;
...
//# sourceMappingURL=NewYear1ScrollItem.js.map