 ...
 * @author ycg
 */
var AcChessRewardTab2ScrollItem = (function (_super) {
    __extends(AcChessRewardTab2ScrollItem, _super);
    function AcChessRewardTab2ScrollItem() {
        var _this = _super.call(this) || this;
        _this._aid = null;
        _this._code = null;
        return _this;
    }
    Object.defineProperty(AcChessRewardTab2ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcChessRewardTab2ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcChessRewardTab2ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcChessRewardTab2ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcChessRewardTab2ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
    };
    AcChessRewardTab2ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 5;
        //title txt
        var titleTxtStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acChessAchieveItemInfo", this.getTypeCode()), ["" + data.needNum]);
        ;
        ...
        if (this.vo.isGetAchievementById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_CHESS_GETNUMREWARDS, { activeId: _this.vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcChessRewardTab2ScrollItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcChessRewardTab2ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcChessRewardTab2ScrollItem.prototype.dispose = function () {
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcChessRewardTab2ScrollItem;
}(ScrollListItem));
__reflect(AcChessRewardTab2ScrollItem.prototype, "AcChessRewardTab2ScrollItem");
//# sourceMappingURL=AcChessRewardTab2ScrollItem.js.map