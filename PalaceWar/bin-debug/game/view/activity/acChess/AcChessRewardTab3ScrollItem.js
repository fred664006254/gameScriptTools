 ...
 */
var AcChessRewardTab3ScrollItem = (function (_super) {
    __extends(AcChessRewardTab3ScrollItem, _super);
    function AcChessRewardTab3ScrollItem() {
    ...
    Object.defineProperty(AcChessRewardTab3ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcChessRewardTab3ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcChessRewardTab3ScrollItem.prototype, "aid", {
        get: function () {
            return this.vo.aid;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcChessRewardTab3ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcChessRewardTab3ScrollItem.prototype.initItem = function (index, data, itemparam) {
        var _this = this;
        var view = this;
        ...
        var titleTxt = ComponentManager.getTextField(LanguageManager.getlocal("chessquestType" + data.questType, [String(data.value)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        titleTxt.x = bottom2.x + 10;
        titleTxt.y = bottom2.y + 13;
        this.addChild(titleTxt);
        var currNum = this.vo.getTaskNumByType(data.fid, data.sid);
        var needStrKey = "acchess_taskprocess";
        // if (currNum >= data.value){
        //     needStrKey = "acchess_taskprocess";
        // }
        ...
        var needStrKey2 = "acchess_taskpro";
        // if (currNum >= data.value){
        //     needStrKey2 = "acchess_taskpro";
        // }        
        ...
        if (currNum >= data.value) {
            if (this.vo.isGetTaskById(data.fid, data.sid)) {
                ...
                var reviceBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, "taskCollect", function () {
                    ...
                    NetManager.request(NetRequestConst.REQUEST_CHESS_GETTASK, { activeId: _this.vo.aidAndCode, pos: [data.fid, data.sid] });
                }, this);
    ...
    AcChessRewardTab3ScrollItem.prototype.update = function () {
        var vo = this.vo;
        if (!vo) {
            return;
        }
    ...
    AcChessRewardTab3ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcChessRewardTab3ScrollItem.prototype.taskGoBtnHandler = function () {
    ...
    AcChessRewardTab3ScrollItem.prototype.dispose = function () {
        this._data = null;
        this._needTxt = null;
        _super.prototype.dispose.call(this);
    };
    return AcChessRewardTab3ScrollItem;
}(ScrollListItem));
__reflect(AcChessRewardTab3ScrollItem.prototype, "AcChessRewardTab3ScrollItem");
//# sourceMappingURL=AcChessRewardTab3ScrollItem.js.map