...
/**
  * 钱庄  宝箱详情
  * @class BankBoxDePopupView
  */
var BankBoxDePopupView = (function (_super) {
    __extends(BankBoxDePopupView, _super);
    function BankBoxDePopupView() {
    ...
    BankBoxDePopupView.prototype.initView = function () {
     ...
     * 刷新界面
     */
    BankBoxDePopupView.prototype.refreshView = function () {
    ...
    BankBoxDePopupView.prototype.getRewardHandler = function (event) {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aid, this._code);
     ...
     * 前往充值按钮
     */
    BankBoxDePopupView.prototype.rechargeClick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aid, this._code);
        var deltaT = vo.et - GameData.serverTime;
        if (deltaT < 0) {
            App.CommonUtil.showTip(LanguageManager.getlocal("acPunishEnd"));
     ...
     * 领取按钮
     */
    BankBoxDePopupView.prototype.receiveClick = function () {
        var cfg = Config.AcCfg.getCfgByActivityIdAndCode(this._aid, this._code);
        var boxCfg = cfg.getBoxData(String(this._boxNeedGem));
    ...
    BankBoxDePopupView.prototype.getTitleStr = function () {
        return "acRechargeBoxPopupViewTitle";
    };
    BankBoxDePopupView.prototype.getShowHeight = function () {
        return 340;
    };
    BankBoxDePopupView.prototype.dispose = function () {
    ...
    return BankBoxDePopupView;
}(PopupView));
__reflect(BankBoxDePopupView.prototype, "BankBoxDePopupView");
//# sourceMappingURL=BankBoxDePopupView.js.map