...
var AcGambleResultView = (function (_super) {
    __extends(AcGambleResultView, _super);
    function AcGambleResultView() {
        return _super.call(this) || this;
    }
    AcGambleResultView.prototype.getResourceList = function () {
    ...
    AcGambleResultView.prototype.getTitleBgName = function () {
        return null;
    };
    AcGambleResultView.prototype.getTitleStr = function () {
        return null;
    };
    AcGambleResultView.prototype.getBgName = function () {
        return "public_9_bg8";
    };
    AcGambleResultView.prototype.isTouchMaskClose = function () {
        return true;
    };
    AcGambleResultView.prototype.initView = function () {
    };
    AcGambleResultView.prototype.init = function () {
        var view = this;
        ...
        var winText = BaseBitmap.create(isWin ? "gambleresultTitle1_" + data.code : "gambleresultTitle2_" + data.code);
        ...
        var battleFail = ComponentManager.getTextField(LanguageManager.getlocal(str + "-" + data.code, param), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var showBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_YELLOW, 'confirmBtn', view.hide, view);
    ...
    AcGambleResultView.prototype.hide = function () {
        if (this.param.data.callback) {
            this.param.data.callback.apply(this.param.data.obj);
        }
        _super.prototype.hide.call(this);
    };
    AcGambleResultView.prototype.showDamageRankClick = function () {
        var view = this;
        ViewController.getInstance().openView(ViewConst.POPUP.ALLIANCEWARDAMAGERANKVIEW, view.param.data);
    };
    AcGambleResultView.prototype.dispose = function () {
        var view = this;
        view.viewBg.removeTouchTap();
        _super.prototype.dispose.call(this);
    };
    return AcGambleResultView;
}(BaseView));
__reflect(AcGambleResultView.prototype, "AcGambleResultView");
//# sourceMappingURL=AcGambleResultView.js.map