...
var AcMouseGoldRewardTab2ScrollItem = /** @class */ (function (_super) {
    __extends(AcMouseGoldRewardTab2ScrollItem, _super);
    function AcMouseGoldRewardTab2ScrollItem() {
        var _this = _super.call(this) || this;
        _this._aid = null;
        _this._code = null;
        return _this;
    }
    Object.defineProperty(AcMouseGoldRewardTab2ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcMouseGoldRewardTab2ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcMouseGoldRewardTab2ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcMouseGoldRewardTab2ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcMouseGoldRewardTab2ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
    };
    AcMouseGoldRewardTab2ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 13;
        //title txt
        var titleTxtStr = LanguageManager.getlocal("acMouseGoldAchievementItemInfo", ["" + data.specialnum]);
        ...
        if (this.vo.isGetAchieveRewardById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACMOUSEGOLD_GETACHIEVEMENT, { activeId: _this.vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcMouseGoldRewardTab2ScrollItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcMouseGoldRewardTab2ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcMouseGoldRewardTab2ScrollItem.prototype.dispose = function () {
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcMouseGoldRewardTab2ScrollItem;
}(ScrollListItem));
//# sourceMappingURL=AcMouseGoldRewardTab2ScrollItem.js.map