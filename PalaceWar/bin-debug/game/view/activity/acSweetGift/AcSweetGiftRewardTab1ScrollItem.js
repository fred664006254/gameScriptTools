...
/**
  ...
  */
var AcSweetGiftRewardTab1ScrollItem = (function (_super) {
    __extends(AcSweetGiftRewardTab1ScrollItem, _super);
    function AcSweetGiftRewardTab1ScrollItem() {
     ...
     * 初始化itemview
     */
    AcSweetGiftRewardTab1ScrollItem.prototype.initItem = function (index, data, itemParam) {
        this._itemData = data;
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("sweetgiftRechargeItemTitle", [String(this._itemData.needGem)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var progressStr = LanguageManager.getlocal("sweetgiftProgressText", [String(currChargeGem), String(data.needGem)]);
    ...
    AcSweetGiftRewardTab1ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcSweetGiftRewardTab1ScrollItem.prototype.dispose = function () {
        this._itemData = null;
        _super.prototype.dispose.call(this);
    };
    return AcSweetGiftRewardTab1ScrollItem;
}(ScrollListItem));
__reflect(AcSweetGiftRewardTab1ScrollItem.prototype, "AcSweetGiftRewardTab1ScrollItem");
//# sourceMappingURL=AcSweetGiftRewardTab1ScrollItem.js.map