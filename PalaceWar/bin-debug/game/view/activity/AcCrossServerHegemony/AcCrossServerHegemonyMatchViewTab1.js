...
//
var AcCrossServerHegemonyMatchViewTab1 = /** @class */ (function (_super) {
    __extends(AcCrossServerHegemonyMatchViewTab1, _super);
    function AcCrossServerHegemonyMatchViewTab1(param) {
        var _this = _super.call(this) || this;
        _this._timeCdText = null;
        _this.startCurMatchTime = (10 * 24 + 21) * 60 * 60;
    ...
    Object.defineProperty(AcCrossServerHegemonyMatchViewTab1.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerHegemonyMatchViewTab1.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerHegemonyMatchViewTab1.prototype.getListType = function () {
        return 1;
    };
    AcCrossServerHegemonyMatchViewTab1.prototype.initView = function () {
        // let border = BaseBitmap.create("accshegemony_border1");
        // border.width = GameConfig.stageWidth;
        // border.height = GameConfig.stageHeigth - 69;
        // this.addChild(border);
        // let bottom = BaseBitmap.create("accshegemony_bottom");
        // bottom.x = 0;
        // bottom.y = GameConfig.stageHeigth - bottom.height -81-69;//border.y + border.height - bottom.height;
    ...
    AcCrossServerHegemonyMatchViewTab1.prototype.createMatchMap = function () {
        this._mapContainer = new BaseDisplayObjectContainer();
        this._mapContainer.width = GameConfig.stageWidth;
        this._mapContainer.height = 130 * 8;
        ...
        for (var i = 0; i < 8; i++) {
            ...
            winBgUp.y = startY + 36 - winBgUp.height / 2;
            this._mapContainer.addChild(winBgUp);
            this._winNameBgList.push(winBgUp);
            var winTextUp = ComponentManager.getTextField("", 22, TextFieldConst.COLOR_WARN_YELLOW); //COLOR_WARN_YELLOW2
            ...
            bgUp1.y = startY + 36 - bgUp1.height / 2;
            this._mapContainer.addChild(bgUp1);
            this._nameBgList.push(bgUp1);
            var textUp1 = ComponentManager.getTextField("", 22, 0x9adbff); //COLOR_WARN_YELLOW
            ...
            bgUp2.y = startY + 93 - bgUp2.height / 2;
            ...
            var upLine1 = BaseBitmap.create("accshegemony_matchline1_1");
            upLine1.x = 210 - upLine1.width / 2;
            upLine1.y = startY + 62 - upLine1.height / 2;
            this._mapContainer.addChild(upLine1);
            var upLine2 = BaseBitmap.create("accshegemony_matchline1_2");
            upLine2.x = 210 - upLine2.width / 2;
            upLine2.y = startY + 62 - upLine2.height / 2;
            this._mapContainer.addChild(upLine2);
            upLine2.visible = false;
            var upLine3 = BaseBitmap.create("accshegemony_matchline1_3");
            upLine3.x = 210 - upLine3.width / 2;
            upLine3.y = startY + 62 - upLine3.height / 2;
            ...
            winBgDown.y = startY + 93 - winBgDown.height / 2;
            ...
            bgDown1.y = startY + 36 - bgDown1.height / 2;
            ...
            bgDown2.y = startY + 93 - bgDown2.height / 2;
            ...
            var downLine1 = BaseBitmap.create("accshegemony_matchline1_1");
            downLine1.setScale(-1);
            downLine1.x = 430 - downLine1.width * downLine1.scaleX / 2;
            downLine1.y = startY + 62 - downLine1.height * downLine1.scaleY / 2;
            this._mapContainer.addChild(downLine1);
            var downLine2 = BaseBitmap.create("accshegemony_matchline1_3");
            downLine2.setScale(-1);
            downLine2.x = 430 - downLine2.width * downLine2.scaleX / 2;
            downLine2.y = startY + 62 - downLine2.height * downLine2.scaleY / 2;
            downLine2.visible = false;
            this._mapContainer.addChild(downLine2);
            var downLine3 = BaseBitmap.create("accshegemony_matchline1_2");
            downLine3.setScale(-1);
            downLine3.x = 430 - downLine3.width * downLine3.scaleX / 2;
            downLine3.y = startY + 62 - downLine3.height * downLine3.scaleY / 2;
            ...
            if (i != 8 - 1) {
                ...
                line.y = startY + 130 - line.height / 2;
                this._mapContainer.addChild(line);
            }
        }
    };
    AcCrossServerHegemonyMatchViewTab1.prototype.initMatchMap = function () {
        var dataList = Api.crossServerHegemonyVoApi.getDetailPkInfo(0);
        // let dataList = [];
        ...
        for (var i = 0; i < this._nameBgList.length; i += 2) {
            ...
            if (i / 2 < dataList.length) {
                ...
                nameText1.text = LanguageManager.getlocal("acCrossServerHegemonyMatchBlankName1", ["32"]);
                nameText2.text = LanguageManager.getlocal("acCrossServerHegemonyMatchBlankName1", ["32"]);
            }
        ...
        for (var j = 0; j < this._winNameBgList.length; j++) {
            ...
            if (j < dataList.length) {
                if (dataList[j]["win"] == -1) {
                    nameText.text = LanguageManager.getlocal("acCrossServerHegemonyMatchBlankName1", ["16"]);
                }
    ...
    AcCrossServerHegemonyMatchViewTab1.prototype.refreshTimeText = function () {
    ...
    AcCrossServerHegemonyMatchViewTab1.prototype.tick = function () {
        // console.log(22222);
        this.refreshTimeText();
    };
    AcCrossServerHegemonyMatchViewTab1.prototype.dispose = function () {
    ...
    return AcCrossServerHegemonyMatchViewTab1;
}(CommonViewTab));
//# sourceMappingURL=AcCrossServerHegemonyMatchViewTab1.js.map