...
//
var AcCrossServerHegemonyRewardViewTab2 = /** @class */ (function (_super) {
    __extends(AcCrossServerHegemonyRewardViewTab2, _super);
    function AcCrossServerHegemonyRewardViewTab2(param) {
    ...
    Object.defineProperty(AcCrossServerHegemonyRewardViewTab2.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerHegemonyRewardViewTab2.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerHegemonyRewardViewTab2.prototype.getListType = function () {
        return 1;
    };
    AcCrossServerHegemonyRewardViewTab2.prototype.initView = function () {
        ...
        this.addChild(tip);
        var listBtn = ComponentManager.getButton(ButtonConst.BTN2_BIG_YELLOW, "acCrossServerHegemonyRewardListBtn1", this.listBtnClick, this, null, null, null, TextFieldConst.COLOR_BLACK);
        ...
        var list = this.cfg.getFinalRewardList();
        var rect = new egret.Rectangle(0, 0, 610, GameConfig.stageHeigth - 89 - 60 - 60 - detailBg.height + 35 - 84);
        var scrollList = ComponentManager.getScrollList(AcCrossServerHegemonyRewardScrollItem2, list, rect);
    ...
    AcCrossServerHegemonyRewardViewTab2.prototype.listBtnClick = function () {
    ...
    AcCrossServerHegemonyRewardViewTab2.prototype.tick = function () {
        if (this._listBtn) {
            if (this.vo.getEndTimeByMatchId(29, 0) <= GameData.serverTime) {
                this._listBtn.setGray(false);
            }
    ...
    AcCrossServerHegemonyRewardViewTab2.prototype.dispose = function () {
        this._listBtn = null;
        _super.prototype.dispose.call(this);
    };
    return AcCrossServerHegemonyRewardViewTab2;
}(CommonViewTab));
//# sourceMappingURL=AcCrossServerHegemonyRewardViewTab2.js.map