 ...
 */
var AcCrossServerHegemonyRewardScrollItem2 = (function (_super) {
    __extends(AcCrossServerHegemonyRewardScrollItem2, _super);
    function AcCrossServerHegemonyRewardScrollItem2() {
        return _super.call(this) || this;
    }
    AcCrossServerHegemonyRewardScrollItem2.prototype.initItem = function (index, data) {
        this.width = 610;
        ...
        if (index < 2) {
            titleTF.text = LanguageManager.getlocal("acCrossServerHegemonyRewardTTRank" + (index + 1));
        }
        else if (master.rank[0] == master.rank[1]) {
            titleTF.text = LanguageManager.getlocal("acCrossServerHegemonyRewardTTRank6", [String(master.rank[0])]);
        }
        else {
            titleTF.text = LanguageManager.getlocal("acCrossServerHegemonyRewardTTRank4", [String(master.rank[0]), String(master.rank[1])]);
        }
        ...
        if (master.assetReward) {
            // rewardStr = "28_0001_"+master.assetReward+"|"+master.getReward;
        ...
        var memberBg = BaseBitmap.create("public_9_bg95"); //aobaidescnamebg
        memberBg.width = 300;
    ...
    AcCrossServerHegemonyRewardScrollItem2.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcCrossServerHegemonyRewardScrollItem2.prototype.getSpaceY = function () {
        return 5;
    };
    AcCrossServerHegemonyRewardScrollItem2.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcCrossServerHegemonyRewardScrollItem2;
}(ScrollListItem));
__reflect(AcCrossServerHegemonyRewardScrollItem2.prototype, "AcCrossServerHegemonyRewardScrollItem2");
//# sourceMappingURL=AcCrossServerHegemonyRewardScrollItem2.js.map