 ...
 * desc:群雄逐鹿
*/
var AcCrossServerHegemonyView = (function (_super) {
    __extends(AcCrossServerHegemonyView, _super);
    function AcCrossServerHegemonyView() {
        var _this = _super.call(this) || this;
        _this._curRoundDetailTxt = null;
        _this._curRoundDetailBg = null;
        _this._curRoundName = null;
        _this._chatTxt = null;
        _this._changeServantBtn = null;
        _this._showRewardBtn = null;
        _this._matchDetailNode = null;
        _this._acTimeTxt = null;
        _this._cdTimeTxt = null;
        _this._scrollList = null;
        // private _isChangeServant = false;
        _this._lmnameTxt = null;
        _this._rankBtn = null;
        return _this;
    }
    Object.defineProperty(AcCrossServerHegemonyView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerHegemonyView.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerHegemonyView.prototype.getTyeCode = function () {
        return this.code;
    };
    AcCrossServerHegemonyView.prototype.getRequestData = function () {
        return { requestType: NetRequestConst.REQUEST_ACHEGEMONY_HEGEMONYOPEN, requestData: {
                activeId: this.vo.aidAndCode,
            } };
    };
    AcCrossServerHegemonyView.prototype.receiveData = function (data) {
        if (data.ret) {
            App.LogUtil.log("receiveData hegemonyview");
        }
    };
    AcCrossServerHegemonyView.prototype.refreshRedDot = function () {
    ...
    AcCrossServerHegemonyView.prototype.refreshCurStatus = function () {
    ...
    AcCrossServerHegemonyView.prototype.getCdTimeTxt = function () {
        var curMatchId = this.vo.getNextMatchId();
        // App.LogUtil.log("getCdTimeTxt: "+ curMatchId);
        if (curMatchId > 29) {
            curMatchId = 29;
        }
        var status = this.vo.checkStatusByMatchId(curMatchId);
        var returnStr = "";
        if (status == 1 || status == 2) {
            var cdStr = this.vo.getCdStrByMatchId(curMatchId);
    ...
    AcCrossServerHegemonyView.prototype.initView = function () {
        ...
        var titleBg = BaseBitmap.create("accshegemony_maintitlebg");
        ...
        var detailBtn = ComponentManager.getButton("accshegemony_detailbtn", null, this.detailBtnListener, this);
        ...
        var detailBtnTxt = BaseBitmap.create("accshegemony_maindetailtxt");
        ...
        var rankBtn = ComponentManager.getButton("accshegemony_mainrankicon", null, this.rankBtnListener, this);
        ...
        var rankBtnTxt = BaseBitmap.create("accshegemony_mainranktxt");
        ...
        var redRankTip = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyRank"), 22, TextFieldConst.COLOR_WARN_YELLOW);
        ...
        var redNameTip = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyAllName2"), 22, TextFieldConst.COLOR_WARN_YELLOW);
        ...
        var redQuTip = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyQu"), 22, TextFieldConst.COLOR_WARN_YELLOW);
        redQuTip.x = 327 - redQuTip.width / 2 + 5;
        redQuTip.y = redBg.y + redBg.height / 2 - redQuTip.height / 2;
        this.addChildToContainer(redQuTip);
        var redWinNumTip = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyWinNum"), 22, TextFieldConst.COLOR_WARN_YELLOW);
        ...
        var redPowerUpTip = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyPowerPlus"), 22, TextFieldConst.COLOR_WARN_YELLOW);
        ...
        // topBg.visible = false;
        var listContainer = new BaseDisplayObjectContainer();
        ...
        var topBg = BaseBitmap.create("accshegemony_maintopbg");
        topBg.width = 620;
        ...
        var listRect = new egret.Rectangle(0, 0, 620, listContainer.height - 90);
        var scrollList = ComponentManager.getScrollList(AcCrossServerHegemonyMainScrollList, list, listRect, { aid: this.aid, code: this.code });
        ...
        // this.vo.
        var cdTimeStr = this.getCdTimeTxt();
        ...
        var topTip = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyClickTip"), 20, 0x9cb1c7);
        ...
        ///下面
        var downBg = BaseBitmap.create("accshegemony_mainuibottombg");
        downBg.width = 640;
        ...
        var lmnameTxt = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyAllname", [this.vo.getAllName()]), 20, TextFieldConst.COLOR_BROWN);
        ...
        var detailTxt = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyRule"), 20, TextFieldConst.COLOR_BROWN);
        detailTxt.width = 554;
        ...
        if (this.vo.isCanJoin()) {
            var zigeTxt = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyCanJoin"), 20, TextFieldConst.COLOR_WARN_GREEN4);
            zigeTxt.x = this._acTimeTxt.x;
            zigeTxt.y = detailTxt.y + detailTxt.height + 5;
            this._matchDetailNode.addChild(zigeTxt);
        }
        else {
            var zigeStr = "acCrossServerHegemonyNoAllianceJoin";
            if (this.vo.isHasAlliance()) {
                zigeStr = "acCrossServerHegemonyNotCanJoin";
            }
            var zigeTxt = ComponentManager.getTextField(LanguageManager.getlocal(zigeStr), 20, 0xbe4545);
            zigeTxt.x = this._acTimeTxt.x;
            zigeTxt.y = detailTxt.y + detailTxt.height + 5;
            this._matchDetailNode.addChild(zigeTxt);
        }
    ...
    AcCrossServerHegemonyView.prototype.updateRankRequest = function () {
    ...
    AcCrossServerHegemonyView.prototype.updateRankData = function (event) {
    ...
    AcCrossServerHegemonyView.prototype.changeServantBtnListener = function () {
    ...
    AcCrossServerHegemonyView.prototype.getAlliDetail = function (event) {
    ...
    AcCrossServerHegemonyView.prototype.showRewardBtnListener = function () {
        if (!this.vo.isOpenActivity()) {
            App.CommonUtil.showTip(LanguageManager.getlocal("acCrossServerHegemonyRoundTip0"));
            return;
        }
    ...
    AcCrossServerHegemonyView.prototype.detailBtnListener = function () {
        if (!this.vo.isInActivity()) {
            this.vo.showAcEndTip();
            return;
        }
        var curStatus = this.vo.getCurStatus();
        var viewName = ViewConst.POPUP.ACCROSSSERVERHEGEMONYMATCHVIEW;
        if (curStatus == 12) {
    ...
    AcCrossServerHegemonyView.prototype.rankBtnListener = function () {
        if (!this.vo.isInActivity()) {
            this.vo.showAcEndTip();
            return;
        }
    ...
    AcCrossServerHegemonyView.prototype.chatBgClickHandler = function () {
        // if(this._stopTouch){
        //     return;
        // }
        ...
        var sendTip = LanguageManager.getlocal("acCrossServerHegemonyNotChatTip");
    ...
    AcCrossServerHegemonyView.prototype.ShowNotOpenView = function () {
        var container = this.container.getChildByName("notOpenContainer");
        if (!this.vo.isOpenActivity()) {
            if (!container) {
                var notOpenContainer = new BaseDisplayObjectContainer();
                ...
                var touchPos = BaseBitmap.create("public_9_viewmask"); //public_alphabg public_9_viewmask 
                ...
                var msgText = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyRoundTip0"), TextFieldConst.FONTSIZE_TITLE_SMALL);
    ...
    AcCrossServerHegemonyView.prototype.refreshNotOpenView = function () {
        var container = this.container.getChildByName("notOpenContainer");
        if (this.vo.isOpenActivity()) {
            if (container) {
                container.visible = false;
    ...
    AcCrossServerHegemonyView.prototype.tick = function () {
        if (this._chatTxt) {
            var showStr = Api.chatVoApi.getLastAcCrossMessage();
            if (!showStr) {
                showStr = "";
    ...
    AcCrossServerHegemonyView.prototype.refreshView = function () {
    };
    Object.defineProperty(AcCrossServerHegemonyView.prototype, "uiType", {
        get: function () {
            return "2";
        },
        enumerable: true,
    ...
    AcCrossServerHegemonyView.prototype.getBigFrame = function () {
        return "commonview_bigframe";
    };
    AcCrossServerHegemonyView.prototype.isHideTitleBgShadow = function () {
        return true;
    };
    AcCrossServerHegemonyView.prototype.getTitleBgName = function () {
        return ResourceManager.hasRes("achegemony_titlebg-" + this.code) ? "achegemony_titlebg-" + this.code : "achegemony_titlebg-1";
    };
    AcCrossServerHegemonyView.prototype.getTitleStr = function () {
        return "";
    };
    AcCrossServerHegemonyView.prototype.getCloseBtnName = function () {
        return ButtonConst.COMMON_CLOSE_1;
    };
    AcCrossServerHegemonyView.prototype.getResourceList = function () {
    ...
    AcCrossServerHegemonyView.prototype.getRuleInfoParam = function () {
    ...
    AcCrossServerHegemonyView.prototype.dispose = function () {
    ...
    return AcCrossServerHegemonyView;
}(AcCommonView));
__reflect(AcCrossServerHegemonyView.prototype, "AcCrossServerHegemonyView");
//# sourceMappingURL=AcCrossServerHegemonyView.js.map