...
//
var AcCrossServerHegemonyMatchViewTab2 = /** @class */ (function (_super) {
    __extends(AcCrossServerHegemonyMatchViewTab2, _super);
    function AcCrossServerHegemonyMatchViewTab2(param) {
        var _this = _super.call(this) || this;
        _this._timeCdText = null;
        _this.startCurMatchTime = (11 * 24 + 21) * 60 * 60;
    ...
    Object.defineProperty(AcCrossServerHegemonyMatchViewTab2.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerHegemonyMatchViewTab2.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerHegemonyMatchViewTab2.prototype.getListType = function () {
        return 1;
    };
    AcCrossServerHegemonyMatchViewTab2.prototype.initView = function () {
        ...
        this.addChild(redBg);
        this._redBg = redBg;
        var matchName = ComponentManager.getTextField(LanguageManager.getlocal("acCrossServerHegemonyMatchTab2"), 24, TextFieldConst.COLOR_WARN_YELLOW2);
    ...
    AcCrossServerHegemonyMatchViewTab2.prototype.createMatchMap = function () {
        this._mapContainer = new BaseDisplayObjectContainer();
        this._mapContainer.width = GameConfig.stageWidth;
        this._mapContainer.height = 236 * 4;
        ...
        for (var i = 0; i < 4; i++) {
            ...
            winBgUp.y = startY + 92 - winBgUp.height / 2;
            ...
            bgUp1.y = startY + 66 - bgUp1.height / 2;
            ...
            bgUp2.y = startY + 172 - bgUp2.height / 2;
            ...
            var upLine1 = BaseBitmap.create("accshegemony_matchline2_1");
            upLine1.x = 210 - upLine1.width / 2;
            upLine1.y = startY + 118 - upLine1.height / 2;
            this._mapContainer.addChild(upLine1);
            var upLine2 = BaseBitmap.create("accshegemony_matchline2_2");
            upLine2.x = 210 - upLine2.width / 2;
            upLine2.y = startY + 118 - upLine2.height / 2;
            this._mapContainer.addChild(upLine2);
            upLine2.visible = false;
            var upLine3 = BaseBitmap.create("accshegemony_matchline2_3");
            upLine3.x = 210 - upLine3.width / 2;
            upLine3.y = startY + 118 - upLine3.height / 2;
            ...
            winBgDown.y = startY + 146 - winBgDown.height / 2;
            ...
            bgDown1.y = startY + 66 - bgDown1.height / 2;
            ...
            bgDown2.y = startY + 172 - bgDown2.height / 2;
            ...
            var downLine1 = BaseBitmap.create("accshegemony_matchline2_1");
            downLine1.setScale(-1);
            downLine1.x = 430 - downLine1.width * downLine1.scaleX / 2;
            downLine1.y = startY + 118 - downLine1.height * downLine1.scaleY / 2;
            this._mapContainer.addChild(downLine1);
            var downLine2 = BaseBitmap.create("accshegemony_matchline2_3");
            downLine2.setScale(-1);
            downLine2.x = 430 - downLine2.width * downLine2.scaleX / 2;
            downLine2.y = startY + 118 - downLine2.height * downLine2.scaleY / 2;
            downLine2.visible = false;
            this._mapContainer.addChild(downLine2);
            var downLine3 = BaseBitmap.create("accshegemony_matchline2_2");
            downLine3.setScale(-1);
            downLine3.x = 430 - downLine3.width * downLine3.scaleX / 2;
            downLine3.y = startY + 118 - downLine3.height * downLine3.scaleY / 2;
            ...
            if (i != 4 - 1) {
                ...
                line.y = startY + 236 - line.height / 2;
                this._mapContainer.addChild(line);
            }
        }
    };
    AcCrossServerHegemonyMatchViewTab2.prototype.initMatchMap = function () {
        var dataList = Api.crossServerHegemonyVoApi.getDetailPkInfo(1);
        // let dataList = [];
        for (var i = 0; i < this._nameBgList.length; i += 2) {
            ...
            if (i / 2 < dataList.length) {
                ...
                nameText1.text = LanguageManager.getlocal("acCrossServerHegemonyMatchBlankName1", ["16"]);
                nameText2.text = LanguageManager.getlocal("acCrossServerHegemonyMatchBlankName1", ["16"]);
            }
    ...
    AcCrossServerHegemonyMatchViewTab2.prototype.refreshTimeText = function () {
    ...
    AcCrossServerHegemonyMatchViewTab2.prototype.tick = function () {
        this.refreshTimeText();
    };
    AcCrossServerHegemonyMatchViewTab2.prototype.dispose = function () {
    ...
    return AcCrossServerHegemonyMatchViewTab2;
}(CommonViewTab));
//# sourceMappingURL=AcCrossServerHegemonyMatchViewTab2.js.map