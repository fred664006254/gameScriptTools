...
var AcTombGetRewardView = (function (_super) {
    __extends(AcTombGetRewardView, _super);
    function AcTombGetRewardView() {
        return _super.call(this) || this;
    }
    Object.defineProperty(AcTombGetRewardView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcTombGetRewardView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcTombGetRewardView.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcTombGetRewardView.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcTombGetRewardView.prototype, "code", {
        get: function () {
    ...
    AcTombGetRewardView.prototype.getUicode = function () {
        var baseview = ViewController.getInstance().getView('AcTombView');
        return baseview.getUiCode();
    };
    AcTombGetRewardView.prototype.initView = function () {
    ...
    AcTombGetRewardView.prototype.doWaitAni = function (tmpNode, waitT) {
        tmpNode.alpha = 0;
        egret.Tween.get(tmpNode, { loop: false }).wait(waitT).to({ alpha: 1 }, 500);
    };
    AcTombGetRewardView.prototype.getShowHeight = function () {
        var re_data = this.param.data;
        //"6_1150_4|6_1710_1";
        var rewardTab = re_data.split('|');
        return rewardTab.length > 4 ? 528 : 300;
    };
    AcTombGetRewardView.prototype.getResourceList = function () {
    ...
    AcTombGetRewardView.prototype.isTouchMaskClose = function () {
        return true;
    };
    AcTombGetRewardView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcTombGetRewardView;
}(BaseView));
__reflect(AcTombGetRewardView.prototype, "AcTombGetRewardView");
//# sourceMappingURL=AcTombGetRewardView.js.map