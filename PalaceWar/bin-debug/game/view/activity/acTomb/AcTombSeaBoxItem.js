 ...
 * author qianjun
 */
var AcTombSeaBoxItem = (function (_super) {
    __extends(AcTombSeaBoxItem, _super);
    function AcTombSeaBoxItem() {
    ...
    Object.defineProperty(AcTombSeaBoxItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcTombSeaBoxItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcTombSeaBoxItem.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcTombSeaBoxItem.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcTombSeaBoxItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcTombSeaBoxItem.prototype.getUicode = function () {
        var baseview = ViewController.getInstance().getView('AcTombView');
        return baseview.getUiCode();
    };
    AcTombSeaBoxItem.prototype.initItem = function (index, data, itemparam) {
        var _this = this;
        /*
            floor//当前层数,
            id//对应编号,
        */
        ...
        var iconStr = "teamiconstatus1-" + code;
        ...
        icon.addTouchTap(function () {
            ...
            if (status == 1) {
                ...
                */
                ...
                NetManager.request(NetRequestConst.REQUEST_ACTIVITY_TOMBDIG, {
                    activeId: view.vo.aidAndCode,
                    index: param.index,
                    x: param.x,
                    y: param.y
                ...
                if (cfg.type == 2) {
                    var finished = view.vo.getBoxRewardById(data.id);
                    if (finished) {
                        App.CommonUtil.showTip(LanguageManager.getlocal("tombfloorboxtip2-" + code));
                    }
                    else {
                        SoundManager.playEffect(SoundConst.EFFECT_TOMB_REWARD);
                        //宝箱飞出特效
                        view._icon.alpha = 0;
                        var icon_1 = BaseBitmap.create(cfg.getnpcPic(code));
                        ...
                        var circle_1 = BaseBitmap.create("tombboxcircle" + cfg.id + "-" + code);
    ...
    AcTombSeaBoxItem.prototype.playBoxEff = function (data) {
        var view = this;
        view.vo.moviePlay = true;
        var code = view.getUicode();
        ...
        */
        var tombboxef = ComponentManager.getCustomMovieClip("tombboxef" + code + "-", 5, 70);
        tombboxef.width = 125;
        ...
        tombboxef.setEndCallBack(function () {
            ...
            egret.Tween.get(tombboxef).wait(700).call(function () {
                ...
                if (itemreward) {
                    ...
                    icon = cfg.getnpcIcon(code);
                }
                view._icon.setload(icon);
                var parent = view.parent.parent.parent;
                var tombdoor = ComponentManager.getCustomMovieClip("tombdoor" + code + "-", 7, 50);
                tombdoor.width = 218;
                tombdoor.height = 218;
                ...
                var tombdoorlight = BaseBitmap.create("doorlight-" + code);
                ...
                tombdoor.setFrameEvent(1, function () {
                    ...
                    var tombbubble = ComponentManager.getCustomMovieClip("tombbubble" + code + "-", 18, 70);
                    tombbubble.width = 72;
    ...
    AcTombSeaBoxItem.prototype.update = function () {
        var view = this;
        ...
        if (data) {
            ...
            if (status_1 == 2) {
                ...
                iconStr = "teamiconstatus" + status_1 + "-" + code;
            }
        }
        view._icon.alpha = 1;
    ...
    AcTombSeaBoxItem.prototype.freshAfterDig = function () {
        var view = this;
        SoundManager.playEffect(SoundConst.EFFECT_TOMB_BOX);
        //打开宝箱特效
        view.playBoxEff(null);
    };
    AcTombSeaBoxItem.prototype.dispose = function () {
        var view = this;
        view._data = null;
    ...
    return AcTombSeaBoxItem;
}(ScrollListItem));
__reflect(AcTombSeaBoxItem.prototype, "AcTombSeaBoxItem");
//# sourceMappingURL=AcTombSeaBoxItem.js.map