...
//
var AcTombRewardViewTab3 = (function (_super) {
    __extends(AcTombRewardViewTab3, _super);
    function AcTombRewardViewTab3(param) {
    ...
    Object.defineProperty(AcTombRewardViewTab3.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcTombRewardViewTab3.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcTombRewardViewTab3.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcTombRewardViewTab3.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcTombRewardViewTab3.prototype, "code", {
        get: function () {
    ...
    AcTombRewardViewTab3.prototype.getUicode = function () {
        var baseview = ViewController.getInstance().getView('AcTombView');
        return baseview.getUiCode();
    };
    AcTombRewardViewTab3.prototype.getListType = function () {
        return 3;
    };
    AcTombRewardViewTab3.prototype.initView = function () {
        ...
        for (var index = 0; index < rankList.length; index++) {
            ...
            var txt = ComponentManager.getTextField(rItem.getnpcName(view.getUicode()), 24, TextFieldConst.COLOR_LIGHT_YELLOW);
    ...
    AcTombRewardViewTab3.prototype.getCountTimeStr = function (time) {
        if (time < 0) {
            time = 0;
        }
        return App.DateUtil.getFormatBySecond(time);
    };
    AcTombRewardViewTab3.prototype.dispose = function () {
    ...
    return AcTombRewardViewTab3;
}(CommonViewTab));
__reflect(AcTombRewardViewTab3.prototype, "AcTombRewardViewTab3");
//# sourceMappingURL=AcTombRewardViewTab3.js.map