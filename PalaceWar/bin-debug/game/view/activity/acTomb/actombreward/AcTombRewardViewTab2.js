...
//
var AcTombRewardViewTab2 = (function (_super) {
    __extends(AcTombRewardViewTab2, _super);
    function AcTombRewardViewTab2(param) {
    ...
    Object.defineProperty(AcTombRewardViewTab2.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcTombRewardViewTab2.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcTombRewardViewTab2.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcTombRewardViewTab2.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcTombRewardViewTab2.prototype, "code", {
        get: function () {
    ...
    AcTombRewardViewTab2.prototype.getUicode = function () {
        var baseview = ViewController.getInstance().getView('AcTombView');
        return baseview.getUiCode();
    };
    AcTombRewardViewTab2.prototype.getListType = function () {
        return 2;
    };
    AcTombRewardViewTab2.prototype.initView = function () {
        ...
        for (var index = 0; index < rankList.length; index++) {
            ...
            var winbg = BaseBitmap.create("tombrewardrankbg-" + view.getUicode());
            winbg.y = scroStartY;
        ...
        txt3.text = LanguageManager.getlocal("tombrank2-" + view.getUicode(), [color, rankstr]);
    ...
    AcTombRewardViewTab2.prototype.tick = function () {
    ...
    AcTombRewardViewTab2.prototype.rankCLick = function () {
        var view = this;
        if (view.vo.isEnd) {
    ...
    AcTombRewardViewTab2.prototype.getCountTimeStr = function (time) {
        if (time < 0) {
            time = 0;
        }
        return App.DateUtil.getFormatBySecond(time);
    };
    AcTombRewardViewTab2.prototype.dispose = function () {
    ...
    return AcTombRewardViewTab2;
}(CommonViewTab));
__reflect(AcTombRewardViewTab2.prototype, "AcTombRewardViewTab2");
//# sourceMappingURL=AcTombRewardViewTab2.js.map