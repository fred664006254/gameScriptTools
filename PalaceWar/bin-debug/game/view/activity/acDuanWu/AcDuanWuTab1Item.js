...
var AcDuanWuTab1Item = (function (_super) {
    __extends(AcDuanWuTab1Item, _super);
    function AcDuanWuTab1Item() {
    ...
    Object.defineProperty(AcDuanWuTab1Item.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcDuanWuTab1Item.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcDuanWuTab1Item.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcDuanWuTab1Item.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcDuanWuTab1Item.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcDuanWuTab1Item.prototype, "uicode", {
        get: function () {
            return this._uicode;
        },
        enumerable: true,
    ...
    AcDuanWuTab1Item.prototype.initItem = function (index, data, itemparam) {
        var view = this;
        ...
        this.addChild(Txt1);
        var str = "1013_0_" + this._rechargeItem.zongZiGet + "_" + this.uicode + "|" + this._rechargeItem.getReward;
    ...
    //刷新按钮状态
    AcDuanWuTab1Item.prototype.refreshBtnStatus = function () {
        var tmpVo = this.vo;
        if (!tmpVo) {
            return;
        }
    ...
    AcDuanWuTab1Item.prototype.refreshUI = function () {
    ...
    AcDuanWuTab1Item.prototype.createCollectFlag = function () {
    ...
    AcDuanWuTab1Item.prototype.eventCollectHandler = function (event) {
        ...
        NetManager.request(NetRequestConst.REQUEST_ACTIVITY_GETDUANWUITEMB, {
            activeId: this.acTivityId,
            rechargeId: this._itemData
        });
    };
    AcDuanWuTab1Item.prototype.goRechargeHandler = function (event) {
        if (!this.vo.isInActivity()) {
    ...
    AcDuanWuTab1Item.prototype.getSpaceX = function () {
        return 10;
    };
    /**
     * 不同格子Y间距
     */
    AcDuanWuTab1Item.prototype.getSpaceY = function () {
        return 4;
    };
    AcDuanWuTab1Item.prototype.dispose = function () {
        this._itemData = null;
        this._collectFlag = null;
        this._progress = null;
        this._collectBtn = null;
    ...
    return AcDuanWuTab1Item;
}(ScrollListItem));
__reflect(AcDuanWuTab1Item.prototype, "AcDuanWuTab1Item");
//# sourceMappingURL=AcDuanWuTab1Item.js.map