 ...
 * author qianjun
 */
var AcMotherDayCardPoolView = (function (_super) {
    __extends(AcMotherDayCardPoolView, _super);
    function AcMotherDayCardPoolView() {
        return _super.call(this) || this;
    }
    Object.defineProperty(AcMotherDayCardPoolView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcMotherDayCardPoolView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcMotherDayCardPoolView.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcMotherDayCardPoolView.prototype, "aid", {
        get: function () {
    ...
    AcMotherDayCardPoolView.prototype.getUiCode = function () {
        var code = '';
    ...
    AcMotherDayCardPoolView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([]);
    };
    AcMotherDayCardPoolView.prototype.initView = function () {
        // let tabName = ["acPunishRankRewardTab1"];
        var view = this;
        var code = view.getUiCode();
        var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("motherdaypooltip-" + (Number(code) == 7 ? "3" : code)), 20, TextFieldConst.COLOR_BLACK);
    ...
    AcMotherDayCardPoolView.prototype.getShowHeight = function () {
        return 560;
    };
    AcMotherDayCardPoolView.prototype.getTitleStr = function () {
        var code = this.getUiCode();
        return "motherdaypoolreward-" + (Number(code) == 7 ? "3" : code);
    };
    AcMotherDayCardPoolView.prototype.dispose = function () {
        var view = this;
        _super.prototype.dispose.call(this);
    };
    return AcMotherDayCardPoolView;
}(PopupView));
__reflect(AcMotherDayCardPoolView.prototype, "AcMotherDayCardPoolView");
//# sourceMappingURL=AcMotherDayCardPoolView.js.map