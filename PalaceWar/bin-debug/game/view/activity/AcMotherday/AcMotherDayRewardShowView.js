...
var AcMotherDayRewardShowView = (function (_super) {
    __extends(AcMotherDayRewardShowView, _super);
    function AcMotherDayRewardShowView() {
        return _super.call(this) || this;
    }
    AcMotherDayRewardShowView.prototype.initView = function () {
        ...
        if (this.param.data.msg) {
            var msgTxt = ComponentManager.getTextField(this.param.data.msg, 20, TextFieldConst.COLOR_LIGHT_YELLOW);
    ...
    AcMotherDayRewardShowView.prototype.doWaitAni = function (tmpNode, waitT) {
        tmpNode.alpha = 0;
        egret.Tween.get(tmpNode, { loop: false }).wait(waitT).to({ alpha: 1 }, 500);
    };
    AcMotherDayRewardShowView.prototype.hide = function () {
        if (this.param.data.callback) {
            this.param.data.callback.apply(this.param.data.callobj);
        }
        _super.prototype.hide.call(this);
    };
    AcMotherDayRewardShowView.prototype.getShowHeight = function () {
        var re_data = this.param.data;
        //"6_1150_4|6_1710_1";
        var rewardTab = re_data.split('|');
        return rewardTab.length > 5 ? 528 : 300;
    };
    AcMotherDayRewardShowView.prototype.getTitleStr = function () {
        return null;
    };
    AcMotherDayRewardShowView.prototype.getResourceList = function () {
    ...
    AcMotherDayRewardShowView.prototype.isTouchMaskClose = function () {
        return true;
    };
    AcMotherDayRewardShowView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcMotherDayRewardShowView;
}(BaseView));
__reflect(AcMotherDayRewardShowView.prototype, "AcMotherDayRewardShowView");
//# sourceMappingURL=AcMotherDayRewardShowView.js.map