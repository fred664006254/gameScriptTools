 ...
 */
var AcMotherDayActivityRewardPopupView = (function (_super) {
    __extends(AcMotherDayActivityRewardPopupView, _super);
    function AcMotherDayActivityRewardPopupView() {
    ...
    AcMotherDayActivityRewardPopupView.prototype.isSceneCode = function (code) {
        var arr = [3, 4, 7, 8];
        return arr.indexOf(Number(code)) > -1;
    };
    AcMotherDayActivityRewardPopupView.prototype.getUiCode = function () {
        var code = '';
    ...
    AcMotherDayActivityRewardPopupView.prototype.initView = function () {
     ...
     * 刷新UI
     */
    AcMotherDayActivityRewardPopupView.prototype.refreashView = function () {
    ...
    /**tab 刷新 */
    AcMotherDayActivityRewardPopupView.prototype.refreashTabBar = function () {
        var cfg = Config.AcCfg.getCfgByActivityIdAndCode(this.param.data.aid, this.param.data.code);
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this.param.data.aid, this.param.data.code);
        if (this._taskTabBar) {
    ...
    /**充值奖励返回 */
    AcMotherDayActivityRewardPopupView.prototype.chargeHandle = function (event) {
        if (event.data.ret) {
    ...
    /** 任务奖励返回 */
    AcMotherDayActivityRewardPopupView.prototype.taskHandle = function (event) {
        if (event.data.ret) {
    ...
    /** 任务奖励返回 */
    AcMotherDayActivityRewardPopupView.prototype.shopHandle = function (event) {
        if (event.data.ret) {
            var rewards = event.data.data.data.rewards;
            var rewardVoList = GameData.formatRewardItem(rewards);
            App.CommonUtil.playRewardFlyAction(rewardVoList);
     ...
     * 重置高度
     */
    AcMotherDayActivityRewardPopupView.prototype.resetBgSize = function () {
     ...
     * 充值说明事件
     */
    AcMotherDayActivityRewardPopupView.prototype.chargeBtnClick = function () {
     ...
     * 充值奖励UI
     */
    AcMotherDayActivityRewardPopupView.prototype.showChargeUI = function () {
        var cfg = Config.AcCfg.getCfgByActivityIdAndCode(this.param.data.aid, this.param.data.code);
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this.param.data.aid, this.param.data.code);
     ...
     * 任务说明事件
     */
    AcMotherDayActivityRewardPopupView.prototype.taskBtnClick = function () {
     ...
     * 任务奖励UI
     */
    AcMotherDayActivityRewardPopupView.prototype.showTaskUI = function () {
        var cfg = Config.AcCfg.getCfgByActivityIdAndCode(this.param.data.aid, this.param.data.code);
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this.param.data.aid, this.param.data.code);
        ...
        var scenecode = this.isSceneCode(this.param.data.code) ? "3" : this.param.data.code;
        var tabarArr = ["acMotherDayActivityRewardTaskTab1-" + scenecode, "acMotherDayActivityRewardTaskTab2-" + scenecode, "acMotherDayActivityRewardTaskTab3-" + scenecode];
    ...
    /**Tab 事件 */
    AcMotherDayActivityRewardPopupView.prototype.taskTabBarClick = function (data) {
     ...
     * 充值说明事件
     */
    AcMotherDayActivityRewardPopupView.prototype.shopBtnClick = function () {
     ...
     * 充值奖励UI
     */
    AcMotherDayActivityRewardPopupView.prototype.showShopUI = function () {
        var cfg = Config.AcCfg.getCfgByActivityIdAndCode(this.param.data.aid, this.param.data.code);
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this.param.data.aid, this.param.data.code);
        ...
        var itemGem3 = BaseLoadBitmap.create("itemicon" + id);
        itemGem3.width = 100;
        itemGem3.height = 100;
    ...
    AcMotherDayActivityRewardPopupView.prototype.getTitleStr = function () {
        return "acMotherDayActivityRewardPopupViewTitle-3";
    };
    AcMotherDayActivityRewardPopupView.prototype.getResourceList = function () {
    ...
    AcMotherDayActivityRewardPopupView.prototype.getShowHeight = function () {
        return 840;
    };
    AcMotherDayActivityRewardPopupView.prototype.dispose = function () {
    ...
    return AcMotherDayActivityRewardPopupView;
}(PopupView));
__reflect(AcMotherDayActivityRewardPopupView.prototype, "AcMotherDayActivityRewardPopupView");
//# sourceMappingURL=AcMotherDayActivityRewardPopupView.js.map