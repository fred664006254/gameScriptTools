...
/**
  ...
  * author 张朝阳
  * date 2019/7/16
  * @class AcMotherDayActivityRewardTaskScrollItem
  */
var AcMotherDayActivityRewardTaskScrollItem = (function (_super) {
    __extends(AcMotherDayActivityRewardTaskScrollItem, _super);
    function AcMotherDayActivityRewardTaskScrollItem() {
        var _this = _super.call(this) || this;
        _this._itemData = null;
        _this._aidAndCode = null;
        return _this;
    }
    AcMotherDayActivityRewardTaskScrollItem.prototype.isSceneCode = function (code) {
        var arr = [3, 4, 7, 8];
        return arr.indexOf(Number(code)) > -1;
    };
    AcMotherDayActivityRewardTaskScrollItem.prototype.getUiCode = function () {
        var code = '';
     ...
     * 初始化itemview
     */
    AcMotherDayActivityRewardTaskScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        this._itemData = data;
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acMotherDayActivityRewardTaskScrollItemTaskType" + this._itemData.questType + "-" + (this.isSceneCode(this._aidAndCode.code) ? "3" : this._aidAndCode.code), [String(this._itemData.value)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        if (this._itemData.specialReward) {
            rewards = "1007_0_" + this._itemData.specialReward + "_" + (this.getUiCode()) + "|" + this._itemData.getReward;
        }
        ...
        if (vo.getTaskFlag(String(this._aidAndCode.dayId), this._itemData.questType)) {
            ...
            if (vo.getTaskValue(String(this._aidAndCode.dayId), this._itemData.questType) >= this._itemData.value) {
                ...
                var reviceBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, "taskCollect", function () {
                    ...
                    NetManager.request(NetRequestConst.REQUEST_MOTHERDAY_GETMOTHERDAYTASK, { activeId: vo.aidAndCode, taskId: Number(data.id), diffday: _this._aidAndCode.dayId });
                }, this);
                ...
                if (this._itemData.questType == "1004") {
                    ...
                    var goBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_RED, "taskGoBtn", this.goBtnClick, this);
    ...
    AcMotherDayActivityRewardTaskScrollItem.prototype.goBtnClick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this._aidAndCode.aid, this._aidAndCode.code);
    ...
    AcMotherDayActivityRewardTaskScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcMotherDayActivityRewardTaskScrollItem.prototype.dispose = function () {
        this._itemData = null;
        _super.prototype.dispose.call(this);
    };
    return AcMotherDayActivityRewardTaskScrollItem;
}(ScrollListItem));
__reflect(AcMotherDayActivityRewardTaskScrollItem.prototype, "AcMotherDayActivityRewardTaskScrollItem");
//# sourceMappingURL=AcMotherDayActivityRewardTaskScrollItem.js.map