 ...
 * @author ycg
 */
var AcNightSkyDetailScrollItem1 = (function (_super) {
    __extends(AcNightSkyDetailScrollItem1, _super);
    function AcNightSkyDetailScrollItem1() {
        var _this = _super.call(this) || this;
        _this._aid = null;
        _this._code = null;
        return _this;
    }
    Object.defineProperty(AcNightSkyDetailScrollItem1.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcNightSkyDetailScrollItem1.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcNightSkyDetailScrollItem1.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcNightSkyDetailScrollItem1.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcNightSkyDetailScrollItem1.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
    };
    AcNightSkyDetailScrollItem1.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 13;
        //title txt
        var titleTxtStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acNightSkyDetailProcessTitle", this.getTypeCode()), ["" + data.needNum]);
        ;
        ...
        if (this.vo.isGetAchieveRewardById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACNIGHTSKY_ACHIVERWD, { activeId: _this.vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcNightSkyDetailScrollItem1.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcNightSkyDetailScrollItem1.prototype.getSpaceY = function () {
        return 5;
    };
    AcNightSkyDetailScrollItem1.prototype.dispose = function () {
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcNightSkyDetailScrollItem1;
}(ScrollListItem));
__reflect(AcNightSkyDetailScrollItem1.prototype, "AcNightSkyDetailScrollItem1");
//# sourceMappingURL=AcNightSkyDetailScrollItem1.js.map