...
/**
 * author : qianjun
 * desc : 兔宝活动 累计充值itemrender
 */
var AcRabbitComingShopRechargeItem = (function (_super) {
    __extends(AcRabbitComingShopRechargeItem, _super);
    function AcRabbitComingShopRechargeItem() {
    ...
    Object.defineProperty(AcRabbitComingShopRechargeItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcRabbitComingShopRechargeItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcRabbitComingShopRechargeItem.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcRabbitComingShopRechargeItem.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcRabbitComingShopRechargeItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcRabbitComingShopRechargeItem.prototype.getUiCode = function () {
        var code = '';
    ...
    AcRabbitComingShopRechargeItem.prototype.initItem = function (index, data, itemparam) {
        var view = this;
        ...
        this.addChild(Txt1);
        var str = "1050_1_" + data.specialGift;
    ...
    //刷新按钮状态
    AcRabbitComingShopRechargeItem.prototype.refreshBtnStatus = function () {
        var tmpVo = this.vo;
        if (!tmpVo) {
            return;
        }
    ...
    AcRabbitComingShopRechargeItem.prototype.refreshUI = function () {
    ...
    AcRabbitComingShopRechargeItem.prototype.createCollectFlag = function () {
    ...
    AcRabbitComingShopRechargeItem.prototype.eventCollectHandler = function (event) {
        ...
        NetManager.request(NetRequestConst.REQUEST_RABBIT_RECHARGE, {
            activeId: this.acTivityId,
            rkey: this._itemData
        });
    };
    AcRabbitComingShopRechargeItem.prototype.goRechargeHandler = function (event) {
        if (this.vo.et < GameData.serverTime) {
            App.CommonUtil.showTip(LanguageManager.getlocal("time_error"));
            return;
        }
    ...
    AcRabbitComingShopRechargeItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcRabbitComingShopRechargeItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcRabbitComingShopRechargeItem.prototype.dispose = function () {
        this._itemData = null;
        this._collectFlag = null;
        this._progress = null;
        this._collectBtn = null;
    ...
    return AcRabbitComingShopRechargeItem;
}(ScrollListItem));
__reflect(AcRabbitComingShopRechargeItem.prototype, "AcRabbitComingShopRechargeItem");
//# sourceMappingURL=AcRabbitComingShopRechargeItem.js.map