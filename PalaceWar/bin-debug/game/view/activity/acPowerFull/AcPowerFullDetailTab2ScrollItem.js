 ...
 * @author ycg
 */
var AcPowerFullDetailTab2ScrollItem = /** @class */ (function (_super) {
    __extends(AcPowerFullDetailTab2ScrollItem, _super);
    function AcPowerFullDetailTab2ScrollItem() {
        var _this = _super.call(this) || this;
        _this._aid = null;
        _this._code = null;
        return _this;
    }
    Object.defineProperty(AcPowerFullDetailTab2ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcPowerFullDetailTab2ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcPowerFullDetailTab2ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcPowerFullDetailTab2ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcPowerFullDetailTab2ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
    };
    AcPowerFullDetailTab2ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 13;
        //title txt
        var titleTxtStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acPowerFullDetailProcessNum", this.getTypeCode()), ["" + data.needNum]);
        ;
        ...
        var progressStr = LanguageManager.getlocal("acLotusDetailProcessNum-1", [String(currNum), String(data.needNum)]);
        ...
        if (this.vo.isGetAchieveRewardById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                _this.vo.setAchRewardId(data.id);
                NetManager.request(NetRequestConst.REQUEST_ACPOWERFULL_ACHIEVERWD, { activeId: _this.vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcPowerFullDetailTab2ScrollItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcPowerFullDetailTab2ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcPowerFullDetailTab2ScrollItem.prototype.dispose = function () {
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcPowerFullDetailTab2ScrollItem;
}(ScrollListItem));
//# sourceMappingURL=AcPowerFullDetailTab2ScrollItem.js.map