 ...
 * 衣装预览
 * date 2020.4.14
 * @class AcLotusDetailPopupViewTab4
 */
var AcLotusDetailPopupViewTab4 = /** @class */ (function (_super) {
    __extends(AcLotusDetailPopupViewTab4, _super);
    function AcLotusDetailPopupViewTab4(data) {
    ...
    AcLotusDetailPopupViewTab4.prototype.initView = function () {
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACLOTUS_EXCHANGE, this.exchangeCallback, this);
        ...
        var topStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acLotusSkinTopMsg", this.getTypeCode()), ["" + toolItemVo.num, toolItemVo.name]);
        ...
        var exchangeBg = BaseBitmap.create(App.CommonUtil.getResByCode("aclotus_skinprocessbg", this.getTypeCode()));
        ...
        var exchangeBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, App.CommonUtil.getCnByCode("acLotusDetailSkinget", this.getTypeCode()), this.exchangeBtnClick, this);
        ...
        progress.setText(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acLotusDetailProcessNum", this.getTypeCode()), ["" + currNum, "" + toolItemVo.num]));
    };
    AcLotusDetailPopupViewTab4.prototype.exchangeBtnClick = function () {
        var toolItemVo = this.vo.getShowSkinData();
        var toolData = Api.itemVoApi.getItemInfoVoById(toolItemVo.id);
        var currNum = 0;
        if (toolData) {
        ...
        if (currNum >= toolItemVo.num) {
            //兑换
            NetManager.request(NetRequestConst.REQUEST_ACLOTUS_EXCHANGE, { activeId: this.vo.aidAndCode });
        }
    };
    AcLotusDetailPopupViewTab4.prototype.exchangeCallback = function (evt) {
        if (!evt.data.ret) {
            return;
        }
    ...
    AcLotusDetailPopupViewTab4.prototype.getRewardCallback = function () {
        var toolItemVo = this.vo.getShowSkinData();
        var toolData = Api.itemVoApi.getItemInfoVoById(toolItemVo.id);
        var currNum = 0;
        if (toolData) {
    ...
    AcLotusDetailPopupViewTab4.prototype.dealAttrChangeInfo = function (skinId) {
        var skinCfg = Config.WifeskinCfg.getWifeCfgById(skinId);
    ...
    Object.defineProperty(AcLotusDetailPopupViewTab4.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcLotusDetailPopupViewTab4.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcLotusDetailPopupViewTab4.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcLotusDetailPopupViewTab4.prototype, "aid", {
        get: function () {
    ...
    AcLotusDetailPopupViewTab4.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
    };
    AcLotusDetailPopupViewTab4.prototype.dispose = function () {
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACLOTUS_EXCHANGE, this.exchangeCallback, this);
    ...
    return AcLotusDetailPopupViewTab4;
}(CommonViewTab));
//# sourceMappingURL=AcLotusDetailPopupViewTab4.js.map