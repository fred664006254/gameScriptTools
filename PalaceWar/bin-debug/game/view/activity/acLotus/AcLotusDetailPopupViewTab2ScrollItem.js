 ...
 * @author ycg
 */
var AcLotusDetailPopupViewTab2ScrollItem = (function (_super) {
    __extends(AcLotusDetailPopupViewTab2ScrollItem, _super);
    function AcLotusDetailPopupViewTab2ScrollItem() {
        var _this = _super.call(this) || this;
        _this.itemParam = null;
        return _this;
    }
    Object.defineProperty(AcLotusDetailPopupViewTab2ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcLotusDetailPopupViewTab2ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcLotusDetailPopupViewTab2ScrollItem.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcLotusDetailPopupViewTab2ScrollItem.prototype, "code", {
        get: function () {
    ...
    AcLotusDetailPopupViewTab2ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
    };
    AcLotusDetailPopupViewTab2ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 13;
        //title txt
        var titleTxtStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acLotusDetailProcessTitle", this.getTypeCode()), ["" + data.specialnum]);
        ;
        ...
        var progressStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acLotusDetailProcessNum", this.getTypeCode()), [String(currNum), String(data.specialnum)]);
        ...
        if (this.vo.isGetAchieveRewardById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACLOTUS_GETREWARD, { activeId: _this.vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcLotusDetailPopupViewTab2ScrollItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcLotusDetailPopupViewTab2ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcLotusDetailPopupViewTab2ScrollItem.prototype.dispose = function () {
        this.itemParam = null;
        _super.prototype.dispose.call(this);
    };
    return AcLotusDetailPopupViewTab2ScrollItem;
}(ScrollListItem));
__reflect(AcLotusDetailPopupViewTab2ScrollItem.prototype, "AcLotusDetailPopupViewTab2ScrollItem");
//# sourceMappingURL=AcLotusDetailPopupViewTab2ScrollItem.js.map