...
var AcCrossServerIntimacyCheerViewScrollItem3 = (function (_super) {
    __extends(AcCrossServerIntimacyCheerViewScrollItem3, _super);
    function AcCrossServerIntimacyCheerViewScrollItem3() {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewScrollItem3.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewScrollItem3.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcCrossServerIntimacyCheerViewScrollItem3.prototype.getUiCode = function () {
        var code = "";
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewScrollItem3.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewScrollItem3.prototype, "cfg", {
        get: function () {
     ...
     * 初始化itemview
     */
    AcCrossServerIntimacyCheerViewScrollItem3.prototype.initItem = function (index, data, itemParam) {
        this.width = 620;
        this.height = 190;
        ...
        if (data.special1) {
            reward = "1060_0_" + data.special1 + "_" + this.getUiCode() + "|" + data.getReward;
        }
     ...
     * 领取奖励Click
     */
    AcCrossServerIntimacyCheerViewScrollItem3.prototype.reviceBtnClick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this.aid, this.code);
        if (!vo.isStart) {
            App.CommonUtil.showTip(LanguageManager.getlocal('acPunishEnd'));
            return;
        }
        NetManager.request(NetRequestConst.REQUEST_ACTIVITY_CROSSIMACY_GETTASKREWARD, { activeId: vo.aidAndCode, rkey: this._data.id });
    };
    /**
     * 刷新UI
     */
    AcCrossServerIntimacyCheerViewScrollItem3.prototype.refreshView = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this.aid, this.code);
     ...
     * 前往的Click
     */
    AcCrossServerIntimacyCheerViewScrollItem3.prototype.goBtnClick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode(this.aid, this.code);
        if (!vo.isInActivity()) {
            App.CommonUtil.showTip(LanguageManager.getlocal('acPunishEnd'));
            return;
    ...
    AcCrossServerIntimacyCheerViewScrollItem3.prototype.getSpaceY = function () {
        return 10;
    };
    AcCrossServerIntimacyCheerViewScrollItem3.prototype.dispose = function () {
        this._data = null;
    ...
    return AcCrossServerIntimacyCheerViewScrollItem3;
}(ScrollListItem));
__reflect(AcCrossServerIntimacyCheerViewScrollItem3.prototype, "AcCrossServerIntimacyCheerViewScrollItem3");
//# sourceMappingURL=AcCrossServerIntimacyCheerViewScrollItem3.js.map