...
//人气商店
var AcCrossServerIntimacyCheerViewTab4 = /** @class */ (function (_super) {
    __extends(AcCrossServerIntimacyCheerViewTab4, _super);
    function AcCrossServerIntimacyCheerViewTab4(data) {
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.getUiCode = function () {
        var code = "";
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab4.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab4.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab4.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab4.prototype, "cfg", {
        get: function () {
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.initView = function () {
        ...
        var scrollList = ComponentManager.getScrollList(AcCrossServerIntimacyCheerViewScrollItem4, [], tmpRect, { aid: this.aid, code: this.code });
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.tick = function () {
        if (this._timeDown) {
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.refreshData = function (event) {
        if (event) {
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.checkRed = function () {
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.refreshView = function () {
        this.freshList();
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.formatFlagScoreShopCfg = function () {
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.formatFlagScoreShop2Cfg = function () {
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.getTabbarTextArr = function () {
        return ["croessServerImacyTab1", "croessServerImacyTab2"];
    };
    AcCrossServerIntimacyCheerViewTab4.prototype.initTabbarGroup = function () {
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.clickTabbarHandler = function (data) {
        _super.prototype.clickTabbarHandler.call(this, data);
        var index = Number(data.index);
        this.tabbarHandler(index);
    };
    AcCrossServerIntimacyCheerViewTab4.prototype.tabbarHandler = function (index) {
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.freshList = function () {
        if (this._index == 0) {
    ...
    AcCrossServerIntimacyCheerViewTab4.prototype.addTabbarGroupBg = function () {
        return true;
    };
    AcCrossServerIntimacyCheerViewTab4.prototype.getTabbarName = function () {
        return ButtonConst.BTN_BIG_TAB2;
    };
    AcCrossServerIntimacyCheerViewTab4.prototype.dispose = function () {
    ...
    return AcCrossServerIntimacyCheerViewTab4;
}(CommonViewTab));
//# sourceMappingURL=AcCrossServerIntimacyCheerViewTab4.js.map