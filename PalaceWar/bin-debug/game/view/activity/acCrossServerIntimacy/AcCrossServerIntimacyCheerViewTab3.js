...
//任务
var AcCrossServerIntimacyCheerViewTab3 = (function (_super) {
    __extends(AcCrossServerIntimacyCheerViewTab3, _super);
    function AcCrossServerIntimacyCheerViewTab3(data) {
    ...
    AcCrossServerIntimacyCheerViewTab3.prototype.getUiCode = function () {
        var code = "";
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab3.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab3.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab3.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab3.prototype, "cfg", {
        get: function () {
    ...
    AcCrossServerIntimacyCheerViewTab3.prototype.initView = function () {
        ...
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSIMACY_GETTASKREWARD, this.getRewardCallback, this);
        var tmpRect = new egret.Rectangle(0, 0, 620, this.height - 20);
        var dataList = this.vo.getSortTaskCfg();
        var scrollList = ComponentManager.getScrollList(AcCrossServerIntimacyCheerViewScrollItem3, dataList, tmpRect, { aid: this.aid, code: this.code });
    ...
    AcCrossServerIntimacyCheerViewTab3.prototype.refreshView = function () {
        var dataList = this.vo.getSortTaskCfg();
        this._scrollList.refreshData(dataList, { aid: this.aid, code: this.code });
    };
    AcCrossServerIntimacyCheerViewTab3.prototype.getRewardCallback = function (event) {
        if (event.data && event.data.ret) {
            var data = event.data.data.data;
            var rewards = data.rewards;
            if (data.specialGift) {
                if (data.rewards) {
                    rewards = "1060_0_" + data.specialGift + "_" + this.getUiCode() + "|" + data.rewards;
                }
                else {
                    rewards = "1060_0_" + data.specialGift + "_" + this.getUiCode();
                }
            }
    ...
    AcCrossServerIntimacyCheerViewTab3.prototype.dispose = function () {
        App.MessageHelper.removeNetMessage(MessageConst.MESSAGE_MODEL_ACTIVITY, this.refreshView, this);
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSIMACY_GETTASKREWARD, this.getRewardCallback, this);
        this._scrollList = null;
        _super.prototype.dispose.call(this);
    };
    return AcCrossServerIntimacyCheerViewTab3;
}(CommonViewTab));
__reflect(AcCrossServerIntimacyCheerViewTab3.prototype, "AcCrossServerIntimacyCheerViewTab3");
//# sourceMappingURL=AcCrossServerIntimacyCheerViewTab3.js.map