...
//助威
var AcCrossServerIntimacyCheerViewTab2 = (function (_super) {
    __extends(AcCrossServerIntimacyCheerViewTab2, _super);
    function AcCrossServerIntimacyCheerViewTab2(param) {
    ...
    AcCrossServerIntimacyCheerViewTab2.prototype.getUiCode = function () {
        var code = "";
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab2.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab2.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab2.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerIntimacyCheerViewTab2.prototype, "cfg", {
        get: function () {
    ...
    AcCrossServerIntimacyCheerViewTab2.prototype.initView = function () {
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSIMACY_GETFLAGREWARD, this.refreshScore, this);
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSIMACY_USEFLAG, this.refreshData, this);
        ...
        var flagNum = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverImacyCheerflag", this.getUiCode()), [String(fNum)]), 24, TextFieldConst.COLOR_WHITE);
        ...
        var info = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverImacyCheerInfo", this.getUiCode())), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_WHITE);
        info.width = 600;
        info.lineSpacing = 5;
        info.x = scoreNum.x;
        ...
        var redPlusTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverImacyCheerAddPower", this.getUiCode())), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var playerAddTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverImacyCheerSelfNum", this.getUiCode())), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var list = [];
        var rankData = Api.crossImacyVoApi.flagRankInfo;
        if (rankData) {
            list = rankData;
        }
        var listH = detailBg.y - redBg.y - redBg.height - 5;
        var rect = new egret.Rectangle(0, 0, 620, listH);
        var scrollList = ComponentManager.getScrollList(AcCrossServerIntimacyCheerViewScrollItem2, list, rect, { aid: this.aid, code: this.code });
    ...
    AcCrossServerIntimacyCheerViewTab2.prototype.tick = function () {
        if (this._cheerTip) {
            var cheerTipStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossServerPowerCheerNotOpen", this.getUiCode(), "7"));
            var cheerEndTime = this.vo.getCheerEndTime();
            if (GameData.serverTime >= cheerEndTime) {
    ...
    AcCrossServerIntimacyCheerViewTab2.prototype.refreshView = function () {
        ...
        this._flagNum.text = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverImacyCheerflag", this.getUiCode()), [String(this.vo.getFightFlagNum())]);
    ...
    AcCrossServerIntimacyCheerViewTab2.prototype.refreshScore = function (event) {
    ...
    AcCrossServerIntimacyCheerViewTab2.prototype.refreshData = function (event) {
        if (event.data && event.data.ret) {
            var d = event.data.data.data;
            var rank = d.atkranks;
            Api.crossImacyVoApi.setFlagRankInfo(rank);
            this._scrollList.refreshData(rank, { aid: this.param.data.aid, code: this.param.data.code });
            this.refreshView();
        }
    };
    AcCrossServerIntimacyCheerViewTab2.prototype.scoreBtnClick = function () {
        if (!this.vo.isStart) {
            this.vo.showAcEndTip();
            return;
        }
        if (this.vo.isCanGetFlagScore()) {
            NetManager.request(NetRequestConst.REQUEST_ACTIVITY_CROSSIMACY_GETFLAGREWARD, { activeId: this.vo.aidAndCode });
        }
    };
    AcCrossServerIntimacyCheerViewTab2.prototype.ruleBtnClick = function () {
        ViewController.getInstance().openView(ViewConst.POPUP.ACCROSSSERVERIMACYCHEERRULEPOPUPVIEW, {
            aid: this.param.data.aid,
            code: this.param.data.code,
        });
    };
    AcCrossServerIntimacyCheerViewTab2.prototype.dispose = function () {
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSIMACY_GETFLAGREWARD, this.refreshScore, this);
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSIMACY_USEFLAG, this.refreshData, this);
    ...
    return AcCrossServerIntimacyCheerViewTab2;
}(CommonViewTab));
__reflect(AcCrossServerIntimacyCheerViewTab2.prototype, "AcCrossServerIntimacyCheerViewTab2");
//# sourceMappingURL=AcCrossServerIntimacyCheerViewTab2.js.map