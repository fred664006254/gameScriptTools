...
/**
  ...
  * author ycg
  * date 2020.2.26
  * @class AcRecoveryDetailTab1ScrollItem
  */
var AcRecoveryDetailTab1ScrollItem = (function (_super) {
    __extends(AcRecoveryDetailTab1ScrollItem, _super);
    function AcRecoveryDetailTab1ScrollItem() {
     ...
     * 初始化itemview
     */
    AcRecoveryDetailTab1ScrollItem.prototype.initItem = function (index, data, itemParam) {
        this._itemData = data;
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acRecoveryChargeItem", [String(this._itemData.needGem)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        if (this._itemData.specialGift) {
            rewards = "1042_0_" + this._itemData.specialGift + "_" + this.getTypeCode() + "|" + rewards;
        }
        ...
        var progressStr = LanguageManager.getlocal("acRecoveryProcessNum-" + this.getTypeCode(), [String(currChargeGem), String(data.needGem)]);
        ...
        if (vo.isGetChargeRewardById(data.id)) {
            ...
            if (vo.getCurrRecharge() >= data.needGem) {
                ...
                var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                    ...
                    NetManager.request(NetRequestConst.REQUEST_ACRECOVERY_CHARGE, { activeId: vo.aidAndCode, idx: data.id });
                }, this);
    ...
    AcRecoveryDetailTab1ScrollItem.prototype.getTypeCode = function () {
        if (this._aidAndCode.code == "2") {
            return "1";
        }
        return this._aidAndCode.code;
    };
    AcRecoveryDetailTab1ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcRecoveryDetailTab1ScrollItem.prototype.dispose = function () {
        this._itemData = null;
        _super.prototype.dispose.call(this);
    };
    return AcRecoveryDetailTab1ScrollItem;
}(ScrollListItem));
__reflect(AcRecoveryDetailTab1ScrollItem.prototype, "AcRecoveryDetailTab1ScrollItem");
//# sourceMappingURL=AcRecoveryDetailTab1ScrollItem.js.map