 ...
 */
var AcRecoveryDetailPopupViewTab4 = (function (_super) {
    __extends(AcRecoveryDetailPopupViewTab4, _super);
    function AcRecoveryDetailPopupViewTab4(data) {
        var _this = _super.call(this) || this;
        _this.param = data;
        _this.initView();
        return _this;
    }
    AcRecoveryDetailPopupViewTab4.prototype.initView = function () {
        ...
        var topMsg = ComponentManager.getTextField(LanguageManager.getlocal("acRecoverySkinTopMsg-" + this.getTypeCode(), [String(needData.needNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        topMsg.setPosition(msgBg.x + msgBg.width / 2 - topMsg.width / 2, msgBg.y + msgBg.height / 2 - topMsg.height / 2);
        this.addChild(topMsg);
        var skinFlag = App.CommonUtil.getServantSkinFlagById(skinId);
        if (skinFlag) {
    ...
    Object.defineProperty(AcRecoveryDetailPopupViewTab4.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcRecoveryDetailPopupViewTab4.prototype, "vo", {
        get: function () {
    ...
    AcRecoveryDetailPopupViewTab4.prototype.getTypeCode = function () {
        var code = this.code;
        if (code == "2") {
            return "1";
        }
    ...
    Object.defineProperty(AcRecoveryDetailPopupViewTab4.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcRecoveryDetailPopupViewTab4.prototype, "code", {
        get: function () {
    ...
    AcRecoveryDetailPopupViewTab4.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcRecoveryDetailPopupViewTab4;
}(CommonViewTab));
__reflect(AcRecoveryDetailPopupViewTab4.prototype, "AcRecoveryDetailPopupViewTab4");
//# sourceMappingURL=AcRecoveryDetailPopupViewTab4.js.map