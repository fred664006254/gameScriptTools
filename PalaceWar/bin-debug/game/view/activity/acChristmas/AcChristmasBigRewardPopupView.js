 ...
 */
var AcChristmasBigRewardPopupView = (function (_super) {
    __extends(AcChristmasBigRewardPopupView, _super);
    function AcChristmasBigRewardPopupView() {
        return _super.call(this) || this;
    }
    AcChristmasBigRewardPopupView.prototype.initView = function () {
        this.aid = this.param.data.aid;
        this.code = this.param.data.code;
        var acCfg = Config.AcCfg.getCfgByActivityIdAndCode(this.aid, this.code);
        var skinCfg = Config.ServantskinCfg.getServantSkinItemById(acCfg.skin);
        ...
        var topDesc = ComponentManager.getTextField(LanguageManager.getlocal("acChristmasBigRewardPopupViewTopDesc"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
    ...
    AcChristmasBigRewardPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "skin_detail_namebg", "servant_star",
            "servant_infoPro1", "servant_infoPro2", "servant_infoPro3", "servant_infoPro4",
        ]);
    };
    AcChristmasBigRewardPopupView.prototype.getTitleStr = function () {
        return "acChristmasBigRewardPopupViewTitle";
    };
    // protected getShowHeight() {
    // 	return 760;
    // }
    AcChristmasBigRewardPopupView.prototype.getBgExtraHeight = function () {
        return 20;
    };
    AcChristmasBigRewardPopupView.prototype.dispose = function () {
        this.aid = null;
        this.code = null;
        _super.prototype.dispose.call(this);
    };
    return AcChristmasBigRewardPopupView;
}(PopupView));
__reflect(AcChristmasBigRewardPopupView.prototype, "AcChristmasBigRewardPopupView");
//# sourceMappingURL=AcChristmasBigRewardPopupView.js.map