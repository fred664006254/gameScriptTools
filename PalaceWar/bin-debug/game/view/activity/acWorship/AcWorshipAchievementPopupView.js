 ...
 */
var AcWorshipAchievementPopupView = (function (_super) {
    __extends(AcWorshipAchievementPopupView, _super);
    function AcWorshipAchievementPopupView() {
        var _this = _super.call(this) || this;
        _this._scrollList = null;
        return _this;
    }
    AcWorshipAchievementPopupView.prototype.initView = function () {
    ...
    /**刷新item */
    AcWorshipAchievementPopupView.prototype.weathRewardHandle = function (event) {
        if (event.data.ret) {
    ...
    AcWorshipAchievementPopupView.prototype.getTitleStr = function () {
        return "acWorshipAchievementPopupViewTitle-" + this.param.data.code;
    };
    AcWorshipAchievementPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat(["progress3_bg", "progress3"
        ]);
    };
    AcWorshipAchievementPopupView.prototype.dispose = function () {
    ...
    return AcWorshipAchievementPopupView;
}(PopupView));
__reflect(AcWorshipAchievementPopupView.prototype, "AcWorshipAchievementPopupView");
//# sourceMappingURL=AcWorshipAchievementPopupView.js.map