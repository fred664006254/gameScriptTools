 ...
 */
var AcWorshipAchievementScrollItem = (function (_super) {
    __extends(AcWorshipAchievementScrollItem, _super);
    function AcWorshipAchievementScrollItem() {
        return _super.call(this) || this;
    }
    AcWorshipAchievementScrollItem.prototype.initItem = function (index, data, itemParam) {
        // getReward
        // value
        //id
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acWorshipAchievementPopupViewItemTitle-" + code, [String(data.needNum)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var percent = vo.getItemValue() / data.needNum;
        var textStr = vo.getItemValue() + "/" + data.needNum;
        ...
        if (vo.checkRewardFlag(data.id)) {
            ...
            var receiveBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, 'taskCollect', function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACTIVITY_GETWORSHIPACHIEVEMENT, { activeId: vo.aidAndCode, rkey: data.id });
            }, this);
            ...
            if (vo.getItemValue() >= data.needNum) {
    ...
    AcWorshipAchievementScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcWorshipAchievementScrollItem.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcWorshipAchievementScrollItem;
}(ScrollListItem));
__reflect(AcWorshipAchievementScrollItem.prototype, "AcWorshipAchievementScrollItem");
//# sourceMappingURL=AcWorshipAchievementScrollItem.js.map