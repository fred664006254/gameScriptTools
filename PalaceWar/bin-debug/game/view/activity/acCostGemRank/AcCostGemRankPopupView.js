...
var AcCostGemRankPopupView = (function (_super) {
    __extends(AcCostGemRankPopupView, _super);
    function AcCostGemRankPopupView() {
        var _this = _super.call(this) || this;
        _this._listdata = [];
        return _this;
    }
    AcCostGemRankPopupView.prototype.getTitleStr = function () {
        return "buildtxt1Tab4_1";
    };
    AcCostGemRankPopupView.prototype.getUiCode = function () {
        var code = '';
    ...
    Object.defineProperty(AcCostGemRankPopupView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCostGemRankPopupView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCostGemRankPopupView.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcCostGemRankPopupView.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcCostGemRankPopupView.prototype, "acTivityId", {
        get: function () {
    ...
    AcCostGemRankPopupView.prototype.getRequestData = function () {
        return {
            requestType: NetRequestConst.REQUEST_COSTGEMRANK_GETLIST,
            requestData: {
                activeId: this.acTivityId
            }
        };
    };
    AcCostGemRankPopupView.prototype.receiveData = function (data) {
        if (data.data.data) {
            this.vo.setRankInfo(data.data.data);
            this._listdata = data.data.data.rankArr;
        }
    };
    AcCostGemRankPopupView.prototype.initView = function () {
    ...
    AcCostGemRankPopupView.prototype.resetBgSize = function () {
    ...
    //     }
    // }
    AcCostGemRankPopupView.prototype.getResourceList = function () {
    ...
    AcCostGemRankPopupView.prototype.dispose = function () {
        this._nodeContainer = null;
        this._scrollView = null;
        this._listdata = [];
        _super.prototype.dispose.call(this);
    };
    return AcCostGemRankPopupView;
}(PopupView));
__reflect(AcCostGemRankPopupView.prototype, "AcCostGemRankPopupView");
//# sourceMappingURL=AcCostGemRankPopupView.js.map