...
var AcRechargeBoxPopupView = (function (_super) {
    ...
    Object.defineProperty(AcRechargeBoxPopupView.prototype, "newCode", {
        get: function () {
            var code = "";
    ...
    AcRechargeBoxPopupView.prototype.getRewardHandler = function (event) {
        ...
        if (replacerewards) {
            if (this.newCode == "1" || this.newCode == "3" || this.newCode == "4" || this.newCode == "5" || this.newCode == "12") {
                ...
                var rewardName = Config.WifeskinCfg.getWifeCfgById(GameData.formatRewardItem(oldReward)[0].id).name;
                ViewController.getInstance().openView(ViewConst.POPUP.COMMONCHANGEOTHERREWARD, {
                    "name": rewardName, "touch": newReward, "message": "changeOtherRewardTip", callback: function () {
...
//# sourceMappingURL=AcRechargeBoxPopupView.js.map