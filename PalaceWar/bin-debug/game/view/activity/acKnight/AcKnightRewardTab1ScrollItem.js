...
var AcKnightRewardTab1ScrollItem = (function (_super) {
    __extends(AcKnightRewardTab1ScrollItem, _super);
    function AcKnightRewardTab1ScrollItem() {
    ...
    Object.defineProperty(AcKnightRewardTab1ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcKnightRewardTab1ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcKnightRewardTab1ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcKnightRewardTab1ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcKnightRewardTab1ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
     ...
     * 初始化itemview
     */
    AcKnightRewardTab1ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        this._itemData = data;
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acKnightRechargeItemInfo", this.getTypeCode()), [String(this._itemData.needGem)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        if (this.vo.isGetRecharge(String(data.id))) {
            ...
            if (currChargeGem >= data.needGem) {
                ...
                var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                    ...
                    NetManager.request(NetRequestConst.REQUEST_KNIGHT_GETRINFORWD, { activeId: _this.vo.aidAndCode, rkey: Number(data.id) });
                }, this);
    ...
    AcKnightRewardTab1ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcKnightRewardTab1ScrollItem.prototype.dispose = function () {
        this._itemData = null;
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcKnightRewardTab1ScrollItem;
}(ScrollListItem));
__reflect(AcKnightRewardTab1ScrollItem.prototype, "AcKnightRewardTab1ScrollItem");
//# sourceMappingURL=AcKnightRewardTab1ScrollItem.js.map