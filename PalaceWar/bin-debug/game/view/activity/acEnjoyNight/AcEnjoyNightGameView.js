...
var AcEnjoyNightGameView = (function (_super) {
    __extends(AcEnjoyNightGameView, _super);
    function AcEnjoyNightGameView() {
    ...
    AcEnjoyNightGameView.prototype.getTitleBgName = function () {
        return null;
    };
    AcEnjoyNightGameView.prototype.getTitleStr = function () {
        return null;
    };
    AcEnjoyNightGameView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcEnjoyNightGameView.prototype.getBgName = function () {
        return "acenjoynight_gamebg-1";
    };
    AcEnjoyNightGameView.prototype.initBg = function () {
    ...
    AcEnjoyNightGameView.prototype.isShowMask = function () {
        return true;
    };
    AcEnjoyNightGameView.prototype.getResourceList = function () {
        var guidePic = [];
    ...
    AcEnjoyNightGameView.prototype.initView = function () {
    ...
    AcEnjoyNightGameView.prototype.gameHandle = function (i) {
    ...
    AcEnjoyNightGameView.prototype.playAnim = function () {
    ...
    AcEnjoyNightGameView.prototype.play2 = function () {
        if (this._win) {
            var win = this._win;
    ...
    AcEnjoyNightGameView.prototype.stopshakeScreen = function () {
        this.x = 0;
        this.y = 0;
        this._isShakeing = false;
        egret.startTick(this.shakeScreen, this);
    };
    AcEnjoyNightGameView.prototype.shakeScreen = function (timeStamp) {
        var spaceTime = 100;
    ...
    AcEnjoyNightGameView.prototype.hide = function (isDispose) {
        var view = this;
    ...
    AcEnjoyNightGameView.prototype.dispose = function () {
    ...
    return AcEnjoyNightGameView;
}(CommonView));
__reflect(AcEnjoyNightGameView.prototype, "AcEnjoyNightGameView");
//# sourceMappingURL=AcEnjoyNightGameView.js.map