 ...
 */
var AcDestroySameChargeItem = (function (_super) {
    __extends(AcDestroySameChargeItem, _super);
    function AcDestroySameChargeItem() {
    ...
    Object.defineProperty(AcDestroySameChargeItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcDestroySameChargeItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcDestroySameChargeItem.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcDestroySameChargeItem.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcDestroySameChargeItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcDestroySameChargeItem.prototype.getUiCode = function () {
        var code = '';
    ...
    AcDestroySameChargeItem.prototype.initItem = function (index, data, itemparam) {
        var view = this;
        ...
        this.addChild(Txt1);
        var str = "1029_0_" + this._rechargeItem.specialGift + "_" + this.getUiCode() + "|" + this._rechargeItem.getReward;
    ...
    //刷新按钮状态
    AcDestroySameChargeItem.prototype.refreshBtnStatus = function () {
        var tmpVo = this.vo;
        if (!tmpVo) {
            return;
        }
    ...
    AcDestroySameChargeItem.prototype.refreshUI = function () {
    ...
    AcDestroySameChargeItem.prototype.createCollectFlag = function () {
    ...
    AcDestroySameChargeItem.prototype.eventCollectHandler = function (event) {
        ...
        NetManager.request(NetRequestConst.REQUEST_DESTROYSAME_CHARGE, {
            activeId: this.acTivityId,
            rkey: this._itemData
        });
    };
    AcDestroySameChargeItem.prototype.goRechargeHandler = function (event) {
        if (this.vo.et < GameData.serverTime) {
            App.CommonUtil.showTip(LanguageManager.getlocal("time_error"));
            return;
        }
    ...
    AcDestroySameChargeItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcDestroySameChargeItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcDestroySameChargeItem.prototype.dispose = function () {
        this._itemData = null;
        this._collectFlag = null;
        this._progress = null;
        this._collectBtn = null;
    ...
    return AcDestroySameChargeItem;
}(ScrollListItem));
__reflect(AcDestroySameChargeItem.prototype, "AcDestroySameChargeItem");
//# sourceMappingURL=AcDestroySameChargeItem.js.map