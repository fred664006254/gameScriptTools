...
/**
  ...
  */
var AcFindSameRewardTab1ScrollItem = (function (_super) {
    __extends(AcFindSameRewardTab1ScrollItem, _super);
    function AcFindSameRewardTab1ScrollItem() {
    ...
    Object.defineProperty(AcFindSameRewardTab1ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcFindSameRewardTab1ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcFindSameRewardTab1ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcFindSameRewardTab1ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcFindSameRewardTab1ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
     ...
     * 初始化itemview
     */
    AcFindSameRewardTab1ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        this._itemData = data;
        ...
        if (this.vo.isGetRechargeById(data.id)) {
            ...
            if (currChargeGem >= data.needGem) {
                ...
                var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                    ...
                    NetManager.request(NetRequestConst.REQUEST_FINDSAME_GETRECHARGE, { activeId: _this.vo.aidAndCode, rkey: Number(data.id) });
                }, this);
    ...
    AcFindSameRewardTab1ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcFindSameRewardTab1ScrollItem.prototype.dispose = function () {
        this._itemData = null;
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcFindSameRewardTab1ScrollItem;
}(ScrollListItem));
__reflect(AcFindSameRewardTab1ScrollItem.prototype, "AcFindSameRewardTab1ScrollItem");
//# sourceMappingURL=AcFindSameRewardTab1ScrollItem.js.map