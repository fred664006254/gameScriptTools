 ...
 * @author ycg
 */
var AcFindSameRewardTab2ScrollItem = (function (_super) {
    __extends(AcFindSameRewardTab2ScrollItem, _super);
    function AcFindSameRewardTab2ScrollItem() {
        var _this = _super.call(this) || this;
        _this._aid = null;
        _this._code = null;
        return _this;
    }
    Object.defineProperty(AcFindSameRewardTab2ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcFindSameRewardTab2ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcFindSameRewardTab2ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcFindSameRewardTab2ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcFindSameRewardTab2ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
    };
    AcFindSameRewardTab2ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 5;
        //title txt
        var titleTxtStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acFindSameAchieveItemInfo", this.getTypeCode()), ["" + data.needNum]);
        ;
        ...
        var currNum = this.vo.getProcess();
        ...
        if (this.vo.isGetAchievementById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_FINDSAME_GETACHIEVEMENT, { activeId: _this.vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcFindSameRewardTab2ScrollItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcFindSameRewardTab2ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcFindSameRewardTab2ScrollItem.prototype.dispose = function () {
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcFindSameRewardTab2ScrollItem;
}(ScrollListItem));
__reflect(AcFindSameRewardTab2ScrollItem.prototype, "AcFindSameRewardTab2ScrollItem");
//# sourceMappingURL=AcFindSameRewardTab2ScrollItem.js.map