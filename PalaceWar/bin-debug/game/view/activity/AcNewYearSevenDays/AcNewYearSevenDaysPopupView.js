 ...
 * 春节活动 奖励宝箱奖励预览弹板
 */
var AcNewYearSevenDaysPopupView = (function (_super) {
    __extends(AcNewYearSevenDaysPopupView, _super);
    function AcNewYearSevenDaysPopupView() {
    ...
    AcNewYearSevenDaysPopupView.prototype.getTitleStr = function () {
        return "acNewYearPopupViewTitle";
    };
    AcNewYearSevenDaysPopupView.prototype.initView = function () {
        ...
        if (this._name == "newYear1") {
            ...
            var curr_acNewYearVo = Api.acVoApi.getActivityVoByAidAndCode(AcConst.AID_ACNEWYEAR7DAYS, this._code);
        ...
        if (this.param.data.day !== tmpVo.diffday) {
            this._goBtn.visible = false;
        }
        else {
    ...
    AcNewYearSevenDaysPopupView.prototype.collectHandler = function (evt) {
        //领取状态 第一页面礼包
        if (this._btnTypeNum == 2) {
            NetManager.request(NetRequestConst.REQUEST_ACTIVITY_GETNEWYEARREWARD, { "activeId": AcConst.AID_ACNEWYEAR7DAYS + "-" + this._code, "questType": this._rewardNum + "", "ftype": 3 });
        }
        else {
            if (this.isShowBtnType == 1) {
                NetManager.request(NetRequestConst.REQUEST_ACTIVITY_GETNEWYEARREWARD, { "activeId": AcConst.AID_ACNEWYEAR7DAYS + "-" + this._code, "questType": 1001 + "", "ftype": 2 });
            }
            else {
                this.hide();
            }
    ...
    AcNewYearSevenDaysPopupView.prototype.refreshUIInfo = function (evt) {
        if (evt.data.ret) {
            var collectflag = BaseBitmap.create("collectflag");
            collectflag.x = 245;
            collectflag.y = 167;
    ...
    AcNewYearSevenDaysPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([]);
    };
    AcNewYearSevenDaysPopupView.prototype.dispose = function () {
        this._rbg = null;
        this._goBtn = null;
    ...
    return AcNewYearSevenDaysPopupView;
}(PopupView));
__reflect(AcNewYearSevenDaysPopupView.prototype, "AcNewYearSevenDaysPopupView");
//# sourceMappingURL=AcNewYearSevenDaysPopupView.js.map