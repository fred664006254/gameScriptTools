 ...
 */
var AcNewYearRedChargeItem = (function (_super) {
    __extends(AcNewYearRedChargeItem, _super);
    function AcNewYearRedChargeItem() {
    ...
    Object.defineProperty(AcNewYearRedChargeItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcNewYearRedChargeItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcNewYearRedChargeItem.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcNewYearRedChargeItem.prototype, "aid", {
        get: function () {
            return AcConst.AID_NEWYEARRED;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(AcNewYearRedChargeItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcNewYearRedChargeItem.prototype.getUiCode = function () {
        var code = '';
    ...
    AcNewYearRedChargeItem.prototype.initItem = function (index, data, itemparam) {
        var view = this;
        ...
        //进度条
        this._progress = ComponentManager.getProgressBar("progress5", "progress3_bg", 430);
        this._progress.x = 15;
        // progress.y = 185;
    ...
    //刷新按钮状态
    AcNewYearRedChargeItem.prototype.refreshBtnStatus = function () {
        var tmpVo = this.vo;
        if (!tmpVo) {
            return;
        }
    ...
    AcNewYearRedChargeItem.prototype.refreshUI = function () {
    ...
    AcNewYearRedChargeItem.prototype.createCollectFlag = function () {
    ...
    AcNewYearRedChargeItem.prototype.eventCollectHandler = function (event) {
        ...
        NetManager.request(NetRequestConst.REQUEST_NEWYEARRED_GEREWARD, {
            activeId: this.acTivityId,
            rkey: this._itemData
        });
    };
    AcNewYearRedChargeItem.prototype.goRechargeHandler = function (event) {
        if (!this.vo.isInActivity()) {
            App.CommonUtil.showTip(LanguageManager.getlocal("time_error"));
            return;
        }
    ...
    AcNewYearRedChargeItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcNewYearRedChargeItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcNewYearRedChargeItem.prototype.dispose = function () {
        this._itemData = null;
        this._collectFlag = null;
        this._progress = null;
        this._collectBtn = null;
    ...
    return AcNewYearRedChargeItem;
}(ScrollListItem));
__reflect(AcNewYearRedChargeItem.prototype, "AcNewYearRedChargeItem");
//# sourceMappingURL=AcNewYearRedChargeItem.js.map