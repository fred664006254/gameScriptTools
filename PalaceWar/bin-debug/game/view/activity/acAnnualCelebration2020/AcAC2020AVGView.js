...
var AcAC2020AVGView = (function (_super) {
    __extends(AcAC2020AVGView, _super);
    function AcAC2020AVGView() {
    ...
    AcAC2020AVGView.prototype.getResourceList = function () {
        var view = this;
    ...
    Object.defineProperty(AcAC2020AVGView.prototype, "acTivityId", {
        get: function () {
    ...
    AcAC2020AVGView.prototype.getTitleBgName = function () {
        return null;
    };
    AcAC2020AVGView.prototype.getTitleStr = function () {
        return null;
    };
    AcAC2020AVGView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcAC2020AVGView.prototype.getBgName = function () {
        return null;
    };
    AcAC2020AVGView.prototype.isShowMask = function () {
        return true;
    };
    AcAC2020AVGView.prototype.preInit = function () {
    ...
    AcAC2020AVGView.prototype.init = function () {
        _super.prototype.init.call(this);
        var view = this;
        var mapcfg = view.AVGDialog[view._mapId];
        if (mapcfg.randomId) {
            var bid = mapcfg.bgname;
            var randomKey = App.MathUtil.getRandom() % mapcfg.randomId + 1;
            var titlestr = mapcfg.title;
            var descstr = LanguageManager.getlocal("acAC2020StoryDesc_" + this._mapId + "_1_" + randomKey);
        ...
        if (mapcfg.blueRandom) {
            var randomkey = App.MathUtil.getRandom(1, mapcfg.blueRandom.length + 1);
            this._curIdx = mapcfg.blueRandom[randomkey - 1];
        }
        this._curConfig = view.AVGDialog[view._mapId][this._curIdx];
        this.showPage();
    };
    AcAC2020AVGView.prototype.clickPage = function (evt) {
    ...
    Object.defineProperty(AcAC2020AVGView.prototype, "nextId", {
        get: function () {
            if (this._curConfig && this._curConfig.nextId) {
                return this._curConfig.nextId;
            }
            if (this._curConfig && this._curConfig.nextTab) {
                var key = App.MathUtil.getRandom() % this._curConfig.nextTab.length + 1; //App.MathUtil.getRandom(1,this._curConfig.nextTab.length);
    ...
    AcAC2020AVGView.prototype.doNextStep = function (step) {
        var view = this;
        var nextId = null;
        if (step) {
            nextId = step;
    ...
    AcAC2020AVGView.prototype.showPage = function () {
        if (this._showManTab) {
        ...
        if (this._curConfig.descId) {
            ...
            this._codonLength = 0;
            this._descText.text = "";
            var str = "acAC2020StoryDesc_" + this._mapId + "_" + this._curConfig.descId;
    ...
    AcAC2020AVGView.prototype.clickSelectedHandler = function (event, branchBtn, binfo) {
        switch (event.type) {
    ...
    AcAC2020AVGView.prototype.changeBgCallBack = function () {
    ...
    AcAC2020AVGView.prototype.showShakeAnim = function () {
    ...
    AcAC2020AVGView.prototype.shakeScreen = function () {
    ...
    AcAC2020AVGView.prototype.textShootAnim = function () {
    ...
    AcAC2020AVGView.prototype.textAnim = function (t) {
    ...
    AcAC2020AVGView.prototype.skipAnim = function () {
        this.hide();
    };
    /**
     * 收到通知 下一步
     */
    AcAC2020AVGView.prototype.noticeNextStep = function () {
        this.doNextStep();
    };
    AcAC2020AVGView.prototype.initView = function () {
    };
    AcAC2020AVGView.prototype.getParent = function () {
        return LayerManager.maskLayer;
    };
    AcAC2020AVGView.prototype.hide = function (isDispose) {
        var view = this;
    ...
    AcAC2020AVGView.prototype.dispose = function () {
    ...
    return AcAC2020AVGView;
}(CommonView));
__reflect(AcAC2020AVGView.prototype, "AcAC2020AVGView");
//# sourceMappingURL=AcAC2020AVGView.js.map