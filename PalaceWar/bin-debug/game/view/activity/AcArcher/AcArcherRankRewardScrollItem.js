...
/**
  ...
  */
var AcArcherRankRewardScrollItem = (function (_super) {
    __extends(AcArcherRankRewardScrollItem, _super);
    function AcArcherRankRewardScrollItem() {
        return _super.call(this) || this;
    }
    /**
     * 初始化viewItem
     */
    AcArcherRankRewardScrollItem.prototype.initItem = function (index, data) {
        ...
        itemTitleTF.setPosition(itemTopBg.x + itemTopBg.width / 2 - itemTitleTF.width / 2, itemTopBg.y + itemTopBg.height / 2 - itemTitleTF.height / 2 + 1);
    ...
    AcArcherRankRewardScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcArcherRankRewardScrollItem.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcArcherRankRewardScrollItem;
}(ScrollListItem));
__reflect(AcArcherRankRewardScrollItem.prototype, "AcArcherRankRewardScrollItem");
//# sourceMappingURL=AcArcherRankRewardScrollItem.js.map