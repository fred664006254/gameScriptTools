...
var AcBattlePassRewardPopupViewTab2 = (function (_super) {
    __extends(AcBattlePassRewardPopupViewTab2, _super);
    function AcBattlePassRewardPopupViewTab2(param) {
    ...
    Object.defineProperty(AcBattlePassRewardPopupViewTab2.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcBattlePassRewardPopupViewTab2.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcBattlePassRewardPopupViewTab2.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcBattlePassRewardPopupViewTab2.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcBattlePassRewardPopupViewTab2.prototype, "uicode", {
        get: function () {
            var code = "";
    ...
    AcBattlePassRewardPopupViewTab2.prototype.initView = function () {
        var view = this;
        view.height = 780;
        view.width = 544;
        var index = 2;
    ...
    AcBattlePassRewardPopupViewTab2.prototype.initSkin = function (skinId) {
        var view = this;
        var need = 0;
    ...
    AcBattlePassRewardPopupViewTab2.prototype.initServantWife = function (wifeId) {
        var view = this;
        ...
        if (isWife) {
            ...
            var bg = BaseLoadBitmap.create("previewbg_wife");
            bg.width = 544;
            bg.height = 400;
            bg.setPosition(this.width / 2 - bg.width / 2 + 13, 90);
            this.addChild(bg);
            var rect = new egret.Rectangle(0, 0, 544, 368 + 116);
            var maskContan = new BaseDisplayObjectContainer();
            maskContan.width = 544;
            maskContan.height = 368 + 116;
            maskContan.mask = rect;
            // maskContan.setPosition(bg.x + bg.width / 2 - maskContan.width / 2, bg.y + 30);
            this.addChild(maskContan);
            var boneName = undefined;
    ...
    AcBattlePassRewardPopupViewTab2.prototype.initTitle = function (titleid) {
        var view = this;
    ...
    AcBattlePassRewardPopupViewTab2.prototype.initUnlockPos = function () {
        var view = this;
        var bigbg = BaseBitmap.create("battlepassrewardbg");
        bigbg.height = 668;
        bigbg.setPosition(12, 55);
    ...
    AcBattlePassRewardPopupViewTab2.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcBattlePassRewardPopupViewTab2;
}(CommonViewTab));
__reflect(AcBattlePassRewardPopupViewTab2.prototype, "AcBattlePassRewardPopupViewTab2");
//# sourceMappingURL=AcBattlePassRewardPopupViewTab2.js.map