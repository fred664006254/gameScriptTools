 ...
 * author yangchengguo
 * date 2019.9.5
 * @class AcThrowStoneAchieveRewardScrollItem
 */
var AcThrowStoneAchieveRewardScrollItem = (function (_super) {
    __extends(AcThrowStoneAchieveRewardScrollItem, _super);
    function AcThrowStoneAchieveRewardScrollItem() {
        return _super.call(this) || this;
    }
    AcThrowStoneAchieveRewardScrollItem.prototype.initItem = function (index, data, itemParam) {
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acthrowstoneBoxRewardInfo-" + this.getTypeCode(code), [String(data.needNum)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var textStr = LanguageManager.getlocal("acthrowstoneBoxRewardNum-" + this.getTypeCode(code), ["" + vo.getScore(), "" + data.needNum]);
        var textColor = TextFieldConst.COLOR_WHITE;
        progressBar.setPercentage(percent, textStr, textColor);
        progressBar.scaleX = 0.95;
        var titelTxt = ComponentManager.getTextField(LanguageManager.getlocal("acthrowstoneBoxRewardItemProgress-" + this.getTypeCode(code)), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BLACK);
        ...
        var status = vo.getAchievementStatusById(data.id);
        if (status == 2) {
            var flagScale = 0.6;
            ...
            var receiveBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, 'taskCollect', function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACTIVITY_THROWSTONE_GETACHIEVEMENT, { activeId: vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcThrowStoneAchieveRewardScrollItem.prototype.getTypeCode = function (code) {
        if (code == "2") {
            return "1";
        }
        return code;
    };
    AcThrowStoneAchieveRewardScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcThrowStoneAchieveRewardScrollItem.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcThrowStoneAchieveRewardScrollItem;
}(ScrollListItem));
__reflect(AcThrowStoneAchieveRewardScrollItem.prototype, "AcThrowStoneAchieveRewardScrollItem");
//# sourceMappingURL=AcThrowStoneAchieveRewardScrollItem.js.map