 ...
 */
var AcThrowStoneRewardPopViewTab4 = (function (_super) {
    __extends(AcThrowStoneRewardPopViewTab4, _super);
    function AcThrowStoneRewardPopViewTab4() {
        var _this = _super.call(this) || this;
        _this.initView();
        return _this;
    }
    AcThrowStoneRewardPopViewTab4.prototype.initView = function () {
        ...
        var topMsg = ComponentManager.getTextField(LanguageManager.getlocal("acthrowstoneWifeTopMsg-" + this.getTypeCode(), [String(needData.needNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        topMsg.setPosition(msgBg.x + msgBg.width / 2 - topMsg.width / 2, msgBg.y + msgBg.height / 2 - topMsg.height / 2);
        this.addChild(topMsg);
        var wifeBg = BaseBitmap.create("acthrowstone_servant_preview_bg");
        ...
        var rect = new egret.Rectangle(0, 0, wifeBg.width, wifeBg.height);
    ...
    Object.defineProperty(AcThrowStoneRewardPopViewTab4.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcThrowStoneRewardPopViewTab4.prototype, "vo", {
        get: function () {
    ...
    AcThrowStoneRewardPopViewTab4.prototype.getAid = function () {
        return this.aid ? this.aid : this.param.data.aid;
    };
    AcThrowStoneRewardPopViewTab4.prototype.getCode = function () {
        return this.code ? this.code : this.param.data.code;
    };
    AcThrowStoneRewardPopViewTab4.prototype.getTypeCode = function () {
    ...
    AcThrowStoneRewardPopViewTab4.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcThrowStoneRewardPopViewTab4;
}(AcCommonViewTab));
__reflect(AcThrowStoneRewardPopViewTab4.prototype, "AcThrowStoneRewardPopViewTab4");
//# sourceMappingURL=AcThrowStoneRewardPopViewTab4.js.map