...
/**
  ...
  * author yangchengguo
  * date 2019.8.20
  * @class AcThrowStoneRewardTab1ScrollItem
  */
var AcThrowStoneRewardTab1ScrollItem = (function (_super) {
    __extends(AcThrowStoneRewardTab1ScrollItem, _super);
    function AcThrowStoneRewardTab1ScrollItem() {
     ...
     * 初始化itemview
     */
    AcThrowStoneRewardTab1ScrollItem.prototype.initItem = function (index, data, itemParam) {
        this._itemData = data;
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acthrowstoneChargeItemMsg", [String(this._itemData.needGem)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        if (this._itemData.specialGift) {
            rewards = "1027_0_" + this._itemData.specialGift + "_" + this._aidAndCode.code + "|" + rewards;
        }
        ...
        var progressStr = LanguageManager.getlocal("acthrowstoneChargeNum", [String(currChargeGem), String(data.needGem)]);
        ...
        if (vo.isGetRechargeById(data.id)) {
            ...
            if (vo.getChargeNum() >= data.needGem) {
                ...
                var reviceBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, "taskCollect", function () {
                    ...
                    NetManager.request(NetRequestConst.REQUEST_ACTIVITY_THROWSTONE_GETCHARGE, { activeId: vo.aidAndCode, rkey: Number(data.id) });
                }, this);
    ...
    AcThrowStoneRewardTab1ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcThrowStoneRewardTab1ScrollItem.prototype.dispose = function () {
        this._itemData = null;
        _super.prototype.dispose.call(this);
    };
    return AcThrowStoneRewardTab1ScrollItem;
}(ScrollListItem));
__reflect(AcThrowStoneRewardTab1ScrollItem.prototype, "AcThrowStoneRewardTab1ScrollItem");
//# sourceMappingURL=AcThrowStoneRewardTab1ScrollItem.js.map