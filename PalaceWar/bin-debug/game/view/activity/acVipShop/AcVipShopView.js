...
var AcVipShopView = (function (_super) {
    ...
    AcVipShopView.prototype.initView = function () {
        ...
        var topBg = BaseLoadBitmap.create("activity_vipshop_topbg" + this.code);
        topBg.width = 640;
        ...
        if (this._cfgObj) {
            ...
            var scrollList = ComponentManager.getScrollList(AcVipShopViewScrollItem, this._itemArr, tmpRect, this.code);
...
//# sourceMappingURL=AcVipShopView.js.map