...
//攻城奖励 周六第1场
var AcThreeKingdomsRankViewTab2Tab4 = (function (_super) {
    __extends(AcThreeKingdomsRankViewTab2Tab4, _super);
    function AcThreeKingdomsRankViewTab2Tab4(param) {
    ...
    Object.defineProperty(AcThreeKingdomsRankViewTab2Tab4.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcThreeKingdomsRankViewTab2Tab4.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcThreeKingdomsRankViewTab2Tab4.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcThreeKingdomsRankViewTab2Tab4.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcThreeKingdomsRankViewTab2Tab4.prototype, "acTivityId", {
        get: function () {
    ...
    AcThreeKingdomsRankViewTab2Tab4.prototype.getUiCode = function () {
        var code = '';
    ...
    AcThreeKingdomsRankViewTab2Tab4.prototype.getListType = function () {
        return 1;
    };
    AcThreeKingdomsRankViewTab2Tab4.prototype.initView = function () {
        var view = this;
    ...
    // 	}
    // }
    AcThreeKingdomsRankViewTab2Tab4.prototype.getCountTimeStr = function (time) {
        if (time < 0) {
            time = 0;
        }
        return App.DateUtil.getFormatBySecond(time);
    };
    AcThreeKingdomsRankViewTab2Tab4.prototype.mapinfoback = function (evt) {
        var view = this;
        if (evt.data.ret && (evt.data.data.data.day == 7 && evt.data.data.data.ftype == 3)) {
    ...
    AcThreeKingdomsRankViewTab2Tab4.prototype.tick = function () {
        var view = this;
        //本周激战期
        var week = view.vo.getCurWeek();
        var start = view.vo.activeSt + (week - 1) * (7 * 86400);
    ...
    AcThreeKingdomsRankViewTab2Tab4.prototype.rewardback = function (evt) {
        var view = this;
        if (evt.data.ret) {
            var rData = evt.data.data.data;
            if (rData.ftype == 3 && rData.day == 7) {
    ...
    AcThreeKingdomsRankViewTab2Tab4.prototype.dispose = function () {
        var view = this;
    ...
    return AcThreeKingdomsRankViewTab2Tab4;
}(CommonViewTab));
__reflect(AcThreeKingdomsRankViewTab2Tab4.prototype, "AcThreeKingdomsRankViewTab2Tab4");
//# sourceMappingURL=AcThreeKingdomsRankViewTab2Tab4.js.map