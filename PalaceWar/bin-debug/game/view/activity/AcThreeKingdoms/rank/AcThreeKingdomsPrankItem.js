...
var AcThreeKingdomsPrankItem = (function (_super) {
    __extends(AcThreeKingdomsPrankItem, _super);
    function AcThreeKingdomsPrankItem() {
        var _this = _super.call(this) || this;
        _this._data = null;
        return _this;
    }
    AcThreeKingdomsPrankItem.prototype.initItem = function (index, data, itemparam) {
        this._data = data;
        ...
        var shuiyin = BaseBitmap.create("threekingdomspranklistshuiyin" + data.kingdom);
    ...
    AcThreeKingdomsPrankItem.prototype.userShotCallback = function (event) {
    ...
    AcThreeKingdomsPrankItem.prototype.dispose = function () {
    ...
    return AcThreeKingdomsPrankItem;
}(ScrollListItem));
__reflect(AcThreeKingdomsPrankItem.prototype, "AcThreeKingdomsPrankItem");
//# sourceMappingURL=AcThreeKingdomsPrankItem.js.map