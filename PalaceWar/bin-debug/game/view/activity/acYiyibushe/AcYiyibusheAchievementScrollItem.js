 ...
 */
var AcYiyibusheAchievementScrollItem = (function (_super) {
    __extends(AcYiyibusheAchievementScrollItem, _super);
    function AcYiyibusheAchievementScrollItem() {
        return _super.call(this) || this;
    }
    /**
     * 初始化itemview
     */
    AcYiyibusheAchievementScrollItem.prototype.initItem = function (index, data, itemParam) {
        this._data = data;
        ...
        //标题
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acYiyibusheAchieveRewardItemTitle-" + this.getTypeCode(), [String(data.needNum)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        //进度条标题
        var proTitle = ComponentManager.getTextField(LanguageManager.getlocal("acYiyibusheAchieveCurTitle"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BLACK);
    ...
    AcYiyibusheAchievementScrollItem.prototype.getTypeCode = function () {
        return this._code;
    };
    AcYiyibusheAchievementScrollItem.prototype.getSpaceY = function () {
        return 10;
    };
    AcYiyibusheAchievementScrollItem.prototype.dispose = function () {
        this._data = null;
        this._aid = null;
        this._code = null;
        this._vo = null;
    ...
    return AcYiyibusheAchievementScrollItem;
}(ScrollListItem));
__reflect(AcYiyibusheAchievementScrollItem.prototype, "AcYiyibusheAchievementScrollItem");
//# sourceMappingURL=AcYiyibusheAchievementScrollItem.js.map