...
/**
  ...
  * author 张朝阳
  * date 2018/7/11
  * @class AcMaChaoRankScrollItem
  */
var AcMaChaoRankScrollItem = (function (_super) {
    __extends(AcMaChaoRankScrollItem, _super);
    function AcMaChaoRankScrollItem() {
        return _super.call(this) || this;
    }
    /**
     * 初始化itemview
     */
    AcMaChaoRankScrollItem.prototype.initItem = function (index, data) {
        var itemData = data;
        ...
        nameTF.setPosition(this.x - nameTF.width / 2 + 230, this.y + this.height / 2 - nameTF.height / 2);
        this.addChild(nameTF);
        //杀敌数
        var killTF = ComponentManager.getTextField(data.value, TextFieldConst.FONTSIZE_CONTENT_COMMON);
        killTF.setPosition(this.x + this.width - killTF.width / 2 - 120, this.y + this.height / 2 - killTF.height / 2);
    ...
    AcMaChaoRankScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcMaChaoRankScrollItem.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcMaChaoRankScrollItem;
}(ScrollListItem));
__reflect(AcMaChaoRankScrollItem.prototype, "AcMaChaoRankScrollItem");
//# sourceMappingURL=AcMaChaoRankScrollItem.js.map