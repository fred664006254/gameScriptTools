...
//帮会累计充值
var AcAlliaceToTalRankListPopupView = (function (_super) {
    __extends(AcAlliaceToTalRankListPopupView, _super);
    function AcAlliaceToTalRankListPopupView() {
    ...
    AcAlliaceToTalRankListPopupView.prototype.initView = function () {
        ...
        var scrollView = ComponentManager.getScrollList(AcAlliaceTotalListScrollItem, this.dataList, rect);
    ...
    AcAlliaceToTalRankListPopupView.prototype.getRequestData = function () {
    ...
    AcAlliaceToTalRankListPopupView.prototype.receiveData = function (data) {
        if (data.ret) {
            this.dataList = data.data.data.chargeList;
        }
    };
    AcAlliaceToTalRankListPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([]);
    };
    AcAlliaceToTalRankListPopupView.prototype.dispose = function () {
        this._aid = "";
        this._code = "";
    ...
    return AcAlliaceToTalRankListPopupView;
}(PopupView));
__reflect(AcAlliaceToTalRankListPopupView.prototype, "AcAlliaceToTalRankListPopupView");
//# sourceMappingURL=AcAlliaceToTalRankListPopupView.js.map