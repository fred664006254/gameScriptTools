 ...
 */
var AcSmashEggAchievementScrollItem = (function (_super) {
    __extends(AcSmashEggAchievementScrollItem, _super);
    function AcSmashEggAchievementScrollItem() {
        return _super.call(this) || this;
    }
    AcSmashEggAchievementScrollItem.prototype.initItem = function (index, data, itemParam) {
        // getReward
        // value
        //id
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acSmashEggAchievementPopupViewItemTitle-" + code, [String(data.needNum)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var titelTxt = ComponentManager.getTextField(LanguageManager.getlocal("acSmashEggAchievementPopupViewItemProgress-" + code), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BLACK);
    ...
    AcSmashEggAchievementScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcSmashEggAchievementScrollItem.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcSmashEggAchievementScrollItem;
}(ScrollListItem));
__reflect(AcSmashEggAchievementScrollItem.prototype, "AcSmashEggAchievementScrollItem");
//# sourceMappingURL=AcSmashEggAchievementScrollItem.js.map