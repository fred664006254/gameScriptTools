 ...
 */
var AcSmashEggSkinPopupView = (function (_super) {
    __extends(AcSmashEggSkinPopupView, _super);
    function AcSmashEggSkinPopupView() {
        var _this = _super.call(this) || this;
        _this._progress = null;
        _this._desc = null;
        return _this;
    }
    AcSmashEggSkinPopupView.prototype.initView = function () {
        var _this = this;
        ...
        var topDesc = ComponentManager.getTextField(LanguageManager.getlocal("acSmashEggClothesTip-" + this.code, [String(rewardsVo.num)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        ...
        var btn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, "acSearchProofSkinPopupViewExchange-" + this.code, function () {
            ...
            if (_this._progress.getPercent() < 1) {
                App.CommonUtil.showTip(LanguageManager.getlocal("acSmashEggNotEnoughProof-" + _this.code));
                return;
            }
    ...
    AcSmashEggSkinPopupView.prototype.claimRewardsHandle = function (event) {
        if (event.data.ret) {
            ...
            var rewardsVo2 = GameData.formatRewardItem(acCfg.itemExchange[0].getReward)[0];
            var rewardsVo3 = GameData.formatRewardItem(acCfg.itemExchange[1].costProof)[0];
            var proofNum = Api.itemVoApi.getItemNumInfoVoById(rewardsVo1.id);
            var cfg = Config.ServantskinCfg.getServantSkinItemById(String(acCfg.show));
            if (!cfg.canExchangeItem()) {
                this._progress.setPercentage(proofNum / rewardsVo3.num, String(proofNum) + "/" + String(rewardsVo3.num));
                this._desc.text = LanguageManager.getlocal("acSmashEggAlreadyHave-" + this.code);
    ...
    AcSmashEggSkinPopupView.prototype.getResourceList = function () {
    ...
    AcSmashEggSkinPopupView.prototype.getTitleStr = function () {
        return "acSmashEggSkinPopupViewTitle-" + this.param.data.code;
    };
    // protected getShowHeight() {
    // 	return 815+40;
    // }
    AcSmashEggSkinPopupView.prototype.getBgExtraHeight = function () {
        return 20;
    };
    AcSmashEggSkinPopupView.prototype.dispose = function () {
    ...
    return AcSmashEggSkinPopupView;
}(PopupView));
__reflect(AcSmashEggSkinPopupView.prototype, "AcSmashEggSkinPopupView");
//# sourceMappingURL=AcSmashEggSkinPopupView.js.map