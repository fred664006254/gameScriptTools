 ...
 * author qianjun
 */
var AcCrossServerWifeTalentViewTab3 = (function (_super) {
    __extends(AcCrossServerWifeTalentViewTab3, _super);
    function AcCrossServerWifeTalentViewTab3(data) {
    ...
    Object.defineProperty(AcCrossServerWifeTalentViewTab3.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWifeTalentViewTab3.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerWifeTalentViewTab3.prototype.initView = function () {
        ...
        var tiptxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCrossLeagueCn("acCrossServerWifeBattleTip1", this.vo.isCrossLeague())), 20, TextFieldConst.COLOR_BLACK);
    ...
    AcCrossServerWifeTalentViewTab3.prototype.freshView = function () {
        var model = this.vo.wifebattlecross; //Api.wifebattleVoApi.wifebattleVo;
        var plusv = this.vo.test ? 0 : model.info.totaltactadd ? model.info.totaltactadd : 0;
        var rankBuff = 0;
        var wifeBattleBuff = this.cfg.wifeBattleBuff;
    ...
    AcCrossServerWifeTalentViewTab3.prototype.orderHandler = function () {
    ...
    AcCrossServerWifeTalentViewTab3.prototype.showBuffLvUI = function (param) {
    ...
    //     } 
    // }
    AcCrossServerWifeTalentViewTab3.prototype.checkHaveBuff = function () {
        return true;
    };
    AcCrossServerWifeTalentViewTab3.prototype.refreshWhenSwitchBack = function () {
        _super.prototype.refreshWhenSwitchBack.call(this);
        this.refreshList(null);
    };
    AcCrossServerWifeTalentViewTab3.prototype.refreshList = function (evt) {
        if (evt) {
    ...
    AcCrossServerWifeTalentViewTab3.prototype.dispose = function () {
    ...
    return AcCrossServerWifeTalentViewTab3;
}(CommonViewTab));
__reflect(AcCrossServerWifeTalentViewTab3.prototype, "AcCrossServerWifeTalentViewTab3");
//# sourceMappingURL=AcCrossServerWifeTalentViewTab3.js.map