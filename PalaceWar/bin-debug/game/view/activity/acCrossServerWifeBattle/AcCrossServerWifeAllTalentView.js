...
var AcCrossServerWifeAllTalentView = (function (_super) {
    __extends(AcCrossServerWifeAllTalentView, _super);
    ...
    // }
    function AcCrossServerWifeAllTalentView() {
    ...
    AcCrossServerWifeAllTalentView.prototype.checkHaveBuff = function () {
        // let modelList:AcBaseVo[] = Api.acVoApi.getActivityVoListByAid("wifeBattleRank");
    ...
    Object.defineProperty(AcCrossServerWifeAllTalentView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerWifeAllTalentView.prototype, "vo", {
        get: function () {
    ...
    AcCrossServerWifeAllTalentView.prototype.initView = function () {
        ...
        topBg.y = 75;
        this.addChild(topBg);
        var topInBg = BaseBitmap.create("wifetalentnumbg");
        ...
        if (isHaveBuff) {
            ...
            // }
            this._descTxt = ComponentManager.getTextField(LanguageManager.getlocal("wifeBattleAllTalentDesc", ["" + App.MathUtil.accMul(nextAdd, this.vo.buff)]), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
            ...
            var acTime = this.vo.getAcLocalTime();
        ...
        var list = this.vo.test ? [] : this.vo.wifebattlecross.info.tmpattr.wifeadd_arr; //Api.wifebattleVoApi.wifebattleVo.info.tmpattr.wifeadd_arr;
        list = list ? list : [];
        list.sort(function (a, b) {
            return b.talentadd - a.talentadd;
        });
        this._scrollList = ComponentManager.getScrollList(AcCrossServerWifeAllTalentScrollItem, list, rect, { aid: this.param.data.aid, code: this.param.data.code });
        this._scrollList.x = 320 - this._scrollList.width / 2;
        this._scrollList.y = title.y + title.height + 10;
        this.addChild(this._scrollList);
    };
    AcCrossServerWifeAllTalentView.prototype.orderHandler = function () {
    ...
    AcCrossServerWifeAllTalentView.prototype.getResourceList = function () {
    ...
    AcCrossServerWifeAllTalentView.prototype.refreshList = function () {
        var model = this.vo.wifebattlecross; //Api.wifebattleVoApi.wifebattleVo;
        var plusv = this.vo.test ? 0 : (model.info.totaltactadd ? model.info.totaltactadd : 0);
        var allTalentStr = null;
        if (plusv == 0) {
        ...
        if (this._isOrderDown) {
            ...
            this._scrollList.refreshData(list, { aid: this.param.data.aid, code: this.param.data.code });
        }
        else {
            list.sort(function (a, b) {
    ...
    AcCrossServerWifeAllTalentView.prototype.hide = function () {
        AcCrossServerWifeBattleView.isOpenWin = false;
        _super.prototype.hide.call(this);
    };
    AcCrossServerWifeAllTalentView.prototype.dispose = function () {
    ...
    return AcCrossServerWifeAllTalentView;
}(CommonView));
__reflect(AcCrossServerWifeAllTalentView.prototype, "AcCrossServerWifeAllTalentView");
//# sourceMappingURL=AcCrossServerWifeAllTalentView.js.map