 ...
 */
var AcSearchProofAchievementPopupView = (function (_super) {
    __extends(AcSearchProofAchievementPopupView, _super);
    function AcSearchProofAchievementPopupView() {
        var _this = _super.call(this) || this;
        _this._scrollList = null;
        return _this;
    }
    AcSearchProofAchievementPopupView.prototype.initView = function () {
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACTIVITY_GETPROOFREWARDS, this.weathRewardHandle, this);
        ...
        this._scrollList = ComponentManager.getScrollList(AcSearchProofAchievementScrollItem, processCfg, rect, { id: id, code: code, aid: aid });
    ...
    /**刷新item */
    AcSearchProofAchievementPopupView.prototype.weathRewardHandle = function (event) {
        if (event.data.ret) {
    ...
    AcSearchProofAchievementPopupView.prototype.getTitleStr = function () {
        return "acSearchProofAchievementPopupViewTitle-" + this.param.data.code;
    };
    AcSearchProofAchievementPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat(["progress3_bg", "progress3"
        ]);
    };
    AcSearchProofAchievementPopupView.prototype.dispose = function () {
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACTIVITY_GETPROOFREWARDS, this.weathRewardHandle, this);
        this._scrollList = null;
        _super.prototype.dispose.call(this);
    };
    return AcSearchProofAchievementPopupView;
}(PopupView));
__reflect(AcSearchProofAchievementPopupView.prototype, "AcSearchProofAchievementPopupView");
//# sourceMappingURL=AcSearchProofAchievementPopupView.js.map