 ...
 */
var AcSearchProofRewardsPoolPopupView = (function (_super) {
    __extends(AcSearchProofRewardsPoolPopupView, _super);
    function AcSearchProofRewardsPoolPopupView() {
        return _super.call(this) || this;
    }
    AcSearchProofRewardsPoolPopupView.prototype.initView = function () {
        var aid = this.param.data.aid;
        var code = this.param.data.code;
        var cfg = Config.AcCfg.getCfgByActivityIdAndCode(aid, code);
        var topTF = ComponentManager.getTextField(LanguageManager.getlocal("acSearchProofRewardsPoolPopupViewTopDesc-" + code), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BLACK);
    ...
    AcSearchProofRewardsPoolPopupView.prototype.getTitleStr = function () {
        return "acSearchProofRewardsPoolPopupViewTitle-" + this.param.data.code;
    };
    AcSearchProofRewardsPoolPopupView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcSearchProofRewardsPoolPopupView;
}(PopupView));
__reflect(AcSearchProofRewardsPoolPopupView.prototype, "AcSearchProofRewardsPoolPopupView");
//# sourceMappingURL=AcSearchProofRewardsPoolPopupView.js.map