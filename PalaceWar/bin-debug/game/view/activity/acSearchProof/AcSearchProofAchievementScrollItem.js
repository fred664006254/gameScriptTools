 ...
 * author 张朝阳
 * date 2018/12/26
 * @class AcSearchProofAchievementScrollItem
 */
var AcSearchProofAchievementScrollItem = (function (_super) {
    __extends(AcSearchProofAchievementScrollItem, _super);
    function AcSearchProofAchievementScrollItem() {
        return _super.call(this) || this;
    }
    AcSearchProofAchievementScrollItem.prototype.initItem = function (index, data, itemParam) {
        // getReward
        // value
        //id
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acSearchProofAchievementPopupViewItemTitle-" + code, [String(data.needNum)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var percent = vo.getnum() / data.needNum;
        var textStr = vo.getnum() + "/" + data.needNum;
        var textColor = TextFieldConst.COLOR_WHITE;
        progressBar.setPercentage(percent, textStr, textColor);
        progressBar.scaleX = 0.95;
        var titelTxt = ComponentManager.getTextField(LanguageManager.getlocal("acSearchProofAchievementPopupViewItemProgress-" + code), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BLACK);
        ...
        if (vo.checkRewardFlag(data.id)) {
            ...
            var receiveBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, 'taskCollect', function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACTIVITY_GETPROOFREWARDS, { activeId: vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcSearchProofAchievementScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcSearchProofAchievementScrollItem.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcSearchProofAchievementScrollItem;
}(ScrollListItem));
__reflect(AcSearchProofAchievementScrollItem.prototype, "AcSearchProofAchievementScrollItem");
//# sourceMappingURL=AcSearchProofAchievementScrollItem.js.map