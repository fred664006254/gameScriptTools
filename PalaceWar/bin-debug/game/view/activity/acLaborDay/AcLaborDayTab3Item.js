 ...
 */
var AcLaborDayTab3Item = (function (_super) {
    __extends(AcLaborDayTab3Item, _super);
    function AcLaborDayTab3Item() {
    ...
    Object.defineProperty(AcLaborDayTab3Item.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab3Item.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab3Item.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab3Item.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab3Item.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcLaborDayTab3Item.prototype.initItem = function (index, data, itemparam) {
        var view = this;
        ...
        var str = "1005_0_" + this.cfg.task[this._curIdx].shuipiaoGet + "_" + view._code + "|" + data.getReward;
    ...
    AcLaborDayTab3Item.prototype.collectHandler = function (evt) {
        var vo = this.vo;
        if (!vo) {
            return;
        }
    ...
    AcLaborDayTab3Item.prototype.eventCollectHandlerCallBack = function (event) {
        ...
        var str = "1005_0_" + this.cfg.task[this._curIdx].shuipiaoGet + "_" + this._code + "|" + rewards;
    ...
    AcLaborDayTab3Item.prototype.update = function () {
        var vo = this.vo;
        if (!vo) {
            return;
        }
    ...
    AcLaborDayTab3Item.prototype.getSpaceY = function () {
        return 10;
    };
    AcLaborDayTab3Item.prototype.dispose = function () {
        this._goBtn3 = null;
    ...
    return AcLaborDayTab3Item;
}(ScrollListItem));
__reflect(AcLaborDayTab3Item.prototype, "AcLaborDayTab3Item");
//# sourceMappingURL=AcLaborDayTab3Item.js.map