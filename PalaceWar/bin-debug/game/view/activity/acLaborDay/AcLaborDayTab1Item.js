 ...
 */
var AcLaborDayTab1Item = (function (_super) {
    __extends(AcLaborDayTab1Item, _super);
    function AcLaborDayTab1Item() {
    ...
    Object.defineProperty(AcLaborDayTab1Item.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab1Item.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab1Item.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab1Item.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab1Item.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcLaborDayTab1Item.prototype.initItem = function (index, data, itemparam) {
        var view = this;
        ...
        this.addChild(Txt1);
        var str = "1005_0_" + this._rechargeItem.specialItem + "_" + this.code + "|" + this._rechargeItem.getReward;
    ...
    //刷新按钮状态
    AcLaborDayTab1Item.prototype.refreshBtnStatus = function () {
        var tmpVo = this.vo;
        if (!tmpVo) {
            return;
        }
    ...
    AcLaborDayTab1Item.prototype.refreshUI = function () {
    ...
    AcLaborDayTab1Item.prototype.createCollectFlag = function () {
    ...
    AcLaborDayTab1Item.prototype.eventCollectHandlerCallBack = function (event) {
        ...
        var str = "1005_0_" + this._rechargeItem.specialItem + "_" + this.code + "|" + rewards;
    ...
    AcLaborDayTab1Item.prototype.eventCollectHandler = function (event) {
    ...
    AcLaborDayTab1Item.prototype.goRechargeHandler = function (event) {
        if (this.vo.et < GameData.serverTime) {
            App.CommonUtil.showTip(LanguageManager.getlocal("time_error"));
            return;
        }
    ...
    AcLaborDayTab1Item.prototype.getSpaceX = function () {
        return 10;
    };
    /**
     * 不同格子Y间距
     */
    AcLaborDayTab1Item.prototype.getSpaceY = function () {
        return 5;
    };
    AcLaborDayTab1Item.prototype.dispose = function () {
    ...
    return AcLaborDayTab1Item;
}(ScrollListItem));
__reflect(AcLaborDayTab1Item.prototype, "AcLaborDayTab1Item");
//# sourceMappingURL=AcLaborDayTab1Item.js.map