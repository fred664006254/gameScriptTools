 ...
 */
var AcLaborDayTab4Item = (function (_super) {
    __extends(AcLaborDayTab4Item, _super);
    function AcLaborDayTab4Item() {
    ...
    Object.defineProperty(AcLaborDayTab4Item.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab4Item.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab4Item.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab4Item.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcLaborDayTab4Item.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcLaborDayTab4Item.prototype.initItem = function (index, data, itemparam) {
        var view = this;
        ...
        view._data = data;
        view._curIdx = index;
        App.MessageHelper.addEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_ACTIVITY_LABORSHOP), this.eventCollectHandlerCallBack, this);
    ...
    AcLaborDayTab4Item.prototype.buyHandler = function (evt) {
        var vo = this.vo;
        if (!vo) {
            return;
        }
    ...
    //弹出消费提示框显示确认
    AcLaborDayTab4Item.prototype.confirmCallbackHandler = function () {
        var view = this;
        view.vo.lastidx = this._curIdx;
        NetManager.request(NetRequestConst.REQUEST_ACTIVITY_LABORSHOP, {
            activeId: view.acTivityId,
            shopId: view._data.sortId + 1
        });
    };
    //检查是否需要弹出消费提示框
    AcLaborDayTab4Item.prototype.checkNeedWarnPopup = function () {
        //物品价格
        var view = this;
    ...
    AcLaborDayTab4Item.prototype.eventCollectHandlerCallBack = function (event) {
        var view = this;
    ...
    AcLaborDayTab4Item.prototype.getSpaceY = function () {
        return 10;
    };
    AcLaborDayTab4Item.prototype.dispose = function () {
        var view = this;
        view._data = null;
        App.MessageHelper.removeEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_ACTIVITY_LABORSHOP), this.eventCollectHandlerCallBack, this);
        //App.MessageHelper.removeEventListener(MessageConst.MESSAGE_MAYDAY_FRESH_ITEM,this.update,this); 		
        _super.prototype.dispose.call(this);
    };
    return AcLaborDayTab4Item;
}(ScrollListItem));
__reflect(AcLaborDayTab4Item.prototype, "AcLaborDayTab4Item");
//# sourceMappingURL=AcLaborDayTab4Item.js.map