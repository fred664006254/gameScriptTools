 ...
 */
var AcAnnualPrayChargeItem = (function (_super) {
    __extends(AcAnnualPrayChargeItem, _super);
    function AcAnnualPrayChargeItem() {
    ...
    Object.defineProperty(AcAnnualPrayChargeItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcAnnualPrayChargeItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcAnnualPrayChargeItem.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcAnnualPrayChargeItem.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcAnnualPrayChargeItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcAnnualPrayChargeItem.prototype.getUiCode = function () {
        var code = '';
    ...
    AcAnnualPrayChargeItem.prototype.initItem = function (index, data, itemparam) {
        var view = this;
    ...
    //刷新按钮状态
    AcAnnualPrayChargeItem.prototype.refreshBtnStatus = function () {
        var tmpVo = this.vo;
        if (!tmpVo) {
            return;
        }
    ...
    AcAnnualPrayChargeItem.prototype.refreshUI = function () {
    ...
    AcAnnualPrayChargeItem.prototype.createCollectFlag = function () {
    ...
    AcAnnualPrayChargeItem.prototype.eventCollectHandler = function (event) {
    ...
    AcAnnualPrayChargeItem.prototype.goRechargeHandler = function (event) {
        if (this.vo.et < GameData.serverTime) {
            App.CommonUtil.showTip(LanguageManager.getlocal("time_error"));
            return;
        }
    ...
    AcAnnualPrayChargeItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcAnnualPrayChargeItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcAnnualPrayChargeItem.prototype.dispose = function () {
        this._itemData = null;
        this._collectFlag = null;
        this._progress = null;
        this._collectBtn = null;
    ...
    return AcAnnualPrayChargeItem;
}(ScrollListItem));
__reflect(AcAnnualPrayChargeItem.prototype, "AcAnnualPrayChargeItem");
//# sourceMappingURL=AcAnnualPrayChargeItem.js.map