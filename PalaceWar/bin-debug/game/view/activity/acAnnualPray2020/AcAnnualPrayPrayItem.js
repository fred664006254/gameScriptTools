...
var AcAnnualPrayPrayItem = (function (_super) {
    __extends(AcAnnualPrayPrayItem, _super);
    function AcAnnualPrayPrayItem() {
        var _this = _super.call(this) || this;
        _this.itemData = null;
        _this._code = '';
        return _this;
    }
    Object.defineProperty(AcAnnualPrayPrayItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcAnnualPrayPrayItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcAnnualPrayPrayItem.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcAnnualPrayPrayItem.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcAnnualPrayPrayItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcAnnualPrayPrayItem.prototype.getUiCode = function () {
        var code = '';
    ...
    AcAnnualPrayPrayItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        var view = this;
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acAnnualPrayPrayTip5", code), [String(data.ratetime)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var percent = vo.getPrayNum() / data.ratetime;
        var textStr = vo.getPrayNum() + "/" + data.ratetime;
        ...
        if (vo.isGetJinduAward(data.id)) {
            ...
            var receiveBtn_1 = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, 'taskCollect', function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ANNUALPRAY_GETJINDUREWARD, { activeId: vo.aidAndCode, rkey: data.id });
            }, this);
            ...
            if (vo.getPrayNum() >= data.ratetime) {
                receiveBtn_1.setEnable(true);
            }
            else {
                receiveBtn_1.setEnable(false);
            }
        }
    ...
    AcAnnualPrayPrayItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcAnnualPrayPrayItem.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcAnnualPrayPrayItem;
}(ScrollListItem));
__reflect(AcAnnualPrayPrayItem.prototype, "AcAnnualPrayPrayItem");
//# sourceMappingURL=AcAnnualPrayPrayItem.js.map