 ...
 */
var AcSkinOfLibaiDetailTab2ScrollItem = (function (_super) {
    __extends(AcSkinOfLibaiDetailTab2ScrollItem, _super);
    function AcSkinOfLibaiDetailTab2ScrollItem() {
        return _super.call(this) || this;
    }
    AcSkinOfLibaiDetailTab2ScrollItem.prototype.initItem = function (index, data, itemParam) {
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acSkinoflibaiAchieveRewardTitle-" + this.getTypeCode(code), [String(data.specialnum)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var textStr = LanguageManager.getlocal("acSkinoflibaiChargeNum", ["" + processNum, "" + data.specialnum]);
    ...
    AcSkinOfLibaiDetailTab2ScrollItem.prototype.getTypeCode = function (code) {
        if (code == "2") {
            return "1";
        }
        return code;
    };
    AcSkinOfLibaiDetailTab2ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcSkinOfLibaiDetailTab2ScrollItem.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcSkinOfLibaiDetailTab2ScrollItem;
}(ScrollListItem));
__reflect(AcSkinOfLibaiDetailTab2ScrollItem.prototype, "AcSkinOfLibaiDetailTab2ScrollItem");
//# sourceMappingURL=AcSkinOfLibaiDetailTab2ScrollItem.js.map