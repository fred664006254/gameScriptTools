 ...
 * @author 张朝阳
 * date 2018/12/28
 * @class AcWealthComingGetRewardPopupView
 */
var AcWealthComingGetRewardPopupView = (function (_super) {
    __extends(AcWealthComingGetRewardPopupView, _super);
    function AcWealthComingGetRewardPopupView() {
    ...
    AcWealthComingGetRewardPopupView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcWealthComingGetRewardPopupView.prototype.isTouchMaskClose = function () {
        return true;
    };
    AcWealthComingGetRewardPopupView.prototype.initView = function () {
    ...
    /**buff 相关 */
    AcWealthComingGetRewardPopupView.prototype.initBuffers = function (buffers) {
        var cyhtNum = buffers["cyht"] ? buffers["cyht"] : 0;
        var tjhcNum = buffers["tjhc"] ? buffers["tjhc"] : 0;
        var csjdNum = buffers["csjd"] ? buffers["csjd"] : 0;
        var wealthLuckTxt1 = ComponentManager.getTextField(LanguageManager.getlocal("acWealthComingGetRewardPopupViewBufferType1", [String(cyhtNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        ...
        var wealthLuckTxt2 = ComponentManager.getTextField(LanguageManager.getlocal("acWealthComingGetRewardPopupViewBufferType2", [String(tjhcNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        ...
        var wealthLuckTxt3 = ComponentManager.getTextField(LanguageManager.getlocal("acWealthComingGetRewardPopupViewBufferType3", [String(csjdNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
     ...
     * 显示初始化View
     */
    AcWealthComingGetRewardPopupView.prototype.showInitView = function () {
     ...
     * 播放动画
     */
    AcWealthComingGetRewardPopupView.prototype.playAni = function () {
        this.createItem(this._count);
    };
    /**
     * 不播放动画
     */
    AcWealthComingGetRewardPopupView.prototype.noPlayAni = function () {
     ...
     * 实例化 Item
     */
    AcWealthComingGetRewardPopupView.prototype.createItem = function (count) {
    ...
    * 获得额外的奖励
    */
    AcWealthComingGetRewardPopupView.prototype.getOtherReward = function (otherData) {
    ...
    AcWealthComingGetRewardPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            'public_9_wordbg2', "tailor_get_light",
            "tailor_get_word",
        ]);
    };
    AcWealthComingGetRewardPopupView.prototype.dispose = function () {
    ...
    return AcWealthComingGetRewardPopupView;
}(BaseView));
__reflect(AcWealthComingGetRewardPopupView.prototype, "AcWealthComingGetRewardPopupView");
//# sourceMappingURL=AcWealthComingGetRewardPopupView.js.map