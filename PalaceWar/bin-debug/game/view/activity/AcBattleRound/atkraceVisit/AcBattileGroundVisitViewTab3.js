...
var AcBattileGroundVisitViewTab3 = (function (_super) {
    ...
    AcBattileGroundVisitViewTab3.prototype.getUiCode = function () {
        var code = "";
    ...
    AcBattileGroundVisitViewTab3.prototype.useCallback = function (evt) {
        ...
        if (data) {
            if (data.bgstats) {
                App.CommonUtil.showTip(LanguageManager.getlocal("acBattleGroundBgStasTip" + data.bgstats + "-" + this.getUiCode()));
                this.refreshView();
                return;
            }
            if (data.atkraceinfo) {
...
//# sourceMappingURL=AcBattileGroundVisitViewTab3.js.map