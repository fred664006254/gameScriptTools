...
var AcBattleHistoryRankScrollItem = (function (_super) {
    __extends(AcBattleHistoryRankScrollItem, _super);
    function AcBattleHistoryRankScrollItem() {
    ...
    AcBattleHistoryRankScrollItem.prototype.initItem = function (index, data, code) {
        this.width = 640;
        this._data = data;
    ...
    Object.defineProperty(AcBattleHistoryRankScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcBattleHistoryRankScrollItem.prototype, "vo", {
        get: function () {
    ...
    AcBattleHistoryRankScrollItem.prototype.getSpaceY = function () {
        return -5;
    };
    AcBattleHistoryRankScrollItem.prototype.getSpaceX = function () {
        return 0;
    };
    AcBattleHistoryRankScrollItem.prototype.userShotCallback = function (event) {
    ...
    AcBattleHistoryRankScrollItem.prototype.dispose = function () {
    ...
    return AcBattleHistoryRankScrollItem;
}(ScrollListItem));
__reflect(AcBattleHistoryRankScrollItem.prototype, "AcBattleHistoryRankScrollItem");
//# sourceMappingURL=AcBattleHistoryRankScrollItem.js.map