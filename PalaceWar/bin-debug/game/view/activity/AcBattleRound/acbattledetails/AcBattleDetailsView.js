 ...
 */
var AcBattleDetailsView = /** @class */ (function (_super) {
    ...
    AcBattleDetailsView.prototype.getUiCode = function () {
        var code = "";
    ...
    AcBattleDetailsView.prototype.openList = function () {
        if (this.vo.flag) {
            return;
        }
    ...
    AcBattleDetailsView.prototype.showServantUI = function () {
        ...
        var code = this.getUiCode();
        var cheericon = BaseBitmap.create("battlegroundcheericon-" + this.getUiCode());
        App.DisplayUtil.setLayoutPosition(LayoutConst.lefttop, cheericon, bg, [15, 0]);
        this._servantContainer.addChild(cheericon);
        var alliinfo = view.vo.getAllianceInfoById(Api.playerVoApi.getPlayerAllianceId());
        ...
        var cheertiptxt = ComponentManager.getTextField(LanguageManager.getlocal("battlegroundcheertip16-" + this.getUiCode(), [add]), 20, TextFieldConst.COLOR_BLACK);
        ...
        if (Api.switchVoApi.checkOpenAtkracegChangegpoint()) {
            var scoreTip = ComponentManager.getTextField(LanguageManager.getlocal("acBattleGroundTip12-" + this.getUiCode()), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
    ...
    AcBattleDetailsView.prototype.showRankUI = function (zidRank) {
        ...
        var rankRequest = { requestType: NetRequestConst.REQUEST_BATTLEGROUND_GETANK, requestParam: { activeId: this.param.data.aid + "-" + this.param.data.code, index: 1 } };
        var scrollList = ComponentManager.getRankScrollList(AcBattleRankScrollItem, arr, tmpRect, data, rankRequest);
        ...
        //帮会排行
        var allianScrollList = ComponentManager.getScrollList(AcBattleRankScrollItem, arr, tmpRect, data);
    ...
    AcBattleDetailsView.prototype.getRequestData = function () {
...
//# sourceMappingURL=AcBattleDetailsView.js.map