 ...
 */
var AcWealthCarpWifeSkinRewardPopupView = (function (_super) {
    __extends(AcWealthCarpWifeSkinRewardPopupView, _super);
    function AcWealthCarpWifeSkinRewardPopupView() {
        return _super.call(this) || this;
    }
    AcWealthCarpWifeSkinRewardPopupView.prototype.initView = function () {
        this.aid = this.param.data.aid;
        this.code = this.param.data.code;
        var acCfg = Config.AcCfg.getCfgByActivityIdAndCode(this.aid, this.code);
        var wifeSkinCfg = Config.WifeskinCfg.getWifeCfgById(acCfg.corePrize);
        ...
        var skinTitle = App.CommonUtil.getWifeSkinFlagById(acCfg.corePrize);
        if (skinTitle) {
        ...
        var buttomTipTxt = ComponentManager.getTextField(LanguageManager.getlocal("acWealthCarpServantSkinRewardPopupViewButtomDesc-" + this.code), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BLACK);
    ...
    AcWealthCarpWifeSkinRewardPopupView.prototype.dealAttrChangeInfo = function (skinId) {
    ...
    AcWealthCarpWifeSkinRewardPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "skin_detail_namebg",
        ]);
    };
    AcWealthCarpWifeSkinRewardPopupView.prototype.getTitleStr = function () {
        return "acWealthCarpServantSkinRewardPopupViewTitle-" + this.param.data.code;
    };
    // protected getShowHeight() {
    // 	return 720;
    // }
    AcWealthCarpWifeSkinRewardPopupView.prototype.dispose = function () {
        this.aid = null;
        this.code = null;
        _super.prototype.dispose.call(this);
    };
    return AcWealthCarpWifeSkinRewardPopupView;
}(PopupView));
__reflect(AcWealthCarpWifeSkinRewardPopupView.prototype, "AcWealthCarpWifeSkinRewardPopupView");
//# sourceMappingURL=AcWealthCarpWifeSkinRewardPopupView.js.map