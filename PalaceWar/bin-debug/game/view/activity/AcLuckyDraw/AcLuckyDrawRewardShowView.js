...
var AcLuckDrawRewardShowView = (function (_super) {
    __extends(AcLuckDrawRewardShowView, _super);
    function AcLuckDrawRewardShowView() {
        return _super.call(this) || this;
    }
    AcLuckDrawRewardShowView.prototype.initView = function () {
    ...
    AcLuckDrawRewardShowView.prototype.doWaitAni = function (tmpNode, waitT) {
        tmpNode.alpha = 0;
        egret.Tween.get(tmpNode, { loop: false }).wait(waitT).to({ alpha: 1 }, 500);
    };
    AcLuckDrawRewardShowView.prototype.hide = function () {
        if (this.param.data.callback) {
            this.param.data.callback.apply(this.param.data.callobj);
        }
        _super.prototype.hide.call(this);
    };
    AcLuckDrawRewardShowView.prototype.getShowHeight = function () {
        var re_data = this.param.data;
        //"6_1150_4|6_1710_1";
        var rewardTab = re_data.split('|');
        return rewardTab.length > 5 ? 528 : 300;
    };
    AcLuckDrawRewardShowView.prototype.getResourceList = function () {
    ...
    AcLuckDrawRewardShowView.prototype.isTouchMaskClose = function () {
        return true;
    };
    AcLuckDrawRewardShowView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcLuckDrawRewardShowView;
}(BaseView));
__reflect(AcLuckDrawRewardShowView.prototype, "AcLuckDrawRewardShowView");
//# sourceMappingURL=AcLuckyDrawRewardShowView.js.map