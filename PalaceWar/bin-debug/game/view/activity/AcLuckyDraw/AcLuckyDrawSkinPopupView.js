 ...
 * author 钱竣
 */
var AcLuckyDrawSkinPopupView = (function (_super) {
    __extends(AcLuckyDrawSkinPopupView, _super);
    function AcLuckyDrawSkinPopupView() {
        return _super.call(this) || this;
    }
    Object.defineProperty(AcLuckyDrawSkinPopupView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcLuckyDrawSkinPopupView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcLuckyDrawSkinPopupView.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcLuckyDrawSkinPopupView.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcLuckyDrawSkinPopupView.prototype, "code", {
        get: function () {
    ...
    AcLuckyDrawSkinPopupView.prototype.initView = function () {
        var view = this;
        var obj = {
            1: 'wife',
            2: 'servant',
        ...
        var isWifeskin = obj[this.code] == "wife";
        if (isWifeskin) {
            ...
            var bg = BaseLoadBitmap.create("luckdrawshowbg-" + view.getUiCode());
            bg.width = 544;
            bg.height = 400;
            ...
            var topDesc = ComponentManager.getTextField(LanguageManager.getlocal("acLuckyDrawAwardTip1-" + view.code, [view.cfg.getTotalProgress().toString(), Config.WifeskinCfg.getWifeCfgById(view.cfg.getSkin(view.code)).name]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
            ...
            topbg.setPosition(this.viewBg.x + this.viewBg.width / 2 - topbg.width / 2, 0);
            this.addChildToContainer(topbg);
            var topDesc = ComponentManager.getTextField(LanguageManager.getlocal("acLuckyDrawAwardTip1-" + this.code, [view_1.cfg.getTotalProgress().toString(), view_1.cfg.getSkinName(view_1.code)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
            topDesc.setPosition(topbg.x + topbg.width / 2 - topDesc.width / 2, topbg.y + topbg.height / 2 - topDesc.height / 2);
            this.addChildToContainer(topDesc);
            var skinnamebg = BaseBitmap.create("skin_detail_namebg");
            skinnamebg.setPosition(bg.x, bg.y + 20);
    ...
    AcLuckyDrawSkinPopupView.prototype.getUiCode = function () {
    ...
    AcLuckyDrawSkinPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "skin_detail_namebg", "servant_star",
            "servant_infoPro1", "servant_infoPro2", "servant_infoPro3", "servant_infoPro4",
        ]);
    };
    AcLuckyDrawSkinPopupView.prototype.getTitleStr = function () {
        return "dailyTaskRewardPreviewPopuiViewTitle";
    };
    // protected getShowHeight() {
    // 	return 760;
    // }
    AcLuckyDrawSkinPopupView.prototype.getBgExtraHeight = function () {
        return 20;
    };
    AcLuckyDrawSkinPopupView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcLuckyDrawSkinPopupView;
}(PopupView));
__reflect(AcLuckyDrawSkinPopupView.prototype, "AcLuckyDrawSkinPopupView");
//# sourceMappingURL=AcLuckyDrawSkinPopupView.js.map