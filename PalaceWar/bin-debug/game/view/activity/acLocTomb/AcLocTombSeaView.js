 ...
 * desc:东海皇陵海底寻宝界面
*/
var AcLocTombSeaView = (function (_super) {
    __extends(AcLocTombSeaView, _super);
    function AcLocTombSeaView() {
    ...
    Object.defineProperty(AcLocTombSeaView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcLocTombSeaView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcLocTombSeaView.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcLocTombSeaView.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcLocTombSeaView.prototype, "code", {
        get: function () {
    ...
    AcLocTombSeaView.prototype.getSoundBgName = function () {
        return SoundConst.MUSIC_TOMBSEA;
    };
    AcLocTombSeaView.prototype.getResourceList = function () {
        var code = this.code;
    ...
    AcLocTombSeaView.prototype.getTitleStr = function () {
        return "loctombtitle-" + this.code;
    };
    AcLocTombSeaView.prototype.initView = function () {
        var view = this;
        var code = view.code;
        ...
        var boatscan = ComponentManager.getCustomMovieClip("tombboatscan" + view.code + "-", 13, 70);
        ...
        var boatalpha = BaseBitmap.create("tombrankalpha-" + view.code);
        ...
        //海平面特效
        var sealine = ComponentManager.getCustomMovieClip("tombsea" + view.code + "-", 12, 130);
        sealine.width = 639;
        sealine.height = 37;
        ...
        if (qulaity) {
            ...
            var scrollList = ComponentManager.getScrollList(AcLocTombSeaFloorItem, arr, rect, code, 30);
            ...
            var str = LanguageManager.getlocal("loctombtimetip" + period + "-" + view.code, [App.DateUtil.getFormatBySecond(view.vo.getCountDownTime())]);
            var wordsText = ComponentManager.getTextField(LanguageManager.getlocal("loctombnoattend-" + view.code, [Api.playerVoApi.getPlayerOfficeByLevel(this.cfg.lvNeed), str]), TextFieldConst.FONTSIZE_CONTENT_COMMON);
        ...
        var top2 = BaseBitmap.create("tombbg5-" + view.code);
    ...
    //吐泡泡动画
    AcLocTombSeaView.prototype.showBublle = function () {
        var view = this;
        //粒子效果
        /**
         *  走到水面的时长区间：12s-40s
        ...
        */
        ...
        var _loop_1 = function (i) {
            var bubble = BaseBitmap.create("shuizhu0" + view.code);
    ...
    AcLocTombSeaView.prototype.removeBubble = function () {
        var view = this;
        var num = 15;
        for (var i = 0; i < num; ++i) {
    ...
    AcLocTombSeaView.prototype.judgeFloorById = function (id) {
        var view = this;
        var floor = 1;
        return floor;
    };
    AcLocTombSeaView.prototype.getCurFloor = function () {
        var view = this;
        var list = view._list;
    ...
    AcLocTombSeaView.prototype.getIndexs = function (num) {
        var view = this;
        var arr = [];
    ...
    AcLocTombSeaView.prototype.jumpToFloor = function (floor) {
        var view = this;
        var list = view._list;
    ...
    AcLocTombSeaView.prototype.jumpClick = function () {
        var view = this;
        if (view.vo.moviePlay) {
            return;
        }
    ...
    AcLocTombSeaView.prototype.freshCoinText = function () {
        var view = this;
        if (view._coinTxt) {
    ...
    AcLocTombSeaView.prototype.infoClick = function () {
        var view = this;
    ...
    AcLocTombSeaView.prototype.getRuleInfo = function () {
        return "loctombrule-" + this.code;
    };
    AcLocTombSeaView.prototype.getRuleInfoParam = function () {
    ...
    AcLocTombSeaView.prototype.moreClick = function () {
        var view = this;
    ...
    AcLocTombSeaView.prototype.freshView = function () {
        var view = this;
        view.freshCoinText();
    };
    AcLocTombSeaView.prototype.tick = function () {
        var view = this;
    ...
    AcLocTombSeaView.prototype.enterInHandler = function () {
        var view = this;
        if (view.vo.moviePlay) {
            return;
        }
    ...
    AcLocTombSeaView.prototype.getRequestData = function () {
        var view = this;
    ...
    AcLocTombSeaView.prototype.receiveData = function (data) {
        var view = this;
        view.vo.setMapInfo(data.data.data.map);
        // view.vo.setBossNumInfo(data.data.data);
    };
    AcLocTombSeaView.prototype.mapCallBack = function (evt) {
        var view = this;
    ...
    AcLocTombSeaView.prototype.bossCallBack = function (evt) {
        var view = this;
        var data = evt.data.data.data;
        if (data) {
            //特殊数据
    ...
    //默认刷新30层数据
    AcLocTombSeaView.prototype.freshMapData = function (floor, floorNum) {
    ...
    AcLocTombSeaView.prototype.digCallBack = function (evt) {
        var view = this;
        var data = evt.data.data.data;
        if (data && data.map) {
            view.vo.setMapInfo(data.map);
            ...
            if (data.score) {
                var strList_1 = [];
                var scrore = data.score;
                var flyStr1 = LanguageManager.getlocal("acPunishGetScoreTxt1", [String(scrore)]);
                strList_1.push({ tipMessage: flyStr1 });
                var flyStr2 = LanguageManager.getlocal("acPunishGetScoreTxt3", [String(scrore)]);
    ...
    AcLocTombSeaView.prototype.attackCallBack = function (evt) {
        var view = this;
        var data = evt.data.data.data;
        if (data && data.map) {
    ...
    AcLocTombSeaView.prototype.searchCallback = function (evt) {
        var view = this;
        if (!view.vo.isInActTime()) {
            App.CommonUtil.showTip(LanguageManager.getlocal("acwipeBossEnd"));
            view.hide();
    ...
    AcLocTombSeaView.prototype.dispose = function () {
        var view = this;
    ...
    return AcLocTombSeaView;
}(CommonView));
__reflect(AcLocTombSeaView.prototype, "AcLocTombSeaView");
//# sourceMappingURL=AcLocTombSeaView.js.map