...
desc : 每日任务
*/
var AcDechuanshidaiTaskViewTab2 = (function (_super) {
    __extends(AcDechuanshidaiTaskViewTab2, _super);
    function AcDechuanshidaiTaskViewTab2(data) {
    ...
    Object.defineProperty(AcDechuanshidaiTaskViewTab2.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiTaskViewTab2.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiTaskViewTab2.prototype, "acTivityId", {
        get: function () {
    ...
    AcDechuanshidaiTaskViewTab2.prototype.getUiCode = function () {
        var code = '';
    ...
    AcDechuanshidaiTaskViewTab2.prototype.initView = function () {
        var _this = this;
        var view = this;
    ...
    AcDechuanshidaiTaskViewTab2.prototype.getArr = function () {
        var view = this;
        var arr = [];
        var day = view._day;
    ...
    AcDechuanshidaiTaskViewTab2.prototype.rewardCallBack = function (evt) {
        var view = this;
    ...
    AcDechuanshidaiTaskViewTab2.prototype.totalrewardCallBack = function (evt) {
        var view = this;
        if (view.vo.lastday != view._day) {
            return;
        }
    ...
    AcDechuanshidaiTaskViewTab2.prototype.update = function () {
        var view = this;
        var code = view.getUiCode();
        if (!view.vo) {
            return;
    ...
    AcDechuanshidaiTaskViewTab2.prototype.dispose = function () {
        var view = this;
    ...
    return AcDechuanshidaiTaskViewTab2;
}(AcCommonViewTab));
__reflect(AcDechuanshidaiTaskViewTab2.prototype, "AcDechuanshidaiTaskViewTab2");
//# sourceMappingURL=AcDechuanshidaiTaskViewTab2.js.map