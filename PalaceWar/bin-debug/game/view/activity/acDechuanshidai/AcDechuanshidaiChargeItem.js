 ...
 */
var AcDechuanshidaiChargeItem = (function (_super) {
    __extends(AcDechuanshidaiChargeItem, _super);
    function AcDechuanshidaiChargeItem() {
    ...
    Object.defineProperty(AcDechuanshidaiChargeItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiChargeItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiChargeItem.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiChargeItem.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiChargeItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcDechuanshidaiChargeItem.prototype.getUiCode = function () {
        var code = '';
    ...
    AcDechuanshidaiChargeItem.prototype.initItem = function (index, data, itemparam) {
        var view = this;
    ...
    //刷新按钮状态
    AcDechuanshidaiChargeItem.prototype.refreshBtnStatus = function () {
        var tmpVo = this.vo;
        if (!tmpVo) {
            return;
        }
    ...
    AcDechuanshidaiChargeItem.prototype.refreshUI = function () {
    ...
    AcDechuanshidaiChargeItem.prototype.createCollectFlag = function () {
    ...
    AcDechuanshidaiChargeItem.prototype.eventCollectHandler = function (event) {
        ...
        NetManager.request(NetRequestConst.REQUEST_DECHUAN_RECHARGE, {
            activeId: this.acTivityId,
            rkey: this._itemData
        });
    };
    AcDechuanshidaiChargeItem.prototype.goRechargeHandler = function (event) {
        if (this.vo.et < GameData.serverTime) {
            App.CommonUtil.showTip(LanguageManager.getlocal("time_error"));
            return;
        }
    ...
    AcDechuanshidaiChargeItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcDechuanshidaiChargeItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcDechuanshidaiChargeItem.prototype.dispose = function () {
        this._itemData = null;
        this._collectFlag = null;
        this._progress = null;
        this._collectBtn = null;
    ...
    return AcDechuanshidaiChargeItem;
}(ScrollListItem));
__reflect(AcDechuanshidaiChargeItem.prototype, "AcDechuanshidaiChargeItem");
//# sourceMappingURL=AcDechuanshidaiChargeItem.js.map