...
desc : 每日任务
*/
var AcDechuanshidaiTaskViewTab1 = (function (_super) {
    __extends(AcDechuanshidaiTaskViewTab1, _super);
    function AcDechuanshidaiTaskViewTab1(data) {
    ...
    Object.defineProperty(AcDechuanshidaiTaskViewTab1.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiTaskViewTab1.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiTaskViewTab1.prototype, "acTivityId", {
        get: function () {
    ...
    AcDechuanshidaiTaskViewTab1.prototype.getUiCode = function () {
        var code = '';
    ...
    AcDechuanshidaiTaskViewTab1.prototype.initView = function () {
        var _this = this;
        var view = this;
    ...
    AcDechuanshidaiTaskViewTab1.prototype.getArr = function () {
        var view = this;
        var arr = [];
        var day = view._day;
    ...
    AcDechuanshidaiTaskViewTab1.prototype.rewardCallBack = function (evt) {
        var view = this;
    ...
    AcDechuanshidaiTaskViewTab1.prototype.totalrewardCallBack = function (evt) {
        var view = this;
        if (view.vo.lastday != view._day) {
            return;
        }
    ...
    AcDechuanshidaiTaskViewTab1.prototype.update = function () {
        var view = this;
        var code = view.getUiCode();
        if (!view.vo) {
            return;
    ...
    AcDechuanshidaiTaskViewTab1.prototype.dispose = function () {
        var view = this;
    ...
    return AcDechuanshidaiTaskViewTab1;
}(AcCommonViewTab));
__reflect(AcDechuanshidaiTaskViewTab1.prototype, "AcDechuanshidaiTaskViewTab1");
//# sourceMappingURL=AcDechuanshidaiTaskViewTab1.js.map