...
var AcDechuanshidaiExchangeItem = (function (_super) {
    __extends(AcDechuanshidaiExchangeItem, _super);
    function AcDechuanshidaiExchangeItem() {
    ...
    Object.defineProperty(AcDechuanshidaiExchangeItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiExchangeItem.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiExchangeItem.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiExchangeItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcDechuanshidaiExchangeItem.prototype.getUiCode = function () {
        var code = '';
    ...
    AcDechuanshidaiExchangeItem.prototype.init = function (data, itemparam, f, o) {
        var view = this;
        ...
        App.DisplayUtil.setLayoutPosition(LayoutConst.rightverticalCenter, this._claimBtn, wordsBg, [25, 0]);
        ...
        var getItem = null;
        if (data.costdeZi) {
            costItem = "1031_1_" + data.costdeZi + "_" + code;
        }
        if (data.costchuanZi) {
            if (costItem) {
                costItem += "|";
            ...
            costItem += "1031_2_" + data.costchuanZi + "_" + code;
        }
        if (data.costshiZi) {
            if (costItem) {
                costItem += "|";
            ...
            costItem += "1031_3_" + data.costshiZi + "_" + code;
        }
        if (data.costdaiZi) {
            if (costItem) {
                costItem += "|";
            ...
            costItem += "1031_4_" + data.costdaiZi + "_" + code;
        }
        if (data.item) {
            getItem = data.item;
        }
        ...
        for (var i = 0; i < len; i++) {
            ...
            if (icon) {
                ...
                this.addChild(icon);
                if (i < len - 1) {
                    var plus1 = BaseBitmap.create("dechuanchangeadd-" + code);
                    plus1.setPosition(icon.x + icon.width * icon.scaleX + 5, icon.y + icon.height * icon.scaleY / 2 - plus1.height / 2);
                    this.addChild(plus1);
                }
            }
        }
        var getIcon = GameData.getRewardItemIcons(getItem, true)[0];
        getIcon.setScale(0.6);
        var iconbg = getIcon.getChildByName("iconBg");
        iconbg.setScale(1.48);
        iconbg.setRes("dechuanchangeiconbg-" + this.getUiCode());
        iconbg.x = -8;
        iconbg.y = -6;
        App.DisplayUtil.setLayoutPosition(LayoutConst.leftverticalCenter, getIcon, wordsBg, [300, 0]);
        this.addChild(getIcon);
        var arrow = BaseBitmap.create("dechuanchangearrow-" + code);
        arrow.setPosition(getIcon.x - arrow.width + 3, getIcon.y + getIcon.height * getIcon.scaleY / 2 - arrow.height / 2);
        this.addChild(arrow);
    };
    Object.defineProperty(AcDechuanshidaiExchangeItem.prototype, "sortId", {
        get: function () {
            var n = this._cfg.id;
    ...
    AcDechuanshidaiExchangeItem.prototype.dispose = function () {
        this._cfg = null;
        this._code = null;
    ...
    return AcDechuanshidaiExchangeItem;
}(BaseDisplayObjectContainer));
__reflect(AcDechuanshidaiExchangeItem.prototype, "AcDechuanshidaiExchangeItem");
//# sourceMappingURL=AcDechuanshidaiExchangeItem.js.map