...
desc : 门客预览
*/
var AcDechuanshidaiPopupViewTab3 = (function (_super) {
    __extends(AcDechuanshidaiPopupViewTab3, _super);
    function AcDechuanshidaiPopupViewTab3(data) {
    ...
    Object.defineProperty(AcDechuanshidaiPopupViewTab3.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiPopupViewTab3.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiPopupViewTab3.prototype, "acTivityId", {
        get: function () {
    ...
    AcDechuanshidaiPopupViewTab3.prototype.getUiCode = function () {
        var code = '';
    ...
    AcDechuanshidaiPopupViewTab3.prototype.initView = function () {
        var view = this;
        ...
        Bg.y = 55;
        view.addChild(Bg);
        var wifeId = view.cfg.getServant(code);
        ...
        if (isWife) {
            ...
            var str = LanguageManager.getlocal("battlepassunlockwifetip", [String(need), wifeCfg.name]);
            ...
            this.addChild(topbgLine);
            var str = LanguageManager.getlocal("acDechuanshidaitip2-" + code, [servantCfg.name]);
            var topDesc = ComponentManager.getTextField(str, TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
            topDesc.setPosition(topbg.x + topbg.width / 2 - topDesc.width / 2, topbg.y + topbg.height / 2 - topDesc.height / 2 - 2);
            this.addChild(topDesc);
            var skinnamebg = BaseLoadBitmap.create("skin_detail_namebg");
    ...
    AcDechuanshidaiPopupViewTab3.prototype.dispose = function () {
        this._nodeContainer = null;
        //App.MessageHelper.removeEventListener(MessageConst.MESSAGE_DBDAY_FRESH_ITEM,this.update,this);
        _super.prototype.dispose.call(this);
    };
    return AcDechuanshidaiPopupViewTab3;
}(AcCommonViewTab));
__reflect(AcDechuanshidaiPopupViewTab3.prototype, "AcDechuanshidaiPopupViewTab3");
//# sourceMappingURL=AcDechuanshidaiPopupViewTab3.js.map