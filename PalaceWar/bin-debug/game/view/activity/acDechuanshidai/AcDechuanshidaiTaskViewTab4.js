...
desc : 每日任务
*/
var AcDechuanshidaiTaskViewTab4 = (function (_super) {
    __extends(AcDechuanshidaiTaskViewTab4, _super);
    function AcDechuanshidaiTaskViewTab4(data) {
    ...
    Object.defineProperty(AcDechuanshidaiTaskViewTab4.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiTaskViewTab4.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcDechuanshidaiTaskViewTab4.prototype, "acTivityId", {
        get: function () {
    ...
    AcDechuanshidaiTaskViewTab4.prototype.getUiCode = function () {
        var code = '';
    ...
    AcDechuanshidaiTaskViewTab4.prototype.initView = function () {
        var _this = this;
        var view = this;
    ...
    AcDechuanshidaiTaskViewTab4.prototype.getArr = function () {
        var view = this;
        var arr = [];
        var day = view._day;
    ...
    AcDechuanshidaiTaskViewTab4.prototype.rewardCallBack = function (evt) {
        var view = this;
    ...
    AcDechuanshidaiTaskViewTab4.prototype.totalrewardCallBack = function (evt) {
        var view = this;
        if (view.vo.lastday != view._day) {
            return;
        }
    ...
    AcDechuanshidaiTaskViewTab4.prototype.update = function () {
        var view = this;
        var code = view.getUiCode();
        if (!view.vo) {
            return;
    ...
    AcDechuanshidaiTaskViewTab4.prototype.dispose = function () {
        var view = this;
    ...
    return AcDechuanshidaiTaskViewTab4;
}(AcCommonViewTab));
__reflect(AcDechuanshidaiTaskViewTab4.prototype, "AcDechuanshidaiTaskViewTab4");
//# sourceMappingURL=AcDechuanshidaiTaskViewTab4.js.map