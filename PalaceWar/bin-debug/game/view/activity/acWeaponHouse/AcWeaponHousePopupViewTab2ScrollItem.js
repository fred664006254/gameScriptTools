...
var AcWeaponHousePopupViewTab2ScrollItem = /** @class */ (function (_super) {
    __extends(AcWeaponHousePopupViewTab2ScrollItem, _super);
    function AcWeaponHousePopupViewTab2ScrollItem() {
    ...
    Object.defineProperty(AcWeaponHousePopupViewTab2ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcWeaponHousePopupViewTab2ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcWeaponHousePopupViewTab2ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcWeaponHousePopupViewTab2ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcWeaponHousePopupViewTab2ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
     ...
     * 初始化itemview
     */
    AcWeaponHousePopupViewTab2ScrollItem.prototype.initItem = function (index, data, itemParam) {
        this._itemData = data;
        ...
        var currChargeGem = this.vo.getTask(this._itemData.id1, Number(this._itemData.id2) - 1);
        var value;
        var title;
        if (data.needNum) {
        ...
        var tasknum = Object.keys(this.cfg.scheduleAll[this._itemData.id1]).length;
    ...
    AcWeaponHousePopupViewTab2ScrollItem.prototype.collectHandler = function (evt) {
        var vo = this.vo;
        if (!vo) {
            return;
        }
        ...
        var taskNum = vo.getTask(this._itemData.id1, Number(this._itemData.id2) - 1);
        ...
        if (this._itemData.needNum) {
            if (taskNum >= this._itemData.needNum) {
                NetManager.request(NetRequestConst.REQUEST_WEAPONHOUSE_GETSCHEDULEALL, { activeId: this.vo.aidAndCode, rkey: Number(this._itemData.id1), rNum: Number(this._itemData.id2) });
            }
        }
        else {
    ...
    AcWeaponHousePopupViewTab2ScrollItem.prototype.update = function () {
        var vo = this.vo;
        if (!vo) {
            return;
        }
        ...
        if (this._goBtn3) {
            if (taskNum >= this._itemData.needNum || taskNum >= this._itemData.value2) {
                if (vo.isGetTaskReward(this._itemData.id1, Number(this._itemData.id2) - 1)) {
    ...
    AcWeaponHousePopupViewTab2ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcWeaponHousePopupViewTab2ScrollItem.prototype.dispose = function () {
        this._itemData = null;
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcWeaponHousePopupViewTab2ScrollItem;
}(ScrollListItem));
//# sourceMappingURL=AcWeaponHousePopupViewTab2ScrollItem.js.map