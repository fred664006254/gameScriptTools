...
var AcDoubleSeventhAVGView = (function (_super) {
    __extends(AcDoubleSeventhAVGView, _super);
    function AcDoubleSeventhAVGView() {
    ...
    Object.defineProperty(AcDoubleSeventhAVGView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcDoubleSeventhAVGView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcDoubleSeventhAVGView.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcDoubleSeventhAVGView.prototype, "codeResStr", {
        get: function () {
            var str = "";
            switch (String(this.param.data.code)) {
                ...
                case "4":
                    ...
                    break;
                default:
                    str = ("_code" + this.param.data.code);
                    break;
            }
            return str;
        },
    ...
    Object.defineProperty(AcDoubleSeventhAVGView.prototype, "code", {
        get: function () {
            var str = "";
            switch (String(this.param.data.code)) {
                case "1":
    ...
    AcDoubleSeventhAVGView.prototype.getResourceList = function () {
        // test code
        ...
        var guidePic = [];
        var allAvg = null;
        if (view.param.data.type && view.param.data.type == "MainTask") {
            allAvg = Config.MaintaskCfg.getDialogByBuildId(1);
        }
        else {
            allAvg = view.vo.getAvgConfig(view.param.data.buidId, this.param.data.code);
        }
    ...
    AcDoubleSeventhAVGView.prototype.getTitleBgName = function () {
        return null;
    };
    AcDoubleSeventhAVGView.prototype.getTitleStr = function () {
        return null;
    };
    AcDoubleSeventhAVGView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcDoubleSeventhAVGView.prototype.getBgName = function () {
        return null;
    };
    AcDoubleSeventhAVGView.prototype.isShowMask = function () {
        return false;
    };
    AcDoubleSeventhAVGView.prototype.preInit = function () {
    ...
    AcDoubleSeventhAVGView.prototype.init = function () {
        ...
        if (view.param.data.type && view.param.data.type == "MainTask") {
            if (Api.otherInfoVoApi.getCurSceneId() == "106") {
                this._myBg = BaseLoadBitmap.create("story_bg6");
                this._myBg.width = GameConfig.stageWidth;
                this._myBg.height = GameConfig.stageHeigth;
            }
            else {
                this._myBg = BaseBitmap.create(Api.otherInfoVoApi.getSceneResName());
            }
        }
        else {
            this._myBg = BaseBitmap.create('acsevenbg' + this.codeResStr);
        }
        // this._myBg.height = GameConfig.stageHeigth;
        this._myBg.width = GameConfig.stageWidth;
        ...
        // }
        if (view.param.data.type && view.param.data.type == "MainTask") {
            this._curConfig = Config.MaintaskCfg.getDialogByBuildId(1)[this._curIdx];
        }
        else {
            this._curConfig = view.vo.getAvgConfig(view.param.data.buidId, this.param.data.code)[this._curIdx];
        }
        this.showPage();
    };
    AcDoubleSeventhAVGView.prototype.clickPage = function (evt) {
    ...
    AcDoubleSeventhAVGView.prototype.doNextStep = function (step) {
        var view = this;
        var nextId = null;
        if (step) {
            nextId = step;
        ...
        if (this._curConfig && nextId == null) {
            ...
            var allAvg = null;
            if (view.param.data.type == "MainTask") {
                allAvg = Config.MaintaskCfg.getDialogByBuildId(1);
            }
            else {
                allAvg = view.vo.getAvgConfig(view.param.data.buidId, this.param.data.code);
    ...
    AcDoubleSeventhAVGView.prototype.showPage = function () {
        //this.doStepHandle();
        if (this._showManTab) {
        ...
        if (this._curConfig.descId) {
            ...
            if (this._curConfig.clickContinue) {
                ...
                this._codonLength = 0;
                this._descText.text = "";
                this._descContent = LanguageManager.getlocal("DoubleSevenAVGDialog" + this._curConfig.descId + this.code);
                if (this.param.data.type && this.param.data.type == "MainTask") {
                    this._descContent = LanguageManager.getlocal("MainTaskDialog" + this._curConfig.descId);
                }
                needShoot = true;
            }
            else {
                this._descText.text = LanguageManager.getlocal("DoubleSevenAVGDialog" + this._curConfig.descId + this.code);
                if (this.param.data.type && this.param.data.type == "MainTask") {
                    this._descContent = LanguageManager.getlocal("MainTaskDialog" + this._curConfig.descId);
                }
    ...
    AcDoubleSeventhAVGView.prototype.clickSelectedHandler = function (event, branchBtn, step) {
        switch (event.type) {
    ...
    AcDoubleSeventhAVGView.prototype.changeBgCallBack = function () {
    ...
    AcDoubleSeventhAVGView.prototype.showShakeAnim = function () {
    ...
    AcDoubleSeventhAVGView.prototype.shakeScreen = function () {
    ...
    AcDoubleSeventhAVGView.prototype.showFogAnim = function () {
        this._myBg.y = 0;
    ...
    AcDoubleSeventhAVGView.prototype.textShootAnim = function () {
    ...
    AcDoubleSeventhAVGView.prototype.textAnim = function (t) {
    ...
    AcDoubleSeventhAVGView.prototype.skipAnim = function () {
        this.hide();
     ...
     * 收到通知 下一步
     */
    AcDoubleSeventhAVGView.prototype.noticeNextStep = function () {
        this.doNextStep();
    };
    AcDoubleSeventhAVGView.prototype.initView = function () {
    };
    AcDoubleSeventhAVGView.prototype.getParent = function () {
        return LayerManager.maskLayer;
    };
    AcDoubleSeventhAVGView.prototype.hide = function (isDispose) {
        var tempObj = this._obj;
        var tempFunc = this._callbackF;
        if (!isDispose) {
            if (tempObj && tempFunc) {
    ...
    AcDoubleSeventhAVGView.prototype.doStepHandle = function () {
        if (this._curIdx == "1") {
    ...
    AcDoubleSeventhAVGView.prototype.dispose = function () {
    ...
    return AcDoubleSeventhAVGView;
}(CommonView));
__reflect(AcDoubleSeventhAVGView.prototype, "AcDoubleSeventhAVGView");
//# sourceMappingURL=AcDoubleSeventhAVGView.js.map