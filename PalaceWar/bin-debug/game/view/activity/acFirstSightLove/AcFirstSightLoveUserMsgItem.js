 ...
 */
var AcFirstSightLoveUserMsgItem = (function (_super) {
    __extends(AcFirstSightLoveUserMsgItem, _super);
    function AcFirstSightLoveUserMsgItem() {
    ...
    AcFirstSightLoveUserMsgItem.prototype.initItem = function (index, data, itemParam) {
        var view = this;
        view._data = data;
        view.width = 560 - 32;
        ...
        var name1 = ComponentManager.getTextField(String(index + 1) + ".", TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_BROWN);
        this.addChild(name1);
        name1.x = 10;
        name1.y = 5;
        ...
        if (data == 1) {
            this._maxLength = 200;
            var inputTF2 = ComponentManager.getInputTextField(TextFieldConst.COLOR_LIGHT_YELLOW, TextFieldConst.FONTSIZE_TITLE_SMALL, 530 - 32, 100, "public_9_bg5", LanguageManager.getlocal("acQuestionTip3-1"), 0xb1b1b1);
            ...
            this._maxLength = 200;
            var inputTF2 = ComponentManager.getInputTextField(TextFieldConst.COLOR_LIGHT_YELLOW, TextFieldConst.FONTSIZE_TITLE_SMALL, 530 - 32, 90, "public_9_bg5", LanguageManager.getlocal("acQuestionTip3-1"), 0xb1b1b1);
            inputTF2.name = "inputTF2";
            App.DisplayUtil.setLayoutPosition(LayoutConst.lefttop, inputTF2, name1, [5, name.textHeight + 10]);
            view.addChild(inputTF2);
            var inputMaxText = ComponentManager.getTextField(LanguageManager.getlocal("acQuestionAnswerWord-1", [this._maxLength + ""]), TextFieldConst.FONTSIZE_CONTENT_SMALL, 0xc2b89e);
    ...
    AcFirstSightLoveUserMsgItem.prototype.arrowClickHandler = function (idx) {
        this._showIdx = idx;
        var info = {};
        info["index"] = idx;
        if (idx == 3) {
    ...
    AcFirstSightLoveUserMsgItem.prototype.setBirthday = function (str) {
    ...
    AcFirstSightLoveUserMsgItem.prototype.callbackInput = function (event) {
        var view = this;
    ...
    AcFirstSightLoveUserMsgItem.prototype.checkAnwser = function () {
        var view = this;
        var answer = null;
        var msg = '';
        if (this._data == 3) {
    ...
    AcFirstSightLoveUserMsgItem.prototype.getIsAnswer = function () {
        var view = this;
        var flag = false;
        if (this._data == 3) {
            if (this._textTab[0].text && this._textTab[1].text && this._textTab[2].text) {
    ...
    AcFirstSightLoveUserMsgItem.prototype.showEffect = function () {
        var view = this;
        if (view._showEff) {
            return;
        }
    ...
    AcFirstSightLoveUserMsgItem.prototype.dispose = function () {
        this._data = null;
    ...
    return AcFirstSightLoveUserMsgItem;
}(ScrollListItem));
__reflect(AcFirstSightLoveUserMsgItem.prototype, "AcFirstSightLoveUserMsgItem");
//# sourceMappingURL=AcFirstSightLoveUserMsgItem.js.map