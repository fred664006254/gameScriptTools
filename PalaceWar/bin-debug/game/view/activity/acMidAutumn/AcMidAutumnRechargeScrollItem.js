...
var AcMidAutumnRechargeScrollItem = (function (_super) {
    ...
    AcMidAutumnRechargeScrollItem.prototype.initItem = function (index, data, itemParam) {
        ...
        var titleTF = ComponentManager.getTextField(LanguageManager.getlocal("acMidAutumnRechargeTitle", [String(this._itemData.needGem)]), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        for (var i = 0; i < rewardArr.length; i++) {
            ...
            rewardItem.setPosition(rewardBg.x + rewardItem.width / 2 + i % 4 * (rewardItem.width - 5), rewardBg.y + rewardItem.height / 2 + (Math.floor((i + 1) / 5)) * rewardItem.height + 3);
        ...
        this._rechargeBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_RED, "acCarnivalToChargeBtnText", this.rechargeHandler, this);
        ...
        this._receiveBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "ac_recharge_Btntxt2", this.receiveHandler, this);
    ...
    AcMidAutumnRechargeScrollItem.prototype.refreshBtn = function () {
        ...
        if (vo.isReceiveRecharge(this._itemData.id)) {
            ...
            if (vo.getRechargeValue() < this._itemData.needGem) {
                ...
                if (deltaT < 0) {
                    this._rechargeBtn.setGray(true);
                }
            }
            else {
                this._receiveBM.setVisible(false);
...
//# sourceMappingURL=AcMidAutumnRechargeScrollItem.js.map