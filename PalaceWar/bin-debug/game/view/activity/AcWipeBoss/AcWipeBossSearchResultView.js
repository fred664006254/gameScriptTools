...
var AcWipeBossSearchResultView = (function (_super) {
    ...
    AcWipeBossSearchResultView.prototype.initView = function () {
        ...
        App.DisplayUtil.setLayoutPosition(LayoutConst.leftbottom, cancelBtn, descbg, [140, 55]);
        ...
        App.DisplayUtil.setLayoutPosition(LayoutConst.rightbottom, confirmBtn, descbg, [140, 55]);
        ...
        if (resultInfo.type == 2) {
            ...
            var keyTxt = ComponentManager.getTextField("" + LanguageManager.getlocal("acwipeBossKillKey" + boxId) + keynum + "/1", 22, 0xff3c3c);
            ...
            if (PlatformManager.checkIsTextHorizontal()) {
                ...
                var namebg = BaseBitmap.create("aobainamebg");
                App.DisplayUtil.setLayoutPosition(LayoutConst.lefttop, namebg, infoGroup, [55, 0], true);
                infoGroup.addChild(namebg);
                var nameTxt = ComponentManager.getTextField(name, 22);
                nameTxt.width = 22;
...
//# sourceMappingURL=AcWipeBossSearchResultView.js.map