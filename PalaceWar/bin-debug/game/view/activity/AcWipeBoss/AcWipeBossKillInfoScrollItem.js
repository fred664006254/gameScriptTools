...
var AcWipeBossKillInfoScrollItem = (function (_super) {
    ...
    AcWipeBossKillInfoScrollItem.prototype.initItem = function (index, data, itemparam) {
        ...
        var trankTxt1 = ComponentManager.getTextField(String(index + 1), 20);
        ...
        var timeTxt = ComponentManager.getTextField(App.DateUtil.getFormatBySecond(data.time, 2), 20, TextFieldConst.COLOR_WARN_YELLOW2);
        ...
        var killRewardTxt = ComponentManager.getTextField(rewardstr, 18, TextFieldConst.COLOR_WARN_GREEN2);
...
//# sourceMappingURL=AcWipeBossKillInfoScrollItem.js.map