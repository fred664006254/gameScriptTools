 ...
 */
var AcWeiZhengRechargeItem = (function (_super) {
    __extends(AcWeiZhengRechargeItem, _super);
    function AcWeiZhengRechargeItem() {
    ...
    Object.defineProperty(AcWeiZhengRechargeItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcWeiZhengRechargeItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcWeiZhengRechargeItem.prototype, "acTivityId", {
        get: function () {
    ...
    Object.defineProperty(AcWeiZhengRechargeItem.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcWeiZhengRechargeItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    AcWeiZhengRechargeItem.prototype.getUiCode = function () {
        var code = "";
    ...
    AcWeiZhengRechargeItem.prototype.initItem = function (index, data, itemparam) {
        var view = this;
        ...
        scroStartY += 100;
        bg.height = scroStartY + 55;
        this.height = bg.height;
        //进度条
        this._progress = ComponentManager.getProgressBar("progress5", "progress3_bg", 345);
        this._progress.x = 10;
        // progress.y = 185;
        this._progress.y = scroStartY + 15;
        this.addChild(this._progress);
        this.refreshBtnStatus();
    };
    //刷新按钮状态
    AcWeiZhengRechargeItem.prototype.refreshBtnStatus = function () {
        var tmpVo = this.vo;
        if (!tmpVo) {
            return;
        }
        ...
        //检查是否创建已经领取标签
        if (tmpVo.getChargeLq(this._itemData)) {
    ...
    AcWeiZhengRechargeItem.prototype.refreshUI = function () {
    ...
    AcWeiZhengRechargeItem.prototype.createCollectFlag = function () {
    ...
    AcWeiZhengRechargeItem.prototype.eventCollectHandler = function (event) {
        ...
        NetManager.request(NetRequestConst.REQUEST_WEIZHENG_GETRECHARGE, {
            activeId: this.acTivityId,
            rechargeId: this._itemData
        });
    };
    AcWeiZhengRechargeItem.prototype.goRechargeHandler = function (event) {
        if (this.vo.et < GameData.serverTime) {
            App.CommonUtil.showTip(LanguageManager.getlocal("time_error"));
            return;
        }
    ...
    AcWeiZhengRechargeItem.prototype.getSpaceX = function () {
        return 10;
    };
    /**
     * 不同格子Y间距
     */
    AcWeiZhengRechargeItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcWeiZhengRechargeItem.prototype.dispose = function () {
        this._itemData = null;
        this._collectFlag = null;
        this._progress = null;
        this._collectBtn = null;
    ...
    return AcWeiZhengRechargeItem;
}(ScrollListItem));
__reflect(AcWeiZhengRechargeItem.prototype, "AcWeiZhengRechargeItem");
//# sourceMappingURL=AcWeiZhengRechargeItem.js.map