...
var AcSkyArmorRewardTab2ScrollItem = /** @class */ (function (_super) {
    __extends(AcSkyArmorRewardTab2ScrollItem, _super);
    function AcSkyArmorRewardTab2ScrollItem() {
        var _this = _super.call(this) || this;
        _this._aid = null;
        _this._code = null;
        return _this;
    }
    Object.defineProperty(AcSkyArmorRewardTab2ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcSkyArmorRewardTab2ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcSkyArmorRewardTab2ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcSkyArmorRewardTab2ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcSkyArmorRewardTab2ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
    };
    AcSkyArmorRewardTab2ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 13;
        //title txt
        var titleTxtStr = LanguageManager.getlocal("acSkyArmorAchievementItemInfo", ["" + data.needNum]);
        ...
        if (this.vo.isGetAchievementById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACSKYARMOR_GETNUMREWARDS, { activeId: _this.vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcSkyArmorRewardTab2ScrollItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcSkyArmorRewardTab2ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcSkyArmorRewardTab2ScrollItem.prototype.dispose = function () {
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcSkyArmorRewardTab2ScrollItem;
}(ScrollListItem));
//# sourceMappingURL=AcSkyArmorRewardTab2ScrollItem.js.map