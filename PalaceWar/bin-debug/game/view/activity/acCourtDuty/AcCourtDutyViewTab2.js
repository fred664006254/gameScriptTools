 ...
 */
var AcCourtDutyViewTab2 = (function (_super) {
    __extends(AcCourtDutyViewTab2, _super);
    function AcCourtDutyViewTab2() {
    ...
    AcCourtDutyViewTab2.prototype.initView = function () {
        ...
        var dataList = this.vo.getSortHuangBangTaskCfg();
        var rect = new egret.Rectangle(0, 0, listBg.width - 10, listBg.height - 10);
        var scrollList = ComponentManager.getScrollList(AcCourtDutyViewTaskScrollItem, dataList, rect, { aid: this.aid, code: this.code, type: 2 });
        scrollList.setPosition(listBg.x + 5, listBg.y + 5);
        this.addChild(scrollList);
        this._scrollList = scrollList;
        this.initFetters();
    };
    AcCourtDutyViewTab2.prototype.refreshView = function () {
    ...
    //初始化锁链
    AcCourtDutyViewTab2.prototype.initFetters = function () {
        ...
        if (this._maskPanel == null) {
            ...
            var dialogText = ComponentManager.getTextField(LanguageManager.getlocal("acCourtDutyRechargeInfo2-" + this.getTypeCode(), ["" + this.cfg.needRecharge2]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
            ...
            var currRechargeNumStr = LanguageManager.getlocal("acCourtDutyRechargeNum-" + this.getTypeCode(), ["" + currRechargeNum, "" + this.cfg.needRecharge2]);
    ...
    //播放锁链特效
    AcCourtDutyViewTab2.prototype.playFetters = function () {
        var _this = this;
        // let locakKey = this.vo.aidAndCode + Api.playerVoApi.getPlayerID() + "2" + this.vo.et;
    ...
    AcCourtDutyViewTab2.prototype.hideMaskPanel = function () {
        this._maskPanel.visible = false;
    };
    //刷新充值进度
    AcCourtDutyViewTab2.prototype.refreshFetterPanel = function () {
        if (this._lockDialog) {
            var currNum = this.vo.getRechargeNum();
            var progress = this._lockDialog.getChildByName("progress");
            var currNumStr = LanguageManager.getlocal("acCourtDutyRechargeNum-" + this.getTypeCode(), ["" + currNum, "" + this.cfg.needRecharge2]);
    ...
    AcCourtDutyViewTab2.prototype.rechargeHandler = function () {
        if (!this.vo.isInActivity()) {
    ...
    AcCourtDutyViewTab2.prototype.unlockHandler = function () {
        var unlockBtn = this._lockDialog.getChildByName("unlockBtn");
    ...
    AcCourtDutyViewTab2.prototype.unlockCallback = function (evt) {
        if (!this._isUnlock) {
            return;
        }
    ...
    AcCourtDutyViewTab2.prototype.getTypeCode = function () {
        return this.code;
    };
    Object.defineProperty(AcCourtDutyViewTab2.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCourtDutyViewTab2.prototype, "vo", {
        get: function () {
    ...
    AcCourtDutyViewTab2.prototype.dispose = function () {
    ...
    return AcCourtDutyViewTab2;
}(AcCommonViewTab));
__reflect(AcCourtDutyViewTab2.prototype, "AcCourtDutyViewTab2");
//# sourceMappingURL=AcCourtDutyViewTab2.js.map