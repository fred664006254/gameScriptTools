 ...
 * @author ycg
 */
var AcWeaponMazeDetailPopupScrollItem2 = (function (_super) {
    __extends(AcWeaponMazeDetailPopupScrollItem2, _super);
    function AcWeaponMazeDetailPopupScrollItem2() {
        var _this = _super.call(this) || this;
        _this._aid = null;
        _this._code = null;
        return _this;
    }
    Object.defineProperty(AcWeaponMazeDetailPopupScrollItem2.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcWeaponMazeDetailPopupScrollItem2.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcWeaponMazeDetailPopupScrollItem2.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcWeaponMazeDetailPopupScrollItem2.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcWeaponMazeDetailPopupScrollItem2.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
    };
    AcWeaponMazeDetailPopupScrollItem2.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 5;
        //title txt
        var titleTxtStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acWeaponMazeDetailAchieveItemInfo", this.getTypeCode()), ["" + data.needNum]);
        ;
        ...
        if (this.vo.isGetAchieveRewardById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACWEAPONMAZE_GETACHIEVT, { activeId: _this.vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcWeaponMazeDetailPopupScrollItem2.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcWeaponMazeDetailPopupScrollItem2.prototype.getSpaceY = function () {
        return 5;
    };
    AcWeaponMazeDetailPopupScrollItem2.prototype.dispose = function () {
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcWeaponMazeDetailPopupScrollItem2;
}(ScrollListItem));
__reflect(AcWeaponMazeDetailPopupScrollItem2.prototype, "AcWeaponMazeDetailPopupScrollItem2");
//# sourceMappingURL=AcWeaponMazeDetailPopupScrollItem2.js.map