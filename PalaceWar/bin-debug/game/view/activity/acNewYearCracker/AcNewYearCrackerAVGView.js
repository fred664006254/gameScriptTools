...
var AcNewYearCrackerAVGView = (function (_super) {
    __extends(AcNewYearCrackerAVGView, _super);
    function AcNewYearCrackerAVGView() {
        ...
        _this.AVGDialog = {
            ...
            1: {
                ...
                2: {
                    ...
                    "2": { "nextId": null, "descId": 2, "bgId": 6, "personPic": 'wife_full_101', "nameId": "wifeName_101", "clickContinue": true },
                },
                3: {
                    "1": { "nextId": "2", "descId": 1, "bgId": 6, "personPic": 1, "nameId": "storyNPCName1", "clickContinue": true },
                    "2": { "nextId": null, "descId": 2, "bgId": 6, "personPic": 'wife_full_102', "nameId": "wifeName_102", "clickContinue": true },
                },
                4: {
                    "1": { "nextId": "2", "descId": 1, "bgId": 6, "personPic": 1, "nameId": "storyNPCName1", "clickContinue": true },
                    "2": { "nextId": null, "descId": 2, "bgId": 6, "personPic": 'servant_full_1003', "nameId": "servant_name1003", "clickContinue": true },
                },
                5: {
                    "1": { "nextId": "2", "descId": 1, "bgId": 6, "personPic": 1, "nameId": "storyNPCName1", "clickContinue": true },
                    "2": { "nextId": null, "descId": 2, "bgId": 6, "personPic": 'servant_full_1002', "nameId": "servant_name1002", "clickContinue": true },
                },
                6: {
                    "1": { "nextId": "2", "descId": 1, "bgId": 6, "personPic": 1, "nameId": "storyNPCName1", "clickContinue": true },
                    "2": { "nextId": null, "descId": 2, "bgId": 6, "personPic": 'wife_full_208', "nameId": "wifeName_208", "clickContinue": true },
                },
                7: {
                    "1": { "nextId": "2", "descId": 1, "bgId": 6, "personPic": 1, "nameId": "storyNPCName1", "clickContinue": true },
                    "2": { "nextId": "3", "descId": 2, "bgId": 6, "personPic": 'servant_full_1001', "nameId": "servant_name1001", "clickContinue": true },
                    "3": { "nextId": "4", "descId": 3, "bgId": 6, "personPic": 'wife_full_101', "nameId": "wifeName_101", "clickContinue": true },
    ...
    AcNewYearCrackerAVGView.prototype.getResourceList = function () {
        // test code
        // Api.rookieVoApi.isInGuiding = true;
        var view = this;
        view._curIdx = '1';
        view._code = Number(view.param.data.code);
        view._key = view.param.data.key;
        var guidePic = [];
        var allAvg = view.AVGDialog[view._code][view._key][view._curIdx];
    ...
    AcNewYearCrackerAVGView.prototype.getTitleBgName = function () {
        return null;
    };
    AcNewYearCrackerAVGView.prototype.getTitleStr = function () {
        return null;
    };
    AcNewYearCrackerAVGView.prototype.getCloseBtnName = function () {
        return null;
    };
    AcNewYearCrackerAVGView.prototype.getBgName = function () {
        return null;
    };
    AcNewYearCrackerAVGView.prototype.isShowMask = function () {
        return true;
    };
    AcNewYearCrackerAVGView.prototype.preInit = function () {
    ...
    AcNewYearCrackerAVGView.prototype.init = function () {
        ...
        var bgname = "accrackertbg1-" + this._code;
        ...
        this._curConfig = view.AVGDialog[view._code][view._key][this._curIdx]; //RookieCfg.getRookieCfg(this._curIdx);
        this.showPage();
    };
    AcNewYearCrackerAVGView.prototype.clickPage = function (evt) {
    ...
    AcNewYearCrackerAVGView.prototype.doNextStep = function (step) {
        var view = this;
        var nextId = null;
        if (step) {
            nextId = step;
        ...
        if (this._curConfig && nextId == null) {
            ...
            this._curIdx = nextId;
            this._curConfig = view.AVGDialog[view._code][view._key][this._curIdx];
            this.showPage();
        }
    ...
    AcNewYearCrackerAVGView.prototype.showPage = function () {
        //this.doStepHandle();
        if (this._showManTab) {
        ...
        if (this._curConfig.descId) {
            ...
            if (1) {
                ...
                this._codonLength = 0;
                this._descText.text = "";
                var str = "acNewYearCrackerTalk" + this._key + "_" + this._curConfig.descId + "-" + this.param.data.code;
    ...
    AcNewYearCrackerAVGView.prototype.clickSelectedHandler = function (event, branchBtn, step) {
        switch (event.type) {
    ...
    AcNewYearCrackerAVGView.prototype.changeBgCallBack = function () {
    ...
    AcNewYearCrackerAVGView.prototype.showShakeAnim = function () {
    ...
    AcNewYearCrackerAVGView.prototype.shakeScreen = function () {
    ...
    AcNewYearCrackerAVGView.prototype.showFogAnim = function () {
        this._myBg.y = 0;
    ...
    AcNewYearCrackerAVGView.prototype.textShootAnim = function () {
    ...
    AcNewYearCrackerAVGView.prototype.textAnim = function (t) {
    ...
    AcNewYearCrackerAVGView.prototype.skipAnim = function () {
        this.hide();
    };
    /**
     * 收到通知 下一步
     */
    AcNewYearCrackerAVGView.prototype.noticeNextStep = function () {
        this.doNextStep();
    };
    AcNewYearCrackerAVGView.prototype.initView = function () {
    };
    AcNewYearCrackerAVGView.prototype.getParent = function () {
        return LayerManager.maskLayer;
    };
    AcNewYearCrackerAVGView.prototype.hide = function (isDispose) {
        var view = this;
        if (!isDispose) {
        }
    ...
    AcNewYearCrackerAVGView.prototype.doStepHandle = function () {
        if (this._curIdx == "1") {
    ...
    AcNewYearCrackerAVGView.prototype.dispose = function () {
    ...
    return AcNewYearCrackerAVGView;
}(CommonView));
__reflect(AcNewYearCrackerAVGView.prototype, "AcNewYearCrackerAVGView");
//# sourceMappingURL=AcNewYearCrackerAVGView.js.map