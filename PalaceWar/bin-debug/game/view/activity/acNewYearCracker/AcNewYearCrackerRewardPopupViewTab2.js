...
desc : 庭院奖励
*/
var AcNewYearCrackerRewardPopupViewTab2 = (function (_super) {
    __extends(AcNewYearCrackerRewardPopupViewTab2, _super);
    function AcNewYearCrackerRewardPopupViewTab2(data) {
    ...
    Object.defineProperty(AcNewYearCrackerRewardPopupViewTab2.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcNewYearCrackerRewardPopupViewTab2.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcNewYearCrackerRewardPopupViewTab2.prototype, "acTivityId", {
        get: function () {
    ...
    AcNewYearCrackerRewardPopupViewTab2.prototype.initView = function () {
        var view = this;
        view.height = 571;
        view.width = 530;
    ...
    AcNewYearCrackerRewardPopupViewTab2.prototype.update = function () {
        var view = this;
        if (!view.vo) {
            return;
        }
    ...
    AcNewYearCrackerRewardPopupViewTab2.prototype.updateArr = function (arr) {
        var view = this;
        var vo = view.vo;
        if (!vo) {
            return;
    ...
    AcNewYearCrackerRewardPopupViewTab2.prototype.dispose = function () {
        var view = this;
    ...
    return AcNewYearCrackerRewardPopupViewTab2;
}(CommonViewTab));
__reflect(AcNewYearCrackerRewardPopupViewTab2.prototype, "AcNewYearCrackerRewardPopupViewTab2");
//# sourceMappingURL=AcNewYearCrackerRewardPopupViewTab2.js.map