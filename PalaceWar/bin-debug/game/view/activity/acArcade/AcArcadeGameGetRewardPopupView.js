...
var AcArcadeGameGetRewardPopupView = (function (_super) {
    ...
    AcArcadeGameGetRewardPopupView.prototype.initBuffers = function (buffers) {
        ...
        var wealthLuckTxt1 = ComponentManager.getTextField(LanguageManager.getlocal("acArcadeGameRewardViewBufferType1-" + this.param.data.code, [String(cyhtNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        ...
        var wealthLuckTxt2 = ComponentManager.getTextField(LanguageManager.getlocal("acArcadeGameRewardViewBufferType2-" + this.param.data.code, [String(tjhcNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
        ...
        var wealthLuckTxt3 = ComponentManager.getTextField(LanguageManager.getlocal("acArcadeGameRewardViewBufferType3-" + this.param.data.code, [String(csjdNum)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WHITE);
...
//# sourceMappingURL=AcArcadeGameGetRewardPopupView.js.map