...
/**
  ...
  */
var AcArcadeRechageScrollItem = (function (_super) {
    __extends(AcArcadeRechageScrollItem, _super);
    function AcArcadeRechageScrollItem() {
     ...
     * 初始化itemview
     */
    AcArcadeRechageScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        this._itemData = data;
        ...
        if (vo.getChargeFlag(data.id)) {
            ...
            if (vo.getChargeValue() >= data.needGem) {
                ...
                var chargeBtn = ComponentManager.getButton(ButtonConst.BTN_NORMAL_RED, "taskGoBtn", function () {
                    var v = Api.acVoApi.getActivityVoByAidAndCode(_this._aidAndCode.aid, _this._aidAndCode.code);
    ...
    AcArcadeRechageScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcArcadeRechageScrollItem.prototype.dispose = function () {
        this._itemData = null;
        _super.prototype.dispose.call(this);
    };
    return AcArcadeRechageScrollItem;
}(ScrollListItem));
__reflect(AcArcadeRechageScrollItem.prototype, "AcArcadeRechageScrollItem");
//# sourceMappingURL=AcArcadeRechageScrollItem.js.map