 ...
 * @author ycg
 */
var AcGoodMatchDetailTab1ScrollItem = /** @class */ (function (_super) {
    __extends(AcGoodMatchDetailTab1ScrollItem, _super);
    function AcGoodMatchDetailTab1ScrollItem() {
        var _this = _super.call(this) || this;
        _this._aid = null;
        _this._code = null;
        return _this;
    }
    Object.defineProperty(AcGoodMatchDetailTab1ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcGoodMatchDetailTab1ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcGoodMatchDetailTab1ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcGoodMatchDetailTab1ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcGoodMatchDetailTab1ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
    };
    AcGoodMatchDetailTab1ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 13;
        //title txt
        var titleTxtStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acGoodMatchProcessTitle", this.getTypeCode()), ["" + data.needNum]);
        ;
        ...
        if (this.vo.isGetAchieveRewardById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACGOODMATCH_GETACHRWD, { activeId: _this.vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcGoodMatchDetailTab1ScrollItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcGoodMatchDetailTab1ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcGoodMatchDetailTab1ScrollItem.prototype.dispose = function () {
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcGoodMatchDetailTab1ScrollItem;
}(ScrollListItem));
//# sourceMappingURL=AcGoodMatchDetailTab1ScrollItem.js.map