 ...
 */
var AcSeaWomanPopViewTab3 = /** @class */ (function (_super) {
    __extends(AcSeaWomanPopViewTab3, _super);
    function AcSeaWomanPopViewTab3(data) {
    ...
    AcSeaWomanPopViewTab3.prototype.initView = function () {
        ...
        var topStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acSeaWomanSkinTopMsg", this.getTypeCode()), ["" + toolItemVo.num, toolItemVo.name]);
        ...
        var exchangeBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "exchange", this.exchangeBtnClick, this);
    ...
    AcSeaWomanPopViewTab3.prototype.exchangeBtnClick = function () {
        if (this.vo.isEnd) {
    ...
    AcSeaWomanPopViewTab3.prototype.exchangeCallback = function (evt) {
        if (!evt.data.ret) {
            return;
        }
    ...
    AcSeaWomanPopViewTab3.prototype.getRewardCallback = function () {
        var toolItemVo = this.vo.getShowSkinData();
        var toolData = Api.itemVoApi.getItemInfoVoById(toolItemVo.id);
        var currNum = 0;
        if (toolData) {
    ...
    AcSeaWomanPopViewTab3.prototype.dealAttrChangeInfo = function (skinId) {
        var skinCfg = Config.WifeskinCfg.getWifeCfgById(skinId);
    ...
    Object.defineProperty(AcSeaWomanPopViewTab3.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcSeaWomanPopViewTab3.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcSeaWomanPopViewTab3.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcSeaWomanPopViewTab3.prototype, "aid", {
        get: function () {
    ...
    AcSeaWomanPopViewTab3.prototype.getTypeCode = function () {
        return this.param.data.uicode;
    };
    AcSeaWomanPopViewTab3.prototype.dispose = function () {
    ...
    return AcSeaWomanPopViewTab3;
}(CommonViewTab));
//# sourceMappingURL=AcSeaWomanPopViewTab3.js.map