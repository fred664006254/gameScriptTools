 ...
 * @author sl
 */
var AcBirdBridgeScrollItem2 = /** @class */ (function (_super) {
    __extends(AcBirdBridgeScrollItem2, _super);
    function AcBirdBridgeScrollItem2() {
    ...
    Object.defineProperty(AcBirdBridgeScrollItem2.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcBirdBridgeScrollItem2.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcBirdBridgeScrollItem2.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcBirdBridgeScrollItem2.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcBirdBridgeScrollItem2.prototype.getTypeCode = function () {
        return this._uicode;
    };
    AcBirdBridgeScrollItem2.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 13;
        //title txt
        var titleTxtStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acBirdBridgeProcessTitle", this.getTypeCode()), ["" + data.needNum]);
        ;
        ...
        var currNum = this.vo.ainfo[0].v;
        var progressStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acLotusDetailProcessNum", "1"), [String(currNum), String(data.needNum)]);
        progress.setPercentage(currNum / data.needNum, progressStr, TextFieldConst.COLOR_WHITE);
        if (this.vo.isGetAchievementOneRewardById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_AC_BIRDBRIDGEGETACHIEVE, { activeId: _this.vo.aidAndCode, rkey: data.id, all: 0 });
            }, this);
    ...
    AcBirdBridgeScrollItem2.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcBirdBridgeScrollItem2.prototype.getSpaceY = function () {
        return 5;
    };
    AcBirdBridgeScrollItem2.prototype.dispose = function () {
        this._aid = null;
        this._code = null;
        this._uicode = null;
        _super.prototype.dispose.call(this);
    };
    return AcBirdBridgeScrollItem2;
}(ScrollListItem));
//# sourceMappingURL=AcBirdBridgeScrollItem2.js.map