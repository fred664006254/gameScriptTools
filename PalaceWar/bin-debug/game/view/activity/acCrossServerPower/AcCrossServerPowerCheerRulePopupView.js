...
//规则
var AcCrossServerPowerRulePopupView = (function (_super) {
    __extends(AcCrossServerPowerRulePopupView, _super);
    function AcCrossServerPowerRulePopupView() {
        var _this = _super.call(this) || this;
        _this._bgHeight = 0;
        return _this;
    }
    Object.defineProperty(AcCrossServerPowerRulePopupView.prototype, "uiType", {
        get: function () {
            return "2";
        },
        enumerable: true,
    ...
    AcCrossServerPowerRulePopupView.prototype.getUiCode = function () {
        var code = "";
    ...
    Object.defineProperty(AcCrossServerPowerRulePopupView.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerRulePopupView.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerRulePopupView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerRulePopupView.prototype, "cfg", {
        get: function () {
    ...
    // 打开该面板时，需要传参数msg
    AcCrossServerPowerRulePopupView.prototype.initView = function () {
        ...
        var msgTF1 = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverPowerFlagRule1", this.getUiCode())), 20, TextFieldConst.COLOR_BROWN);
        msgTF1.width = 460;
        ...
        for (var i = scoreRebate.length - 1; i >= 0; i--) {
            ...
            var msgStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverPowerFlagRule2", this.getUiCode()), [String(rebateCfg.rank[0]), String(rebateCfg.rank[1]), String(rebateCfg.multiplying * this.cfg.flagScoreNum1)]);
            if (rebateCfg.rank[0] == rebateCfg.rank[1] && rebateCfg.rank[1] == 1) {
                msgStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverPowerFlagRule3", this.getUiCode()), [String(rebateCfg.multiplying * this.cfg.flagScoreNum1)]);
            }
    ...
    AcCrossServerPowerRulePopupView.prototype.resetBgSize = function () {
        // this.setConfirmBtnPosition(this.viewBg.x + this.viewBg.width/2- 86 -27,this._bgHeight + 30);
        _super.prototype.resetBgSize.call(this);
    };
    AcCrossServerPowerRulePopupView.prototype.getTitleStr = function () {
        return App.CommonUtil.getCnByCode("acCrossserverPowerCheerRuleTitle", this.getUiCode());
    };
    AcCrossServerPowerRulePopupView.prototype.isTouchMaskClose = function () {
        return (this.param && this.param.data && this.param.data.touchMaskClose) ? true : false;
    };
    AcCrossServerPowerRulePopupView.prototype.hide = function () {
        _super.prototype.hide.call(this);
    };
    AcCrossServerPowerRulePopupView.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcCrossServerPowerRulePopupView;
}(PopupView));
__reflect(AcCrossServerPowerRulePopupView.prototype, "AcCrossServerPowerRulePopupView");
//# sourceMappingURL=AcCrossServerPowerCheerRulePopupView.js.map