 ...
 * desc : 积分兑换itemrender
 */
var AcCrossServerPowerCheerViewScrollItem4 = /** @class */ (function (_super) {
    __extends(AcCrossServerPowerCheerViewScrollItem4, _super);
    function AcCrossServerPowerCheerViewScrollItem4() {
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewScrollItem4.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewScrollItem4.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewScrollItem4.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewScrollItem4.prototype, "cfg", {
        get: function () {
    ...
    AcCrossServerPowerCheerViewScrollItem4.prototype.initItem = function (index, data, itemparam) {
    ...
    AcCrossServerPowerCheerViewScrollItem4.prototype.buyHandler = function (evt) {
        var vo = this.vo;
        if (!vo) {
            return;
        }
        ...
        if (have < cost) {
            if (this._data.isItem) {
                App.CommonUtil.showTip(LanguageManager.getlocal("croessServerPowerExchangeNoEnough"));
            }
            else {
        ...
        if (this._data.isItem) {
            NetManager.request(NetRequestConst.REQUEST_ACTIVITY_CROSSPOWER_SHOP2EXCHANGE, {
            ...
            NetManager.request(NetRequestConst.REQUEST_ACTIVITY_CROSSPOWER_SHOPBUY, {
                activeId: this.vo.aidAndCode,
                rkey: this._data.id,
                num: 1
            });
    ...
    AcCrossServerPowerCheerViewScrollItem4.prototype.getSpaceX = function () {
        return 0;
    };
    AcCrossServerPowerCheerViewScrollItem4.prototype.getSpaceY = function () {
        return 10;
    };
    AcCrossServerPowerCheerViewScrollItem4.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return AcCrossServerPowerCheerViewScrollItem4;
}(ScrollListItem));
//# sourceMappingURL=AcCrossServerPowerCheerViewScrollItem4.js.map