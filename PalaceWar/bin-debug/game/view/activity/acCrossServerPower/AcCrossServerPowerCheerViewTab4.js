...
//人气商店
var AcCrossServerPowerCheerViewTab4 = /** @class */ (function (_super) {
    __extends(AcCrossServerPowerCheerViewTab4, _super);
    function AcCrossServerPowerCheerViewTab4(data) {
    ...
    AcCrossServerPowerCheerViewTab4.prototype.getUiCode = function () {
        var code = "";
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewTab4.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewTab4.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewTab4.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewTab4.prototype, "cfg", {
        get: function () {
    ...
    AcCrossServerPowerCheerViewTab4.prototype.initView = function () {
        var baseView = ViewController.getInstance().getView("AcCrossServerPowerCheerView");
        this.height = baseView.tabHeight;
        this.width = GameConfig.stageWidth;
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSPOWER_SHOPBUY, this.refreshData, this);
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSPOWER_SHOP2EXCHANGE, this.refreshData, this);
        ...
        var scoreIcon1 = BaseBitmap.create("itemicon" + needId);
        scoreIcon1.setScale(0.5);
        this.addChild(scoreIcon1);
        App.DisplayUtil.setLayoutPosition(LayoutConst.leftverticalCenter, scoreIcon1, scoreNumBg, [-3, 0]);
        ...
        this.addChild(info);
        this._info2 = info;
        this._info1 = ComponentManager.getTextField(LanguageManager.getlocal("croessServerPowerExchangeTxt"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
        ...
        var scrollList = ComponentManager.getScrollList(AcCrossServerPowerCheerViewScrollItem4, [], tmpRect, { aid: this.aid, code: this.code });
    ...
    AcCrossServerPowerCheerViewTab4.prototype.tick = function () {
        if (this._timeDown) {
    ...
    AcCrossServerPowerCheerViewTab4.prototype.refreshData = function (event) {
        if (event) {
    ...
    AcCrossServerPowerCheerViewTab4.prototype.checkRed = function () {
    ...
    AcCrossServerPowerCheerViewTab4.prototype.refreshView = function () {
        this.freshList();
    ...
    AcCrossServerPowerCheerViewTab4.prototype.formatFlagScoreShopCfg = function () {
    ...
    AcCrossServerPowerCheerViewTab4.prototype.formatFlagScoreShop2Cfg = function () {
    ...
    AcCrossServerPowerCheerViewTab4.prototype.getTabbarTextArr = function () {
        return ["croessServerPowerTab1", "croessServerPowerTab2"];
    };
    AcCrossServerPowerCheerViewTab4.prototype.initTabbarGroup = function () {
    ...
    AcCrossServerPowerCheerViewTab4.prototype.clickTabbarHandler = function (data) {
        _super.prototype.clickTabbarHandler.call(this, data);
        var index = Number(data.index);
        this.tabbarHandler(index);
    };
    AcCrossServerPowerCheerViewTab4.prototype.tabbarHandler = function (index) {
    ...
    AcCrossServerPowerCheerViewTab4.prototype.freshList = function () {
        if (this._index == 0) {
    ...
    AcCrossServerPowerCheerViewTab4.prototype.addTabbarGroupBg = function () {
        return true;
    };
    AcCrossServerPowerCheerViewTab4.prototype.getTabbarName = function () {
        return ButtonConst.BTN_BIG_TAB2;
    };
    AcCrossServerPowerCheerViewTab4.prototype.dispose = function () {
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSPOWER_SHOPBUY, this.refreshData, this);
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSPOWER_SHOP2EXCHANGE, this.refreshData, this);
    ...
    return AcCrossServerPowerCheerViewTab4;
}(CommonViewTab));
//# sourceMappingURL=AcCrossServerPowerCheerViewTab4.js.map