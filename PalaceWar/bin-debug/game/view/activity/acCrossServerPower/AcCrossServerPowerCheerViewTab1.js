...
//衣装预览
var AcCrossServerPowerCheerViewTab1 = (function (_super) {
    __extends(AcCrossServerPowerCheerViewTab1, _super);
    function AcCrossServerPowerCheerViewTab1(data) {
    ...
    AcCrossServerPowerCheerViewTab1.prototype.getUiCode = function () {
        var code = "";
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewTab1.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewTab1.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewTab1.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerViewTab1.prototype, "cfg", {
        get: function () {
    ...
    AcCrossServerPowerCheerViewTab1.prototype.initView = function () {
        ...
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSPOWER_EXCHANGE, this.exchangeCallback, this);
        var bg = BaseLoadBitmap.create(App.CommonUtil.getResByCode("crosspowerenterbg", this.getUiCode()));
        this.addChild(bg);
        ...
        if ((!Api.switchVoApi.checkCloseBone()) && skinBoneName && RES.hasRes(skinBoneName) && App.CommonUtil.check_dragon()) {
            ...
            skin.setScale(1.1);
            skin.setPosition(GameConfig.stageWidth / 2, exchangeContainer.y + 10);
            this.addChild(skin);
        }
        else {
            ...
            skinImg.y = exchangeContainer.y + 10;
        ...
        //skinFlag
        var skinFlag = BaseBitmap.create(App.CommonUtil.getResByCode("accrosspower_skinflag", this.code));
        ...
        //skin info
        var skinGetInfo = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossServerPowerSkinGet", this.getUiCode(), "7")), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
        ...
        var exchangeTip = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossServerPowerSkinChangeInfo", this.getUiCode(), "7"), ["" + toolItemVo.num, toolItemVo.name]), TextFieldConst.FONTSIZE_ACTIVITY_COMMON, TextFieldConst.COLOR_BROWN);
    ...
    AcCrossServerPowerCheerViewTab1.prototype.exchangeBtnClick = function () {
        if (!this.vo.isStart) {
        ...
        if (currNum >= toolItemVo.num) {
            //兑换
            NetManager.request(NetRequestConst.REQUEST_ACTIVITY_CROSSPOWER_EXCHANGE, { activeId: this.vo.aidAndCode });
        }
    };
    AcCrossServerPowerCheerViewTab1.prototype.showSkinDetailInfo = function () {
        var _this = this;
    ...
    AcCrossServerPowerCheerViewTab1.prototype.exchangeCallback = function (event) {
        if (!event.data.ret) {
            return;
        }
    ...
    AcCrossServerPowerCheerViewTab1.prototype.refreshView = function () {
        var toolItemVo = GameData.formatRewardItem(this.cfg.change.needNum)[0];
        var toolData = Api.itemVoApi.getItemInfoVoById(toolItemVo.id);
        var currNum = 0;
        if (toolData) {
    ...
    AcCrossServerPowerCheerViewTab1.prototype.dispose = function () {
        App.MessageHelper.removeNetMessage(MessageConst.MESSAGE_MODEL_ACTIVITY, this.refreshView, this);
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACTIVITY_CROSSPOWER_EXCHANGE, this.exchangeCallback, this);
        this._progress = null;
        this._exchangeBtn = null;
        this._isUp = false;
        _super.prototype.dispose.call(this);
    };
    return AcCrossServerPowerCheerViewTab1;
}(CommonViewTab));
__reflect(AcCrossServerPowerCheerViewTab1.prototype, "AcCrossServerPowerCheerViewTab1");
//# sourceMappingURL=AcCrossServerPowerCheerViewTab1.js.map