 ...
 * author ycg
 * date 2020.4.21
 * @class AcCrossServerPowerCheerUseFlagPopupView
 */
var AcCrossServerPowerCheerUseFlagPopupView = (function (_super) {
    __extends(AcCrossServerPowerCheerUseFlagPopupView, _super);
    function AcCrossServerPowerCheerUseFlagPopupView() {
    ...
    Object.defineProperty(AcCrossServerPowerCheerUseFlagPopupView.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerUseFlagPopupView.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerUseFlagPopupView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerUseFlagPopupView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossServerPowerCheerUseFlagPopupView.prototype, "uiType", {
        get: function () {
            return "2";
        },
        enumerable: true,
    ...
    AcCrossServerPowerCheerUseFlagPopupView.prototype.getBgExtraHeight = function () {
        return 25;
    };
    AcCrossServerPowerCheerUseFlagPopupView.prototype.getFrameName = function () {
        return "popup_frame1";
    };
    AcCrossServerPowerCheerUseFlagPopupView.prototype.initView = function () {
        ...
        var confirmTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverPowerUseFlagConfirm", this.code), ["1", this._name, String(this.cfg.flagScoreNum1)]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BROWN);
    ...
    AcCrossServerPowerCheerUseFlagPopupView.prototype.dragCallback = function (curNum) {
        this._useNum = curNum;
        this._selectedNumTF.text = this._useNum + "";
        var numTFW = this._selectedNumTF.width + this._maxNumTF.width;
        this._selectedNumTF.x = this._numBg.x + (this._numBg.width - numTFW) / 2;
        this._maxNumTF.x = this._selectedNumTF.x + this._selectedNumTF.width;
        this._confirmTxt.text = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossserverPowerUseFlagConfirm", this.code), ["" + this._useNum, this._name, String(this.cfg.flagScoreNum1 * this._useNum)]);
        this._confirmTxt.x = this.viewBg.width / 2 - this._confirmTxt.width / 2;
    };
    AcCrossServerPowerCheerUseFlagPopupView.prototype.useHandler = function (param) {
        if (!this.vo.isInActivity()) {
            this.vo.showAcEndTip();
            return;
        }
        NetManager.request(NetRequestConst.REQUEST_ACTIVITY_CROSSPOWER_USEFLAG, { activeId: this.vo.aidAndCode, fuid: this.param.data.fuid, num: this._useNum });
        this.hide();
    };
    AcCrossServerPowerCheerUseFlagPopupView.prototype.cancelHandler = function (param) {
        this.hide();
    };
    AcCrossServerPowerCheerUseFlagPopupView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "progress2", "progress20_bg", "popupview_itemsbg",
        ]);
    };
    AcCrossServerPowerCheerUseFlagPopupView.prototype.dispose = function () {
        this._useNum = 1;
    ...
    return AcCrossServerPowerCheerUseFlagPopupView;
}(PopupView));
__reflect(AcCrossServerPowerCheerUseFlagPopupView.prototype, "AcCrossServerPowerCheerUseFlagPopupView");
//# sourceMappingURL=AcCrossServerPowerCheerUseFlagPopupView.js.map