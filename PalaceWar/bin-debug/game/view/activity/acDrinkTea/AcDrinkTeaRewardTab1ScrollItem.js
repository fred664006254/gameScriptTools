...
var AcDrinkTeaRewardTab1ScrollItem = (function (_super) {
    __extends(AcDrinkTeaRewardTab1ScrollItem, _super);
    function AcDrinkTeaRewardTab1ScrollItem() {
    ...
    Object.defineProperty(AcDrinkTeaRewardTab1ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcDrinkTeaRewardTab1ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcDrinkTeaRewardTab1ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcDrinkTeaRewardTab1ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcDrinkTeaRewardTab1ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
     ...
     * 初始化itemview
     */
    AcDrinkTeaRewardTab1ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        this._itemData = data;
        ...
        if (this.vo.isGetRecharge(String(data.id))) {
            ...
            if (currChargeGem >= data.needGem) {
                ...
                var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                    ...
                    NetManager.request(NetRequestConst.REQUEST_DRINKTEA_GETRECHARGE, { activeId: _this.vo.aidAndCode, rkey: Number(data.id) });
                }, this);
    ...
    AcDrinkTeaRewardTab1ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcDrinkTeaRewardTab1ScrollItem.prototype.dispose = function () {
        this._itemData = null;
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcDrinkTeaRewardTab1ScrollItem;
}(ScrollListItem));
__reflect(AcDrinkTeaRewardTab1ScrollItem.prototype, "AcDrinkTeaRewardTab1ScrollItem");
//# sourceMappingURL=AcDrinkTeaRewardTab1ScrollItem.js.map