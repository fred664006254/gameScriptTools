...
var AcSkySoundRewardTab2ScrollItem = (function (_super) {
    __extends(AcSkySoundRewardTab2ScrollItem, _super);
    function AcSkySoundRewardTab2ScrollItem() {
        var _this = _super.call(this) || this;
        _this._aid = null;
        _this._code = null;
        return _this;
    }
    Object.defineProperty(AcSkySoundRewardTab2ScrollItem.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcSkySoundRewardTab2ScrollItem.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcSkySoundRewardTab2ScrollItem.prototype, "code", {
        get: function () {
            return this._code;
        },
        enumerable: true,
    ...
    Object.defineProperty(AcSkySoundRewardTab2ScrollItem.prototype, "aid", {
        get: function () {
            return this._aid;
        },
        enumerable: true,
    ...
    AcSkySoundRewardTab2ScrollItem.prototype.getTypeCode = function () {
        if (this.code == "2") {
            return "1";
        }
        return this.code;
    };
    AcSkySoundRewardTab2ScrollItem.prototype.initItem = function (index, data, itemParam) {
        var _this = this;
        ...
        bg.y = titleBg.y + 13;
        //title txt
        var titleTxtStr = LanguageManager.getlocal("acSkySoundAchievementItemInfo", ["" + data.needNum]);
        ...
        if (this.vo.isGetAchievementById(data.id)) {
            ...
            var reviceBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "taskCollect", function () {
                ...
                NetManager.request(NetRequestConst.REQUEST_ACSKYSOUND_GETSOUNDNUM, { activeId: _this.vo.aidAndCode, rkey: data.id });
            }, this);
    ...
    AcSkySoundRewardTab2ScrollItem.prototype.getSpaceX = function () {
        return 0;
    };
    /**
     * 不同格子Y间距
     */
    AcSkySoundRewardTab2ScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    AcSkySoundRewardTab2ScrollItem.prototype.dispose = function () {
        this._aid = null;
        this._code = null;
        _super.prototype.dispose.call(this);
    };
    return AcSkySoundRewardTab2ScrollItem;
}(ScrollListItem));
__reflect(AcSkySoundRewardTab2ScrollItem.prototype, "AcSkySoundRewardTab2ScrollItem");
//# sourceMappingURL=AcSkySoundRewardTab2ScrollItem.js.map