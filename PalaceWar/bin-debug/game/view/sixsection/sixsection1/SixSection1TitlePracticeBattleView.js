...
var SixSection1TitlePracticeBattleView = /** @class */ (function (_super) {
    __extends(SixSection1TitlePracticeBattleView, _super);
    function SixSection1TitlePracticeBattleView() {
    ...
    SixSection1TitlePracticeBattleView.prototype.getSoundBgName = function () {
        return SoundConst.MUSIC_CHALLENGE;
    };
    SixSection1TitlePracticeBattleView.prototype.getCloseBtnName = function () {
        return null;
    };
    SixSection1TitlePracticeBattleView.prototype.getTitleStr = function () {
        return null;
    };
    SixSection1TitlePracticeBattleView.prototype.getTitleBgName = function () {
        return null;
    };
    SixSection1TitlePracticeBattleView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "arena_bg", "atkrace_skip", 'specialview_commoni_namebg', "atkrace_battle_info", "progress7_bg", "progress8",
        ]);
    };
    SixSection1TitlePracticeBattleView.prototype.getBgName = function () {
        return "arena_bg";
    };
    SixSection1TitlePracticeBattleView.prototype.isShowOpenAni = function () {
        return false;
    };
    SixSection1TitlePracticeBattleView.prototype.initView = function () {
    ...
    Object.defineProperty(SixSection1TitlePracticeBattleView.prototype, "upPlayerInfo", {
        get: function () {
            //上方信息 敌对
    ...
    Object.defineProperty(SixSection1TitlePracticeBattleView.prototype, "downPlayerInfo", {
        get: function () {
            //下方玩家 自己 主视角
    ...
    SixSection1TitlePracticeBattleView.prototype.skipBattle = function () {
        if (this._isEnd != true) {
            if (!this._skip) {
                if (this._type != 1) {
                    this._curRound = 5;
    ...
    SixSection1TitlePracticeBattleView.prototype.initBattleInfo = function () {
        this.roundBeginAnim();
    };
    SixSection1TitlePracticeBattleView.prototype.roundBeginAnim = function () {
        this._curRound++;
        if (this._upHero) {
    ...
    SixSection1TitlePracticeBattleView.prototype.removeRoundAnim = function () {
    ...
    SixSection1TitlePracticeBattleView.prototype.roundBegin = function () {
    ...
    SixSection1TitlePracticeBattleView.prototype.showWinBattle = function (str, isup, ismiddle) {
        ...
        descbg.height = 92;
        descbg.width = 392;
        App.LogUtil.log("showWinBattle " + descbg);
        if (ismiddle) {
    ...
    SixSection1TitlePracticeBattleView.prototype.getCurRoundData = function (round) {
     ...
     * 开始一回合战斗
     */
    SixSection1TitlePracticeBattleView.prototype.showRound = function () {
        var _this = this;
    ...
    SixSection1TitlePracticeBattleView.prototype.atkEndCallback = function () {
    ...
    SixSection1TitlePracticeBattleView.prototype.showEndGameBefore = function () {
        var failMan;
        if (this._winFlag == 1) {
    ...
    SixSection1TitlePracticeBattleView.prototype.showEndGame = function () {
        if (this._isEnd) {
            return;
        }
        // if (this._type == 1)
    ...
    //真结束
    SixSection1TitlePracticeBattleView.prototype.battleEnd = function () {
        this._isEnd = true;
        this._isPause = true;
        ViewController.getInstance().openView(ViewConst.COMMON.SIXSECTION1TITLEBATTLERESULTVIEW, { f: this.hide, o: this, type: this._winFlag });
    };
    SixSection1TitlePracticeBattleView.prototype.battleCallbackEnd = function () {
        this._fuction.apply(this._obj, [this._type]);
        this.hide();
    };
    //给icon贴上 胜 或 负
    SixSection1TitlePracticeBattleView.prototype.showMaskAndWin = function (round) {
    };
    SixSection1TitlePracticeBattleView.prototype.dispose = function () {
        this._isEnd = false;
        this._type = 0;
        this._curRound = 0;
        this._fuction = null;
    ...
    return SixSection1TitlePracticeBattleView;
}(BaseBattleView));
//# sourceMappingURL=SixSection1TitlePracticeBattleView.js.map