 ...
 *
 */
var SixSection1TitleBattleView = (function (_super) {
    __extends(SixSection1TitleBattleView, _super);
    function SixSection1TitleBattleView() {
    ...
    SixSection1TitleBattleView.prototype.getResourceList = function () {
        return _super.prototype.getResourceList.call(this).concat([
            "atkrace_battle_info", "arena_bg", "battle_attack_anim"
        ]);
    };
    SixSection1TitleBattleView.prototype.getBgName = function () {
        return "arena_bg";
    };
    SixSection1TitleBattleView.prototype.getTitleStr = function () {
        return "studyatkBattleViewTitle";
    };
    SixSection1TitleBattleView.prototype.initView = function () {
    ...
    SixSection1TitleBattleView.prototype.showRound = function () {
    ...
    SixSection1TitleBattleView.prototype.showDialog = function () {
        if (this._curRound % 2 == 0) {
    ...
    SixSection1TitleBattleView.prototype.resetContainer = function () {
        this.removeChildFromContainer(this._rattleContainer);
        this.showRound();
    };
    SixSection1TitleBattleView.prototype.showEnd = function () {
        var heroArray = [];
        var scaleTo = 0.4;
        var moveY;
        var offsetY;
    ...
    SixSection1TitleBattleView.prototype.showBeAttackAnim = function () {
        var offsetY;
        var beAttackHero;
        if (this._winCode == 1) {
    ...
    SixSection1TitleBattleView.prototype.clipEndCallback = function () {
        if (this._beAttackClip) {
            this.removeChildFromContainer(this._beAttackClip);
        }
    };
    SixSection1TitleBattleView.prototype.showBattleRsult = function () {
        var dialogType;
    ...
    SixSection1TitleBattleView.prototype.initDialogBg = function () {
    ...
    SixSection1TitleBattleView.prototype.initDialog = function () {
        ...
        var myKey = this._myInfo[0].topTitle ? this._myInfo[0].topTitle.sortKey : null;
        var titleinfo = App.CommonUtil.getTitleData(myKey);
        var myTitleCfg = Config.TitleCfg.getTitleCfgById(titleinfo.title);
        var otherKey = this._myInfo[1].topTitle ? this._myInfo[1].topTitle.sortKey : null;
        var othertitleinfo = App.CommonUtil.getTitleData(otherKey);
    ...
    // idx 0 下面  1 上面
    SixSection1TitleBattleView.prototype.getPlayerContainer = function (idx) {
     ...
     *
     */
    SixSection1TitleBattleView.prototype.getDialogType = function () {
        var dialogType;
        var myInfo = this._myInfo[0];
        var otherInfo = this._myInfo[1];
        var myTitle = myInfo.topTitle ? myInfo.topTitle.sortKey : null;
        var titleinfo = App.CommonUtil.getTitleData(myTitle);
        var myTitleCfg = Config.TitleCfg.getTitleCfgById(titleinfo.title);
        var otherTitle = otherInfo.topTitle ? otherInfo.topTitle.sortKey : null;
        var othertitleinfo = App.CommonUtil.getTitleData(otherTitle);
    ...
    SixSection1TitleBattleView.prototype.dispose = function () {
    ...
    return SixSection1TitleBattleView;
}(CommonView));
__reflect(SixSection1TitleBattleView.prototype, "SixSection1TitleBattleView");
//# sourceMappingURL=SixSection1TitleBattleView.js.map