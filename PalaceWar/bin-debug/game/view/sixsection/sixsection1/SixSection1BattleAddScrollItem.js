 ...
 *
 */
var SixSection1BattleAddScrollItem = /** @class */ (function (_super) {
    __extends(SixSection1BattleAddScrollItem, _super);
    function SixSection1BattleAddScrollItem() {
        return _super.call(this) || this;
    }
    SixSection1BattleAddScrollItem.prototype.initItem = function (index, data) {
        this.width = 600;
        this.height = 148;
        ...
        var zizhi = ComponentManager.getTextField(LanguageManager.getlocal("sixSection1BattleDetail_zizhi", [String(data.needv)]), 18, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var strr = LanguageManager.getlocal("sixSection1BattleDetail_itembuff" + data.type, [String(vv)]);
        ...
        var getBtn = ComponentManager.getButton(ButtonConst.BTN2_SMALL_YELLOW, "allianceBtnCheck", function () {
            ViewController.getInstance().openView(ViewConst.POPUP.SIXSECTION1BATTLEADDDETAILPOPUPVIEW, {
                info: data
            });
        }, this);
        getBtn.x = 440;
    ...
    SixSection1BattleAddScrollItem.prototype.getSpaceY = function () {
        return 5;
    };
    return SixSection1BattleAddScrollItem;
}(ScrollListItem));
//# sourceMappingURL=SixSection1BattleAddScrollItem.js.map