...
var AllianceInfoPopupView = (function (_super) {
    ...
    function AllianceInfoPopupView() {
        ...
        _this._newTex = "";
        _this._userIdtxt = null;
        _this._infoMaxNum = 0;
        _this._inputMaxText = null;
        _this._inputMaxText2 = null;
        return _this;
    }
    AllianceInfoPopupView.prototype.initView = function () {
        ...
        var inputTF2 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 45, "public_9_bg5", LanguageManager.getlocal(isEn ? "allianceCreateWeixinholder2" : "allianceCreateWeixinholder"), 0xb1b1b1, allianceVo.cweixin);
        ...
        var inputTF3 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_TITLE_SMALL, 466, 45, "public_9_bg5", LanguageManager.getlocal(isEn ? "allianceCreateQQholder2" : "allianceCreateQQholder"), 0xb1b1b1, allianceVo.cqq);
        ...
        var inputMaxText = ComponentManager.getTextField(LanguageManager.getlocal("allianceSurplus", [newfontNum + ""]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var inputMaxText2 = ComponentManager.getTextField(LanguageManager.getlocal("allianceSurplus", [newfontNum2 + ""]), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var inputTF5 = ComponentManager.getInputTextField(TextFieldConst.COLOR_WHITE, TextFieldConst.FONTSIZE_CONTENT_COMMON, 466, 100, "public_9_probiginnerbg", LanguageManager.getlocal("allianceCreateMsgholder", [this._infoMaxNum + ""]), 0xb1b1b1, allianceVo.intro);
    ...
    //对内
    AllianceInfoPopupView.prototype.callbackInput = function (event) {
        ...
        var newlength1 = this._infoMaxNum - _length;
        if (newlength1 < 0) {
            newlength1 = 0;
        }
    ...
    //对外
    AllianceInfoPopupView.prototype.callbackInput2 = function (event) {
...
//# sourceMappingURL=AllianceInfoPopupView.js.map