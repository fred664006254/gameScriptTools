 ...
 */
var AllianceCreateView = /** @class */ (function (_super) {
    ...
    AllianceCreateView.prototype.initView = function () {
        ...
        if (taskId && taskCfg) {
            if (taskCfg.questType == 604 || taskCfg.questType == 701 || taskCfg.questType == 702 || taskCfg.questType == 703) {
                this._mainTaskHandKey = App.MainTaskHandUtil.addHandNode(this.container, randomBtn.x + randomBtn.width / 2 - 10, randomBtn.y + 10, [randomBtn], taskCfg.questType, true, function () {
                    return true;
                }, this);
            }
        }
    ...
    AllianceCreateView.prototype.getRuleInfo = function () {
    ...
    AllianceCreateView.prototype.getExtraRuleInfo = function () {
        var params = [];
...
//# sourceMappingURL=AllianceCreateView.js.map