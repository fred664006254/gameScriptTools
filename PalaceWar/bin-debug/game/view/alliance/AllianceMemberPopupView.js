...
var AllianceMemberPopupView = (function (_super) {
    ...
    AllianceMemberPopupView.prototype.initView = function () {
        // this._openType = this.param.data.openType;
        ...
        this._memberText.x = 30 + GameData.popupviewOffsetX;
    ...
    AllianceMemberPopupView.prototype.quitAlliance = function (evt) {
        if (!evt.data.ret) {
            return;
        }
        this.hide();
...
//# sourceMappingURL=AllianceMemberPopupView.js.map