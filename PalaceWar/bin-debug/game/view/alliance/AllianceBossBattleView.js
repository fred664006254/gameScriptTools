...
var AllianceBossBattleView = (function (_super) {
    ...
    AllianceBossBattleView.prototype.initView = function () {
        ...
        var curValue = Api.allianceVoApi.getBossHp(this._eliteidx == null ? this._idx : this._eliteidx);
        this.resetTopKey();
        var proType = 2;
        if (limitlessBossId && limitlessBossId == this._idx) {
            proType = 3;
        ...
        var servantName = ComponentManager.getTextField(LanguageManager.getlocal("allianceBoss_monsterName" + id), TextFieldConst.FONTSIZE_TITLE_SMALL, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        if (autoBattleNeedVipLv != null) {
            if (Api.playerVoApi.getPlayerVipLevel() < autoBattleNeedVipLv) {
                var reachText = ComponentManager.getTextField(LanguageManager.getlocal("autoBattleTip_AllianceDungeon", [String(autoBattleNeedVipLv)]), TextFieldConst.FONTSIZE_CONTENT_SMALL);
    ...
    AllianceBossBattleView.prototype.refreshDecreeAtrr = function () {
        var addInfo = Api.allianceVoApi.getDecreePolicyAddAttrInfo();
        if (addInfo) {
            ...
            if (addInfo.lastTimes > 0) {
                ...
                var addV = (addInfo.addExtent * 100).toFixed(1) + "%";
...
//# sourceMappingURL=AllianceBossBattleView.js.map