...
var WelfareViewYearCard = (function (_super) {
    ...
    function WelfareViewYearCard() {
        ...
        _this._descTF = null;
        _this._oldPriceText = null;
        _this._acTimeTF = null;
        _this._lineShape = null;
        _this._descSp = null;
        _this.img_des6 = null;
        _this.hasGetSp = null;
        _this.cardTimedeTxt = null;
        return _this;
    }
    WelfareViewYearCard.prototype.init = function () {
        _super.prototype.init.call(this);
        var acDiscountVo = Api.acVoApi.checkIsYearCardDiscount();
        ...
        if (Api.switchVoApi.checkOpenNewMonthCardAndYearCard()) {
            ...
            if (!PlatformManager.checkIsThSp()) {
                var rewardName1 = ComponentManager.getTextField(LanguageManager.getlocal("servant_name1034"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_QUALITY_WHITE);
                ...
                var rewardName2 = ComponentManager.getTextField(LanguageManager.getlocal("wifeName_303"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_QUALITY_WHITE);
            ...
            if (acDiscountVo && (!Api.switchVoApi.checkCloseYearCardTip())) {
                var tipTF = ComponentManager.getTextField(LanguageManager.getlocal("welfareViewYearCardDiscountTip"), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_WARN_RED);
                ...
                if (Api.switchVoApi.checkOpenNewMonthCardAndYearCard() || (acDiscountVo)) {
                    ...
                    if (Api.switchVoApi.checkOpenNewMonthCardAndYearCard()) {
                        ...
                        if (acDiscountVo) {
                            ...
                            var et = void 0;
                            var loopTime = Number(Config.GameprojectCfg.cycle[acDiscountVo.aid + "_" + acDiscountVo.code]);
                            if (Api.switchVoApi.checkOpenDiscountLoopTime()) {
                                var et2 = GameData.serverTime - (GameData.serverTime - acDiscountVo.st) % (loopTime) + loopTime;
                    ...
                    var gStr = "";
                    var cfg = Config.AcCfg.getCfgByActivityIdAndCode(AcConst.AID_ACDISCOUNT, "2");
                    var cfg2 = Config.AcCfg.getCfgByActivityIdAndCode(AcConst.AID_ACDISCOUNT, "3");
                    if (cfg) {
                    ...
                    var rechargeItemCurrentCfg = Config.RechargeCfg.getRechargeItemCfgByKey(gStr);
    ...
    WelfareViewYearCard.prototype.tick = function () {
        ...
        if (acDiscountVo) {
            ...
            if (this._openDialogDiscountEnabled) {
                ...
                this._openDialogDiscountEnabled = false;
                var rechargeItemCurrentCfg = Config.RechargeCfg.getRechargeItemCfgByKey("g8");
                this._goToRechargeBtn.setText(LanguageManager.getlocal("anyMoney", [rechargeItemCurrentCfg.cost.toString()]), false);
    ...
    WelfareViewYearCard.prototype.showText = function (num) {
        if (num === void 0) { num = 0; }
        //年卡有效期
    ...
    WelfareViewYearCard.prototype.getResPreName = function () {
        if (Api.switchVoApi.checkOpenNewMonthCardAndYearCard()) {
            return "yearcard_2";
        }
        else {
...
//# sourceMappingURL=WelfareViewYearCard.js.map