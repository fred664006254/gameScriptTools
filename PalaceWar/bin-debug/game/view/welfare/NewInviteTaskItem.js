 ...
 * author qianjun
 */
var NewInviteTaskItem = (function (_super) {
    __extends(NewInviteTaskItem, _super);
    function NewInviteTaskItem() {
        return _super.call(this) || this;
    }
    NewInviteTaskItem.prototype.initItem = function (index, data, itemparam) {
        var view = this;
        view.width = 480;
        view.height = 225;
        ...
        view.addChild(Txt1);
        var box = BaseBitmap.create("newinviterewardbox");
        box.addTouchTap(function () {
            ViewController.getInstance().openView(ViewConst.POPUP.NEWINVITEREWARDPOPUPVIEW, {
        ...
        var friendnum = data.type == "invite" ? tmpVo.getInviteFriendNum() : tmpVo.getInvitePowerNum(cfg.needPower);
        ...
        if (flag) {
            ...
            collectBtn_1.setGray(friendnum < cfg.value);
        }
    };
    NewInviteTaskItem.prototype.dispose = function () {
        _super.prototype.dispose.call(this);
    };
    return NewInviteTaskItem;
}(ScrollListItem));
__reflect(NewInviteTaskItem.prototype, "NewInviteTaskItem");
//# sourceMappingURL=NewInviteTaskItem.js.map