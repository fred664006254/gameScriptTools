...
var WelfareViewRebateScrollItem = (function (_super) {
    ...
    WelfareViewRebateScrollItem.prototype.initItem = function (index, data) {
        ...
        if (index != 0) {
            var titleText = ComponentManager.getTextField(LanguageManager.getlocal("rebateTitle" + index + this.suffixStr), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BLACK);
            titleText.setPosition(temW / 2 - titleText.width / 2 * titleText.scaleX, line1.y);
            this.addChild(titleText);
        }
        var desText = ComponentManager.getTextField(LanguageManager.getlocal("rebateDes" + index + this.suffixStr), TextFieldConst.FONTSIZE_CONTENT_SMALL, TextFieldConst.COLOR_BLACK);
...
//# sourceMappingURL=WelfareViewRebateScrollItem.js.map