 ...
 * 追杀
 */
var AtkraceCrossVisitViewTab3 = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AtkraceCrossVisitViewTab3.prototype, "vo", {
        get: function () {
    ...
    AtkraceCrossVisitViewTab3.prototype.initView = function () {
        ...
        if (lastKillerInfo && lastKillerInfo.uid) {
            ...
            NetManager.request(NetRequestConst.REQUEST_ATKRACECROSS_GETINFO, { "fuid": lastKillerInfo.uid });
    ...
    AtkraceCrossVisitViewTab3.prototype.useCallback = function (data) {
        if (data.data.data.ret == -2) {
            ...
            if (this.vo.checkIsFengyun()) {
                str = LanguageManager.getlocal("atkraceErrordes4_fengyun");
            }
            App.CommonUtil.showTip(str);
            this.refreshView();
        }
...
//# sourceMappingURL=AtkraceCrossVisitViewTab3.js.map