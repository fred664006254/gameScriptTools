...
//助威
var AcCrossAtkraceCheerViewTab2 = /** @class */ (function (_super) {
    __extends(AcCrossAtkraceCheerViewTab2, _super);
    function AcCrossAtkraceCheerViewTab2(param) {
    ...
    AcCrossAtkraceCheerViewTab2.prototype.getUiCode = function () {
        var code = "";
    ...
    Object.defineProperty(AcCrossAtkraceCheerViewTab2.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcCrossAtkraceCheerViewTab2.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcCrossAtkraceCheerViewTab2.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossAtkraceCheerViewTab2.prototype, "cfg", {
        get: function () {
    ...
    AcCrossAtkraceCheerViewTab2.prototype.initView = function () {
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACTIVITY_ATKRACEG_GETFLAGREWARD, this.refreshScore, this);
        App.MessageHelper.addNetMessage(NetRequestConst.REQUEST_ACTIVITY_ATKRACEG_USEFLAG, this.refreshData, this);
        ...
        var flagNum = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossAtkraceCheerflag", this.getUiCode()), [String(fNum)]), 24, TextFieldConst.COLOR_WHITE);
        ...
        var info = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossAtkraceCheerInfo", this.getUiCode())), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_WHITE);
        info.width = 600;
        info.lineSpacing = 5;
        info.x = scoreNum.x;
        ...
        var redPlusTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossAtkraceCheerAddPower", this.getUiCode())), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var playerAddTxt = ComponentManager.getTextField(LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossAtkraceCheerSelfNum", this.getUiCode())), 20, TextFieldConst.COLOR_LIGHT_YELLOW);
        ...
        var list = [];
        var rankData = Api.atkracecrossVoApi.flagRankInfo;
        if (rankData) {
            list = rankData;
        }
        var listH = detailBg.y - redBg.y - redBg.height - 5;
        var rect = new egret.Rectangle(0, 0, 620, listH);
        var scrollList = ComponentManager.getScrollList(AcCrossAtkraceCheerViewScrollItem2, list, rect, { aid: this.aid, code: this.code });
    ...
    AcCrossAtkraceCheerViewTab2.prototype.tick = function () {
        if (this._cheerTip) {
            var cheerTipStr = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossServerPowerCheerNotOpen", this.getUiCode(), "7"));
            var cheerEndTime = this.vo.getCheerEndTime();
            if (GameData.serverTime >= cheerEndTime) {
    ...
    AcCrossAtkraceCheerViewTab2.prototype.refreshView = function () {
        ...
        this._flagNum.text = LanguageManager.getlocal(App.CommonUtil.getCnByCode("acCrossAtkraceCheerflag", this.getUiCode()), [String(this.vo.getFightFlagNum())]);
    ...
    AcCrossAtkraceCheerViewTab2.prototype.refreshScore = function (event) {
    ...
    AcCrossAtkraceCheerViewTab2.prototype.refreshData = function (event) {
        if (event.data && event.data.ret) {
            var d = event.data.data.data;
            var rank = d.atkranks;
            Api.atkracecrossVoApi.setFlagRankInfo(rank);
            this._scrollList.refreshData(rank, { aid: this.param.data.aid, code: this.param.data.code });
            this.refreshView();
        }
    };
    AcCrossAtkraceCheerViewTab2.prototype.scoreBtnClick = function () {
        if (!this.vo.isStart) {
            this.vo.showAcEndTip();
            return;
        }
        if (this.vo.isCanGetFlagScore()) {
            NetManager.request(NetRequestConst.REQUEST_ACTIVITY_ATKRACEG_GETFLAGREWARD, { activeId: this.vo.aidAndCode });
        }
    };
    AcCrossAtkraceCheerViewTab2.prototype.ruleBtnClick = function () {
        ViewController.getInstance().openView(ViewConst.POPUP.ACCROSSATKRACECHEERRULEPOPUPVIEW, {
            aid: this.param.data.aid,
            code: this.param.data.code
        });
    };
    AcCrossAtkraceCheerViewTab2.prototype.dispose = function () {
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACTIVITY_ATKRACEG_GETFLAGREWARD, this.refreshScore, this);
        App.MessageHelper.removeNetMessage(NetRequestConst.REQUEST_ACTIVITY_ATKRACEG_USEFLAG, this.refreshData, this);
    ...
    return AcCrossAtkraceCheerViewTab2;
}(CommonViewTab));
//# sourceMappingURL=AcCrossAtkraceCheerViewTab2.js.map