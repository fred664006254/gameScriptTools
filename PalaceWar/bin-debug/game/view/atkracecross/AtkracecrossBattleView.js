...
var AtkracecrossBattleView = /** @class */ (function (_super) {
    ...
    AtkracecrossBattleView.prototype.requestLoadError = function () {
    ...
    AtkracecrossBattleView.prototype.showSkin = function () {
        var _this = this;
        var view = this;
        var equip = [];
        var servant = Api.servantVoApi.getServantObj(this._oldInfo[0].sid);
    ...
    AtkracecrossBattleView.prototype.checkWeapon = function () {
    ...
    AtkracecrossBattleView.prototype.checkWeaponBack = function (skip) {
    ...
    AtkracecrossBattleView.prototype.showWinBattle = function (str, isup, ismiddle) {
    ...
    AtkracecrossBattleView.prototype.showEndGame = function () {
        ...
        this._isEnd = true;
        if (this._isAttackWin) {
            ViewController.getInstance().openView(ViewConst.BASE.BATTLEWIN, { f: this.endCallBack, o: this, num: this._winNumber, type: 2, fameAdd: 4 });
        }
        else {
...
//# sourceMappingURL=AtkracecrossBattleView.js.map