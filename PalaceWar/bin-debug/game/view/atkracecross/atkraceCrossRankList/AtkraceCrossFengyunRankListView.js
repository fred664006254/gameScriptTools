...
var AtkraceCrossFengyunRankListView = /** @class */ (function (_super) {
    __extends(AtkraceCrossFengyunRankListView, _super);
    function AtkraceCrossFengyunRankListView() {
    ...
    Object.defineProperty(AtkraceCrossFengyunRankListView.prototype, "api", {
        get: function () {
    ...
    AtkraceCrossFengyunRankListView.prototype.getTitleStr = function () {
        return "crossAtkraceRankListViewTitle";
    };
    AtkraceCrossFengyunRankListView.prototype.getResourceList = function () {
    ...
    AtkraceCrossFengyunRankListView.prototype.setTabBarPosition = function () {
        this.tabbarGroup.x = this.viewBg.x + 55;
        this.tabbarGroup.y = this.viewBg.y + 70 - 4 - 16;
    };
    AtkraceCrossFengyunRankListView.prototype.getTabbarTextArr = function () {
        return ["crossAtkraceRankListViewTab1", "crossAtkraceRankListViewTab2"];
    };
    AtkraceCrossFengyunRankListView.prototype.getTabbarName = function () {
        return ButtonConst.BTN2_SMALL_TAB;
    };
    AtkraceCrossFengyunRankListView.prototype.changeTab = function () {
        this._curTabIdx = this.selectedTabIndex;
    ...
    AtkraceCrossFengyunRankListView.prototype.initView = function () {
        ...
        var tabbarGroup = this.tabbarGroup;
        var rankBg = BaseBitmap.create("public_9_bg93");
        rankBg.width = 530;
        rankBg.height = 586;
        rankBg.setPosition(this.viewBg.width / 2 - rankBg.width / 2, tabbarGroup.y + tabbarGroup.height - 60);
        this.addChildToContainer(rankBg);
        var titleBg = BaseBitmap.create("public_9_bg33");
        titleBg.width = rankBg.width;
        titleBg.height = 36;
        titleBg.setPosition(rankBg.x + rankBg.width / 2 - titleBg.width / 2, rankBg.y + 5);
        this.addChildToContainer(titleBg);
        this._scroRect = new egret.Rectangle(titleBg.x, titleBg.y + titleBg.height, titleBg.width, rankBg.height - titleBg.height - 13);
        this._scrollList = ComponentManager.getScrollList(AtkraceCorssFengyunRankItem, this._infoList, this._scroRect);
        ...
        rankText2.setPosition(nickName.x, bottomBg.y + bottomBg.height / 2 + 5);
        ...
        this._scroRect = new egret.Rectangle(titleBg.x, titleBg.y + titleBg.height, titleBg.width, rankBg.height - titleBg.height - 13);
        this._scrollList = ComponentManager.getScrollList(AtkracecrossFengyunServerItem, this._infoList, this._scroRect);
        this._scrollList.x = titleBg.x;
        this._scrollList.y = titleBg.y + titleBg.height;
        this.addChildToContainer(this._scrollList);
        this._scrollList2 = ComponentManager.getScrollList(AtkraceCorssFengyunRankItem, [], this._scroRect);
    ...
    AtkraceCrossFengyunRankListView.prototype.getShowHeight = function () {
        return 830;
    };
    ...
    // 	}
    // }
    AtkraceCrossFengyunRankListView.prototype.fresh_view = function (evt) {
    ...
    AtkraceCrossFengyunRankListView.prototype.tabBtnClickHandler = function (params) {
    ...
    AtkraceCrossFengyunRankListView.prototype.dispose = function () {
        this._merank = 0;
    ...
    return AtkraceCrossFengyunRankListView;
}(PopupView));
//# sourceMappingURL=AtkraceCrossFengyunRankListView.js.map