 ...
 * date 2020.7.8
 * author wxz
 * @class AcCrossAtkraceCheerView
 */
var AcCrossAtkraceCheerView = /** @class */ (function (_super) {
    __extends(AcCrossAtkraceCheerView, _super);
    function AcCrossAtkraceCheerView() {
        var _this = _super.call(this) || this;
        _this._tabHeight = 0;
        return _this;
    }
    AcCrossAtkraceCheerView.prototype.getUiCode = function () {
        var code = "";
    ...
    Object.defineProperty(AcCrossAtkraceCheerView.prototype, "api", {
        get: function () {
    ...
    Object.defineProperty(AcCrossAtkraceCheerView.prototype, "aid", {
        get: function () {
    ...
    Object.defineProperty(AcCrossAtkraceCheerView.prototype, "code", {
        get: function () {
    ...
    Object.defineProperty(AcCrossAtkraceCheerView.prototype, "vo", {
        get: function () {
    ...
    Object.defineProperty(AcCrossAtkraceCheerView.prototype, "cfg", {
        get: function () {
    ...
    Object.defineProperty(AcCrossAtkraceCheerView.prototype, "uiType", {
        get: function () {
            return "2";
        },
        enumerable: true,
    ...
    AcCrossAtkraceCheerView.prototype.getBigFrame = function () {
        return "commonview_bigframe";
    };
    AcCrossAtkraceCheerView.prototype.getTitleBgName = function () {
        return "atkracecross_title2_fengyun";
    };
    AcCrossAtkraceCheerView.prototype.getTitleStr = function () {
        return "";
    };
    AcCrossAtkraceCheerView.prototype.isHideTitleBgShadow = function () {
        return true;
    };
    // protected getCloseBtnName():string{
    //     return ButtonConst.COMMON_CLOSE_1;
    // }
    AcCrossAtkraceCheerView.prototype.getTabbarName = function () {
        return [
    ...
    AcCrossAtkraceCheerView.prototype.getResourceList = function () {
    ...
    AcCrossAtkraceCheerView.prototype.dipose = function () {
    ...
    AcCrossAtkraceCheerView.prototype.getRequestData = function () {
        return { requestType: NetRequestConst.REQUEST_ACTIVITY_ATKRACEG_FLAGRANK, requestData: { activeId: this.vo.aidAndCode } };
    };
    AcCrossAtkraceCheerView.prototype.receiveData = function (data) {
        if (data.ret) {
    ...
    // 初始化tabbarGroup
    AcCrossAtkraceCheerView.prototype.initTabbarGroup = function () {
    ...
    AcCrossAtkraceCheerView.prototype.setTabBarPosition = function () {
        var view = this;
        if (view.tabbarGroup) {
            App.DisplayUtil.setLayoutPosition(LayoutConst.horizontalCentertop, view.tabbarGroup, view.titleBg, [0, view.titleBg.height - 7]);
        }
    };
    Object.defineProperty(AcCrossAtkraceCheerView.prototype, "tabHeight", {
        get: function () {
    ...
    AcCrossAtkraceCheerView.prototype.initView = function () {
        var view = this;
    ...
    AcCrossAtkraceCheerView.prototype.refreshView = function () {
        if (this.tabbarGroup) {
    ...
    return AcCrossAtkraceCheerView;
}(CommonView));
//# sourceMappingURL=AcCrossAtkraceCheerView.js.map