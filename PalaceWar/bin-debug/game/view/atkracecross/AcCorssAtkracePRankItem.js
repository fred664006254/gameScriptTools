 ...
 * desc:个人排行榜单item
*/
var AcCorssAtkracePRankItem = /** @class */ (function (_super) {
    __extends(AcCorssAtkracePRankItem, _super);
    function AcCorssAtkracePRankItem() {
        return _super.call(this) || this;
    }
    AcCorssAtkracePRankItem.prototype.initItem = function (index, data, itemParam) {
        var type = data.type;
        this._data = data;
    ...
    AcCorssAtkracePRankItem.prototype.clickItemHandler = function (event) {
        this.showUserInfo();
    };
    AcCorssAtkracePRankItem.prototype.showUserInfo = function () {
        if (this._data.imacy || this._data.crosspower) {
            var net = NetRequestConst.REQUEST_ATKRACE_USERSHOT;
    ...
    AcCorssAtkracePRankItem.prototype.userShotCallback = function (event) {
    ...
    AcCorssAtkracePRankItem.prototype.dispose = function () {
        this.removeTouchTap();
        _super.prototype.dispose.call(this);
    };
    return AcCorssAtkracePRankItem;
}(ScrollListItem));
//# sourceMappingURL=AcCorssAtkracePRankItem.js.map