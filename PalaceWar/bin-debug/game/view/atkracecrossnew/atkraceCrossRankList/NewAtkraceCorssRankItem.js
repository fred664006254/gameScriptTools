...
var NewAtkraceCorssRankItem = (function (_super) {
    __extends(NewAtkraceCorssRankItem, _super);
    function NewAtkraceCorssRankItem() {
        var _this = _super.call(this) || this;
        _this._data = null;
        return _this;
    }
    NewAtkraceCorssRankItem.prototype.initItem = function (index, data) {
        this.width = 502;
        this.height = 52;
        this._data = data;
        if (index < 3) {
        ...
        var point = String(data.point);
        if (data.point < -8888) {
            point = LanguageManager.getlocal("newatkraceRankLess");
        }
        var scoreTxt = ComponentManager.getTextField(point, TextFieldConst.FONTSIZE_CONTENT_COMMON);
    ...
    NewAtkraceCorssRankItem.prototype.clickItemHandler = function (event) {
        this.showUserInfo();
    };
    NewAtkraceCorssRankItem.prototype.showUserInfo = function () {
    ...
    NewAtkraceCorssRankItem.prototype.userShotCallback = function (event) {
    ...
    NewAtkraceCorssRankItem.prototype.dispose = function () {
        var view = this;
        view.removeTouchTap();
        App.MessageHelper.removeEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_ATKRACE_USERSHOT), this.userShotCallback, this);
    ...
    return NewAtkraceCorssRankItem;
}(ScrollListItem));
__reflect(NewAtkraceCorssRankItem.prototype, "NewAtkraceCorssRankItem");
//# sourceMappingURL=NewAtkraceCorssRankItem.js.map