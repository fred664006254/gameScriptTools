...
var NewAtkracecrossBuyPopupView = /** @class */ (function (_super) {
    __extends(NewAtkracecrossBuyPopupView, _super);
    function NewAtkracecrossBuyPopupView() {
    ...
    NewAtkracecrossBuyPopupView.prototype.getTitleStr = function () {
        return "atkraceBuyPopupViewTitle";
    };
    NewAtkracecrossBuyPopupView.prototype.getRequestData = function () {
    ...
    NewAtkracecrossBuyPopupView.prototype.initView = function () {
     ...
     */
    NewAtkracecrossBuyPopupView.prototype.getBuyTypeContainer = function (info, idx, type) {
    ...
    NewAtkracecrossBuyPopupView.prototype.buyClick = function (idx) {
    ...
    //请求回调
    NewAtkracecrossBuyPopupView.prototype.receiveData = function (data) {
        var rData = data.data;
    ...
    NewAtkracecrossBuyPopupView.prototype.showBuyAnim = function () {
    ...
    NewAtkracecrossBuyPopupView.prototype.dispose = function () {
    ...
    return NewAtkracecrossBuyPopupView;
}(PopupView));
//# sourceMappingURL=NewAtkracecrossBuyPopupView.js.map