...
var NewAtkracecrossActivityRewardViewTab1 = /** @class */ (function (_super) {
    __extends(NewAtkracecrossActivityRewardViewTab1, _super);
    function NewAtkracecrossActivityRewardViewTab1() {
    ...
    Object.defineProperty(NewAtkracecrossActivityRewardViewTab1.prototype, "api", {
        get: function () {
    ...
    Object.defineProperty(NewAtkracecrossActivityRewardViewTab1.prototype, "cfg", {
        get: function () {
            var acode = Api.acVoApi.getActivityVoByAidAndCode("newCrossServerAtkRace").code;
            return Config.AcCfg.getCfgByActivityIdAndCode("newCrossServerAtkRace", acode);
        },
        enumerable: true,
        configurable: true
    });
    NewAtkracecrossActivityRewardViewTab1.prototype.getListType = function () {
        return 1;
    };
    NewAtkracecrossActivityRewardViewTab1.prototype.initView = function () {
        App.MessageHelper.addEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_NEWATKRACEG_WINZIDREWARD), this.collectHandlerCallBack, this);
        ...
        var vo = Api.acVoApi.getActivityVoByAidAndCode("newCrossServerAtkRace");
    ...
    NewAtkracecrossActivityRewardViewTab1.prototype.collectHandler = function () {
        var crossVo = Api.acVoApi.getActivityVoByAidAndCode("newCrossServerAtkRace");
        NetManager.request(NetRequestConst.REQUEST_NEWATKRACEG_WINZIDREWARD, { activeId: "newCrossServerAtkRace-" + crossVo.code });
    };
    NewAtkracecrossActivityRewardViewTab1.prototype.collectHandlerCallBack = function (event) {
    ...
    NewAtkracecrossActivityRewardViewTab1.prototype.tick = function () {
        var vo = Api.acVoApi.getActivityVoByAidAndCode("newCrossServerAtkRace");
        if (this._collectBtn) {
        ...
        if (this._text3) {
            if (GameData.serverTime >= vo.st && GameData.serverTime <= vo.et && GameData.serverTime + 86400 > vo.et) {
                if (this.api.zonerankinfos.length == 2) {
                    if (AtkracecrossActivityRewardView._iszonewin == 1) {
                        this._text3.text = LanguageManager.getlocal("atkracecrossActivityRewardTxt3");
                    }
                    else {
                        this._text3.text = LanguageManager.getlocal("atkracecrossActivityRewardTxt4");
                    }
                }
                else {
                    var rankOrder = 1;
                    ...
                    this._text3.text = LanguageManager.getlocal("atkracecrossActivityRewardTxt7", [rankOrder.toString()]);
                }
            }
            else {
                this._text3.text = LanguageManager.getlocal("atkracecrossActivityRewardTxt6");
            }
        }
    };
    NewAtkracecrossActivityRewardViewTab1.prototype.getCountTimeStr = function (time) {
        if (time < 0) {
            time = 0;
        }
        return App.DateUtil.getFormatBySecond(time);
    };
    NewAtkracecrossActivityRewardViewTab1.prototype.createCollectFlag = function () {
    ...
    NewAtkracecrossActivityRewardViewTab1.prototype.dispose = function () {
        App.MessageHelper.removeEventListener(NetManager.getMessageName(NetRequestConst.REQUEST_NEWATKRACEG_WINZIDREWARD), this.collectHandlerCallBack, this);
    ...
    return NewAtkracecrossActivityRewardViewTab1;
}(CommonViewTab));
//# sourceMappingURL=NewAtkracecrossActivityRewardViewTab1.js.map