 ...
 * 仇人
 */
var NewAtkraceCrossVisitViewTab2 = (function (_super) {
    __extends(NewAtkraceCrossVisitViewTab2, _super);
    function NewAtkraceCrossVisitViewTab2() {
    ...
    NewAtkraceCrossVisitViewTab2.prototype.initView = function () {
    ...
    NewAtkraceCrossVisitViewTab2.prototype.battleCallback = function () {
        NetManager.request(NetRequestConst.REQUEST_ATKRACE_GETMODEL, {});
    };
    NewAtkraceCrossVisitViewTab2.prototype.useCallback = function (data) {
        if (this._scrollList) {
    ...
    NewAtkraceCrossVisitViewTab2.prototype.shownoDataTxt = function () {
        //没有仇人消息
    ...
    NewAtkraceCrossVisitViewTab2.prototype.showList = function () {
        var rect = egret.Rectangle.create();
        rect.setTo(0, 0, 640, 610);
        this._scrollList = ComponentManager.getScrollList(NewActrackCrossVisitTab2Item, this.einList, rect);
        this.addChild(this._scrollList);
        this._scrollList.setPosition(-35, 60);
    };
    NewAtkraceCrossVisitViewTab2.prototype.dispose = function () {
        this.einList = [];
    ...
    return NewAtkraceCrossVisitViewTab2;
}(PopupViewTab));
__reflect(NewAtkraceCrossVisitViewTab2.prototype, "NewAtkraceCrossVisitViewTab2");
//# sourceMappingURL=NewAtkraceCrossVisitViewTab2.js.map