...
var SharePopupView = (function (_super) {
    ...
    SharePopupView.prototype.showNewShareView = function () {
        ...
        var shareTF = ComponentManager.getTextField(LanguageManager.getlocal("sharePopupViewShareGameTip"), TextFieldConst.FONTSIZE_CONTENT_COMMON, TextFieldConst.COLOR_WHITE);
        ...
        var confirmBtn = ComponentManager.getButton(ButtonConst.BTN_BIG_YELLOW, "sharePopupViewTitle", this.showHand, this);
        ...
        //public_searchdescbg
        var txtBg = BaseBitmap.create("public_searchdescbg");
        ...
        var numTxt = ComponentManager.getTextField("", TextFieldConst.FONTSIZE_BUTTON_COMMON, TextFieldConst.COLOR_WHITE);
        if (this._shareNum >= this._allShareNum) {
...
//# sourceMappingURL=SharePopupView.js.map