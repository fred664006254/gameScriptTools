...
var WifestatusScrollItem = (function (_super) {
    ...
    WifestatusScrollItem.prototype.initItem = function (index, data) {
        ...
        // }
        var res = "wifestatus_title" + id + (Api.switchVoApi.checkIsInBlueWife() ? "_male" : "");
    ...
    WifestatusScrollItem.prototype.showIcons = function (index, data) {
        ...
        var _loop_1 = function () {
            ...
            if (Api.switchVoApi.checkOpenBanish() && Api.wifebanishVoApi.getIsWifeBanishing(wifeId)) {
                ...
                banishContainer_1.setPosition(wifeIcon.x + 15, wifeIcon.y + 20);
                statusContanier.addChild(banishContainer_1);
                ...
                var banishInfo = Api.wifebanishVoApi.getBanishInfoVoByWife(wifeId);
        ...
        if (data.id == "1") {
            var _loop_2 = function () {
                ...
                var wifeIcon = this_2.getWifestatusIcon(data, element);
                // wifeIcon.setScale(0.6)
                wifeIcon.x = (wifeIconBaseWidth + 20) * index;
                num = index % 4;
                wifeIcon.x = 10 * (num + 1) + wifeIconBaseWidth * num - 10;
                ...
                if (Api.switchVoApi.checkOpenBanish() && Api.wifebanishVoApi.getIsWifeBanishing(element)) {
                    var banishContainer_2 = new BaseDisplayObjectContainer();
                    banishContainer_2.setPosition(wifeIcon.x + 15, wifeIcon.y + 20);
                    statusContanier.addChild(banishContainer_2);
                    var banishingbg = BaseBitmap.create("public_9_bg60");
                    banishingbg.y = 64;
                    banishingbg.height = 22;
                    banishingbg.width = 50;
                    banishContainer_2.addChild(banishingbg);
                    var banishingbg2 = BaseBitmap.create("public_9_bg60");
                    banishingbg2.y = 64;
                    ...
                    banishingbg2.scaleX = -1;
                    banishingbg2.x = banishingbg.width + banishingbg2.width;
                    banishContainer_2.addChild(banishingbg2);
                    // let banishingText:BaseTextField = ComponentManager.getTextField(LanguageManager.getlocal("banishing")  ,TextFieldConst.FONTSIZE_ACTIVITY_COMMON);
                    // banishingText.setColor(TextFieldConst.COLOR_WARN_GREEN3);
                    // banishingText.setPosition(banishingbg.width-banishingText.width/2,64);
                    // banishContainer.addChild(banishingText);
                    var banishingText = BaseBitmap.create("wife_banishing_text");
                    banishingText.setPosition(banishingbg.width - banishingText.width / 2, 64);
                    banishContainer_2.addChild(banishingText);
                    var banishInfo = Api.wifebanishVoApi.getBanishInfoVoByWife(element);
                    if (banishInfo && banishInfo.et >= GameData.serverTime) {
                        egret.Tween.get(banishContainer_2).wait((banishInfo.et - GameData.serverTime) * 1000).call(function () {
                            banishContainer_2.dispose();
                        });
                    }
                }
            };
    ...
    WifestatusScrollItem.prototype.getWifestatusIcon = function (data, wifeId) {
        ...
        var nameTF = ComponentManager.getTextField(wifeCfg.name, TextFieldConst.FONTSIZE_ACTIVITY_COMMON);
...
//# sourceMappingURL=WifestatusScrollItem.js.map