...
var WifeAllTalentView = (function (_super) {
    ...
    WifeAllTalentView.prototype.initView = function () {
        ...
        App.DisplayUtil.setLayoutPosition(LayoutConst.horizontalCenterverticalCenter, this._allTalentTxt, topInBg);
        ...
        bottomBg.width = 615;
        bottomBg.height = GameConfig.stageHeigth - topBg.height - topBg.y;
        ...
        borderBg.width = 610;
        borderBg.height = bottomBg.height - 40;
        borderBg.x = 320 - borderBg.width / 2;
        borderBg.y = bottomBg.y + 20;
        ...
        var rect = new egret.Rectangle(0, 0, GameConfig.stageWidth, borderBg.height - 15 - 15 - title.height - 10);
...
//# sourceMappingURL=WifeAllTalentView.js.map