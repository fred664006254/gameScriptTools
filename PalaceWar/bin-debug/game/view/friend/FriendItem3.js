...
var FriendItem3 = (function (_super) {
    ...
    FriendItem3.prototype.init = function (bottomH) {
        ...
        var denyBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_RED, "friendsBtnTxt6", this.denyBtnHandler, this);
        ...
        var batchBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, "friendsBtnTxt21", this.batchBtnHandler, this);
    ...
    FriendItem3.prototype.doRefreshList = function () {
        ...
        for (var index = 0; index < receiveList.length; index++) {
            ...
            if (Api.friendVoApi.isInvalidInList3(tmpData.uid)) {
                ...
                uiType = FriendScrollItem.UITYPE3;
...
//# sourceMappingURL=FriendItem3.js.map