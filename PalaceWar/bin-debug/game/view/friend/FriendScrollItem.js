...
var FriendScrollItem = (function (_super) {
    ...
    FriendScrollItem.prototype.initItem = function (index, data, itemParm) {
        this._uiData = data;
        ...
        if (this._uiType == FriendScrollItem.UITYPE1 || this._uiType == FriendScrollItem.UITYPE7) {
            ...
            if (this._uiType == FriendScrollItem.UITYPE7) {
                var adultfriendTxt = ComponentManager.getTextField("allianceTxt", 20, TextFieldConst.COLOR_BROWN);
            ...
            if (Api.switchVoApi.checkOpenPlayerComeBack() && Api.newrebackVoApi.isInviteUid(this._uiData.uid)) {
                var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("playercomebackuserinfo5"), 20, TextFieldConst.COLOR_WARN_GREEN2);
                this.addChild(tipTxt);
                App.DisplayUtil.setLayoutPosition(LayoutConst.lefttop, tipTxt, nameTxt, [nameTxt.textWidth + 5, 0]);
            }
            else if (Api.switchVoApi.checkOpenNewInvite() && Api.newinviteVoApi.isInviteUid(this._uiData.uid)) {
                var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("newinviteuserinfo5"), 20, TextFieldConst.COLOR_WARN_GREEN2);
                this.addChild(tipTxt);
                App.DisplayUtil.setLayoutPosition(LayoutConst.lefttop, tipTxt, nameTxt, [nameTxt.textWidth + 5, 0]);
            }
        }
        ...
        if (onLineTxt) {
            onLineTxt.x = this._bg.x + this._bg.width - 85 - onLineTxt.width / 2;
        }
    };
    ...
    FriendScrollItem.prototype.initUIType3 = function () {
        ...
        var ignoreBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_RED, "friendsBtnTxt16", this.ignoreBtnHandler, this);
        ...
        if (Api.switchVoApi.checkOpenPlayerComeBack() && Api.newrebackVoApi.isInviteUid(this._uiData.uid)) {
            var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("playercomebackuserinfo5"), 20, TextFieldConst.COLOR_WARN_GREEN2);
            this.addChild(tipTxt);
            App.DisplayUtil.setLayoutPosition(LayoutConst.righttop, tipTxt, this._bg, [30, 10]);
        }
        else if (Api.switchVoApi.checkOpenNewInvite() && Api.newinviteVoApi.isInviteUid(this._uiData.uid)) {
            var tipTxt = ComponentManager.getTextField(LanguageManager.getlocal("newinviteuserinfo5"), 20, TextFieldConst.COLOR_WARN_GREEN2);
            this.addChild(tipTxt);
    ...
    FriendScrollItem.prototype.initUIType6 = function () {
        var applyCancelBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_RED, "friendsBtnTxt14", this.applyCancelBtnHandler, this);
        ...
        if (data.data.ret) {
            ...
            if (rData.ret == 0) {
                ...
                if (friendFlag) {
                    ...
                    if (this._uiData && this._uiData.send == 0) {
...
//# sourceMappingURL=FriendScrollItem.js.map