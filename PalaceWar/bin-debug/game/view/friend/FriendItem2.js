...
var FriendItem2 = (function (_super) {
    ...
    FriendItem2.prototype.init = function (bottomH) {
        ...
        var tarWidth = 350;
        var tarHeight = 40;
        var inputTF = ComponentManager.getInputTextField(TextFieldConst.COLOR_QUALITY_GRAY, 18, tarWidth, tarHeight, "public_9_bg5", LanguageManager.getlocal("friends_searchTxt"), TextFieldConst.COLOR_WHITE);
        inputTF.x = 80;
        inputTF.y = 30;
        ...
        var searchBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, "friendsBtnTxt15", this.searchBtnHandler, this);
        ...
        var lineImg = BaseBitmap.create("public_line3");
        lineImg.width = 460;
        lineImg.x = maskbg.x + maskbg.width / 2 - lineImg.width / 2;
        lineImg.y = maskbg.y + maskbg.height / 2 - lineImg.height / 2;
        this.addChild(lineImg);
        var suggestTxt = ComponentManager.getTextField("", 24, TextFieldConst.COLOR_WHITE);
        ...
        var applyBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, "friendsBtnTxt4", this.applyBtnHandler, this);
        ...
        var refreshBtn = ComponentManager.getButton(ButtonConst.BTN_SMALL_YELLOW, "friendsBtnTxt5", this.refreshBtnHandler, this);
...
//# sourceMappingURL=FriendItem2.js.map