...
var AtkraceBattleView = /** @class */ (function (_super) {
    ...
    AtkraceBattleView.prototype.requestLoadError = function () {
    ...
    AtkraceBattleView.prototype.showSkin = function () {
        var _this = this;
        var view = this;
        var equip = [];
        var servant = Api.servantVoApi.getServantObj(this._oldInfo[0].sid);
    ...
    AtkraceBattleView.prototype.checkWeapon = function () {
        ...
        // 	return;
        // }	
        // this.setDownWeaponInfo("1001",0,1);
        // this.setUpWeaponInfo("1001",888,1);
        if (weaponVo) {
    ...
    AtkraceBattleView.prototype.checkWeaponBack = function (skip) {
    ...
    AtkraceBattleView.prototype.showWinBattle = function (str, isup, ismiddle) {
    ...
    AtkraceBattleView.prototype.showEndGame = function () {
        ...
        this._isEnd = true;
        if (this._isAttackWin) {
            ViewController.getInstance().openView(ViewConst.BASE.BATTLEWIN, { f: this.endCallBack, o: this, num: this._winNumber, type: 2, fameAdd: 1 });
        }
        else {
...
//# sourceMappingURL=AtkraceBattleView.js.map