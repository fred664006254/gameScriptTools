...
*/
var PromotePlayerPopViewTab2 = (function (_super) {
    __extends(PromotePlayerPopViewTab2, _super);
    function PromotePlayerPopViewTab2() {
    ...
    Object.defineProperty(PromotePlayerPopViewTab2.prototype, "api", {
        get: function () {
    ...
    PromotePlayerPopViewTab2.prototype.initView = function () {
        var view = this;
    ...
    PromotePlayerPopViewTab2.prototype.refreshTopTitle = function (maskBg) {
        var view = this;
    ...
    PromotePlayerPopViewTab2.prototype.refreshWhenSwitchBack = function () {
        NetManager.request(NetRequestConst.REQUEST_PROMOTE_GETLIST, {
            sortKey: 2
        });
    };
    PromotePlayerPopViewTab2.prototype.getPromotePlayerlistCallBack = function (evt) {
    ...
    PromotePlayerPopViewTab2.prototype.freshList = function () {
        var view = this;
        //列表
    ...
    // 	return 220;
    // };
    PromotePlayerPopViewTab2.prototype.getSheepType = function () {
        return 2;
    };
    PromotePlayerPopViewTab2.prototype.dispose = function () {
        var view = this;
    ...
    return PromotePlayerPopViewTab2;
}(CommonViewTab));
__reflect(PromotePlayerPopViewTab2.prototype, "PromotePlayerPopViewTab2");
//# sourceMappingURL=PromotePlayerPopViewTab2.js.map