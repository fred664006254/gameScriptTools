...
*/
var PromotePlayerPopViewTab3 = (function (_super) {
    __extends(PromotePlayerPopViewTab3, _super);
    function PromotePlayerPopViewTab3() {
    ...
    Object.defineProperty(PromotePlayerPopViewTab3.prototype, "api", {
        get: function () {
    ...
    PromotePlayerPopViewTab3.prototype.initView = function () {
        var view = this;
    ...
    PromotePlayerPopViewTab3.prototype.refreshTopTitle = function (maskBg) {
        var view = this;
    ...
    PromotePlayerPopViewTab3.prototype.refreshWhenSwitchBack = function () {
        NetManager.request(NetRequestConst.REQUEST_PROMOTE_GETLIST, {
            sortKey: 3
        });
    };
    PromotePlayerPopViewTab3.prototype.getPromotePlayerlistCallBack = function (evt) {
        var view = this;
    ...
    PromotePlayerPopViewTab3.prototype.freshList = function () {
        var view = this;
        //列表
    ...
    // 	return 220;
    // };
    PromotePlayerPopViewTab3.prototype.getSheepType = function () {
        return 3;
    };
    PromotePlayerPopViewTab3.prototype.dispose = function () {
        var view = this;
    ...
    return PromotePlayerPopViewTab3;
}(CommonViewTab));
__reflect(PromotePlayerPopViewTab3.prototype, "PromotePlayerPopViewTab3");
//# sourceMappingURL=PromotePlayerPopViewTab3.js.map