...
var SkinRankScrollItem = (function (_super) {
    ...
    SkinRankScrollItem.prototype.initItem = function (index, data) {
        ...
        var startY = 16;
        if (index > 2) {
            var dinner_rankbg = BaseBitmap.create("dinner_rankbg");
            dinner_rankbg.x = 80 - dinner_rankbg.width / 2;
            dinner_rankbg.y = 5;
            this.addChild(dinner_rankbg);
            var titleTxt1 = ComponentManager.getTextField("", 20);
            titleTxt1.text = String(index + 1);
            titleTxt1.x = dinner_rankbg.x + dinner_rankbg.width / 2 - titleTxt1.width / 2;
            titleTxt1.y = dinner_rankbg.y + dinner_rankbg.height / 2 - titleTxt1.height / 2;
        ...
        titleTxt3.x = 355 - titleTxt3.width / 2;
        titleTxt3.y = startY;
...
//# sourceMappingURL=SkinRankScrollItem.js.map