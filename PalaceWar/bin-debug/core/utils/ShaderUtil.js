...
(function (App) {
    var ShaderUtil = (function () {
        ...
        ShaderUtil.setAcKiteLineShader = function (displayObject, offset, boffset) {
            if (App.DeviceUtil.CheckWebglRenderMode()) {
                var uniform = {
                    offset: offset,
                    boffset: boffset
                };
                var customFilter = new egret.CustomFilter(ShaderConst.TEXT_GRADIENT_VERT, ShaderConst.ACKITE_LINE_FRAG, uniform);
                displayObject.filters = [customFilter];
            }
        };
        ShaderUtil.removeShader = function (displayObject) {
            if (App.DeviceUtil.CheckWebglRenderMode()) {
                displayObject.filters = null;
            }
        };
