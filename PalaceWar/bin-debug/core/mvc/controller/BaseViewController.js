...
var BaseViewController = (function (_super) {
    ...
    function BaseViewController() {
        ...
        App.MessageHelper.addEventListener(MessageConst.MESSAGE_DPOBJCTR_ADDSTAGE, _this.showOrHideViewHandler, _this);
        App.MessageHelper.addEventListener(MessageConst.MESSAGE_DPOBJCTR_REMOVESTAGE, _this.showOrHideViewHandler, _this);
        return _this;
    }
    BaseViewController.prototype.showOrHideViewHandler = function (e) {
        ...
        if (tview instanceof CommonView) {
            ...
            if (LayerManager.panelLayer) {
                var numChild = LayerManager.panelLayer.numChildren;
                for (var i = numChild - 1; i >= 0; i--) {
                    var view = LayerManager.panelLayer.getChildAt(i);
    ...
    BaseViewController.prototype.hideTopView = function () {
        ...
        // 	return false;
        // }
        var msgParent = LayerManager.maskLayer;
        if (msgParent) {
        ...
        var parent = LayerManager.panelLayer;
        if (parent) {
