...
var ScrollList = (function (_super) {
    ...
    function ScrollList(pageNum) {
        ...
        _this._lastX = 0;
        _this._lastY = 0;
        _this._contentScaleX = 1;
        _this._contentScaleY = 1;
        _this._changeHandlerRect = new egret.Rectangle();
        /**
         * 每次刷新数量，就是每页数量
         */
        _this._pageNum = 20;
    ...
    ScrollList.prototype.setContentScale = function (scaleX, scaleY) {
        var oldScaleX = this._contentScaleX;
        var oldScaleY = this._contentScaleY;
        ...
        var scrollTop = this.scrollTop * scaleY / oldScaleY;
        if (oldScaleX > scaleX) {
            this.scrollLeft = 0;
        }
     ...
     */
    ScrollList.prototype.setScrollTopByIndex = function (index, duration, isMoveTop) {
        ...
        if (isMoveTop) {
            ...
            var maxY = endRect.y * this._contentScaleY + endRect.height * this._contentScaleY;
            var isTop = false;
            var isEnd = false;
            var scrollTop = this._scrollListHeightArr[index].y * this._contentScaleY;
            if (scrollTop < 0) {
                scrollTop = 0;
            }
            ...
            var endRect = this._scrollListHeightArr[this._scrollListHeightArr.length - 1];
            var maxY = (endRect.y + endRect.height) * this._contentScaleY;
            var isTop = false;
            var isEnd = false;
            var scrollTop = this._scrollListHeightArr[index].y * this._contentScaleY + this._scrollListHeightArr[index].height * this._contentScaleY / 2;
     ...
     */
    ScrollList.prototype.checkIsAtButtomRequest = function () {
        if (this._scrollListHeightArr.length > 0) {
            var lastIndex = this._scrollListHeightArr.length - 1;
            var maxY = this._scrollListHeightArr[lastIndex].y + this._scrollListHeightArr[lastIndex].height - this._scrollRect.height + 120;
            if (this.scrollTop >= maxY - this._scrollListItemArr[lastIndex].getSpaceY()) {
                return true;
            }
            else {
     ...
     */
    ScrollList.prototype.checkIsAtTopRequest = function () {
     ...
     */
    ScrollList.prototype.getCurrMaxScrollTop = function () {
        if (this._scrollListHeightArr.length > 0) {
            var lastIndex = this._scrollListHeightArr.length - 1;
            var maxY = this._scrollListHeightArr[lastIndex].y + this._scrollListHeightArr[lastIndex].height - this._scrollRect.height;
    ...
    ScrollList.prototype.moveChangeHandler = function () {
        if (this._changeCallBack) {
            this._changeCallBack.call(this._changeCallBackObj);
        }
    };
    ScrollList.prototype.bindChangeCallback = function (callback, callbackObj) {
