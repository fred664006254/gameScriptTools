...
var ScrollListItem = (function (_super) {
     ...
     */
    ScrollListItem.prototype.checkBounds = function () {
        return true;
    };
    ScrollListItem.prototype.getBounds = function (resultRect, calculateAnchor) {
        if (!this.checkBounds()) {
            resultRect = resultRect || new egret.Rectangle();
            resultRect.setTo(0, 0, this.width, this.height);
            return resultRect;
        }
        return _super.prototype.getBounds.call(this, resultRect, calculateAnchor);
    };
