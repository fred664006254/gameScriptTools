...
var GodBless = (function (_super) {
    ...
    GodBless.prototype.show = function (key) {
        ...
        var res = "godbless_" + this._config.name;
        if (Api.switchVoApi.checkIsInBlueWife() && RES.hasRes(res + "_blueType")) {
            res = res + "_blueType";
        }
        ResourceManager.loadResources(["godbless_tip_bg", "godbless_tip_bg2", "godbless_tip_word", res], [], this.init, null, this);
    };
    ...
    GodBless.prototype.showName = function () {
        var str = "godbless_" + this._config.name;
        if (Api.switchVoApi.checkIsInBlueWife() && RES.hasRes(str + "_blueType")) {
            str = str + "_blueType";
        }
        var name = BaseBitmap.create(str);
...
//# sourceMappingURL=GodBless.js.map